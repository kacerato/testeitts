...
public class b extends U4.a {
    ...
    public Quaternion f26581J = null;

    public final Vector2 f26584M = new Vector2();

    public final Vector3 f26585N = new Vector3();

    public final Vector3 f26586O = new Vector3();

    public final Vector3 f26587P = new Vector3();

    public final Quaternion f26588Q = new Quaternion();

    public final Quaternion f26589R = new Quaternion();

    public boolean f26590S = false;

    public final Vector3 f26591T = new Vector3(0.0f, 1.0f, 0.0f);

    private Vector3 L(GameObject gameObject) {
        Vector3 vector3 = new Vector3();
        w(gameObject, this.f26591T, vector3, this.f25759a);
        return vector3;
    }
    ...
    public void t(EditorCamera editorCamera, GameObject gameObject, GameObject camera, Transform axisTransform, Vector2 touchSlide, h touch, Panel3DView editor3DViewer) {
        l(editorCamera, editor3DViewer, touch, this.f26585N, this.f26584M);
        this.f26582K.f(this.f26584M);
        float d10 = this.f26582K.d();
        ...
        a(gameObject, this.f26581J, this.f26588Q, d10, 0.0f, 1.0f, 0.0f, editor3DViewer, this.f26589R);
        if (this.f26590S) {
            c(gameObject, this.f26589R, this.f26585N, this.f26587P);
        ...
        this.f26583L.c(quaternion, invertLocal);
        this.f26583L.d(editorCamera, axisTransform, editor3DViewer);
    }
    ...
    public void u(EditorCamera editorCamera, GameObject gameObject, GameObject camera, Transform axisTransform, Vector2 touchSlide, h touch, Panel3DView editor3DViewer) {
        ...
        gameObject.transform.C0(this.f26588Q);
        boolean y10 = y(gameObject, editor3DViewer, this.f26585N);
        this.f26590S = y10;
        if (y10) {
            gameObject.transform.u0(this.f26586O);
            e(this.f26588Q, this.f26586O, this.f26585N, this.f26587P);
        }
        l(editorCamera, editor3DViewer, touch, this.f26585N, this.f26584M);
        this.f26582K = new X4.a(this.f26584M);
        this.f26581J = gameObject.transform.h1();
        this.f26583L = new X4.b(new ColorINT(125, 68, 189, 50), this.f26582K, editorCamera, gameObject, editor3DViewer);
    }
