...
public class e extends c {
    ...
    public boolean f92639q;

    public e(String name, String path, d folder) {
    ...
    @Override
    public int w() {
        return this.f92639q ? R.color.colorAccent : super.w();
    }

    @Override
    public int y() {
        return this.f92639q ? R.color.colorAccent : super.y();
    }
