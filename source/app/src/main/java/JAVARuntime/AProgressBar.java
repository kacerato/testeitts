...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/Builder/aab_release.zip:base/assets/javaruntimelibraries.zip:AProgressBar.class
  base.apk:assets/Editor/Builder/app_release.zip:assets/javaruntimelibraries.zip:AProgressBar.class
  classes.dex
 */
@ClassCategory(cat = {"Android Views"})
public class AProgressBar extends ProgressBar implements AViewInstance {

    public class AnonymousClass1 extends AOnGenericMotionListener {
        final View.OnGenericMotionListener val$l;

        public AnonymousClass1(final View.OnGenericMotionListener val$l) {
            this.val$l = val$l;
        }
    ...
    public class AnonymousClass10 extends AOnCreateContextMenuListener {
        final View.OnCreateContextMenuListener val$l;

        public AnonymousClass10(final View.OnCreateContextMenuListener val$l) {
            this.val$l = val$l;
        }
    ...
    public class AnonymousClass2 extends AOnLongClickListener {
        final View.OnLongClickListener val$l;

        public AnonymousClass2(final View.OnLongClickListener val$l) {
            this.val$l = val$l;
        }
    ...
    public class AnonymousClass3 extends AOnClickListener {
        final View.OnClickListener val$l;

        public AnonymousClass3(final View.OnClickListener val$l) {
            this.val$l = val$l;
        }
    ...
    public class AnonymousClass4 extends AOnTouchListener {
        final View.OnTouchListener val$l;

        public AnonymousClass4(final View.OnTouchListener val$l) {
            this.val$l = val$l;
        }
    ...
    public class AnonymousClass5 extends AOnHoverListener {
        final View.OnHoverListener val$l;

        public AnonymousClass5(final View.OnHoverListener val$l) {
            this.val$l = val$l;
        }
    ...
    public class AnonymousClass6 extends AOnDragListener {
        final View.OnDragListener val$l;

        public AnonymousClass6(final View.OnDragListener val$l) {
            this.val$l = val$l;
        }
    ...
    public class AnonymousClass7 extends AOnKeyListener {
        final View.OnKeyListener val$l;

        public AnonymousClass7(final View.OnKeyListener val$l) {
            this.val$l = val$l;
        }
    ...
    public class AnonymousClass8 extends AOnScrollChangeListener {
        final View.OnScrollChangeListener val$l;

        public AnonymousClass8(final View.OnScrollChangeListener val$l) {
            this.val$l = val$l;
        }
    ...
    public class AnonymousClass9 extends AOnFocusChangeListener {
        final View.OnFocusChangeListener val$l;

        public AnonymousClass9(final View.OnFocusChangeListener val$l) {
            this.val$l = val$l;
        }
    ...
    public AProgressBar(String str) {
        super(null);
    }
