...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/Builder/aab_release.zip:base/assets/javaruntimelibraries.zip:PrecomputedAtmosphereSkybox2.class
  base.apk:assets/Editor/Builder/app_release.zip:assets/javaruntimelibraries.zip:PrecomputedAtmosphereSkybox2.class
  classes.dex
 */
@ClassCategory(cat = {"Post processing"})
public class PrecomputedAtmosphereSkybox2 extends Component {
    @HideGetSet
