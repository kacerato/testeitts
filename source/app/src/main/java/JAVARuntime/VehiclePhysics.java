...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/Builder/aab_release.zip:base/assets/javaruntimelibraries.zip:VehiclePhysics.class
  base.apk:assets/Editor/Builder/app_release.zip:assets/javaruntimelibraries.zip:VehiclePhysics.class
  classes.dex
 */
@ClassCategory(cat = {"Physics"})
public class VehiclePhysics extends Component {
    public void setTorque(float f10, int i10) {
    }

    public void setBrake(float f10, int i10) {
    }

    public void setSteer(float f10, int i10) {
    }
