...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/Builder/aab_release.zip:base/assets/javaruntimelibraries.zip:EmbeddedMatMR.class
  base.apk:assets/Editor/Builder/app_release.zip:assets/javaruntimelibraries.zip:EmbeddedMatMR.class
  classes.dex
 */
@ClassCategory(cat = {"Rendering", "Components"})
public final class EmbeddedMatMR extends Component {
    ...
    public EmbeddedMatMR(Vertex vertex) {
    }
