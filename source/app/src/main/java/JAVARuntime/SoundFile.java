...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/Builder/aab_release.zip:base/assets/javaruntimelibraries.zip:SoundFile.class
  base.apk:assets/Editor/Builder/app_release.zip:assets/javaruntimelibraries.zip:SoundFile.class
  classes.dex
 */
...
public class SoundFile {
    ...
    public class AnonymousClass1 implements m {
        ...
        public C5.b getInspector(Context context, final k constructor, String tittle, q userPointer) {
            return new C5.b(new h() {
                /* JADX WARN: Type inference failed for: r0v2, types: [JAVARuntime.SoundFile, jb.a] */
                @Override
                public Variable get() {
                    ?? r02 = (SoundFile) constructor.getValue();
            ...
            }, tittle, b.a.InputFile, SoundFile.access$000());
        }
        ...
        /* JADX WARN: Type inference failed for: r3v1, types: [JAVARuntime.SoundFile, jb.a] */
        @Override
    ...
    public class AnonymousClass2 implements i {
        ...
        public C5.b getInspector(Context context, final Field field, final Object classInstance, String tittle, final n getSetterListener, q userPointer) {
            return new C5.b(new h() {
                /* JADX WARN: Type inference failed for: r0v4, types: [JAVARuntime.SoundFile, jb.a] */
                @Override
                public Variable get() {
                    try {
                        ?? r02 = (SoundFile) field.get(classInstance);
                        return r02 != 0 ? new Variable("", r02.getFilePath(), Variable.a.File) : new Variable("", "", Variable.a.File);
                ...
                public void set(Variable variable) {
                    ...
                    SoundFile soundFile = new SoundFile(variable.str_value);
                    try {
                        field.set(classInstance, soundFile);
                    } catch (IllegalAccessException e10) {
                        e10.printStackTrace();
                    }
