...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/Builder/aab_release.zip:base/assets/javaruntimelibraries.zip:ACheckBox.class
  base.apk:assets/Editor/Builder/app_release.zip:assets/javaruntimelibraries.zip:ACheckBox.class
  classes.dex
 */
@ClassCategory(cat = {"Android Views"})
public class ACheckBox extends CheckBox implements AViewInstance {
