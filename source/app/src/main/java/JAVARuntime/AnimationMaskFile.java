...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/Builder/aab_release.zip:base/assets/javaruntimelibraries.zip:AnimationMaskFile.class
  base.apk:assets/Editor/Builder/app_release.zip:assets/javaruntimelibraries.zip:AnimationMaskFile.class
  classes.dex
 */
@ClassCategory(cat = {"Animations", "Files"})
public final class AnimationMaskFile {
    ...
    public class AnonymousClass1 implements m {
        ...
        public C5.b getInspector(Context context, final k constructor, String tittle, q userPointer) {
            return new C5.b(new h() {
                /* JADX WARN: Type inference failed for: r0v2, types: [JAVARuntime.AnimationMaskFile, jb.a] */
                @Override
                public Variable get() {
                    ?? r02 = (AnimationMaskFile) constructor.getValue();
                ...
                public void set(Variable variable) {
                    ...
                    constructor.setValue(new AnimationMaskFile(variable.str_value));
                }
            }, tittle, b.a.InputFile, AnimationMaskFile.access$000());
        }
        ...
        public Object restore(Variable variable, q userPointer) {
            if (variable.type == Variable.a.File) {
                return new AnimationMaskFile(variable.str_value);
            }
            return null;
        }

        /* JADX WARN: Type inference failed for: r3v1, types: [JAVARuntime.AnimationMaskFile, jb.a] */
        @Override
        public Variable save(String fieldName, Object value, q userPointer) {
            ?? r32 = (AnimationMaskFile) value;
    ...
    public class AnonymousClass2 implements i {
        ...
        public C5.b getInspector(Context context, final Field field, final Object classInstance, String tittle, final n getSetterListener, q userPointer) {
            return new C5.b(new h() {
                /* JADX WARN: Type inference failed for: r0v4, types: [JAVARuntime.AnimationMaskFile, jb.a] */
                @Override
                public Variable get() {
                    try {
                        ?? r02 = (AnimationMaskFile) field.get(classInstance);
                        return r02 != 0 ? new Variable("", r02.getFilePath(), Variable.a.File) : new Variable("", "", Variable.a.File);
                ...
                public void set(Variable variable) {
                    ...
                    AnimationMaskFile animationMaskFile = new AnimationMaskFile(variable.str_value);
                    try {
                        field.set(classInstance, animationMaskFile);
                    } catch (IllegalAccessException e10) {
                        e10.printStackTrace();
                    }
                    n nVar = getSetterListener;
                    if (nVar != null) {
                        nVar.a(animationMaskFile);
                    }
                }
            }, tittle, b.a.InputFile, AnimationMaskFile.access$000());
        }
        ...
        public C5.b getInspectorForArray(Context context, final Object[] array, final int position, Object classInstance, String tittle, final n getSetterListener, q userPointer) {
            return new C5.b(new h() {
                ...
                @Override
                public Variable get() {
                    ?? r02 = (AnimationMaskFile) array[position];
                ...
                public void set(Variable variable) {
                    ...
                    AnimationMaskFile animationMaskFile = new AnimationMaskFile(variable.str_value);
                    array[position] = animationMaskFile;
                    n nVar = getSetterListener;
                    if (nVar != null) {
                        nVar.a(animationMaskFile);
                    }
        ...
        public C5.b getInspectorForList(Context context, final d8.h list, final int position, Object classInstance, String tittle, final n getSetterListener, q userPointer) {
            return new C5.b(new h() {
                ...
                @Override
                public Variable get() {
                    ?? r02 = (AnimationMaskFile) list.a(position);
                    return r02 != 0 ? new Variable("temp", r02.getFilePath(), Variable.a.File) : new Variable("", "", Variable.a.File);
                }
                ...
                public void set(Variable variable) {
                    ...
                    AnimationMaskFile animationMaskFile = new AnimationMaskFile(variable.str_value);
                    list.b(position, animationMaskFile);
                    n nVar = getSetterListener;
                    if (nVar != null) {
                        nVar.a(animationMaskFile);
                    }
