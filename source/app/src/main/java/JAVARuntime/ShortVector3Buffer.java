...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/Builder/aab_release.zip:base/assets/javaruntimelibraries.zip:ShortVector3Buffer.class
  base.apk:assets/Editor/Builder/app_release.zip:assets/javaruntimelibraries.zip:ShortVector3Buffer.class
  classes.dex
 */
@ClassCategory(cat = {"Vector", "Buffers"})
public class ShortVector3Buffer {
    public ShortVector3Buffer(int i10) {
    }

    public ShortVector3Buffer(NativeShortBuffer nativeShortBuffer) {
    }

    public Vector3 get(int i10) {
        return null;
    }
