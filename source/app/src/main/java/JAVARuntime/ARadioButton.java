...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/Builder/aab_release.zip:base/assets/javaruntimelibraries.zip:ARadioButton.class
  base.apk:assets/Editor/Builder/app_release.zip:assets/javaruntimelibraries.zip:ARadioButton.class
  classes.dex
 */
@ClassCategory(cat = {"Android Views"})
public class ARadioButton extends RadioButton implements AViewInstance {
