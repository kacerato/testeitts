...
public abstract class G extends c0 {
    ...
    public static final long f27444u = 1;

    public transient float[] f27445q;

    public float f27446r;

    public short f27447s;

    public boolean f27448t;

    public G() {
        this.f27446r = 0.0f;
        this.f27447s = (short) 0;
    }
    ...
    */
    ...
    public int of(float f10, int i10, int i11, byte b10) {
        int length = this.f27445q.length;
    ...
    public int pf(float f10) {
        ...
        this.f27448t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27445q[length] == f10) ? (-length) - 1 : rf(f10, length, c10, b10);
        }
        this.f27448t = true;
        qf(length, f10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27446r = objectInput.readFloat();
        this.f27447s = objectInput.readShort();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeFloat(this.f27446r);
        objectOutput.writeShort(this.f27447s);
    }
    ...
    public G(int i10, float f10, float f11, short s10) {
        super(i10, f10);
        this.f27446r = f11;
        this.f27447s = s10;
    }
