...
public abstract class T extends c0 {
    ...
    public static final long f27505u = 1;

    public transient long[] f27506q;
    ...
    */
    ...
    public int of(long j10, int i10, int i11, byte b10) {
        int length = this.f27506q.length;
    ...
    public int pf(long j10) {
        ...
        this.f27509t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27506q[length] == j10) ? (-length) - 1 : rf(j10, length, e10, b10);
        }
        this.f27509t = true;
        qf(length, j10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27507r = objectInput.readLong();
        this.f27508s = objectInput.readByte();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeLong(this.f27507r);
        objectOutput.writeByte(this.f27508s);
    }
    ...
    public T(int i10, float f10, long j10, byte b10) {
        super(i10, f10);
        this.f27507r = j10;
        this.f27508s = b10;
    }
