...
public abstract class AbstractC3163f extends c0 {

    public static final long f27588u = 1;

    public transient byte[] f27589q;
    ...
    */
    ...
    public int of(byte b10, int i10, int i11, byte b11) {
        int length = this.f27589q.length;
    ...
    public int pf(byte b10) {
        ...
        this.f27592t = false;
        if (b11 != 0) {
            return (b11 == 1 && this.f27589q[length] == b10) ? (-length) - 1 : rf(b10, length, d10, b11);
        }
        this.f27592t = true;
        qf(length, b10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27590r = objectInput.readByte();
        this.f27591s = objectInput.readInt();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeByte(this.f27590r);
        objectOutput.writeInt(this.f27591s);
    }

    public AbstractC3163f(int i10) {
        super(i10);
        this.f27590r = (byte) 0;
        this.f27591s = 0;
    }

    public AbstractC3163f(int i10, float f10) {
        super(i10, f10);
        this.f27590r = (byte) 0;
        this.f27591s = 0;
    }

    public AbstractC3163f(int i10, float f10, byte b10, int i11) {
        super(i10, f10);
        this.f27590r = b10;
        this.f27591s = i11;
    }
