...
public abstract class N extends c0 {
    ...
    public static final long f27481u = 1;

    public transient int[] f27482q;

    public int f27483r;

    public float f27484s;
    ...
    */
    ...
    public int of(int i10, int i11, int i12, byte b10) {
        int length = this.f27482q.length;
    ...
    public int pf(int i10) {
        ...
        this.f27485t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27482q[length] == i10) ? (-length) - 1 : rf(i10, length, d10, b10);
        }
        this.f27485t = true;
        qf(length, i10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27483r = objectInput.readInt();
        this.f27484s = objectInput.readFloat();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeInt(this.f27483r);
        objectOutput.writeFloat(this.f27484s);
    }
    ...
    public N(int i10, float f10, int i11, float f11) {
        super(i10, f10);
        this.f27483r = i11;
        this.f27484s = f11;
    }
