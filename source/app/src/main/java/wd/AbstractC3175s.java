...
public abstract class AbstractC3175s extends c0 {

    public static final long f27678u = 1;

    public transient double[] f27679q;

    public double f27680r;

    public char f27681s;

    public boolean f27682t;

    public AbstractC3175s() {
        this.f27680r = 0.0d;
        this.f27681s = (char) 0;
    }
    ...
    */
    ...
    public int of(double d10, int i10, int i11, byte b10) {
        int length = this.f27679q.length;
    ...
    public int pf(double d10) {
        ...
        this.f27682t = false;
        if (b11 != 0) {
            return (b11 == 1 && this.f27679q[length] == d10) ? (-length) - 1 : rf(d10, length, b10, b11);
        }
        this.f27682t = true;
        qf(length, d10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27680r = objectInput.readDouble();
        this.f27681s = objectInput.readChar();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeDouble(this.f27680r);
        objectOutput.writeChar(this.f27681s);
    }

    public AbstractC3175s(int i10) {
        super(i10);
        this.f27680r = 0.0d;
        this.f27681s = (char) 0;
    }

    public AbstractC3175s(int i10, float f10) {
        super(i10, f10);
        this.f27680r = 0.0d;
        this.f27681s = (char) 0;
    }

    public AbstractC3175s(int i10, float f10, double d10, char c10) {
        super(i10, f10);
        this.f27680r = d10;
        this.f27681s = c10;
    }
