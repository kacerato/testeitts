...
public abstract class j0 extends c0 {
    ...
    public static final long f27632u = 1;

    public transient short[] f27633q;

    public short f27634r;
    ...
    */
    ...
    public int of(short s10, int i10, int i11, byte b10) {
        int length = this.f27633q.length;
    ...
    public int pf(short s10) {
        ...
        this.f27636t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27633q[length] == s10) ? (-length) - 1 : rf(s10, length, d10, b10);
        }
        this.f27636t = true;
        qf(length, s10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27634r = objectInput.readShort();
        this.f27635s = objectInput.readLong();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeShort(this.f27634r);
        objectOutput.writeLong(this.f27635s);
    }
    ...
    public j0(int i10, float f10, short s10, long j10) {
        super(i10, f10);
        this.f27634r = s10;
        this.f27635s = j10;
    }
