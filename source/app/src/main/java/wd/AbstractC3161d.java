...
public abstract class AbstractC3161d extends c0 {

    public static final long f27569u = 1;

    public transient byte[] f27570q;

    public byte f27571r;

    public float f27572s;
    ...
    */
    ...
    public int of(byte b10, int i10, int i11, byte b11) {
        int length = this.f27570q.length;
    ...
    public int pf(byte b10) {
        ...
        this.f27573t = false;
        if (b11 != 0) {
            return (b11 == 1 && this.f27570q[length] == b10) ? (-length) - 1 : rf(b10, length, d10, b11);
        }
        this.f27573t = true;
        qf(length, b10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27571r = objectInput.readByte();
        this.f27572s = objectInput.readFloat();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeByte(this.f27571r);
        objectOutput.writeFloat(this.f27572s);
    }

    public AbstractC3161d(int i10) {
        super(i10);
        this.f27571r = (byte) 0;
        this.f27572s = 0.0f;
    }

    public AbstractC3161d(int i10, float f10) {
        super(i10, f10);
        this.f27571r = (byte) 0;
        this.f27572s = 0.0f;
    }

    public AbstractC3161d(int i10, float f10, byte b10, float f11) {
        super(i10, f10);
        this.f27571r = b10;
        this.f27572s = f11;
    }
