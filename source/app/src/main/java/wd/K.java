...
public abstract class K extends c0 {
    ...
    public static final long f27466u = 1;

    public transient int[] f27467q;
    ...
    */
    ...
    public int of(int i10, int i11, int i12, byte b10) {
        int length = this.f27467q.length;
    ...
    public int pf(int i10) {
        ...
        this.f27470t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27467q[length] == i10) ? (-length) - 1 : rf(i10, length, d10, b10);
        }
        this.f27470t = true;
        qf(length, i10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27468r = objectInput.readInt();
        this.f27469s = objectInput.readByte();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeInt(this.f27468r);
        objectOutput.writeByte(this.f27469s);
    }
    ...
    public K(int i10, float f10, int i11, byte b10) {
        super(i10, f10);
        this.f27468r = i11;
        this.f27469s = b10;
    }
