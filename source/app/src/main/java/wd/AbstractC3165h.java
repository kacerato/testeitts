...
public abstract class AbstractC3165h extends c0 {

    public static final long f27608u = 1;

    public transient byte[] f27609q;

    public byte f27610r;

    public short f27611s;

    public boolean f27612t;

    public AbstractC3165h() {
        this.f27610r = (byte) 0;
        this.f27611s = (short) 0;
    }
    ...
    */
    ...
    public int of(byte b10, int i10, int i11, byte b11) {
        int length = this.f27609q.length;
    ...
    public int pf(byte b10) {
        ...
        this.f27612t = false;
        if (b11 != 0) {
            return (b11 == 1 && this.f27609q[length] == b10) ? (-length) - 1 : rf(b10, length, d10, b11);
        }
        this.f27612t = true;
        qf(length, b10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27610r = objectInput.readByte();
        this.f27611s = objectInput.readShort();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeByte(this.f27610r);
        objectOutput.writeShort(this.f27611s);
    }

    public AbstractC3165h(int i10) {
        super(i10);
        this.f27610r = (byte) 0;
        this.f27611s = (short) 0;
    }

    public AbstractC3165h(int i10, float f10) {
        super(i10, f10);
        this.f27610r = (byte) 0;
        this.f27611s = (short) 0;
    }

    public AbstractC3165h(int i10, float f10, byte b10, short s10) {
        super(i10, f10);
        this.f27610r = b10;
        this.f27611s = s10;
    }
