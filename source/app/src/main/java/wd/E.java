...
public abstract class E extends c0 {
    ...
    public static final long f27434u = 1;

    public transient float[] f27435q;
    ...
    */
    ...
    public int of(float f10, int i10, int i11, byte b10) {
        int length = this.f27435q.length;
    ...
    public int pf(float f10) {
        ...
        this.f27438t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27435q[length] == f10) ? (-length) - 1 : rf(f10, length, c10, b10);
        }
        this.f27438t = true;
        qf(length, f10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27436r = objectInput.readFloat();
        this.f27437s = objectInput.readInt();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeFloat(this.f27436r);
        objectOutput.writeInt(this.f27437s);
    }
