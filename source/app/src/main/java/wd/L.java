...
public abstract class L extends c0 {
    ...
    public static final long f27471u = 1;

    public transient int[] f27472q;
    ...
    */
    ...
    public int of(int i10, int i11, int i12, byte b10) {
        int length = this.f27472q.length;
    ...
    public int pf(int i10) {
        ...
        this.f27475t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27472q[length] == i10) ? (-length) - 1 : rf(i10, length, d10, b10);
        }
        this.f27475t = true;
        qf(length, i10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27473r = objectInput.readInt();
        this.f27474s = objectInput.readChar();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeInt(this.f27473r);
        objectOutput.writeChar(this.f27474s);
    }
    ...
    public L(int i10, float f10, int i11, char c10) {
        super(i10, f10);
        this.f27473r = i11;
        this.f27474s = c10;
    }
