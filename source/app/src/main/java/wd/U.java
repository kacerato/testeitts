...
public abstract class U extends c0 {
    ...
    public static final long f27510u = 1;

    public transient long[] f27511q;

    public long f27512r;

    public char f27513s;

    public boolean f27514t;
    ...
    */
    ...
    public int of(long j10, int i10, int i11, byte b10) {
        int length = this.f27511q.length;
    ...
    public int pf(long j10) {
        ...
        this.f27514t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27511q[length] == j10) ? (-length) - 1 : rf(j10, length, e10, b10);
        }
        this.f27514t = true;
        qf(length, j10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27512r = objectInput.readLong();
        this.f27513s = objectInput.readChar();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeLong(this.f27512r);
        objectOutput.writeChar(this.f27513s);
    }
    ...
    public U(int i10, float f10, long j10, char c10) {
        super(i10, f10);
        this.f27512r = j10;
        this.f27513s = c10;
    }
