...
public abstract class F extends c0 {
    ...
    public static final long f27439u = 1;

    public transient float[] f27440q;

    public float f27441r;
    ...
    */
    ...
    public int of(float f10, int i10, int i11, byte b10) {
        int length = this.f27440q.length;
    ...
    public int pf(float f10) {
        ...
        this.f27443t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27440q[length] == f10) ? (-length) - 1 : rf(f10, length, c10, b10);
        }
        this.f27443t = true;
        qf(length, f10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27441r = objectInput.readFloat();
        this.f27442s = objectInput.readLong();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeFloat(this.f27441r);
        objectOutput.writeLong(this.f27442s);
    }
    ...
    public F(int i10, float f10, float f11, long j10) {
        super(i10, f10);
        this.f27441r = f11;
        this.f27442s = j10;
    }
