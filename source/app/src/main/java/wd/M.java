...
public abstract class M extends c0 {
    ...
    public static final long f27476u = 1;

    public transient int[] f27477q;

    public int f27478r;

    public double f27479s;
    ...
    */
    ...
    public int of(int i10, int i11, int i12, byte b10) {
        int length = this.f27477q.length;
    ...
    public int pf(int i10) {
        ...
        this.f27480t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27477q[length] == i10) ? (-length) - 1 : rf(i10, length, d10, b10);
        }
        this.f27480t = true;
        qf(length, i10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27478r = objectInput.readInt();
        this.f27479s = objectInput.readDouble();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeInt(this.f27478r);
        objectOutput.writeDouble(this.f27479s);
    }
    ...
    public M(int i10, float f10, int i11, double d10) {
        super(i10, f10);
        this.f27478r = i11;
        this.f27479s = d10;
    }
