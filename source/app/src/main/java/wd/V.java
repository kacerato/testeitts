...
public abstract class V extends c0 {
    ...
    public static final long f27515u = 1;

    public transient long[] f27516q;

    public long f27517r;

    public double f27518s;
    ...
    */
    ...
    public int pf(long j10) {
        ...
        this.f27519t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27516q[length] == j10) ? (-length) - 1 : rf(j10, length, e10, b10);
        }
        this.f27519t = true;
        qf(length, j10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27517r = objectInput.readLong();
        this.f27518s = objectInput.readDouble();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeLong(this.f27517r);
        objectOutput.writeDouble(this.f27518s);
    }
    ...
    public V(int i10, float f10, long j10, double d10) {
        super(i10, f10);
        this.f27517r = j10;
        this.f27518s = d10;
    }
