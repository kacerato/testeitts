...
public abstract class AbstractC3159b extends c0 {

    public static final long f27549u = 1;

    public transient byte[] f27550q;
    ...
    */
    ...
    public int of(byte b10, int i10, int i11, byte b11) {
        int length = this.f27550q.length;
    ...
    public int pf(byte b10) {
        ...
        this.f27553t = false;
        if (b11 != 0) {
            return (b11 == 1 && this.f27550q[length] == b10) ? (-length) - 1 : rf(b10, length, d10, b11);
        }
        this.f27553t = true;
        qf(length, b10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27551r = objectInput.readByte();
        this.f27552s = objectInput.readChar();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeByte(this.f27551r);
        objectOutput.writeChar(this.f27552s);
    }

    public AbstractC3159b(int i10) {
        super(i10);
        this.f27551r = (byte) 0;
        this.f27552s = (char) 0;
    }

    public AbstractC3159b(int i10, float f10) {
        super(i10, f10);
        this.f27551r = (byte) 0;
        this.f27552s = (char) 0;
    }

    public AbstractC3159b(int i10, float f10, byte b10, char c10) {
        super(i10, f10);
        this.f27551r = b10;
        this.f27552s = c10;
    }
