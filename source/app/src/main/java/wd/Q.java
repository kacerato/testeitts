...
public abstract class Q extends c0 {
    ...
    public static final long f27495u = 1;

    public transient int[] f27496q;
    ...
    */
    ...
    public int of(int i10, int i11, int i12, byte b10) {
        int length = this.f27496q.length;
    ...
    public int pf(int i10) {
        ...
        this.f27499t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27496q[length] == i10) ? (-length) - 1 : rf(i10, length, d10, b10);
        }
        this.f27499t = true;
        qf(length, i10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27497r = objectInput.readInt();
        this.f27498s = objectInput.readLong();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeInt(this.f27497r);
        objectOutput.writeLong(this.f27498s);
    }
    ...
    public Q(int i10, float f10, int i11, long j10) {
        super(i10, f10);
        this.f27497r = i11;
        this.f27498s = j10;
    }
