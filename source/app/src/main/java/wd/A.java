...
public abstract class A extends c0 {
    ...
    public static final long f27415u = 1;

    public transient float[] f27416q;

    public float f27417r;
    ...
    */
    ...
    public int of(float f10, int i10, int i11, byte b10) {
        int length = this.f27416q.length;
    ...
    public int pf(float f10) {
        ...
        this.f27419t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27416q[length] == f10) ? (-length) - 1 : rf(f10, length, c10, b10);
        }
        this.f27419t = true;
        qf(length, f10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27417r = objectInput.readFloat();
        this.f27418s = objectInput.readChar();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeFloat(this.f27417r);
        objectOutput.writeChar(this.f27418s);
    }
    ...
    public A(int i10, float f10, float f11, char c10) {
        super(i10, f10);
        this.f27417r = f11;
        this.f27418s = c10;
    }
