...
public abstract class i0 extends c0 {
    ...
    public static final long f27622u = 1;

    public transient short[] f27623q;

    public short f27624r;
    ...
    */
    ...
    public int of(short s10, int i10, int i11, byte b10) {
        int length = this.f27623q.length;
    ...
    public int pf(short s10) {
        ...
        this.f27626t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27623q[length] == s10) ? (-length) - 1 : rf(s10, length, d10, b10);
        }
        this.f27626t = true;
        qf(length, s10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27624r = objectInput.readShort();
        this.f27625s = objectInput.readInt();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeShort(this.f27624r);
        objectOutput.writeInt(this.f27625s);
    }
    ...
    public i0(int i10, float f10, short s10, int i11) {
        super(i10, f10);
        this.f27624r = s10;
        this.f27625s = i11;
    }
