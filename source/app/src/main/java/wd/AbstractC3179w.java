...
public abstract class AbstractC3179w extends c0 {

    public static final long f27697u = 1;

    public transient double[] f27698q;

    public double f27699r;

    public int f27700s;

    public boolean f27701t;

    public AbstractC3179w() {
        this.f27699r = 0.0d;
        this.f27700s = 0;
    }
    ...
    */
    ...
    public int of(double d10, int i10, int i11, byte b10) {
        int length = this.f27698q.length;
    ...
    public int pf(double d10) {
        ...
        this.f27701t = false;
        if (b11 != 0) {
            return (b11 == 1 && this.f27698q[length] == d10) ? (-length) - 1 : rf(d10, length, b10, b11);
        }
        this.f27701t = true;
        qf(length, d10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27699r = objectInput.readDouble();
        this.f27700s = objectInput.readInt();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeDouble(this.f27699r);
        objectOutput.writeInt(this.f27700s);
    }

    public AbstractC3179w(int i10) {
        super(i10);
        this.f27699r = 0.0d;
        this.f27700s = 0;
    }

    public AbstractC3179w(int i10, float f10) {
        super(i10, f10);
        this.f27699r = 0.0d;
        this.f27700s = 0;
    }

    public AbstractC3179w(int i10, float f10, double d10, int i11) {
        super(i10, f10);
        this.f27699r = d10;
        this.f27700s = i11;
    }
