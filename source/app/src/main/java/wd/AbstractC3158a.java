...
public abstract class AbstractC3158a extends c0 {

    public static final long f27539u = 1;

    public transient byte[] f27540q;
    ...
    */
    ...
    public int of(byte b10, int i10, int i11, byte b11) {
        int length = this.f27540q.length;
    ...
    public int pf(byte b10) {
        ...
        this.f27543t = false;
        if (b11 != 0) {
            return (b11 == 1 && this.f27540q[length] == b10) ? (-length) - 1 : rf(b10, length, d10, b11);
        }
        this.f27543t = true;
        qf(length, b10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27541r = objectInput.readByte();
        this.f27542s = objectInput.readByte();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeByte(this.f27541r);
        objectOutput.writeByte(this.f27542s);
    }

    public AbstractC3158a(int i10) {
        super(i10);
        this.f27541r = (byte) 0;
        this.f27542s = (byte) 0;
    }

    public AbstractC3158a(int i10, float f10) {
        super(i10, f10);
        this.f27541r = (byte) 0;
        this.f27542s = (byte) 0;
    }

    public AbstractC3158a(int i10, float f10, byte b10, byte b11) {
        super(i10, f10);
        this.f27541r = b10;
        this.f27542s = b11;
    }
