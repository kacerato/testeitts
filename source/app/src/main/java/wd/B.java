...
public abstract class B extends c0 {
    ...
    public static final long f27420u = 1;

    public transient float[] f27421q;

    public float f27422r;

    public double f27423s;
    ...
    */
    ...
    public int of(float f10, int i10, int i11, byte b10) {
        int length = this.f27421q.length;
    ...
    public int pf(float f10) {
        ...
        this.f27424t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27421q[length] == f10) ? (-length) - 1 : rf(f10, length, c10, b10);
        }
        this.f27424t = true;
        qf(length, f10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27422r = objectInput.readFloat();
        this.f27423s = objectInput.readDouble();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeFloat(this.f27422r);
        objectOutput.writeDouble(this.f27423s);
    }
    ...
    public B(int i10, float f10, float f11, double d10) {
        super(i10, f10);
        this.f27422r = f11;
        this.f27423s = d10;
    }
