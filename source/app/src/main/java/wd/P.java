...
public abstract class P extends c0 {
    ...
    public static final long f27490u = 1;

    public transient int[] f27491q;
    ...
    */
    ...
    public int of(int i10, int i11, int i12, byte b10) {
        int length = this.f27491q.length;
    ...
    public int pf(int i10) {
        ...
        this.f27494t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27491q[length] == i10) ? (-length) - 1 : rf(i10, length, d10, b10);
        }
        this.f27494t = true;
        qf(length, i10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27492r = objectInput.readInt();
        this.f27493s = objectInput.readInt();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeInt(this.f27492r);
        objectOutput.writeInt(this.f27493s);
    }
