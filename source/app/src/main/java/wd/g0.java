...
public abstract class g0 extends c0 {
    ...
    public static final long f27603u = 1;

    public transient short[] f27604q;

    public short f27605r;
    ...
    */
    ...
    public int of(short s10, int i10, int i11, byte b10) {
        int length = this.f27604q.length;
    ...
    public int pf(short s10) {
        ...
        this.f27607t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27604q[length] == s10) ? (-length) - 1 : rf(s10, length, d10, b10);
        }
        this.f27607t = true;
        qf(length, s10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27605r = objectInput.readShort();
        this.f27606s = objectInput.readFloat();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeShort(this.f27605r);
        objectOutput.writeFloat(this.f27606s);
    }
    ...
    public g0(int i10, float f10, short s10, float f11) {
        super(i10, f10);
        this.f27605r = s10;
        this.f27606s = f11;
    }
