...
public abstract class k0 extends c0 {
    ...
    public static final long f27642u = 1;

    public transient short[] f27643q;

    public short f27644r;

    public short f27645s;

    public boolean f27646t;

    public k0() {
        this.f27644r = (short) 0;
        this.f27645s = (short) 0;
    }
    ...
    */
    ...
    public int of(short s10, int i10, int i11, byte b10) {
        int length = this.f27643q.length;
    ...
    public int pf(short s10) {
        ...
        this.f27646t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27643q[length] == s10) ? (-length) - 1 : rf(s10, length, d10, b10);
        }
        this.f27646t = true;
        qf(length, s10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27644r = objectInput.readShort();
        this.f27645s = objectInput.readShort();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeShort(this.f27644r);
        objectOutput.writeShort(this.f27645s);
    }
    ...
    public k0(int i10, float f10, short s10, short s11) {
        super(i10, f10);
        this.f27644r = s10;
        this.f27645s = s11;
    }
