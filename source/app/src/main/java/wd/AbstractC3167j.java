...
public abstract class AbstractC3167j extends c0 {

    public static final long f27627u = 1;

    public transient char[] f27628q;
    ...
    */
    ...
    public int of(char c10, int i10, int i11, byte b10) {
        int length = this.f27628q.length;
    ...
    public int pf(char c10) {
        ...
        this.f27631t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27628q[length] == c10) ? (-length) - 1 : rf(c10, length, d10, b10);
        }
        this.f27631t = true;
        qf(length, c10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27629r = objectInput.readChar();
        this.f27630s = objectInput.readChar();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeChar(this.f27629r);
        objectOutput.writeChar(this.f27630s);
    }

    public AbstractC3167j(int i10) {
        super(i10);
        this.f27629r = (char) 0;
        this.f27630s = (char) 0;
    }

    public AbstractC3167j(int i10, float f10) {
        super(i10, f10);
        this.f27629r = (char) 0;
        this.f27630s = (char) 0;
    }

    public AbstractC3167j(int i10, float f10, char c10, char c11) {
        super(i10, f10);
        this.f27629r = c10;
        this.f27630s = c11;
    }
