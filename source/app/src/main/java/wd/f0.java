...
public abstract class f0 extends c0 {
    ...
    public static final long f27593u = 1;

    public transient short[] f27594q;

    public short f27595r;

    public double f27596s;

    public boolean f27597t;

    public f0() {
        this.f27595r = (short) 0;
        this.f27596s = 0.0d;
    }
    ...
    */
    ...
    public int of(short s10, int i10, int i11, byte b10) {
        int length = this.f27594q.length;
    ...
    public int pf(short s10) {
        ...
        this.f27597t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27594q[length] == s10) ? (-length) - 1 : rf(s10, length, d10, b10);
        }
        this.f27597t = true;
        qf(length, s10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27595r = objectInput.readShort();
        this.f27596s = objectInput.readDouble();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeShort(this.f27595r);
        objectOutput.writeDouble(this.f27596s);
    }
    ...
    public f0(int i10, float f10, short s10, double d10) {
        super(i10, f10);
        this.f27595r = s10;
        this.f27596s = d10;
    }
