...
public abstract class AbstractC3160c extends c0 {

    public static final long f27559u = 1;

    public transient byte[] f27560q;

    public byte f27561r;

    public double f27562s;

    public boolean f27563t;

    public AbstractC3160c() {
        this.f27561r = (byte) 0;
        this.f27562s = 0.0d;
    }
    ...
    */
    ...
    public int of(byte b10, int i10, int i11, byte b11) {
        int length = this.f27560q.length;
    ...
    public int pf(byte b10) {
        ...
        this.f27563t = false;
        if (b11 != 0) {
            return (b11 == 1 && this.f27560q[length] == b10) ? (-length) - 1 : rf(b10, length, d10, b11);
        }
        this.f27563t = true;
        qf(length, b10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27561r = objectInput.readByte();
        this.f27562s = objectInput.readDouble();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeByte(this.f27561r);
        objectOutput.writeDouble(this.f27562s);
    }

    public AbstractC3160c(int i10) {
        super(i10);
        this.f27561r = (byte) 0;
        this.f27562s = 0.0d;
    }

    public AbstractC3160c(int i10, float f10) {
        super(i10, f10);
        this.f27561r = (byte) 0;
        this.f27562s = 0.0d;
    }

    public AbstractC3160c(int i10, float f10, byte b10, double d10) {
        super(i10, f10);
        this.f27561r = b10;
        this.f27562s = d10;
    }
