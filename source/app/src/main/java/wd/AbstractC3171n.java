...
public abstract class AbstractC3171n extends c0 {

    public static final long f27656u = 1;

    public transient char[] f27657q;
    ...
    */
    ...
    public int of(char c10, int i10, int i11, byte b10) {
        int length = this.f27657q.length;
    ...
    public int pf(char c10) {
        ...
        this.f27660t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27657q[length] == c10) ? (-length) - 1 : rf(c10, length, d10, b10);
        }
        this.f27660t = true;
        qf(length, c10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27658r = objectInput.readChar();
        this.f27659s = objectInput.readInt();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeChar(this.f27658r);
        objectOutput.writeInt(this.f27659s);
    }

    public AbstractC3171n(int i10) {
        super(i10);
        this.f27658r = (char) 0;
        this.f27659s = 0;
    }

    public AbstractC3171n(int i10, float f10) {
        super(i10, f10);
        this.f27658r = (char) 0;
        this.f27659s = 0;
    }

    public AbstractC3171n(int i10, float f10, char c10, int i11) {
        super(i10, f10);
        this.f27658r = c10;
        this.f27659s = i11;
    }
