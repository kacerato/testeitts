...
public abstract class AbstractC3177u extends c0 {

    public static final long f27688u = 1;

    public transient double[] f27689q;

    public double f27690r;

    public float f27691s;

    public boolean f27692t;

    public AbstractC3177u() {
        this.f27690r = 0.0d;
        this.f27691s = 0.0f;
    }
    ...
    */
    ...
    public int of(double d10, int i10, int i11, byte b10) {
        int length = this.f27689q.length;
    ...
    public int pf(double d10) {
        ...
        this.f27692t = false;
        if (b11 != 0) {
            return (b11 == 1 && this.f27689q[length] == d10) ? (-length) - 1 : rf(d10, length, b10, b11);
        }
        this.f27692t = true;
        qf(length, d10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27690r = objectInput.readDouble();
        this.f27691s = objectInput.readFloat();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeDouble(this.f27690r);
        objectOutput.writeFloat(this.f27691s);
    }

    public AbstractC3177u(int i10) {
        super(i10);
        this.f27690r = 0.0d;
        this.f27691s = 0.0f;
    }

    public AbstractC3177u(int i10, float f10) {
        super(i10, f10);
        this.f27690r = 0.0d;
        this.f27691s = 0.0f;
    }

    public AbstractC3177u(int i10, float f10, double d10, float f11) {
        super(i10, f10);
        this.f27690r = d10;
        this.f27691s = f11;
    }
