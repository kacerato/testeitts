...
public abstract class e0 extends c0 {
    ...
    public static final long f27583u = 1;

    public transient short[] f27584q;

    public short f27585r;
    ...
    */
    ...
    public int of(short s10, int i10, int i11, byte b10) {
        int length = this.f27584q.length;
    ...
    public int pf(short s10) {
        ...
        this.f27587t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27584q[length] == s10) ? (-length) - 1 : rf(s10, length, d10, b10);
        }
        this.f27587t = true;
        qf(length, s10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27585r = objectInput.readShort();
        this.f27586s = objectInput.readChar();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeShort(this.f27585r);
        objectOutput.writeChar(this.f27586s);
    }
    ...
    public e0(int i10, float f10, short s10, char c10) {
        super(i10, f10);
        this.f27585r = s10;
        this.f27586s = c10;
    }
