...
public abstract class W extends c0 {
    ...
    public static final long f27520u = 1;

    public transient long[] f27521q;

    public long f27522r;

    public float f27523s;

    public boolean f27524t;
    ...
    */
    ...
    public int of(long j10, int i10, int i11, byte b10) {
        int length = this.f27521q.length;
    ...
    public int pf(long j10) {
        ...
        this.f27524t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27521q[length] == j10) ? (-length) - 1 : rf(j10, length, e10, b10);
        }
        this.f27524t = true;
        qf(length, j10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27522r = objectInput.readLong();
        this.f27523s = objectInput.readFloat();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeLong(this.f27522r);
        objectOutput.writeFloat(this.f27523s);
    }
