...
public abstract class AbstractC3172o extends c0 {

    public static final long f27661u = 1;

    public transient char[] f27662q;
    ...
    */
    ...
    public int of(char c10, int i10, int i11, byte b10) {
        int length = this.f27662q.length;
    ...
    public int pf(char c10) {
        ...
        this.f27665t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27662q[length] == c10) ? (-length) - 1 : rf(c10, length, d10, b10);
        }
        this.f27665t = true;
        qf(length, c10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27663r = objectInput.readChar();
        this.f27664s = objectInput.readLong();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeChar(this.f27663r);
        objectOutput.writeLong(this.f27664s);
    }

    public AbstractC3172o(int i10) {
        super(i10);
        this.f27663r = (char) 0;
        this.f27664s = 0L;
    }

    public AbstractC3172o(int i10, float f10) {
        super(i10, f10);
        this.f27663r = (char) 0;
        this.f27664s = 0L;
    }

    public AbstractC3172o(int i10, float f10, char c10, long j10) {
        super(i10, f10);
        this.f27663r = c10;
        this.f27664s = j10;
    }
