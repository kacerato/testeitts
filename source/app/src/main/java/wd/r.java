...
public abstract class r extends c0 {
    ...
    public static final long f27673u = 1;

    public transient double[] f27674q;

    public double f27675r;
    ...
    */
    ...
    public int of(double d10, int i10, int i11, byte b10) {
        int length = this.f27674q.length;
    ...
    public int pf(double d10) {
        ...
        this.f27677t = false;
        if (b11 != 0) {
            return (b11 == 1 && this.f27674q[length] == d10) ? (-length) - 1 : rf(d10, length, b10, b11);
        }
        this.f27677t = true;
        qf(length, d10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27675r = objectInput.readDouble();
        this.f27676s = objectInput.readByte();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeDouble(this.f27675r);
        objectOutput.writeByte(this.f27676s);
    }
