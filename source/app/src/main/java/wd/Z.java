...
public abstract class Z extends c0 {
    ...
    public static final long f27534u = 1;

    public transient long[] f27535q;
    ...
    */
    ...
    public int of(long j10, int i10, int i11, byte b10) {
        int length = this.f27535q.length;
    ...
    public int pf(long j10) {
        ...
        this.f27538t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27535q[length] == j10) ? (-length) - 1 : rf(j10, length, e10, b10);
        }
        this.f27538t = true;
        qf(length, j10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27536r = objectInput.readLong();
        this.f27537s = objectInput.readLong();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeLong(this.f27536r);
        objectOutput.writeLong(this.f27537s);
    }
    ...
    public Z(int i10, float f10, long j10, long j11) {
        super(i10, f10);
        this.f27536r = j10;
        this.f27537s = j11;
    }
