...
public abstract class C extends c0 {
    ...
    public static final long f27425u = 1;

    public transient float[] f27426q;

    public float f27427r;

    public float f27428s;
    ...
    */
    ...
    public int of(float f10, int i10, int i11, byte b10) {
        int length = this.f27426q.length;
    ...
    public int pf(float f10) {
        ...
        this.f27429t = false;
        if (b10 != 0) {
            return (b10 == 1 && this.f27426q[length] == f10) ? (-length) - 1 : rf(f10, length, c10, b10);
        }
        this.f27429t = true;
        qf(length, f10);
        return length;
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        this.f27427r = objectInput.readFloat();
        this.f27428s = objectInput.readFloat();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeFloat(this.f27427r);
        objectOutput.writeFloat(this.f27428s);
    }
