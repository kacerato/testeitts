...
public class l {
    ...
    public static short[] c(short[] sArr) {
        ...
        for (int i11 = 2; i11 <= 128; i11 <<= 1) {
            ...
            while (i12 < 256) {
                int i13 = i10 + 1;
                short s10 = f35023b[i10];
                int i14 = i12;
                while (i14 < i12 + i11) {
                    short s11 = sArr2[i14];
                    int i15 = i14 + i11;
                    sArr2[i14] = o.a((short) (sArr2[i15] + s11));
                    short s12 = (short) (s11 - sArr2[i15]);
                    sArr2[i15] = s12;
                    sArr2[i15] = b(s10, s12);
                    i14++;
                }
        ...
        for (int i16 = 0; i16 < 256; i16++) {
            sArr2[i16] = b(sArr2[i16], f35023b[127]);
        }
        return sArr2;
    }
    ...
    public static short[] d(short[] sArr) {
        ...
        for (int i11 = 128; i11 >= 2; i11 >>= 1) {
            ...
            while (i12 < 256) {
                int i13 = i10 + 1;
                short s10 = f35022a[i10];
                int i14 = i12;
                while (i14 < i12 + i11) {
                    int i15 = i14 + i11;
                    short b10 = b(s10, sArr2[i15]);
                    sArr2[i15] = (short) (sArr2[i14] - b10);
                    sArr2[i14] = (short) (sArr2[i14] + b10);
                    i14++;
                }
                i12 = i14 + i11;
                i10 = i13;
