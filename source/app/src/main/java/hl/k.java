...
public class k {
    ...
    public static final boolean f91122a = false;

    public static final int f91123b = 32;

    public static final int f91124c = 1024;

    public static final int f91125d = 1824;

    public static final int f91126e = 2048;
    ...
    public static void i(SecureRandom secureRandom, byte[] bArr, byte[] bArr2, byte[] bArr3) {
        ...
        C13529b.e(sArr8, sArr6, bArr5, (byte) 3);
        d(bArr2, sArr5, sArr8);
        C13529b.f(bArr, sArr6, sArr8);
        g(bArr);
    }
}
