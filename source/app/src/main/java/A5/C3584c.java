...
@Deprecated
public class C3584c extends U4.a {

    public final Vector3 f31854J = new Vector3(0.0f, 0.0f, 1.0f);

    public final Vector3 f31855K = new Vector3();

    public final Vector3 f31856L = new Vector3();

    public Vector2 f31857M = null;

    public float f31858N = -999999.0f;
    ...
    public void D(GameObject gameObject, GameObject camera, EditorCamera editorCamera, GameObject selectedObject, Panel3DView editor3DViewer) {
        ...
        gameObject.transform.a0(this.f31854J);
        this.f31855K.set(1.0f, 0.0f, 0.0f);
        this.f31856L.set(0.0f, 1.0f, 0.0f);
    ...
    public void t(EditorCamera editorCamera, GameObject gameObject, GameObject camera, Transform axisTransform, Vector2 touchSlide, h touch, Panel3DView editor3DViewer) {
        ...
        float f13 = f(touchSlide, camera, gameObject.transform.right(), axisTransform);
        Vector3 scale = gameObject.transform.getScale();
        scale.addLocal(f11 * f13, f10 * f12, 0.0f);
    ...
    public a.EnumC0712a v(EditorCamera editorCamera, GameObject gameObject) {
        ...
        sub.normalizeLocal();
        return Nc.b.k(sub.dot(this.f31854J)) >= 0.5f ? a.EnumC0712a.SHOW : a.EnumC0712a.HIDE;
    }
}
