...
@Deprecated
public class C3583b extends U4.a {

    public final Vector3 f31849J = new Vector3(0.0f, 1.0f, 0.0f);

    public final Vector3 f31850K = new Vector3();

    public final Vector3 f31851L = new Vector3();

    public Vector2 f31852M = null;

    public float f31853N = -999999.0f;
    ...
    public void D(GameObject gameObject, GameObject camera, EditorCamera editorCamera, GameObject selectedObject, Panel3DView editor3DViewer) {
        ...
        gameObject.transform.r4(this.f31849J);
        this.f31850K.set(1.0f, 0.0f, 0.0f);
        this.f31851L.set(0.0f, 0.0f, 1.0f);
    ...
    public a.EnumC0712a v(EditorCamera editorCamera, GameObject gameObject) {
        ...
        sub.normalizeLocal();
        return Nc.b.k(sub.dot(this.f31849J)) >= 0.5f ? a.EnumC0712a.SHOW : a.EnumC0712a.HIDE;
    }
}
