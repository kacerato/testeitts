...
public class C15645d extends KeyFactorySpi implements InterfaceC3897c {
    @Override
    public PublicKey a(h0 h0Var) throws IOException {
        return new C15643b(h0Var);
    }

    @Override
    public PrivateKey b(v vVar) throws IOException {
        return new C15642a(vVar);
    }
    ...
    public final Key engineTranslateKey(Key key) throws InvalidKeyException {
        if ((key instanceof C15642a) || (key instanceof C15643b)) {
            return key;
        }
