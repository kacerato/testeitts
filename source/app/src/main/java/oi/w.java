...
public class w {
    ...
    public static final BigInteger f20248d = BigInteger.valueOf(1);

    public static final BigInteger f20249e = BigInteger.valueOf(2);

    public int f20250a;

    public int f20251b;

    public SecureRandom f20252c;

    public C3336c0 a() {
        BigInteger[] bigIntegerArr = new BigInteger[2];
        if (this.f20251b == 1) {
            int nextInt = this.f20252c.nextInt();
            int nextInt2 = this.f20252c.nextInt();
            ...
            return new C3336c0(bigInteger, bigInteger2, g(bigInteger, bigInteger2), new C3342f0(nextInt, nextInt2));
        }
        long nextLong = this.f20252c.nextLong();
        long nextLong2 = this.f20252c.nextLong();
        ...
        return new C3336c0(bigInteger3, bigInteger4, g(bigInteger3, bigInteger4), new C3342f0(nextLong, nextLong2));
    }

    public void b(int i10, int i11, SecureRandom secureRandom) {
        this.f20250a = i10;
        this.f20251b = i11;
        this.f20252c = secureRandom;
    }
    ...
    public final int c(int i10, int i11, BigInteger[] bigIntegerArr, int i12) {
        ...
        while (true) {
            ...
            i15 = this.f20252c.nextInt() / 32768;
        }
        int i16 = i11;
        while (true) {
            ...
            i16 = (this.f20252c.nextInt() / 32768) + 1;
        }
        ...
        while (true) {
            ...
            while (true) {
                ...
                while (i24 < i23) {
                    int i25 = i24 + 1;
                    bigIntegerArr2[i25] = bigIntegerArr2[i24].multiply(bigInteger5).add(bigInteger4).mod(f20249e.pow(i20));
                    i24 = i25;
                }
                BigInteger bigInteger7 = new BigInteger("0");
                for (int i26 = i17; i26 < i23; i26++) {
                    bigInteger7 = bigInteger7.add(bigIntegerArr2[i26].multiply(f20249e.pow(i26 * 16)));
                }
                bigIntegerArr2[i17] = bigIntegerArr2[i23];
                BigInteger bigInteger8 = f20249e;
                int i27 = i21 + 1;
                ...
                BigInteger bigInteger9 = f20248d;
                ...
                while (true) {
                    ...
                    BigInteger bigInteger10 = f20248d;
                    BigInteger add2 = multiply.add(bigInteger10);
                    bigIntegerArr4[i21] = add2;
                    BigInteger bigInteger11 = f20249e;
                    i14 = i23;
                    if (add2.compareTo(bigInteger11.pow(iArr[i21])) == 1) {
                        break;
                    }
                    if (bigInteger11.modPow(bigIntegerArr4[i27].multiply(add.add(BigInteger.valueOf(j10))), bigIntegerArr4[i21]).compareTo(bigInteger10) == 0 && bigInteger11.modPow(add.add(BigInteger.valueOf(j10)), bigIntegerArr4[i21]).compareTo(bigInteger10) != 0) {
                        break;
                    }
                    i28 += 2;
                    i19 = i13;
    ...
    public final long d(long j10, long j11, BigInteger[] bigIntegerArr, int i10) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                while (i19 < i18) {
                    int i20 = i19 + 1;
                    bigIntegerArr2[i20] = bigIntegerArr2[i19].multiply(bigInteger5).add(bigInteger4).mod(f20249e.pow(i17));
                    i19 = i20;
                }
                BigInteger bigInteger7 = new BigInteger("0");
                for (int i21 = i12; i21 < i18; i21++) {
                    bigInteger7 = bigInteger7.add(bigIntegerArr2[i21].multiply(f20249e.pow(i21 * 32)));
                }
    ...
    public final void e(int i10, int i11, BigInteger[] bigIntegerArr) {
        ...
        while (true) {
            if (i12 >= 0 && i12 <= 65536) {
                ...
                i12 = this.f20252c.nextInt() / 32768;
            }
        }
        int i13 = i11;
        while (true) {
        ...
        while (true) {
            ...
            while (i15 < 64) {
                int i16 = i15 + 1;
                bigIntegerArr3[i16] = bigIntegerArr3[i15].multiply(bigInteger2).add(bigInteger).mod(f20249e.pow(16));
                i15 = i16;
            }
            BigInteger bigInteger5 = new BigInteger("0");
            for (int i17 = i14; i17 < 64; i17++) {
                bigInteger5 = bigInteger5.add(bigIntegerArr3[i17].multiply(f20249e.pow(i17 * 16)));
            }
            bigIntegerArr3[i14] = bigIntegerArr3[64];
            BigInteger bigInteger6 = f20249e;
            int i18 = 1024;
            ...
            BigInteger bigInteger7 = f20248d;
            ...
            while (true) {
                ...
                BigInteger bigInteger10 = f20249e;
    ...
    public final void f(long j10, long j11, BigInteger[] bigIntegerArr) {
        ...
        long j14 = j13;
        long d10 = d(j12, j14, bigIntegerArr2, 256);
        int i10 = 0;
        BigInteger bigInteger3 = bigIntegerArr2[0];
        ...
        while (true) {
            ...
            while (i11 < 32) {
                int i12 = i11 + 1;
                bigIntegerArr3[i12] = bigIntegerArr3[i11].multiply(bigInteger2).add(bigInteger).mod(f20249e.pow(32));
                i11 = i12;
            }
            BigInteger bigInteger5 = new BigInteger("0");
            for (int i13 = i10; i13 < 32; i13++) {
                bigInteger5 = bigInteger5.add(bigIntegerArr3[i13].multiply(f20249e.pow(i13 * 32)));
            }
            ...
            while (true) {
                ...
                BigInteger bigInteger8 = f20248d;
                BigInteger add2 = multiply.add(bigInteger8);
                BigInteger bigInteger9 = f20249e;
    ...
    public final BigInteger g(BigInteger bigInteger, BigInteger bigInteger2) {
        BigInteger subtract = bigInteger.subtract(f20248d);
        BigInteger divide = subtract.divide(bigInteger2);
        int bitLength = bigInteger.bitLength();
        while (true) {
            BigInteger f10 = org.bouncycastle.util.b.f(bitLength, this.f20252c);
            BigInteger bigInteger3 = f20248d;
            if (f10.compareTo(bigInteger3) > 0 && f10.compareTo(subtract) < 0) {
                BigInteger modPow = f10.modPow(divide, bigInteger);
