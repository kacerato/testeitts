package org.blacksquircle.ui.language.java.styler;
...
public final class JavaStyler implements LanguageStyler {
    ...
    public static final class Companion {
        ...
        public final JavaStyler getInstance() {
            ...
            Companion companion = JavaStyler.Companion;
    ...
    public JavaStyler(C14026x c14026x) {
        this();
    }
    ...
    public List<SyntaxHighlightSpan> execute(@NotNull String source, @NotNull ColorScheme scheme) {
        ...
        while (true) {
            try {
                switch (WhenMappings.$EnumSwitchMapping$0[javaLexer.advance().ordinal()]) {
                    case 1:
                    case 2:
                    case 3:
                    case 4:
                ...
                Log.e("JavaStyler", e10.getMessage(), e10);
            }
        }
        return arrayList;
    }
