...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/d8lib/android.jar:org/xmlpull/v1/XmlSerializer.class
 */
public interface XmlSerializer {
    ...
    String getPrefix(String str, boolean z10) throws IllegalArgumentException;
    ...
    XmlSerializer text(char[] cArr, int i10, int i11) throws IOException, IllegalArgumentException, IllegalStateException;
