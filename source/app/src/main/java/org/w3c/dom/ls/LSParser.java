...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/d8lib/android.jar:org/w3c/dom/ls/LSParser.class
 */
public interface LSParser {
    ...
    Node parseWithContext(LSInput lSInput, Node node, short s10) throws DOMException, LSException;
