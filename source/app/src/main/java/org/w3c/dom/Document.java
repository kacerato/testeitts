...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/d8lib/android.jar:org/w3c/dom/Document.class
 */
public interface Document extends Node {
    ...
    Node importNode(Node node, boolean z10) throws DOMException;
    ...
    void setXmlStandalone(boolean z10) throws DOMException;
