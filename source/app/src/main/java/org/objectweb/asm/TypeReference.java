...
public class TypeReference {
    ...
    public static TypeReference newTryCatchReference(int i10) {
        return new TypeReference((i10 << 8) | CompilerOptions.UnstableAutoModuleName);
    }
    ...
    public static void putTarget(int i10, ByteVector byteVector) {
        int i11 = i10 >>> 24;
        if (i11 != 0 && i11 != 1) {
            switch (i11) {
                case 16:
            ...
            byteVector.put12(i11, (i10 & 16776960) >> 8);
            return;
        }
        byteVector.putShort(i10 >>> 16);
    }
    ...
    public int getFormalParameterIndex() {
        return (this.targetTypeAndInfo & Spanned.SPAN_PRIORITY) >> 16;
    }
