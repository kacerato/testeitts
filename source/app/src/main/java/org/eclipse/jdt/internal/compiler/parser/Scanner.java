...
public class Scanner implements TerminalTokens {
    ...
    public static class Goal {
        ...
        static {
            for (int i10 = 1; i10 <= 867; i10++) {
                if ("ParenthesizedLambdaParameterList".equals(Parser.name[Parser.non_terminal_index[Parser.lhs[i10]]])) {
                    LambdaParameterListRule = i10;
                } else if ("ParenthesizedCastNameAndBounds".equals(Parser.name[Parser.non_terminal_index[Parser.lhs[i10]]])) {
                    IntersectionCastRule = i10;
                } else if ("ReferenceExpressionTypeArgumentsAndTrunk".equals(Parser.name[Parser.non_terminal_index[Parser.lhs[i10]]])) {
                    ReferenceExpressionRule = i10;
                } else if ("TypeAnnotations".equals(Parser.name[Parser.non_terminal_index[Parser.lhs[i10]]])) {
                    VarargTypeAnnotationsRule = i10;
                } else if ("BlockStatementopt".equals(Parser.name[Parser.non_terminal_index[Parser.lhs[i10]]])) {
                    BlockStatementoptRule = i10;
                }
            }
        ...
        public Goal(int i10, int[] iArr, int i11) {
            this.first = i10;
            this.follow = iArr;
            this.rule = i11;
        }
        ...
        public boolean hasBeenReached(int i10, int i11) {
            if (i10 == this.rule) {
    ...
    public class ScanContextDetector extends VanguardParser {
        ...
        public ScanContext getScanContext(char[] cArr, int i10) {
            this.scanner.setSource(cArr);
            this.scanner.resetTo(0, i10);
            goForCompilationUnit();
            parse(new Goal(2, null, 0) {
                @Override
        ...
        public void initializeScanner() {
            ...
            Scanner scanner = new Scanner(false, false, false, compilerOptions.sourceLevel, compilerOptions.complianceLevel, compilerOptions.taskTags, compilerOptions.taskPriorities, compilerOptions.isTaskCaseSensitive) {
                @Override
                public void updateScanContext(int i10) {
                    if (i10 != 61) {
                        super.updateScanContext(i10);
                    }
                }
            };
    ...
    public static final class VanguardScanner extends Scanner {
        public VanguardScanner(long j10, long j11) {
            super(false, false, false, j10, j11, null, null, false);
        }
    ...
    private ScanContext getScanContext(int i10) {
        ...
        return new ScanContextDetector(compilerOptions).getScanContext(this.source, i10 - 1);
    }
    ...
    private int internalScanIdentifierOrKeyword(int i10, int i11, char[] cArr) {
        switch (cArr[i10]) {
            case 'a':
                if (i11 != 6) {
                    return (i11 == 8 && cArr[i10 + 1] == 'b' && cArr[i10 + 2] == 's' && cArr[i10 + 3] == 't' && cArr[i10 + 4] == 'r' && cArr[i10 + 5] == 'a' && cArr[i10 + 6] == 'c' && cArr[i10 + 7] == 't') ? 52 : 22;
                }
                ...
                return 22;
            case 'b':
                return i11 != 4 ? i11 != 5 ? (i11 == 7 && cArr[i10 + 1] == 'o' && cArr[i10 + 2] == 'o' && cArr[i10 + 3] == 'l' && cArr[i10 + 4] == 'e' && cArr[i10 + 5] == 'a' && cArr[i10 + 6] == 'n') ? 99 : 22 : (cArr[i10 + 1] == 'r' && cArr[i10 + 2] == 'e' && cArr[i10 + 3] == 'a' && cArr[i10 + 4] == 'k') ? 77 : 22 : (cArr[i10 + 1] == 'y' && cArr[i10 + 2] == 't' && cArr[i10 + 3] == 'e') ? 100 : 22;
            case 'c':
                if (i11 == 4) {
                    char c10 = cArr[i10 + 1];
                    return c10 == 'a' ? (cArr[i10 + 2] == 's' && cArr[i10 + 3] == 'e') ? 101 : 22 : (c10 == 'h' && cArr[i10 + 2] == 'a' && cArr[i10 + 3] == 'r') ? 103 : 22;
                }
                if (i11 != 5) {
                    return (i11 == 8 && cArr[i10 + 1] == 'o' && cArr[i10 + 2] == 'n' && cArr[i10 + 3] == 't' && cArr[i10 + 4] == 'i' && cArr[i10 + 5] == 'n' && cArr[i10 + 6] == 'u' && cArr[i10 + 7] == 'e') ? 78 : 22;
                }
                char c11 = cArr[i10 + 1];
                return c11 == 'a' ? (cArr[i10 + 2] == 't' && cArr[i10 + 3] == 'c' && cArr[i10 + 4] == 'h') ? 102 : 22 : c11 == 'l' ? (cArr[i10 + 2] == 'a' && cArr[i10 + 3] == 's' && cArr[i10 + 4] == 's') ? 67 : 22 : (c11 == 'o' && cArr[i10 + 2] == 'n' && cArr[i10 + 3] == 's' && cArr[i10 + 4] == 't') ? 127 : 22;
            case 'd':
                return i11 != 2 ? i11 != 6 ? (i11 == 7 && cArr[i10 + 1] == 'e' && cArr[i10 + 2] == 'f' && cArr[i10 + 3] == 'a' && cArr[i10 + 4] == 'u' && cArr[i10 + 5] == 'l' && cArr[i10 + 6] == 't') ? 73 : 22 : (cArr[i10 + 1] == 'o' && cArr[i10 + 2] == 'u' && cArr[i10 + 3] == 'b' && cArr[i10 + 4] == 'l' && cArr[i10 + 5] == 'e') ? 104 : 22 : cArr[i10 + 1] == 'o' ? 79 : 22;
            case 'e':
                if (i11 == 4) {
                    char c12 = cArr[i10 + 1];
                    if (c12 == 'l') {
                        return (cArr[i10 + 2] == 's' && cArr[i10 + 3] == 'e') ? 112 : 22;
                    }
                ...
                if (i11 == 7 && cArr[i10 + 1] == 'x') {
                    ...
                    if (areRestrictedModuleKeywordsActive() && cArr[i12] == 'p' && cArr[i12 + 1] == 'o' && cArr[i12 + 2] == 'r' && cArr[i12 + 3] == 't' && cArr[i12 + 4] == 's') {
                        return 116;
                    }
                }
                return 22;
            case 'f':
                if (i11 == 3) {
                    return (cArr[i10 + 1] == 'o' && cArr[i10 + 2] == 'r') ? 80 : 22;
                }
                if (i11 != 5) {
                    return (i11 == 7 && cArr[i10 + 1] == 'i' && cArr[i10 + 2] == 'n' && cArr[i10 + 3] == 'a' && cArr[i10 + 4] == 'l' && cArr[i10 + 5] == 'l' && cArr[i10 + 6] == 'y') ? 111 : 22;
                }
                char c13 = cArr[i10 + 1];
                return c13 == 'i' ? (cArr[i10 + 2] == 'n' && cArr[i10 + 3] == 'a' && cArr[i10 + 4] == 'l') ? 53 : 22 : c13 == 'l' ? (cArr[i10 + 2] == 'o' && cArr[i10 + 3] == 'a' && cArr[i10 + 4] == 't') ? 105 : 22 : (c13 == 'a' && cArr[i10 + 2] == 'l' && cArr[i10 + 3] == 's' && cArr[i10 + 4] == 'e') ? 38 : 22;
            case 'g':
                return (i11 == 4 && cArr[i10 + 1] == 'o' && cArr[i10 + 2] == 't' && cArr[i10 + 3] == 'o') ? 128 : 22;
            case 'h':
            case 'j':
            case 'k':
            case 'q':
            ...
            case 'i':
                if (i11 == 2) {
                    return cArr[i10 + 1] == 'f' ? 81 : 22;
                }
                if (i11 == 3) {
                    return (cArr[i10 + 1] == 'n' && cArr[i10 + 2] == 't') ? 107 : 22;
                }
                if (i11 == 6) {
                    return (cArr[i10 + 1] == 'm' && cArr[i10 + 2] == 'p' && cArr[i10 + 3] == 'o' && cArr[i10 + 4] == 'r' && cArr[i10 + 5] == 't') ? 106 : 22;
                }
                if (i11 == 9) {
                    return (cArr[i10 + 1] == 'n' && cArr[i10 + 2] == 't' && cArr[i10 + 3] == 'e' && cArr[i10 + 4] == 'r' && cArr[i10 + 5] == 'f' && cArr[i10 + 6] == 'a' && cArr[i10 + 7] == 'c' && cArr[i10 + 8] == 'e') ? 70 : 22;
                }
                if (i11 != 10) {
                    return 22;
                }
                char c14 = cArr[i10 + 1];
                return c14 == 'm' ? (cArr[i10 + 2] == 'p' && cArr[i10 + 3] == 'l' && cArr[i10 + 4] == 'e' && cArr[i10 + 5] == 'm' && cArr[i10 + 6] == 'e' && cArr[i10 + 7] == 'n' && cArr[i10 + 8] == 't' && cArr[i10 + 9] == 's') ? 123 : 22 : (c14 == 'n' && cArr[i10 + 2] == 's' && cArr[i10 + 3] == 't' && cArr[i10 + 4] == 'a' && cArr[i10 + 5] == 'n' && cArr[i10 + 6] == 'c' && cArr[i10 + 7] == 'e' && cArr[i10 + 8] == 'o' && cArr[i10 + 9] == 'f') ? 17 : 22;
            case 'l':
                return (i11 == 4 && cArr[i10 + 1] == 'o' && cArr[i10 + 2] == 'n' && cArr[i10 + 3] == 'g') ? 108 : 22;
            case 'm':
                return (i11 == 6 && areRestrictedModuleKeywordsActive() && cArr[i10 + 1] == 'o' && cArr[i10 + 2] == 'd' && cArr[i10 + 3] == 'u' && cArr[i10 + 4] == 'l' && cArr[i10 + 5] == 'e') ? 113 : 22;
            case 'n':
                return i11 != 3 ? i11 != 4 ? (i11 == 6 && cArr[i10 + 1] == 'a' && cArr[i10 + 2] == 't' && cArr[i10 + 3] == 'i' && cArr[i10 + 4] == 'v' && cArr[i10 + 5] == 'e') ? 54 : 22 : (cArr[i10 + 1] == 'u' && cArr[i10 + 2] == 'l' && cArr[i10 + 3] == 'l') ? 39 : 22 : (cArr[i10 + 1] == 'e' && cArr[i10 + 2] == 'w') ? 36 : 22;
            case 'o':
                return i11 != 4 ? (i11 == 5 && areRestrictedModuleKeywordsActive() && cArr[i10 + 1] == 'p' && cArr[i10 + 2] == 'e' && cArr[i10 + 3] == 'n' && cArr[i10 + 4] == 's') ? 117 : 22 : (areRestrictedModuleKeywordsActive() && cArr[i10 + 1] == 'p' && cArr[i10 + 2] == 'e' && cArr[i10 + 3] == 'n') ? 114 : 22;
            case 'p':
                switch (i11) {
                    case 6:
                        return (cArr[i10 + 1] == 'u' && cArr[i10 + 2] == 'b' && cArr[i10 + 3] == 'l' && cArr[i10 + 4] == 'i' && cArr[i10 + 5] == 'c') ? 57 : 22;
                    case 7:
                        char c15 = cArr[i10 + 1];
                        return c15 == 'a' ? (cArr[i10 + 2] == 'c' && cArr[i10 + 3] == 'k' && cArr[i10 + 4] == 'a' && cArr[i10 + 5] == 'g' && cArr[i10 + 6] == 'e') ? 85 : 22 : (c15 == 'r' && cArr[i10 + 2] == 'i' && cArr[i10 + 3] == 'v' && cArr[i10 + 4] == 'a' && cArr[i10 + 5] == 't' && cArr[i10 + 6] == 'e') ? 55 : 22;
                    case 8:
                        return (areRestrictedModuleKeywordsActive() && cArr[i10 + 1] == 'r' && cArr[i10 + 2] == 'o' && cArr[i10 + 3] == 'v' && cArr[i10 + 4] == 'i' && cArr[i10 + 5] == 'd' && cArr[i10 + 6] == 'e' && cArr[i10 + 7] == 's') ? 119 : 22;
                    case 9:
                        return (cArr[i10 + 1] == 'r' && cArr[i10 + 2] == 'o' && cArr[i10 + 3] == 't' && cArr[i10 + 4] == 'e' && cArr[i10 + 5] == 'c' && cArr[i10 + 6] == 't' && cArr[i10 + 7] == 'e' && cArr[i10 + 8] == 'd') ? 56 : 22;
                    default:
                        return 22;
                }
            case 'r':
                return i11 != 6 ? (i11 == 8 && areRestrictedModuleKeywordsActive() && cArr[i10 + 1] == 'e' && cArr[i10 + 2] == 'q' && cArr[i10 + 3] == 'u' && cArr[i10 + 4] == 'i' && cArr[i10 + 5] == 'r' && cArr[i10 + 6] == 'e' && cArr[i10 + 7] == 's') ? 115 : 22 : (cArr[i10 + 1] == 'e' && cArr[i10 + 2] == 't' && cArr[i10 + 3] == 'u' && cArr[i10 + 4] == 'r' && cArr[i10 + 5] == 'n') ? 82 : 22;
            case 's':
                if (i11 == 5) {
                    char c16 = cArr[i10 + 1];
                    return c16 == 'h' ? (cArr[i10 + 2] == 'o' && cArr[i10 + 3] == 'r' && cArr[i10 + 4] == 't') ? 109 : 22 : (c16 == 'u' && cArr[i10 + 2] == 'p' && cArr[i10 + 3] == 'e' && cArr[i10 + 4] == 'r') ? 34 : 22;
                }
                if (i11 != 6) {
                    return i11 != 8 ? (i11 == 12 && cArr[i10 + 1] == 'y' && cArr[i10 + 2] == 'n' && cArr[i10 + 3] == 'c' && cArr[i10 + 4] == 'h' && cArr[i10 + 5] == 'r' && cArr[i10 + 6] == 'o' && cArr[i10 + 7] == 'n' && cArr[i10 + 8] == 'i' && cArr[i10 + 9] == 'z' && cArr[i10 + 10] == 'e' && cArr[i10 + 11] == 'd') ? 50 : 22 : (cArr[i10 + 1] == 't' && cArr[i10 + 2] == 'r' && cArr[i10 + 3] == 'i' && cArr[i10 + 4] == 'c' && cArr[i10 + 5] == 't' && cArr[i10 + 6] == 'f' && cArr[i10 + 7] == 'p') ? 58 : 22;
                }
                char c17 = cArr[i10 + 1];
                return c17 == 't' ? (cArr[i10 + 2] == 'a' && cArr[i10 + 3] == 't' && cArr[i10 + 4] == 'i' && cArr[i10 + 5] == 'c') ? 48 : 22 : (c17 == 'w' && cArr[i10 + 2] == 'i' && cArr[i10 + 3] == 't' && cArr[i10 + 4] == 'c' && cArr[i10 + 5] == 'h') ? 51 : 22;
            case 't':
                if (i11 == 2) {
                    return (areRestrictedModuleKeywordsActive() && cArr[i10 + 1] == 'o') ? 124 : 22;
                }
                if (i11 == 3) {
                    return (cArr[i10 + 1] == 'r' && cArr[i10 + 2] == 'y') ? 83 : 22;
                }
                if (i11 != 4) {
                    return i11 != 5 ? i11 != 6 ? i11 != 9 ? (i11 == 10 && areRestrictedModuleKeywordsActive() && cArr[i10 + 1] == 'r' && cArr[i10 + 2] == 'a' && cArr[i10 + 3] == 'n' && cArr[i10 + 4] == 's' && cArr[i10 + 5] == 'i' && cArr[i10 + 6] == 't' && cArr[i10 + 7] == 'i' && cArr[i10 + 8] == 'v' && cArr[i10 + 9] == 'e') ? 121 : 22 : (cArr[i10 + 1] == 'r' && cArr[i10 + 2] == 'a' && cArr[i10 + 3] == 'n' && cArr[i10 + 4] == 's' && cArr[i10 + 5] == 'i' && cArr[i10 + 6] == 'e' && cArr[i10 + 7] == 'n' && cArr[i10 + 8] == 't') ? 59 : 22 : (cArr[i10 + 1] == 'h' && cArr[i10 + 2] == 'r' && cArr[i10 + 3] == 'o' && cArr[i10 + 4] == 'w' && cArr[i10 + 5] == 's') ? 120 : 22 : (cArr[i10 + 1] == 'h' && cArr[i10 + 2] == 'r' && cArr[i10 + 3] == 'o' && cArr[i10 + 4] == 'w') ? 74 : 22;
                }
                char c18 = cArr[i10 + 1];
                return c18 == 'h' ? (cArr[i10 + 2] == 'i' && cArr[i10 + 3] == 's') ? 35 : 22 : (c18 == 'r' && cArr[i10 + 2] == 'u' && cArr[i10 + 3] == 'e') ? 40 : 22;
            case 'u':
                return (i11 == 4 && areRestrictedModuleKeywordsActive() && cArr[i10 + 1] == 's' && cArr[i10 + 2] == 'e' && cArr[i10 + 3] == 's') ? 118 : 22;
            case 'v':
                return i11 != 4 ? (i11 == 8 && cArr[i10 + 1] == 'o' && cArr[i10 + 2] == 'l' && cArr[i10 + 3] == 'a' && cArr[i10 + 4] == 't' && cArr[i10 + 5] == 'i' && cArr[i10 + 6] == 'l' && cArr[i10 + 7] == 'e') ? 60 : 22 : (cArr[i10 + 1] == 'o' && cArr[i10 + 2] == 'i' && cArr[i10 + 3] == 'd') ? 110 : 22;
            case 'w':
                return i11 != 4 ? (i11 == 5 && cArr[i10 + 1] == 'h' && cArr[i10 + 2] == 'i' && cArr[i10 + 3] == 'l' && cArr[i10 + 4] == 'e') ? 75 : 22 : (areRestrictedModuleKeywordsActive() && cArr[i10 + 1] == 'i' && cArr[i10 + 2] == 't' && cArr[i10 + 3] == 'h') ? 125 : 22;
        }
    }
    ...
    public static boolean isRestrictedKeyword(int i10) {
        switch (i10) {
            case 113:
            case 114:
            case 115:
    ...
    private void parseTags() {
        ...
        if (this.checkNonExternalizedStringLiterals && (indexOf = CharOperation.indexOf(TAG_PREFIX, cArr, true, i12, i10)) != -1) {
        ...
        if (!this.checkUninternedIdentityComparison || CharOperation.indexOf(IDENTITY_COMPARISON_TAG, cArr, true, i12, i10) == -1) {
            return;
        }
        ...
        boolean[] zArr2 = new boolean[i13 + 2];
        this.validIdentityComparisonLines = zArr2;
        System.arraycopy(zArr, 0, zArr2, 0, length);
        this.validIdentityComparisonLines[i21] = true;
    }

    private void updateCase(int i10) {
        if (i10 == 101) {
            this.inCase = true;
        }
        if (i10 == 62 || i10 == 98) {
    ...
    */
    ...
    public int disambiguatedRestrictedKeyword(int i10) {
        ScanContext scanContext = this.scanContext;
    ...
    public int disambiguatedToken(int i10) {
        VanguardParser vanguardParser = getVanguardParser();
        if (i10 == 98 && this.inCase) {
            this.nextToken = 98;
            this.inCase = false;
            return 69;
        }
        if (i10 == 23 && maybeAtLambdaOrCast()) {
        ...
        if (i10 == 11 && maybeAtReferenceExpression()) {
    ...
    */
    public int fastForward(Statement statement) {
        ...
        while (true) {
            try {
                ...
                if (nextToken != 2 && nextToken != 3 && nextToken != 11 && nextToken != 67) {
                    if (nextToken != 22) {
                        if (nextToken != 23) {
                            if (nextToken != 26) {
                                if (nextToken != 27 && nextToken != 70 && nextToken != 71) {
                                    switch (nextToken) {
                                        case 33:
                    ...
                    } else if (isAtAssistIdentifier()) {
                        return nextToken;
                    }
                }
                if (getVanguardParser().parse(Goal.BlockStatementoptGoal)) {
                    return nextToken;
                }
            } catch (InvalidInputException unused) {
                return 61;
    ...
    public final int getLineNumber(int i10) {
        return Util.getLineNumber(i10, this.lineEnds, 0, this.linePtr);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:122:0x02e5, code lost:
        ...
        if (r16.tokenizeComments == false) goto L655;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:253:0x0434, code lost:
        ...
        return 90;
     */
    /* JADX WARN: Code restructure failed: missing block: B:254:0x0437, code lost:
    
        return 10;
     */
    /* JADX WARN: Code restructure failed: missing block: B:539:0x068b, code lost:
    
        r0 = 0;
     */
    /* JADX WARN: Code restructure failed: missing block: B:541:0x068e, code lost:
     ...
     */
    /* JADX WARN: Code restructure failed: missing block: B:543:0x0694, code lost:
    
        if (r3 >= r16.eofPosition) goto L690;
     */
    /* JADX WARN: Code restructure failed: missing block: B:544:0x0696, code lost:
    
        r4 = r16.source;
        r6 = r3 + 1;
        r16.currentPosition = r6;
        r9 = r4[r3];
        r16.currentCharacter = r9;
     */
    /* JADX WARN: Code restructure failed: missing block: B:545:0x06a2, code lost:
     ...
     */
    /* JADX WARN: Code restructure failed: missing block: B:548:0x06aa, code lost:
    
        getNextUnicodeChar();
     */
    /* JADX WARN: Code restructure failed: missing block: B:550:0x06b4, code lost:
    
        if (r16.currentCharacter == '\"') goto L689;
     */
    /* JADX WARN: Code restructure failed: missing block: B:551:0x06b6, code lost:
     ...
     */
    /* JADX WARN: Code restructure failed: missing block: B:555:0x06b0, code lost:
    
        if (r9 == '\n') goto L688;
     */
    /* JADX WARN: Code restructure failed: missing block: B:557:0x06c1, code lost:
    
        r16.currentPosition = r3;
     */
    /* JADX WARN: Code restructure failed: missing block: B:562:0x06c4, code lost:
    
        r16.currentPosition = r5;
     */
    /* JADX WARN: Failed to find 'out' block for switch in B:56:0x00e0. Please report as an issue. */
    /* JADX WARN: Removed duplicated region for block: B:507:0x0602 A[RETURN] */
    /* JADX WARN: Removed duplicated region for block: B:508:0x0603 A[Catch: InvalidInputException -> 0x05f3, IndexOutOfBoundsException -> 0x070a, TryCatch #8 {IndexOutOfBoundsException -> 0x070a, InvalidInputException -> 0x05f3, blocks: (B:499:0x05d6, B:501:0x05e8, B:503:0x05ee, B:505:0x05fe, B:508:0x0603, B:515:0x0613, B:517:0x0617, B:519:0x062d, B:521:0x0633, B:522:0x0659, B:524:0x0660, B:525:0x063d, B:527:0x0641, B:528:0x0647, B:529:0x0663, B:531:0x0675, B:533:0x067b, B:534:0x0680, B:537:0x0684, B:542:0x0690, B:544:0x0696, B:546:0x06a4, B:548:0x06aa, B:549:0x06b2, B:551:0x06b6, B:553:0x06b9, B:554:0x06c0, B:557:0x06c1, B:562:0x06c4, B:558:0x06cb, B:559:0x06d2, B:564:0x06c7, B:565:0x06d3, B:566:0x06da, B:567:0x05f6, B:569:0x05fa), top: B:498:0x05d6, outer: #3 }] */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:526:0x067b -> B:497:0x05f1). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:529:0x05fd -> B:498:0x05fe). Please report as a decompilation issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
                                    ...
                                    if (c10 != '\n' && c10 != '\r') {
                                        if (c10 == '\\') {
                                            if (this.unicodeAsBackSlash) {
                                                ...
                                                if (this.withoutUnicodePtr == 0) {
                                                    unicodeInitializeBuffer(i24 - this.startPosition);
                                                }
                                                this.withoutUnicodePtr--;
                                                char[] cArr4 = this.source;
                                                int i26 = this.currentPosition;
                                                this.currentPosition = i26 + 1;
                                                this.currentCharacter = cArr4[i26];
                                            }
                                            scanEscapeCharacter();
                                            if (this.withoutUnicodePtr != 0) {
                                                unicodeStore();
                            ...
                            if (e10.getMessage().equals("Invalid_Escape")) {
                                while (true) {
                                    if (i16 < 50) {
                                        ...
                                        if (i29 + i16 != this.eofPosition) {
                                            char[] cArr6 = this.source;
                                            if (cArr6[i29 + i16] != '\n') {
                                                if (cArr6[i29 + i16] != '\"') {
                                                    i16++;
                                                } else {
                                                    this.currentPosition = i29 + i16 + 1;
                                                }
                                            }
                                        }
                                    }
                            ...
                            case '\'':
                                ...
                                if (getNextChar(JavaElement.JEM_ESCAPE)) {
                                    if (this.unicodeAsBackSlash) {
                                        ...
                                        this.currentPosition = i34 + 1;
                                        this.currentCharacter = cArr10[i34];
                                    }
                                    scanEscapeCharacter();
                                } else {
                                    this.unicodeAsBackSlash = false;
                                ...
                                while (true) {
                                    if (i16 < 20) {
                                        ...
                                        if (i37 + i16 != this.eofPosition) {
                                            char[] cArr12 = this.source;
                                            if (cArr12[i37 + i16] != '\n') {
                                                if (cArr12[i37 + i16] != '\'') {
                                                    i16++;
                                                } else {
                                                    this.currentPosition = i37 + i16 + 1;
                                                }
                                            }
                                        }
                                    }
                            ...
                            case '/':
                                if (!this.skipComments) {
                                    ...
                                    if (nextChar5 != 0) {
                                        if (nextChar5 <= 0) {
                                            ...
                                            try {
                                                ...
                                                while (true) {
                                                    ...
                                                    if (c25 == '/' && z15) {
                                                        int i45 = z14 ? 1003 : 1002;
                                                        recordComment(i45);
                                                        this.commentTagStarts[this.commentPtr] = i44;
                                                        ...
                                                        i41 = this.currentPosition;
                                                        char[] cArr16 = this.source;
                                                        int i46 = i41 + 1;
                                                        this.currentPosition = i46;
                                                        char c27 = cArr16[i41];
                                                        ...
                                                        if (this.currentCharacter == '\\') {
                                                            ...
                                                            int i47 = this.currentPosition;
                                                            if (cArr17[i47] == '\\') {
                                                                this.currentPosition = i47 + 1;
                                                            }
                                                        }
                                                    }
                                                }
                                        ...
                                        this.lastCommentLinePosition = i48;
                                        try {
                                            ...
                                            while (true) {
                                                ...
                                                if (c29 != '\r' && c29 != '\n') {
                                                    ...
                                                    if (i51 >= this.eofPosition) {
                                                        this.lastCommentLinePosition = i51;
                                                        ...
                                                        int i52 = i51 + 1;
                                                        this.currentPosition = i52;
                                                        char c30 = cArr20[i51];
                                                        this.currentCharacter = c30;
                                                        if (c30 == '\\' && cArr20[i52] == 'u') {
                                                            getNextUnicodeChar();
                                                            z17 = true;
                                                        } else {
                                ...
                                switch (c15) {
                                    ...
                                    default:
                                        switch (c15) {
                                            ...
                                            default:
                                                if (c15 < '\u0080') {
                                                    int i54 = ScannerHelper.OBVIOUS_IDENT_CHAR_NATURES[c15];
                                                    if ((i54 & 64) != 0) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:126:0x0156, code lost:
        ...
        if (r16.recordLineSeparator == false) goto L254;
     */
    ...
    */
    ...
    public final boolean maybeAtLambdaOrCast() {
        int i10 = this.lookBack[1];
        if (i10 == 22 || i10 == 75 || i10 == 83 || i10 == 102 || i10 == 34 || i10 == 35 || i10 == 50 || i10 == 51 || i10 == 80 || i10 == 81) {
            return false;
        }
    ...
    public final boolean maybeAtReferenceExpression() {
        ...
        int i11 = iArr[1];
        if (i11 != 0) {
            if (i11 == 22 && (i10 = iArr[0]) != 11 && i10 != 17 && i10 != 21 && i10 != 26 && i10 != 48 && i10 != 67 && i10 != 86 && i10 != 120 && i10 != 123 && i10 != 14 && i10 != 15 && i10 != 33 && i10 != 34 && i10 != 36 && i10 != 37 && i10 != 52 && i10 != 53 && i10 != 70 && i10 != 71) {
                switch (i10) {
                }
            }
            return false;
    ...
    public void resetTo(int i10, int i11) {
        resetTo(i10, i11, isInModuleDeclaration());
    }
    ...
    public int scanNumber(boolean z10) throws InvalidInputException {
        ...
        if (!z10 && this.currentCharacter == '0') {
            ...
            if (getNextCharAsDigit()) {
                ...
                return (getNextChar('d', 'D') >= 0 || !z12) ? 44 : 41;
            }
        }
        consumeDigits(10);
    ...
    public void ungetToken(int i10) {
        if (this.nextToken != 0) {
    ...
    public static class VanguardParser extends Parser {
        ...
        public boolean parse(Goal goal) {
            ...
            try {
                ...
                i10 = ParserBasicInformation.START_STATE;
            ...
            while (true) {
                ...
                i10 = Parser.tAction(i10, this.currentToken);
                if (i10 == 16966) {
                    return false;
                }
                if (i10 > 867) {
                ...
                while (!goal.hasBeenReached(i10, this.currentToken)) {
                    int i12 = this.stateStackTop - (Parser.rhs[i10] - 1);
                    this.stateStackTop = i12;
                    i10 = Parser.ntAction(this.stack[i12], Parser.lhs[i10]);
                    if (i10 > 867) {
                        break;
                    }
                }
    ...
    public Scanner(boolean z10, boolean z11, boolean z12, long j10, long j11, char[][] cArr, char[][] cArr2, boolean z13) {
        char[][] cArr3;
        int i10;
        char[][] cArr4 = cArr2;
        ?? r32 = 0;
        ...
        int i12 = 0;
        while (i12 < 6) {
            for (int i13 = r32; i13 < i11; i13++) {
                int i14 = 0;
                while (i14 < 6) {
                    this.charArray_length[i12][i13][i14] = initCharArray;
                    i14++;
        ...
        if (cArr != null) {
            ...
            if (cArr4 != null) {
                ...
                for (int i15 = r32; i15 < i10; i15++) {
                    iArr2[i15] = i15;
                }
                Util.reverseQuickSort(cArr3, r32, i10 - 1, iArr2);
                char[][] cArr7 = new char[i10];
                for (int i16 = r32; i16 < i10; i16++) {
                    cArr7[i16] = cArr4[iArr2[i16]];
                }
    ...
    public void resetTo(int i10, int i11, boolean z10) {
        resetTo(i10, i11, z10, null);
    }

    public void resetTo(int i10, int i11, boolean z10, ScanContext scanContext) {
        this.diet = false;
        this.currentPosition = i10;
        this.startPosition = i10;
        ...
        iArr[0] = 0;
        this.consumingEllipsisAnnotations = false;
        this.insideModuleInfo = z10;
        if (scanContext == null) {
            scanContext = getScanContext(i10);
        }
    ...
    public Scanner(boolean z10, boolean z11, boolean z12, long j10, char[][] cArr, char[][] cArr2, boolean z13) {
