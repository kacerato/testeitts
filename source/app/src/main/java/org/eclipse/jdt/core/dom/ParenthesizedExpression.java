...
public class ParenthesizedExpression extends Expression {
    ...
    static {
        ChildPropertyDescriptor childPropertyDescriptor = new ChildPropertyDescriptor(ParenthesizedExpression.class, "expression", Expression.class, true, true);
        EXPRESSION_PROPERTY = childPropertyDescriptor;
        ArrayList arrayList = new ArrayList(2);
        ASTNode.createPropertyList(ParenthesizedExpression.class, arrayList);
    ...
    public ASTNode clone0(AST ast) {
        ...
        parenthesizedExpression.setSourceRange(getStartPosition(), getLength());
        parenthesizedExpression.setExpression((Expression) getExpression().clone(ast));
