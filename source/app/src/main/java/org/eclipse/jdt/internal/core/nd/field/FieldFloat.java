...
public class FieldFloat extends BaseField {
    ...
    public FieldFloat(String str, int i10) {
    ...
    public float get(Nd nd2, long j10) {
        return nd2.getDB().getFloat(j10 + this.offset);
    }
    ...
    public void put(Nd nd2, long j10, float f10) {
        Database db2 = nd2.getDB();
        db2.getLog().start(this.tag);
        try {
            nd2.getDB().putFloat(j10 + this.offset, f10);
        } finally {
