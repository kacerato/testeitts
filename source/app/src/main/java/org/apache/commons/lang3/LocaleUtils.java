...
public class LocaleUtils {
    ...
    public static List<Locale> countriesByLanguage(String str) {
        ...
        for (int i10 = 0; i10 < availableLocaleList.size(); i10++) {
            Locale locale = availableLocaleList.get(i10);
    ...
    private static Locale parseLocale(String str) {
        ...
        String[] split = str.split(ConstantDescs.DEFAULT_NAME, -1);
        String str2 = split[0];
        if (split.length == 2) {
            String str3 = split[1];
    ...
    public static Locale toLocale(String str) {
        ...
        if (str.contains(C16181m.f130230g)) {
            throw new IllegalArgumentException("Invalid locale format: " + str);
        }
