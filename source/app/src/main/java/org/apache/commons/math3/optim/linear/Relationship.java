...
public enum Relationship {
    ...
    public static class AnonymousClass1 {
        static final int[] $SwitchMap$org$apache$commons$math3$optim$linear$Relationship;
    ...
    public Relationship oppositeRelationship() {
        int i10 = AnonymousClass1.$SwitchMap$org$apache$commons$math3$optim$linear$Relationship[ordinal()];
