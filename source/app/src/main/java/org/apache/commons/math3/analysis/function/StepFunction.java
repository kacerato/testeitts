...
public class StepFunction implements UnivariateFunction {
    ...
    public double value(double d10) {
        int binarySearch = Arrays.binarySearch(this.abscissa, d10);
        return binarySearch < -1 ? this.ordinate[(-binarySearch) - 2] : binarySearch >= 0 ? this.ordinate[binarySearch] : this.ordinate[0];
    }
}
