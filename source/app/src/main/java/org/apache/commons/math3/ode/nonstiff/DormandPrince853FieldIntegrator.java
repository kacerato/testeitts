...
public class DormandPrince853FieldIntegrator<T extends RealFieldElement<T>> extends EmbeddedRungeKuttaFieldIntegrator<T> {
    ...
    public DormandPrince853FieldIntegrator(Field<T> field, double d10, double d11, double d12, double d13) {
        super(field, METHOD_NAME, 12, d10, d11, d12, d13);
    ...
    public T estimateError(T[][] tArr, T[] tArr2, T[] tArr3, T t10) {
        RealFieldElement realFieldElement = (RealFieldElement) t10.getField().getZero();
        RealFieldElement realFieldElement2 = (RealFieldElement) t10.getField().getZero();
        for (int i10 = 0; i10 < this.mainSetDimension; i10++) {
            RealFieldElement realFieldElement3 = (RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) tArr[0][i10].multiply(this.e1_01)).add((RealFieldElement) tArr[5][i10].multiply(this.e1_06))).add((RealFieldElement) tArr[6][i10].multiply(this.e1_07))).add((RealFieldElement) tArr[7][i10].multiply(this.e1_08))).add((RealFieldElement) tArr[8][i10].multiply(this.e1_09))).add((RealFieldElement) tArr[9][i10].multiply(this.e1_10))).add((RealFieldElement) tArr[10][i10].multiply(this.e1_11))).add((RealFieldElement) tArr[11][i10].multiply(this.e1_12));
            RealFieldElement realFieldElement4 = (RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) tArr[0][i10].multiply(this.e2_01)).add((RealFieldElement) tArr[5][i10].multiply(this.e2_06))).add((RealFieldElement) tArr[6][i10].multiply(this.e2_07))).add((RealFieldElement) tArr[7][i10].multiply(this.e2_08))).add((RealFieldElement) tArr[8][i10].multiply(this.e2_09))).add((RealFieldElement) tArr[9][i10].multiply(this.e2_10))).add((RealFieldElement) tArr[10][i10].multiply(this.e2_11))).add((RealFieldElement) tArr[11][i10].multiply(this.e2_12));
            RealFieldElement max = MathUtils.max((RealFieldElement) tArr2[i10].abs(), (RealFieldElement) tArr3[i10].abs());
            RealFieldElement realFieldElement5 = (RealFieldElement) (this.vecAbsoluteTolerance == null ? ((RealFieldElement) max.multiply(this.scalRelativeTolerance)).add(this.scalAbsoluteTolerance) : ((RealFieldElement) max.multiply(this.vecRelativeTolerance[i10])).add(this.vecAbsoluteTolerance[i10]));
        ...
        if (realFieldElement8.getReal() <= 0.0d) {
            realFieldElement8 = (RealFieldElement) t10.getField().getOne();
        }
        return (T) ((RealFieldElement) ((RealFieldElement) t10.abs()).multiply(realFieldElement)).divide((RealFieldElement) ((RealFieldElement) realFieldElement8.multiply(this.mainSetDimension)).sqrt());
    }
    ...
    @Override
    public DormandPrince853FieldStepInterpolator<T> createInterpolator(boolean z10, T[][] tArr, FieldODEStateAndDerivative<T> fieldODEStateAndDerivative, FieldODEStateAndDerivative<T> fieldODEStateAndDerivative2, FieldEquationsMapper<T> fieldEquationsMapper) {
        return new DormandPrince853FieldStepInterpolator<>(getField(), z10, tArr, fieldODEStateAndDerivative, fieldODEStateAndDerivative2, fieldODEStateAndDerivative, fieldODEStateAndDerivative2, fieldEquationsMapper);
    }

    public DormandPrince853FieldIntegrator(Field<T> field, double d10, double d11, double[] dArr, double[] dArr2) {
        super(field, METHOD_NAME, 12, d10, d11, dArr, dArr2);
        this.e1_01 = fraction(1.16092271E8d, 8.84846592E9d);
        this.e1_06 = fraction(-1871647.0d, 1527680.0d);
        this.e1_07 = fraction(-6.9799717E7d, 1.4079366E8d);
        this.e1_08 = fraction(1.230164450203E12d, 7.39113984E11d);
