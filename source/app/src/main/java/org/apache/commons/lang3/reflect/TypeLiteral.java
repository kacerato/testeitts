...
public abstract class TypeLiteral<T> implements Typed<T> {
    ...
    private static final TypeVariable<Class<TypeLiteral>> f100102T = TypeLiteral.class.getTypeParameters()[0];
    private final String toString;
    public final Type value;

    public TypeLiteral() {
        Map<TypeVariable<?>, Type> typeArguments = TypeUtils.getTypeArguments(getClass(), TypeLiteral.class);
        TypeVariable<Class<TypeLiteral>> typeVariable = f100102T;
