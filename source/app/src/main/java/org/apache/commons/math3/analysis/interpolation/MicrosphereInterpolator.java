...
public class MicrosphereInterpolator implements MultivariateInterpolator {
    ...
    public MicrosphereInterpolator(int i10, int i11) throws NotPositiveException, NotStrictlyPositiveException {
        if (i11 < 0) {
            throw new NotPositiveException(Integer.valueOf(i11));
        }
        if (i10 > 0) {
            this.microsphereElements = i10;
            this.brightnessExponent = i11;
            return;
        }
