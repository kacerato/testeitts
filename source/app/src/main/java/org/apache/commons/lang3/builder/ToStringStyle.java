...
public abstract class ToStringStyle implements Serializable {
    ...
    private String fieldSeparator = DocLint.SEPARATOR;
    private String arrayStart = "{";
    private String arraySeparator = DocLint.SEPARATOR;
    ...
    public static final class JsonToStringStyle extends ToStringStyle {
        ...
        public JsonToStringStyle() {
            ...
            setArrayStart("[");
            setArrayEnd("]");
            setFieldSeparator(DocLint.SEPARATOR);
            setFieldNameValueSeparator(s.f32937c);
            setNullText("null");
    ...
    public static final class MultiLineToStringStyle extends ToStringStyle {
        ...
        public MultiLineToStringStyle() {
            setContentStart("[");
            setFieldSeparator(System.lineSeparator() + GlideException.a.f59088e);
    ...
    public void removeLastFieldSeparator(StringBuffer stringBuffer) {
        ...
        for (int i10 = 0; i10 < length2; i10++) {
            if (stringBuffer.charAt((length - 1) - i10) != this.fieldSeparator.charAt((length2 - 1) - i10)) {
                return;
            }
        }
