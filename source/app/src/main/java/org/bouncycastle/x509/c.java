...
public class c {
    ...
    public static final String f102360l = "2.5.29.32.0";

    public static final int f102361m = 5;

    public static final int f102362n = 6;

    public static final String f102349a = C13478B.f90545u.J();

    public static final String f102350b = C13478B.f90535k.J();

    public static final String f102351c = C13478B.f90546v.J();

    public static final String f102352d = C13478B.f90533i.J();

    public static final String f102353e = C13478B.f90543s.J();

    public static final String f102354f = C13478B.f90531g.J();

    public static final String f102355g = C13478B.f90515A.J();

    public static final String f102356h = C13478B.f90541q.J();

    public static final String f102357i = C13478B.f90540p.J();

    public static final String f102358j = C13478B.f90548x.J();

    public static final String f102359k = C13478B.f90536l.J();

    public static final String[] f102363o = {C13804a.f92557d, "keyCompromise", "cACompromise", "affiliationChanged", "superseded", "cessationOfOperation", "certificateHold", "unknown", "removeFromCRL", "privilegeWithdrawn", "aACompromise"};

    public static Collection a(Hj.t tVar, List list) throws AnnotatedException {
        ...
        for (Object obj : list) {
            if (obj instanceof org.bouncycastle.util.t) {
                ...
                try {
                    hashSet.addAll(Hj.t.c(tVar, (CertStore) obj));
    ...
    public static Collection c(o oVar, List list) throws AnnotatedException {
        ...
        for (Object obj : list) {
            if (obj instanceof org.bouncycastle.util.t) {
                try {
                    for (Object obj2 : ((org.bouncycastle.util.t) obj).a(oVar)) {
    ...
    public static C13486b d(PublicKey publicKey) throws CertPathValidatorException {
        try {
            return h0.w(new oh.r(publicKey.getEncoded()).k()).v();
        } catch (Exception e10) {
    ...
    public static void e(Date date, X509CRL x509crl, Object obj, d dVar) throws AnnotatedException {
        ...
        try {
            ...
            if (revokedCertificate.hasExtensions()) {
                try {
                    F10 = C14522j.F(g(revokedCertificate, y0.f90992k.J()));
                } catch (Exception e10) {
    ...
    public static X500Principal f(Object obj) {
        return obj instanceof X509Certificate ? ((X509Certificate) obj).getIssuerX500Principal() : (X500Principal) ((l) obj).f().b()[0];
    }

    public static B g(X509Extension x509Extension, String str) throws AnnotatedException {
    ...
    public static PublicKey i(List list, int i10) throws CertPathValidatorException {
        ...
        try {
            return KeyFactory.getInstance("DSA", C14720a.f101701e).generatePublic(new DSAPublicKeySpec(dSAPublicKey2.getY(), params.getP(), params.getQ(), params.getG()));
        } catch (Exception e10) {
            throw new RuntimeException(e10.getMessage());
        }
    }

    public static B j(String str, byte[] bArr) throws AnnotatedException {
        try {
            return new oh.r(((AbstractC14551y) new oh.r(bArr).k()).H()).k();
        } catch (Exception e10) {
            throw new AnnotatedException("exception processing extension " + str, e10);
        }
    }

    public static final Set k(E e10) throws CertPathValidatorException {
        HashSet hashSet = new HashSet();
        if (e10 == null) {
            return hashSet;
        }
    ...
    public static void r(int i10, List[] listArr, String str, Map map, X509Certificate x509Certificate) throws AnnotatedException, CertPathValidatorException {
        ...
        for (I i12 : listArr[i10]) {
            if ("2.5.29.32.0".equals(i12.getValidPolicy())) {
                try {
                    Enumeration J10 = E.G(g(x509Certificate, f102349a)).J();
                    while (true) {
                    ...
                    Set set2 = set;
                    boolean contains = x509Certificate.getCriticalExtensionOIDs() != null ? x509Certificate.getCriticalExtensionOIDs().contains(f102349a) : false;
    ...
    public static I s(int i10, List[] listArr, String str, I i11) {
        int i12;
            ...
            if (i13.getValidPolicy().equals(str)) {
                ...
                for (int i14 = i10 - 1; i14 >= 0; i14--) {
                    ...
                    while (i12 < list.size()) {
                        ...
                        i12 = (i15.c() || (i11 = v(i11, listArr, i15)) != null) ? i12 + 1 : 0;
                    }
                }
            }
        }
    ...
    public static I v(I i10, List[] listArr, I i11) {
