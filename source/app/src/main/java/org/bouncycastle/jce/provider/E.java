...
public class E extends CertPathBuilderSpi {

    public final InterfaceC12950f f101605a;

    public final boolean f101606b;

    public Exception f101607c;
    ...
    */
    public CertPathBuilderResult a(X509Certificate x509Certificate, Hj.u uVar, List list) {
        ...
        if (C14725f.w(x509Certificate, uVar.a().v(), uVar.a().t())) {
            try {
                ...
                try {
                    PKIXCertPathValidatorResult pKIXCertPathValidatorResult = (PKIXCertPathValidatorResult) g10.engineValidate(engineGenerateCertPath, uVar);
    ...
    public CertPathBuilderResult engineBuild(CertPathParameters certPathParameters) throws CertPathBuilderException, InvalidAlgorithmParameterException {
        ...
        if (certPathBuilderResult == null && (exc = this.f101607c) != null) {
            if (exc instanceof AnnotatedException) {
                throw new CertPathBuilderException(this.f101607c.getMessage(), this.f101607c.getCause());
            }
            throw new CertPathBuilderException("Possible certificate chain could not be validated.", this.f101607c);
        }
        if (certPathBuilderResult == null && this.f101607c == null) {
