...
public abstract class d {
    ...
    public static final int f99087a = 16;

    public static final int f99088b = 268435455;

    public static final long f99089c = 4294967295L;

    public static final int[] f99090d = {-1, -1, -1, -1, -1, -1, -1, -2, -1, -1, -1, -1, -1, -1};
    ...
    public static void B(int[] iArr, int i10, byte[] bArr, int i11) {
        int i12 = iArr[i10];
        int i13 = iArr[i10 + 1];
        A((i13 << 28) | i12, bArr, i11);
        z(i13 >>> 4, bArr, i11 + 4);
    }
    ...
    public static void C(int[] iArr, int[] iArr2) {
        ...
        L(j10);
        x(j10, iArr3, 0);
        AbstractC15317c.o(f99090d, iArr3, iArr3);
        p(iArr3, 0, iArr2);
    }
    ...
    public static void D(int[] iArr, int[] iArr2) {
        ...
        L(j10);
        x(j10, iArr3, 0);
        AbstractC15317c.p(f99090d, iArr3, iArr3);
        p(iArr3, 0, iArr2);
    }
    ...
    public static void I(int[] iArr, int i10, int[] iArr2) {
        int i11 = iArr[0];
        int i12 = iArr[1];
        int i13 = iArr[2];
        int i14 = iArr[3];
        ...
        long j11 = i10;
        long j12 = j10 * j11;
        int i27 = ((int) j12) & f99088b;
        long j13 = i16 * j11;
        int i28 = ((int) j13) & f99088b;
        long j14 = i20 * j11;
        int i29 = ((int) j14) & f99088b;
        long j15 = i24 * j11;
        int i30 = ((int) j15) & f99088b;
        long j16 = (j12 >>> 28) + (i13 * j11);
        iArr2[2] = ((int) j16) & f99088b;
        long j17 = (j13 >>> 28) + (i17 * j11);
        iArr2[6] = ((int) j17) & f99088b;
        long j18 = (j14 >>> 28) + (i21 * j11);
        iArr2[10] = ((int) j18) & f99088b;
        long j19 = (j15 >>> 28) + (i25 * j11);
        iArr2[14] = ((int) j19) & f99088b;
        long j20 = (j16 >>> 28) + (i14 * j11);
        iArr2[3] = ((int) j20) & f99088b;
        long j21 = (j17 >>> 28) + (i18 * j11);
        iArr2[7] = ((int) j21) & f99088b;
        long j22 = (j18 >>> 28) + (i22 * j11);
        iArr2[11] = ((int) j22) & f99088b;
        long j23 = (j19 >>> 28) + (i26 * j11);
        iArr2[15] = ((int) j23) & f99088b;
        long j24 = j23 >>> 28;
        long j25 = (j20 >>> 28) + (i15 * j11);
        iArr2[4] = ((int) j25) & f99088b;
        long j26 = (j21 >>> 28) + j24 + (i19 * j11);
        iArr2[8] = ((int) j26) & f99088b;
        long j27 = (j22 >>> 28) + (i23 * j11);
        iArr2[12] = ((int) j27) & f99088b;
        long j28 = j24 + (i11 * j11);
        iArr2[0] = ((int) j28) & f99088b;
    ...
    public static void J(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        int i56 = ((int) j82) & f99088b;
        long j83 = j82 >>> 28;
        long j84 = ((j57 + j60) - j12) + j81;
        int i57 = ((int) j84) & f99088b;
        ...
        int i58 = ((int) j89) & f99088b;
        long j90 = (j84 >>> 28) + ((j86 + j87) - j85) + j88;
        int i59 = ((int) j90) & f99088b;
        ...
        int i60 = ((int) j95) & f99088b;
        long j96 = (j90 >>> 28) + ((j92 + j93) - j91) + j94;
        int i61 = ((int) j96) & f99088b;
        ...
        int i62 = ((int) j101) & f99088b;
        long j102 = (j96 >>> 28) + ((j98 + j99) - j97) + j100;
        int i63 = ((int) j102) & f99088b;
        ...
        int i64 = ((int) j107) & f99088b;
        long j108 = (j102 >>> 28) + ((j104 + j105) - j103) + j106;
        int i65 = ((int) j108) & f99088b;
        ...
        int i66 = ((int) j113) & f99088b;
        long j114 = (j108 >>> 28) + ((j110 + j111) - j109) + j112;
        int i67 = ((int) j114) & f99088b;
        ...
        int i68 = ((int) j119) & f99088b;
        long j120 = (j114 >>> 28) + ((j116 + j117) - j115) + j118;
        int i69 = ((int) j120) & f99088b;
        ...
        int i70 = ((int) j124) & f99088b;
        long j125 = (j120 >>> 28) + (j123 - j121);
        int i71 = ((int) j125) & f99088b;
        long j126 = j125 >>> 28;
        long j127 = (j124 >>> 28) + j126 + i57;
        int i72 = ((int) j127) & f99088b;
        long j128 = j126 + i56;
        iArr3[0] = ((int) j128) & f99088b;
    ...
    public static void O(int[] iArr, int i10) {
        int i11;
        int i12 = iArr[15];
        int i13 = i12 & f99088b;
        long j10 = (i12 >>> 28) + i10;
    ...
    public static void Q(int[] iArr, int[] iArr2) {
        ...
        long j33 = i40;
        long j34 = i47;
        long j35 = i49 & 4294967295L;
        long j36 = j34 * j35;
        long j37 = i46;
        long j38 = i50 & 4294967295L;
        long j39 = j36 + (j37 * j38);
        long j40 = i45;
        long j41 = i51 & 4294967295L;
        long j42 = j39 + (j40 * j41);
        long j43 = i44;
        long j44 = j42 + (j43 * j43);
        long j45 = ((j11 + (j22 * j22)) + j44) - j21;
        int i53 = ((int) j45) & f99088b;
        long j46 = (((j31 + (j32 * j32)) + (j33 * j33)) - j11) + j44;
        int i54 = ((int) j46) & f99088b;
        long j47 = j46 >>> 28;
        long j48 = i11;
        long j49 = i26;
        long j50 = j48 * j49;
        ...
        int i57 = ((int) j76) & f99088b;
        long j77 = j66 + ((j72 + j74) - j68) + j75;
        int i58 = ((int) j77) & f99088b;
        long j78 = i13;
    ...
    public static boolean R(int[] iArr, int[] iArr2, int[] iArr3) {
        int[] j10 = j();
        int[] j11 = j();
        Q(iArr, j10);
        J(j10, iArr2, j10);
    ...
    public static void m(byte[] bArr, int i10, int[] iArr) {
        t(bArr, i10, iArr, 0);
        t(bArr, i10 + 7, iArr, 2);
        t(bArr, i10 + 14, iArr, 4);
        t(bArr, i10 + 21, iArr, 6);
        t(bArr, i10 + 28, iArr, 8);
        t(bArr, i10 + 35, iArr, 10);
        t(bArr, i10 + 42, iArr, 12);
        t(bArr, i10 + 49, iArr, 14);
    }

    public static void n(byte[] bArr, int i10, int[] iArr, int i11) {
        t(bArr, i10, iArr, i11);
        t(bArr, i10 + 7, iArr, i11 + 2);
        t(bArr, i10 + 14, iArr, i11 + 4);
        t(bArr, i10 + 21, iArr, i11 + 6);
        t(bArr, i10 + 28, iArr, i11 + 8);
        t(bArr, i10 + 35, iArr, i11 + 10);
        t(bArr, i10 + 42, iArr, i11 + 12);
        t(bArr, i10 + 49, iArr, i11 + 14);
    }
    ...
    public static void q(int[] iArr, int i10, int[] iArr2, int i11) {
        ...
        int i17 = iArr[i10 + 5];
        int i18 = iArr[i10 + 6];
        iArr2[i11] = i12 & f99088b;
        iArr2[i11 + 1] = ((i12 >>> 28) | (i13 << 4)) & f99088b;
        iArr2[i11 + 2] = ((i13 >>> 24) | (i14 << 8)) & f99088b;
        iArr2[i11 + 3] = ((i14 >>> 20) | (i15 << 12)) & f99088b;
        iArr2[i11 + 4] = ((i15 >>> 16) | (i16 << 16)) & f99088b;
        iArr2[i11 + 5] = ((i16 >>> 12) | (i17 << 20)) & f99088b;
        iArr2[i11 + 6] = 268435455 & ((i17 >>> 8) | (i18 << 24));
        iArr2[i11 + 7] = i18 >>> 4;
    }
    ...
    public static void t(byte[] bArr, int i10, int[] iArr, int i11) {
        int s10 = s(bArr, i10);
        int r10 = r(bArr, i10 + 4);
        iArr[i11] = 268435455 & s10;
        iArr[i11 + 1] = (r10 << 4) | (s10 >>> 28);
    }

    public static void u(int[] iArr, int i10, byte[] bArr, int i11) {
        B(iArr, i10, bArr, i11);
        B(iArr, i10 + 2, bArr, i11 + 7);
        B(iArr, i10 + 4, bArr, i11 + 14);
        B(iArr, i10 + 6, bArr, i11 + 21);
        B(iArr, i10 + 8, bArr, i11 + 28);
        B(iArr, i10 + 10, bArr, i11 + 35);
        B(iArr, i10 + 12, bArr, i11 + 42);
        B(iArr, i10 + 14, bArr, i11 + 49);
    }
    ...
    public static void w(int[] iArr, byte[] bArr, int i10) {
        B(iArr, 0, bArr, i10);
        B(iArr, 2, bArr, i10 + 7);
        B(iArr, 4, bArr, i10 + 14);
        B(iArr, 6, bArr, i10 + 21);
        B(iArr, 8, bArr, i10 + 28);
        B(iArr, 10, bArr, i10 + 35);
        B(iArr, 12, bArr, i10 + 42);
        B(iArr, 14, bArr, i10 + 49);
    }

    public static void x(int[] iArr, int[] iArr2, int i10) {
        y(iArr, 0, iArr2, i10);
        y(iArr, 8, iArr2, i10 + 7);
    }

    public static void y(int[] iArr, int i10, int[] iArr2, int i11) {
        int i12 = iArr[i10];
        int i13 = iArr[i10 + 1];
        int i14 = iArr[i10 + 2];
        int i15 = iArr[i10 + 3];
