...
public class C2663v implements Bi.D {

    public static long[] f9967h = {1, 32898, -9223372036854742902L, -9223372034707259392L, 32907, 2147483649L, -9223372034707259263L, -9223372036854743031L, 138, 136, 2147516425L, 2147483658L, 2147516555L, -9223372036854775669L, -9223372036854742903L, -9223372036854743037L, -9223372036854743038L, -9223372036854775680L, 32778, -9223372034707292150L, -9223372034707259263L, -9223372036854742912L, 2147483649L, -9223372034707259384L};

    public final EnumC2383o f9968a;
    ...
    public C2663v() {
        this(288, EnumC2383o.ANY);
    }

    public final void a(byte[] bArr, int i10) {
        int i11 = this.f9971d >>> 6;
        for (int i12 = 0; i12 < i11; i12++) {
            long[] jArr = this.f9969b;
    ...
    @Override
    public String b() {
        return "Keccak-" + this.f9973f;
    }

    @Override
    public int c(byte[] bArr, int i10) {
        r(bArr, i10, this.f9973f);
        reset();
        return f();
    }
    ...
    public final void d() {
        g();
        org.bouncycastle.util.p.K(this.f9969b, 0, this.f9971d >>> 6, this.f9970c, 0);
        this.f9972e = this.f9971d;
    }

    @Override
    public int f() {
        return this.f9973f / 8;
    }
    ...
    public void k(byte[] bArr, int i10, int i11) {
        ...
        int i15 = i14 >>> 3;
        int i16 = this.f9971d >>> 3;
        int i17 = i16 - i15;
        if (i11 < i17) {
            System.arraycopy(bArr, i10, this.f9970c, i15, i11);
            i13 = this.f9972e + (i11 << 3);
        } else {
            if (i15 > 0) {
                System.arraycopy(bArr, i10, this.f9970c, i15, i17);
                a(this.f9970c, 0);
            } else {
                i17 = 0;
            }
            ...
            System.arraycopy(bArr, i10 + i17, this.f9970c, 0, i12);
            i13 = i12 << 3;
        }
        this.f9972e = i13;
    }
    ...
    public void l(int i10, int i11) {
        ...
        this.f9970c[i12 >>> 3] = (byte) (i10 & ((1 << i11) - 1));
        this.f9972e = i12 + i11;
    }

    public InterfaceC2382n m() {
        return Z.a(this, f() * 8, this.f9968a);
    }
    ...
    public final void p(int i10) {
        ...
        while (true) {
            long[] jArr = this.f9969b;
            if (i11 >= jArr.length) {
                org.bouncycastle.util.a.e0(this.f9970c, (byte) 0);
                this.f9972e = 0;
                this.f9974g = false;
                this.f9973f = (AdvertisingSetParameters.INTERVAL_HIGH - i10) / 2;
                return;
            }
            jArr[i11] = 0;
            i11++;
    ...
    public final void q() {
        ...
        if (i12 == this.f9971d) {
            ...
            for (int i16 = 0; i16 < i13; i16++) {
                long[] jArr = this.f9969b;
                jArr[i16] = jArr[i16] ^ org.bouncycastle.util.p.x(this.f9970c, i15);
                i15 += 8;
            }
            if (i14 > 0) {
                long[] jArr2 = this.f9969b;
                jArr2[i13] = (((1 << i14) - 1) & org.bouncycastle.util.p.x(this.f9970c, i15)) ^ jArr2[i13];
            }
        }
        long[] jArr3 = this.f9969b;
        int i17 = (this.f9971d - 1) >>> 6;
    ...
    public void r(byte[] bArr, int i10, long j10) {
        ...
        while (j11 < j10) {
            ...
            int min = (int) Math.min(this.f9972e, j10 - j11);
            System.arraycopy(this.f9970c, (this.f9971d - this.f9972e) / 8, bArr, ((int) (j11 / 8)) + i10, min / 8);
            this.f9972e -= min;
            j11 += min;
        }
    }
    ...
    public C2663v(int i10, EnumC2383o enumC2383o) {
        this.f9969b = new long[25];
        this.f9970c = new byte[192];
        this.f9968a = enumC2383o;
        o(i10);
        Bi.r.a(m());
    }

    public C2663v(EnumC2383o enumC2383o) {
        this(288, enumC2383o);
    }

    public C2663v(C2663v c2663v) {
        long[] jArr = new long[25];
        this.f9969b = jArr;
        this.f9970c = new byte[192];
        this.f9968a = c2663v.f9968a;
        long[] jArr2 = c2663v.f9969b;
        System.arraycopy(jArr2, 0, jArr, 0, jArr2.length);
        byte[] bArr = c2663v.f9970c;
        System.arraycopy(bArr, 0, this.f9970c, 0, bArr.length);
        this.f9971d = c2663v.f9971d;
        this.f9972e = c2663v.f9972e;
        this.f9973f = c2663v.f9973f;
        this.f9974g = c2663v.f9974g;
        Bi.r.a(m());
    }
}
