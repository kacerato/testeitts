...
public class C16210d extends KeyFactorySpi implements InterfaceC3897c {
    @Override
    public PublicKey a(h0 h0Var) throws IOException {
        return new C16208b(h0Var);
    }

    @Override
    public PrivateKey b(v vVar) throws IOException {
        return new C16207a(vVar);
    }
    ...
    public final Key engineTranslateKey(Key key) throws InvalidKeyException {
        if ((key instanceof C16207a) || (key instanceof C16208b)) {
            return key;
        }
