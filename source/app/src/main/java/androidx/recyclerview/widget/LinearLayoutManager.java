...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static class AnchorInfo {
        ...
        public String toString() {
            return "AnchorInfo{mPosition=" + this.mPosition + ", mCoordinate=" + this.mCoordinate + ", mLayoutFromEnd=" + this.mLayoutFromEnd + ", mValid=" + this.mValid + JavaElement.JEM_ANNOTATION;
        }
    }
    ...
    public void prepareForDrop(View view, View view2, int i10, int i11) {
        ...
        char c10 = position < position2 ? (char) 1 : '\uffff';
        if (this.mShouldReverseLayout) {
            if (c10 == 1) {
