...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class ChangeInfo {
        ...
        public String toString() {
            return "ChangeInfo{oldHolder=" + ((Object) this.oldHolder) + ", newHolder=" + ((Object) this.newHolder) + ", fromX=" + this.fromX + ", fromY=" + this.fromY + ", toX=" + this.toX + ", toY=" + this.toY + JavaElement.JEM_ANNOTATION;
        }
