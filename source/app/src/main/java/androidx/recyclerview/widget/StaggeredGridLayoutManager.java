...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        int i12 = this.mLayoutState.mInfinite ? layoutState.mLayoutDirection == 1 ? Integer.MAX_VALUE : Integer.MIN_VALUE : layoutState.mLayoutDirection == 1 ? layoutState.mEndLine + layoutState.mAvailable : layoutState.mStartLine - layoutState.mAvailable;
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (isLayoutRTL() && this.mOrientation == 1) {
                ...
                i11 = endAfterPadding2 - this.mSecondaryOrientation.getDecoratedMeasurement(next);
            } else {
        ...
        return startAfterPadding2 > 0 ? Math.min(layoutState.mAvailable, startAfterPadding2) : i13;
    }
    ...
    */
    ...
    public PointF computeScrollVectorForPosition(int i10) {
        ...
        if (this.mOrientation == 0) {
            pointF.f32425x = calculateScrollDirectionForPosition;
            pointF.f32426y = 0.0f;
        } else {
            pointF.f32425x = 0.0f;
            pointF.f32426y = calculateScrollDirectionForPosition;
        }
        return pointF;
    }
    ...
    */
    public View hasGapsToFix() {
        ...
        char c10 = (this.mOrientation == 1 && isLayoutRTL()) ? (char) 1 : '\uffff';
        if (this.mShouldReverseLayout) {
            childCount = -1;
        } else {
            i11 = 0;
        ...
        while (i11 != childCount) {
            ...
            if (!layoutParams.mFullSpan && (i10 = i11 + i12) != childCount) {
                ...
                if (this.mShouldReverseLayout) {
                    ...
                    if ((layoutParams.mSpan.mIndex - ((LayoutParams) childAt2.getLayoutParams()).mSpan.mIndex >= 0) == (c10 >= 0)) {
                        return childAt;
                    }
                } else {
                    int decoratedStart = this.mPrimaryOrientation.getDecoratedStart(childAt);
    ...
    public static class LazySpanLookup {
        ...
        public static class FullSpanItem implements Parcelable {
            ...
            public String toString() {
                return "FullSpanItem{mPosition=" + this.mPosition + ", mGapDir=" + this.mGapDir + ", mHasUnwantedGapAfter=" + this.mHasUnwantedGapAfter + ", mGapPerSpan=" + Arrays.toString(this.mGapPerSpan) + JavaElement.JEM_ANNOTATION;
            }
