...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo687clone = transition.mo687clone();
        mo687clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo687clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo687clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo687clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo687clone = transition.mo687clone();
        sceneChangeSetup(viewGroup, mo687clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo687clone);
    }
