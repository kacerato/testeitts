...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    public static final ViewProperty f32654X = new ViewProperty("x") {
        @Override
        public float getValue(View view) {
            return view.getX();
        }
    ...
    public static final ViewProperty f32655Y = new ViewProperty("y") {
        @Override
        public float getValue(View view) {
            return view.getY();
        }
    ...
    public static final ViewProperty f32656Z = new ViewProperty("z") {
        @Override
        public float getValue(View view) {
