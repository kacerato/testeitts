...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    private int getKeyline(int i10) {
        ...
        if (iArr == null) {
            Log.e(TAG, "No keylines defined for " + ((Object) this) + " - attempted index lookup " + i10);
            return 0;
        }
        if (i10 >= 0 && i10 < iArr.length) {
            return iArr[i10];
        }
        Log.e(TAG, "Keyline index " + i10 + " out of range for " + ((Object) this));
        return 0;
    }
    ...
    private static int resolveKeylineGravity(int i10) {
        return i10 == 0 ? C16241a.f130538r : i10;
    }
            ...
            if (view.getVisibility() == 8) {
                ...
                if (i28 < 0 || mode == 0) {
                    ...
                    if (z11 || ViewCompat.getFitsSystemWindows(view)) {
                        ...
                        i14 = View.MeasureSpec.makeMeasureSpec(size - systemWindowInsetLeft, mode);
                        i15 = View.MeasureSpec.makeMeasureSpec(size2 - systemWindowInsetTop, mode2);
                    }
                    ...
                    int max = Math.max(i21, i22 + view.getMeasuredWidth() + layoutParams3.leftMargin + layoutParams3.rightMargin);
                    int max2 = Math.max(i16, i23 + view.getMeasuredHeight() + layoutParams3.topMargin + layoutParams3.bottomMargin);
                ...
                int max3 = Math.max(i21, i22 + view.getMeasuredWidth() + layoutParams32.leftMargin + layoutParams32.rightMargin);
                int max22 = Math.max(i16, i23 + view.getMeasuredHeight() + layoutParams32.topMargin + layoutParams32.bottomMargin);
                i26 = View.combineMeasuredStates(i19, view.getMeasuredState());
                i24 = max3;
                i25 = max22;
            }
