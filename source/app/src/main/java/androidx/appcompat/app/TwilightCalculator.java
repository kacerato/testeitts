...
class TwilightCalculator {
    ...
    private static final float f32527C1 = 0.0334196f;

    private static final float f32528C2 = 3.49066E-4f;

    private static final float f32529C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    private static final float f32530J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long j10, double d10, double d11) {
        ...
        double round = ((float) Math.round((r3 - f32530J0) - r7)) + f32530J0 + ((-d11) / 360.0d) + (Math.sin(d12) * 0.0053d) + (Math.sin(2.0d * sin) * (-0.0069d));
