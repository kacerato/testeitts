...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void setEmbeddedTabView(ScrollingTabContainerView scrollingTabContainerView) {
        ...
        layoutParams.gravity = C16241a.f130541u;
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i10, long j10) {
        return ViewCompat.animate(this.mToolbar).alpha(i10 == 0 ? 1.0f : 0.0f).setDuration(j10).setListener(new ViewPropertyAnimatorListenerAdapter() {
