...
public final class PathSegment {
    ...
    public String toString() {
        return "PathSegment{start=" + ((Object) this.mStart) + ", startFraction=" + this.mStartFraction + ", end=" + ((Object) this.mEnd) + ", endFraction=" + this.mEndFraction + JavaElement.JEM_ANNOTATION;
    }
}
