...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    private boolean addFontFromAssetManager(Context context, Object obj, String str, int i10, int i11, int i12, FontVariationAxis[] fontVariationAxisArr) {
        try {
    ...
    public Typeface createFromFontInfo(Context context, CancellationSignal cancellationSignal, FontsContractCompat.FontInfo[] fontInfoArr, int i10) {
        ...
        if (!isFontFamilyPrivateAPIAvailable()) {
            ...
            try {
                ParcelFileDescriptor openFileDescriptor = context.getContentResolver().openFileDescriptor(findBestInfo.getUri(), com.itsmagic.engine.Engines.Engine.Animation.a.f72595c, cancellationSignal);
