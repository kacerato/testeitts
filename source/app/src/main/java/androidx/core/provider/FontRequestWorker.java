...
public class FontRequestWorker {
    ...
    private static String createCacheId(FontRequest fontRequest, int i10) {
    ...
    public static TypefaceResult getFontSync(String str, Context context, FontRequest fontRequest, int i10) {
    ...
    public static Typeface requestFontAsync(final Context context, final FontRequest fontRequest, final int i10, Executor executor, final CallbackWithHandler callbackWithHandler) {
    ...
    public static Typeface requestFontSync(final Context context, final FontRequest fontRequest, CallbackWithHandler callbackWithHandler, final int i10, int i11) {
        final String createCacheId = createCacheId(fontRequest, i10);
        Typeface typeface = sTypefaceCache.get(createCacheId);
        if (typeface != null) {
            callbackWithHandler.onTypefaceResult(new TypefaceResult(typeface));
