...
public final class DisplayCompat {
    ...
    public static class Api23Impl {
        ...
        public static boolean physicalSizeEquals(Display.Mode mode, Point point) {
            return (mode.getPhysicalWidth() == point.f32423x && mode.getPhysicalHeight() == point.f32424y) || (mode.getPhysicalWidth() == point.f32424y && mode.getPhysicalHeight() == point.f32423x);
        }
    ...
    public static final class ModeCompat {
        ...
        public int getPhysicalHeight() {
            return this.mPhysicalSize.f32424y;
        }

        public int getPhysicalWidth() {
            return this.mPhysicalSize.f32423x;
        }
        ...
        public ModeCompat(Display.Mode mode, boolean z10) {
