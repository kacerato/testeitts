...
public final class LayoutInflaterCompat {
    ...
    public static class Factory2Wrapper implements LayoutInflater.Factory2 {
        ...
        public String toString() {
            return getClass().getName() + "{" + ((Object) this.mDelegateFactory) + VectorFormat.DEFAULT_SUFFIX;
        }
    ...
    private static void forceSetFactory2(LayoutInflater layoutInflater, LayoutInflater.Factory2 factory2) {
        ...
        if (field != null) {
            try {
                ...
                Log.e(TAG, "forceSetFactory2 could not set the Factory2 on LayoutInflater " + ((Object) layoutInflater) + "; inflation may have unexpected results.", e11);
            }
        }
    }
