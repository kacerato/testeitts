...
public final class PointerIconCompat {
    ...
    public static PointerIconCompat create(Bitmap bitmap, float f10, float f11) {
        return new PointerIconCompat(Api24Impl.create(bitmap, f10, f11));
    }

    public static PointerIconCompat getSystemIcon(Context context, int i10) {
        return new PointerIconCompat(Api24Impl.getSystemIcon(context, i10));
    }

    public static PointerIconCompat load(Resources resources, int i10) {
