...
public final class AppOpsManagerCompat {
    ...
    public static class Api29Impl {
        ...
        public static int checkOpNoThrow(AppOpsManager appOpsManager, String str, int i10, String str2) {
    ...
    public static int noteOp(Context context, String str, int i10, String str2) {
        return Api19Impl.noteOp((AppOpsManager) context.getSystemService(Context.APP_OPS_SERVICE), str, i10, str2);
    }

    public static int noteOpNoThrow(Context context, String str, int i10, String str2) {
        return Api19Impl.noteOpNoThrow((AppOpsManager) context.getSystemService(Context.APP_OPS_SERVICE), str, i10, str2);
    }
