...
public abstract class AbstractResolvableFuture<V> implements Z<V> {
    ...
    public static final class SetFuture<V> implements Runnable {
        final Z<? extends V> future;
        final AbstractResolvableFuture<V> owner;

        public SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, Z<? extends V> z10) {
    ...
    private static void executeListener(Runnable runnable, Executor executor) {
        try {
            ...
            log.log(Level.SEVERE, "RuntimeException while executing runnable " + ((Object) runnable) + " with executor " + ((Object) executor), (Throwable) e10);
        }
    }
    ...
    public static Object getFutureValue(Z<?> z10) {
        if (z10 instanceof AbstractResolvableFuture) {
            Object obj = ((AbstractResolvableFuture) z10).value;
            if (!(obj instanceof Cancellation)) {
                return obj;
            }
        ...
        try {
            Object uninterruptibly = getUninterruptibly(z10);
            return uninterruptibly == null ? NULL : uninterruptibly;
        } catch (CancellationException e10) {
            if (isCancelled) {
                return new Cancellation(false, e10);
            }
            return new Failure(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: " + ((Object) z10), e10));
        } catch (ExecutionException e11) {
    ...
    public final boolean cancel(boolean z10) {
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(abstractResolvableFuture, obj, cancellation)) {
                ...
                Z<? extends V> z12 = ((SetFuture) obj).future;
                if (!(z12 instanceof AbstractResolvableFuture)) {
                    z12.cancel(z10);
                    return true;
                }
                abstractResolvableFuture = (AbstractResolvableFuture) z12;
    ...
    public boolean setFuture(Z<? extends V> z10) {
        ...
        if (obj == null) {
            if (z10.isDone()) {
                if (!ATOMIC_HELPER.casValue(this, null, getFutureValue(z10))) {
                    return false;
                }
                complete(this);
                return true;
            }
            SetFuture setFuture = new SetFuture(this, z10);
            if (ATOMIC_HELPER.casValue(this, null, setFuture)) {
                try {
                    z10.addListener(setFuture, DirectExecutor.INSTANCE);
                } catch (Throwable th2) {
                    try {
        ...
        if (obj instanceof Cancellation) {
            z10.cancel(((Cancellation) obj).wasInterrupted);
        }
        return false;
    }
