...
public final class MetadataItem extends Table {
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem metadataItem, int i10) {
            return metadataItem.__assign(Table.__indirect(__element(i10), this.f32664bb), this.f32664bb);
        }
    }
    ...
    public int codepoints(int i10) {
        ...
        if (__offset != 0) {
            return this.f32670bb.getInt(__vector(__offset) + (i10 * 4));
        }
        return 0;
    }
    ...
    public short compatAdded() {
        ...
        if (__offset != 0) {
            return this.f32670bb.getShort(__offset + this.bb_pos);
        }
        return (short) 0;
    }
    ...
    public boolean emojiStyle() {
        ...
        return (__offset == 0 || this.f32670bb.get(__offset + this.bb_pos) == 0) ? false : true;
    }
    ...
    public int id() {
        ...
        if (__offset != 0) {
            return this.f32670bb.getInt(__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector intVector) {
        int __offset = __offset(16);
        if (__offset != 0) {
            return intVector.__assign(__vector(__offset), this.f32670bb);
        }
        return null;
    }
}
