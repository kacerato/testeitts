...
public class FlatBufferBuilder {
    ...
    public void clear() {
        this.space = this.f32665bb.capacity();
        this.f32665bb.clear();
        this.minalign = 1;
        while (true) {
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.space = i10;
        byteBuffer.position(i10);
        this.utf8.encodeUtf8(charSequence, this.f32665bb);
        return endVector();
    }
    ...
    public ByteBuffer createUnintializedVector(int i10, int i11, int i12) {
        ...
        ByteBuffer order = this.f32665bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i13);
        return order;
    }
    ...
    public int endTable() {
        ...
        loop2: while (true) {
            ...
            int capacity = this.f32665bb.capacity() - this.vtables[i14];
            int i15 = this.space;
            short s10 = this.f32665bb.getShort(capacity);
            if (s10 == this.f32665bb.getShort(i15)) {
                for (int i16 = 2; i16 < s10; i16 += 2) {
                    if (this.f32665bb.getShort(capacity + i16) != this.f32665bb.getShort(i15 + i16)) {
                        break;
                    }
                }
        ...
        if (i10 != 0) {
            int capacity2 = this.f32665bb.capacity() - offset;
            this.space = capacity2;
            this.f32665bb.putInt(capacity2, i10 - offset);
        } else {
    ...
    public void finish(int i10, boolean z10) {
        ...
        addOffset(i10);
        if (z10) {
            addInt(this.f32665bb.capacity() - this.space);
        }
        this.f32665bb.position(this.space);
        this.finished = true;
    }
    ...
    public FlatBufferBuilder init(ByteBuffer byteBuffer, ByteBufferFactory byteBufferFactory) {
        ...
        this.f32665bb = byteBuffer;
        byteBuffer.clear();
        this.f32665bb.order(ByteOrder.LITTLE_ENDIAN);
        this.minalign = 1;
        this.space = this.f32665bb.capacity();
        this.vtable_in_use = 0;
        this.nested = false;
    ...
    public int offset() {
        return this.f32665bb.capacity() - this.space;
    }
    ...
    public void required(int i10, int i11) {
        int capacity = this.f32665bb.capacity() - i10;
        if (this.f32665bb.getShort((capacity - this.f32665bb.getInt(capacity)) + i11) != 0) {
            return;
        }
        throw new AssertionError((Object) ("FlatBuffers: field " + i11 + " must be set"));
    }

    public byte[] sizedByteArray(int i10, int i11) {
        finished();
        byte[] bArr = new byte[i11];
        this.f32665bb.position(i10);
        this.f32665bb.get(bArr);
        return bArr;
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.f32665bb.duplicate();
        duplicate.position(this.space);
        duplicate.limit(this.f32665bb.capacity());
    ...
    public FlatBufferBuilder(int i10, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            ...
            this.f32665bb = byteBufferFactory.newByteBuffer(i10);
        }
        this.utf8 = utf8;
        this.space = this.f32665bb.capacity();
    }
    ...
    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f32665bb.capacity() - this.space);
    }
    ...
    public int createByteVector(byte[] bArr, int i10, int i11) {
        ...
        this.f32665bb.put(bArr, i10, i11);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f32665bb;
        int i10 = this.space - remaining;
        this.space = i10;
        byteBuffer2.position(i10);
        this.f32665bb.put(byteBuffer);
        return endVector();
    }
