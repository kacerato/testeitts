...
public class FlexBuffers {
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer wrap = ByteBuffer.wrap(this.f32666bb.data());
        ...
        public byte get(int i10) {
            return this.f32666bb.get(this.end + i10);
        }
        ...
        public byte[] getBytes() {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                bArr[i10] = this.f32666bb.get(this.end + i10);
            }
            return bArr;
        }
        ...
        public String toString() {
            return this.f32666bb.getString(this.end, size());
        }

        @Override
        public StringBuilder toString(StringBuilder sb2) {
            sb2.append('\"');
            sb2.append(this.f32666bb.getString(this.end, size()));
            sb2.append('\"');
            return sb2;
        }
    }
    ...
    public static class Key extends Object {
        ...
        public String toString() {
            int i10 = this.end;
            while (this.f32666bb.get(i10) != 0) {
                i10++;
            }
            int i11 = this.end;
            return this.f32666bb.getString(i11, i10 - i11);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int i10) {
            ...
            ReadBuf readBuf = typedVector2.f32666bb;
    ...
    public static class Map extends Vector {
        ...
        public Vector values() {
            return new Vector(this.f32666bb, this.end, this.byteWidth);
        }
    ...
    public static class Reference {
        ...
        public Blob asBlob() {
            ...
            ReadBuf readBuf = this.f32667bb;
            return new Blob(readBuf, FlexBuffers.indirect(readBuf, this.end, this.parentWidth), this.byteWidth);
        }

        public boolean asBoolean() {
            return isBoolean() ? this.f32667bb.get(this.end) != 0 : asUInt() != 0;
        }

        public double asFloat() {
            int i10 = this.type;
            if (i10 == 3) {
                return FlexBuffers.readDouble(this.f32667bb, this.end, this.parentWidth);
            }
            if (i10 == 1) {
                return FlexBuffers.readInt(this.f32667bb, this.end, this.parentWidth);
            }
            if (i10 != 2) {
                if (i10 == 5) {
            ...
            return FlexBuffers.readUInt(this.f32667bb, this.end, this.parentWidth);
        }
        ...
        public int asInt() {
            ...
            if (i10 == 2) {
                return (int) FlexBuffers.readUInt(this.f32667bb, this.end, this.parentWidth);
            }
            if (i10 == 3) {
                return (int) FlexBuffers.readDouble(this.f32667bb, this.end, this.parentWidth);
            }
            if (i10 == 5) {
        ...
        public long asLong() {
            int i10 = this.type;
            if (i10 == 1) {
                return FlexBuffers.readLong(this.f32667bb, this.end, this.parentWidth);
            }
            if (i10 == 2) {
                return FlexBuffers.readUInt(this.f32667bb, this.end, this.parentWidth);
            }
            if (i10 == 3) {
                return (long) FlexBuffers.readDouble(this.f32667bb, this.end, this.parentWidth);
            }
            if (i10 == 5) {
                try {
        ...
        public String asString() {
            if (isString()) {
                int indirect = FlexBuffers.indirect(this.f32667bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f32667bb;
                int i10 = this.byteWidth;
                return this.f32667bb.getString(indirect, (int) FlexBuffers.readUInt(readBuf, indirect - i10, i10));
            }
            if (!isKey()) {
                return "";
            }
            int indirect2 = FlexBuffers.indirect(this.f32667bb, this.end, this.byteWidth);
            int i11 = indirect2;
            while (this.f32667bb.get(i11) != 0) {
                i11++;
            }
            return this.f32667bb.getString(indirect2, i11 - indirect2);
        }
        ...
        public StringBuilder toString(StringBuilder sb2) {
            ...
            sb2.append((java.lang.Object) asVector());
            return sb2;
        }
    }
    ...
    public static abstract class Sized extends Object {
        ...
        public Sized(ReadBuf readBuf, int i10, int i11) {
            super(readBuf, i10, i11);
            this.size = FlexBuffers.readInt(this.f32666bb, i10 - i11, i11);
        }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int i10) {
            ...
            return new Reference(this.f32666bb, this.end + (i10 * this.byteWidth), this.byteWidth, 1, this.elemType);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i10) {
            ...
            return new Reference(this.f32666bb, this.end + (i10 * this.byteWidth), this.byteWidth, Unsigned.byteToUnsignedInt(this.f32666bb.get((int) (this.end + (size * this.byteWidth) + j10))));
        }
