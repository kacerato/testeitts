...
public final class Utf8Safe extends Utf8 {
    ...
    */
    private static int encodeUtf8Array(CharSequence charSequence, byte[] bArr, int i10, int i11) {
        ...
        int i14 = i11 + i10;
        int i15 = 0;
        while (i15 < length && (i13 = i15 + i10) < i14 && (charAt = charSequence.charAt(i15)) < '\u0080') {
        ...
        while (i15 < length) {
            ...
            if (charAt2 < '\u0080' && i16 < i14) {
                ...
                if ((charAt2 >= '\ud800' && '\udfff' >= charAt2) || i16 > i14 - 3) {
                    if (i16 > i14 - 4) {
                        if ('\ud800' <= charAt2 && charAt2 <= '\udfff' && ((i12 = i15 + 1) == charSequence.length() || !Character.isSurrogatePair(charAt2, charSequence.charAt(i12)))) {
