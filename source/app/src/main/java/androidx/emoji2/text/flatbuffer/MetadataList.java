...
public final class MetadataList extends Table {
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataList get(MetadataList metadataList, int i10) {
            return metadataList.__assign(Table.__indirect(__element(i10), this.f32664bb), this.f32664bb);
        }
    }
    ...
    public MetadataItem list(MetadataItem metadataItem, int i10) {
        int __offset = __offset(6);
        if (__offset != 0) {
            return metadataItem.__assign(__indirect(__vector(__offset) + (i10 * 4)), this.f32670bb);
        }
        return null;
    }
    ...
    public MetadataItem.Vector listVector(MetadataItem.Vector vector) {
        int __offset = __offset(6);
        if (__offset != 0) {
            return vector.__assign(__vector(__offset), 4, this.f32670bb);
        }
        return null;
    }
}
