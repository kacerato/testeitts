...
class FocusStrategy {
    ...
    private static boolean beamBeats(int i10, Rect rect, Rect rect2, Rect rect3) {
    ...
    private static boolean beamsOverlap(int i10, Rect rect, Rect rect2) {
        if (i10 != 17) {
            if (i10 != 33) {
                if (i10 != 66) {
                    if (i10 != 130) {
    ...
    public static <L, T> T findNextFocusInAbsoluteDirection(L l10, CollectionAdapter<L, T> collectionAdapter, BoundsAdapter<T> boundsAdapter, T t10, Rect rect, int i10) {
    ...
    public static <L, T> T findNextFocusInRelativeDirection(L l10, CollectionAdapter<L, T> collectionAdapter, BoundsAdapter<T> boundsAdapter, T t10, int i10, boolean z10, boolean z11) {
        int size = collectionAdapter.size(l10);
    ...
    private static boolean isBetterCandidate(int i10, Rect rect, Rect rect2, Rect rect3) {
    ...
    private static boolean isCandidate(Rect rect, Rect rect2, int i10) {
        if (i10 == 17) {
            int i11 = rect.right;
            int i12 = rect2.right;
    ...
    private static boolean isToDirectionOf(int i10, Rect rect, Rect rect2) {
        if (i10 == 17) {
    ...
    private static int majorAxisDistance(int i10, Rect rect, Rect rect2) {
        return Math.max(0, majorAxisDistanceRaw(i10, rect, rect2));
    }

    private static int majorAxisDistanceRaw(int i10, Rect rect, Rect rect2) {
        int i11;
        int i12;
        if (i10 == 17) {
            i11 = rect.left;
    ...
    private static int majorAxisDistanceToFarEdge(int i10, Rect rect, Rect rect2) {
        return Math.max(1, majorAxisDistanceToFarEdgeRaw(i10, rect, rect2));
    }

    private static int majorAxisDistanceToFarEdgeRaw(int i10, Rect rect, Rect rect2) {
        int i11;
        int i12;
        if (i10 == 17) {
            i11 = rect.left;
    ...
    private static int minorAxisDistance(int i10, Rect rect, Rect rect2) {
        if (i10 != 17) {
            if (i10 != 33) {
                if (i10 != 66) {
                    if (i10 != 130) {
