...
public class ViewDragHelper {
    ...
    private int computeAxisDuration(int i10, int i11, int i12) {
        ...
        return Math.min(abs > 0 ? Math.round(Math.abs(distanceInfluenceForSnapDuration / abs) * 1000.0f) * 4 : (int) (((Math.abs(i10) / i12) + 1.0f) * 256.0f), 600);
    }
    ...
    public boolean canScroll(View view, boolean z10, int i10, int i11, int i12, int i13) {
        int i14;
                ...
                if (actionMasked != 2) {
                    if (actionMasked != 3) {
                        if (actionMasked == 5) {
                            ...
                            } else if (i10 == 2 && (findTopChildUnder = findTopChildUnder((int) x10, (int) y10)) == this.mCapturedView) {
                                tryCaptureViewForDrag(findTopChildUnder, pointerId);
                            }
                    ...
                    for (int i13 = 0; i13 < pointerCount; i13++) {
                        ...
                        if (isValidPointerForActionMove(pointerId2)) {
                            ...
                            boolean z11 = findTopChildUnder2 != null && checkTouchSlop(findTopChildUnder2, f10, f11);
                            if (z11) {
                                int left = findTopChildUnder2.getLeft();
                                int i14 = (int) f10;
                                int clampViewPositionHorizontal = this.mCallback.clampViewPositionHorizontal(findTopChildUnder2, left + i14, i14);
                                int top = findTopChildUnder2.getTop();
                                int i15 = (int) f11;
                                int clampViewPositionVertical = this.mCallback.clampViewPositionVertical(findTopChildUnder2, top + i15, i15);
                            ...
                            if (z11 && tryCaptureViewForDrag(findTopChildUnder2, pointerId2)) {
                                break;
                            }
                        }
                    }
