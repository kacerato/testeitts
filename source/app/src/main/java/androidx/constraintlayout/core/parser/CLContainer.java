...
public class CLContainer extends CLElement {
    ...
    public void add(CLElement cLElement) {
        ...
        if (CLParser.DEBUG) {
            System.out.println("added element " + ((Object) cLElement) + " to " + ((Object) this));
        }
    }
    ...
    public CLArray getArray(String str) throws CLParsingException {
        ...
        throw new CLParsingException("no array found for key <" + str + ">, found [" + cLElement.getStrClass() + "] : " + ((Object) cLElement), this);
    }
    ...
    public boolean getBoolean(String str) throws CLParsingException {
        ...
        throw new CLParsingException("no boolean found for key <" + str + ">, found [" + cLElement.getStrClass() + "] : " + ((Object) cLElement), this);
    }
    ...
    public float getFloat(String str) throws CLParsingException {
        ...
        throw new CLParsingException("no float found for key <" + str + ">, found [" + cLElement.getStrClass() + "] : " + ((Object) cLElement), this);
    }
    ...
    public int getInt(String str) throws CLParsingException {
        ...
        throw new CLParsingException("no int found for key <" + str + ">, found [" + cLElement.getStrClass() + "] : " + ((Object) cLElement), this);
    }
    ...
    public CLObject getObject(String str) throws CLParsingException {
        ...
        throw new CLParsingException("no object found for key <" + str + ">, found [" + cLElement.getStrClass() + "] : " + ((Object) cLElement), this);
    }
    ...
    public String getString(String str) throws CLParsingException {
        ...
        throw new CLParsingException("no string found for key <" + str + ">, found [" + (cLElement != null ? cLElement.getStrClass() : null) + "] : " + ((Object) cLElement), this);
    }
