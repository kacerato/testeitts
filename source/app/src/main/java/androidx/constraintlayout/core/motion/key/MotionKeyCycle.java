...
public class MotionKeyCycle extends MotionKey {
    ...
    public void dump() {
        System.out.println("MotionKeyCycle{mWaveShape=" + this.mWaveShape + ", mWavePeriod=" + this.mWavePeriod + ", mWaveOffset=" + this.mWaveOffset + ", mWavePhase=" + this.mWavePhase + ", mRotation=" + this.mRotation + JavaElement.JEM_ANNOTATION);
    }
    ...
    public void printAttributes() {
        ...
        Utils.log("MotionKeyCycle{Shape=" + this.mWaveShape + ", Period=" + this.mWavePeriod + ", Offset=" + this.mWaveOffset + ", Phase=" + this.mWavePhase + JavaElement.JEM_ANNOTATION);
        String[] strArr = (String[]) hashSet.toArray(new String[0]);
        for (int i10 = 0; i10 < strArr.length; i10++) {
            TypedValues.AttributesType.getId(strArr[i10]);
            Utils.log(strArr[i10] + s.f32937c + getValue(strArr[i10]));
        }
    }
