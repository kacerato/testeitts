...
public class Motion implements TypedValues {
    ...
    public void getDpDt(float f10, float f11, float f12, float[] fArr) {
        ...
        if (curveFitArr == null) {
            ...
            float f13 = motionPaths.f32544x;
            MotionPaths motionPaths2 = this.mStartMotionPath;
            float f14 = f13 - motionPaths2.f32544x;
            float f15 = motionPaths.f32545y - motionPaths2.f32545y;
    ...
    public float getFinalX() {
        return this.mEndMotionPath.f32544x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f32545y;
    }
    ...
    public float getKeyFrameParameter(int i10, float f10, float f11) {
        MotionPaths motionPaths = this.mEndMotionPath;
        float f12 = motionPaths.f32544x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f13 = motionPaths2.f32544x;
        float f14 = f12 - f13;
        float f15 = motionPaths.f32545y;
        float f16 = motionPaths2.f32545y;
        float f17 = f15 - f16;
    ...
    public float getStartX() {
        return this.mStartMotionPath.f32544x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f32545y;
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f10, long j10, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            MotionPaths motionPaths = this.mStartMotionPath;
            float f14 = motionPaths.f32544x;
            MotionPaths motionPaths2 = this.mEndMotionPath;
            float f15 = f14 + ((motionPaths2.f32544x - f14) * f13);
            float f16 = motionPaths.f32545y;
            float f17 = f16 + ((motionPaths2.f32545y - f16) * f13);
    ...
    public void setup(int i10, int i11, float f10, long j10) {
        ...
        if (!hashSet2.isEmpty()) {
            ...
            while (it2.hasNext()) {
                ...
                if (next2.startsWith("CUSTOM,")) {
                    ...
                    String str = next2.split(DocLint.SEPARATOR)[c10];
        ...
        for (String str5 : this.mEndMotionPath.customAttributes.o()) {
        ...
        double[][] dArr = (double[][]) Array.newInstance(Double.TYPE, i16, this.mInterpolateVariables.length);
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            double[][] dArr6 = (double[][]) Array.newInstance(Double.TYPE, i32, 2);
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f32544x + " y: " + this.mStartMotionPath.f32545y + " end: x: " + this.mEndMotionPath.f32544x + " y: " + this.mEndMotionPath.f32545y;
    }
