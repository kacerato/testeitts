...
public class Flow extends VirtualLayout {
    ...
    */
    private void measureAligned(ConstraintWidget[] constraintWidgetArr, int i10, int i11, int i12, int[] iArr) {
        int i13;
        int i14;
        boolean z10;
        ConstraintWidget constraintWidget;
        if (i11 == 0) {
            int i15 = this.mMaxElementsWrap;
            if (i15 <= 0) {
                i15 = 0;
                int i16 = 0;
                for (int i17 = 0; i17 < i10; i17++) {
                    ...
                    if (constraintWidget2 != null) {
                        i16 += getWidgetWidth(constraintWidget2, i12);
                        if (i16 > i12) {
                            break;
                        } else {
                            i15++;
            ...
            if (i13 <= 0) {
                ...
                for (int i19 = 0; i19 < i10; i19++) {
                    ...
                    if (constraintWidget3 != null) {
                        i18 += getWidgetHeight(constraintWidget3, i12);
                        if (i18 > i12) {
                            break;
                        } else {
                            i13++;
        ...
        if ((i13 != 0 || i11 != 1) && (i14 != 0 || i11 != 0)) {
            ...
            while (!z10) {
                ...
                for (int i20 = 0; i20 < i14; i20++) {
                    for (int i21 = 0; i21 < i13; i21++) {
                        ...
                        if (i22 < constraintWidgetArr.length && (constraintWidget = constraintWidgetArr[i22]) != null) {
                            ...
                            ConstraintWidget constraintWidget4 = this.mAlignedBiggestElementsInCols[i20];
                            if (constraintWidget4 == null || constraintWidget4.getWidth() < widgetWidth) {
                                this.mAlignedBiggestElementsInCols[i20] = constraintWidget;
                            }
                            int widgetHeight = getWidgetHeight(constraintWidget, i12);
                            ConstraintWidget constraintWidget5 = this.mAlignedBiggestElementsInRows[i21];
                            if (constraintWidget5 == null || constraintWidget5.getHeight() < widgetHeight) {
                                this.mAlignedBiggestElementsInRows[i21] = constraintWidget;
                            }
                        }
                    }
                }
                ...
                for (int i24 = 0; i24 < i14; i24++) {
                    ConstraintWidget constraintWidget6 = this.mAlignedBiggestElementsInCols[i24];
                    if (constraintWidget6 != null) {
                        if (i24 > 0) {
                            i23 += this.mHorizontalGap;
                        }
                        i23 += getWidgetWidth(constraintWidget6, i12);
                    }
                }
                int i25 = 0;
                for (int i26 = 0; i26 < i13; i26++) {
                    ConstraintWidget constraintWidget7 = this.mAlignedBiggestElementsInRows[i26];
                    if (constraintWidget7 != null) {
                        if (i26 > 0) {
                            i25 += this.mVerticalGap;
                        }
                        i25 += getWidgetHeight(constraintWidget7, i12);
                    }
                }
                iArr[0] = i23;
                iArr[1] = i25;
