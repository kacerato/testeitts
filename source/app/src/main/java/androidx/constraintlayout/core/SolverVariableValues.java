...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    private void addToHashMap(SolverVariable solverVariable, int i10) {
        int[] iArr;
        int i11 = solverVariable.f32541id % this.HASH_SIZE;
        int[] iArr2 = this.keys;
        int i12 = iArr2[i11];
        if (i12 == -1) {
            iArr2[i11] = i10;
    ...
    private void addVariable(int i10, SolverVariable solverVariable, float f10) {
        this.variables[i10] = solverVariable.f32541id;
        this.values[i10] = f10;
        this.previous[i10] = -1;
        this.next[i10] = -1;
    ...
    private void removeFromHashMap(SolverVariable solverVariable) {
        int[] iArr;
        int i10;
        int i11 = solverVariable.f32541id;
    ...
    public void put(SolverVariable solverVariable, float f10) {
        ...
        for (int i13 = 0; i13 < i10; i13++) {
            ...
            int i15 = solverVariable.f32541id;
            if (i14 == i15) {
                this.values[i11] = f10;
                return;
            }
