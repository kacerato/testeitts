...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z10) {
        boolean diff = diff(this.f32544x, motionPaths.f32544x);
        boolean diff2 = diff(this.f32545y, motionPaths.f32545y);
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f32544x, this.f32545y, this.width, this.height, this.mPathRotate};
        int i10 = 0;
        for (int i11 : iArr) {
            if (i11 < 6) {
                dArr[i10] = fArr[r2];
    ...
    public void getCenter(double d10, int[] iArr, double[] dArr, float[] fArr, int i10) {
        float f10 = this.f32544x;
        float f11 = this.f32545y;
    ...
    public void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f17 = motionPaths.f32544x;
        float f18 = motionPaths.f32545y;
        float f19 = (motionPaths2.f32544x + (f13 / 2.0f)) - ((f14 / 2.0f) + f17);
        float f20 = (motionPaths2.f32545y + (f15 / 2.0f)) - (f18 + (f16 / 2.0f));
        float f21 = ((f13 - f14) * f11) / 2.0f;
        this.f32544x = (int) ((f17 + (f19 * f10)) - f21);
        float f22 = ((f15 - f16) * f12) / 2.0f;
        this.f32545y = (int) ((f18 + (f20 * f10)) - f22);
        ...
        this.mMode = 0;
        this.f32544x = (int) (((motionPaths.f32544x + (f23 * f19)) + (f25 * f20)) - f21);
        this.f32545y = (int) (((motionPaths.f32545y + (f19 * f24)) + (f20 * f10)) - f22);
    ...
    public void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f15 = motionPaths.f32544x;
        float f16 = motionPaths.width;
        float f17 = motionPaths.f32545y;
        float f18 = motionPaths.height;
        float f19 = (motionPaths2.f32544x + (motionPaths2.width / 2.0f)) - ((f16 / 2.0f) + f15);
        float f20 = (motionPaths2.f32545y + (motionPaths2.height / 2.0f)) - ((f18 / 2.0f) + f17);
        float f21 = f19 * f10;
        float f22 = (f13 * f11) / 2.0f;
        this.f32544x = (int) ((f15 + f21) - f22);
        float f23 = f10 * f20;
        float f24 = (f14 * f12) / 2.0f;
        this.f32545y = (int) ((f17 + f23) - f24);
        ...
        this.mMode = 1;
        float f26 = (int) ((motionPaths.f32544x + f21) - f22);
        float f27 = (int) ((motionPaths.f32545y + f23) - f24);
        this.f32544x = f26 + ((-f20) * f25);
        this.f32545y = f27 + (f19 * f25);
    ...
    public void initPolar(int i10, int i11, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (i12 == 1) {
            ...
            float f19 = motionPaths2.f32544x;
            float f20 = motionPaths.f32544x;
            this.f32544x = (f18 * (f19 - f20)) + f20;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f11 = motionKeyPosition.mPercentY;
            }
            float f21 = motionPaths2.f32545y;
            float f22 = motionPaths.f32545y;
            this.f32545y = (f11 * (f21 - f22)) + f22;
        } else if (i12 != 2) {
            float f23 = Float.isNaN(motionKeyPosition.mPercentX) ? f11 : motionKeyPosition.mPercentX;
            float f24 = motionPaths2.f32544x;
            float f25 = motionPaths.f32544x;
            this.f32544x = (f23 * (f24 - f25)) + f25;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f11 = motionKeyPosition.mPercentY;
            }
            float f26 = motionPaths2.f32545y;
            float f27 = motionPaths.f32545y;
            this.f32545y = (f11 * (f26 - f27)) + f27;
        } else {
            if (Float.isNaN(motionKeyPosition.mPercentX)) {
                float f28 = motionPaths2.f32544x;
                float f29 = motionPaths.f32544x;
                min = ((f28 - f29) * f11) + f29;
            } else {
            ...
            this.f32544x = min;
            if (Float.isNaN(motionKeyPosition.mPercentY)) {
                float f30 = motionPaths2.f32545y;
                float f31 = motionPaths.f32545y;
                f10 = (f11 * (f30 - f31)) + f31;
            } else {
                f10 = motionKeyPosition.mPercentY;
            }
    ...
    public void initScreen(int i10, int i11, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f17 = motionPaths.f32544x;
        float f18 = motionPaths.f32545y;
        float f19 = motionPaths2.f32544x + (f13 / 2.0f);
        float f20 = motionPaths2.f32545y + (f15 / 2.0f);
        float f21 = (f13 - f14) * f11;
        this.f32544x = (int) ((f17 + ((f19 - ((f14 / 2.0f) + f17)) * f10)) - (f21 / 2.0f));
        float f22 = (f15 - f16) * f12;
        this.f32545y = (int) ((f18 + ((f20 - (f18 + (f16 / 2.0f))) * f10)) - (f22 / 2.0f));
        this.width = (int) (f14 + f21);
        this.height = (int) (f16 + f22);
        this.mMode = 2;
        if (!Float.isNaN(motionKeyPosition.mPercentX)) {
            this.f32544x = (int) (motionKeyPosition.mPercentX * ((int) (i10 - this.width)));
        }
        if (!Float.isNaN(motionKeyPosition.mPercentY)) {
            this.f32545y = (int) (motionKeyPosition.mPercentY * ((int) (i11 - this.height)));
        }
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(motionKeyPosition.mTransitionEasing);
        this.mPathMotionArc = motionKeyPosition.mPathMotionArc;
    ...
    public void setView(float f10, MotionWidget motionWidget, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        float f11;
        float f12;
        float f13 = this.f32544x;
        float f14 = this.f32545y;
    ...
    public void setupRelative(Motion motion, MotionPaths motionPaths) {
        double d10 = ((this.f32544x + (this.width / 2.0f)) - motionPaths.f32544x) - (motionPaths.width / 2.0f);
        double d11 = ((this.f32545y + (this.height / 2.0f)) - motionPaths.f32545y) - (motionPaths.height / 2.0f);
        this.mRelativeToController = motion;
        this.f32544x = (float) Math.hypot(d11, d10);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f32545y = (float) (Math.atan2(d11, d10) + 1.5707963267948966d);
        } else {
            this.f32545y = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    public void getCenter(double d10, int[] iArr, double[] dArr, float[] fArr, double[] dArr2, float[] fArr2) {
        float f10;
        float f11 = this.f32544x;
        float f12 = this.f32545y;
