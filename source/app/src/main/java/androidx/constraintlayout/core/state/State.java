...
public class State {
    ...
    public static class AnonymousClass1 {
        static final int[] $SwitchMap$androidx$constraintlayout$core$state$State$Helper;
    ...
    public void apply(ConstraintWidgetContainer constraintWidgetContainer) {
        ...
        for (Object obj : this.mHelperReferences.o()) {
        ...
        for (Object obj2 : this.mReferences.o()) {
        ...
        Iterator<Object> it = this.mReferences.o().iterator();
        while (it.hasNext()) {
        ...
        Iterator<Object> it2 = this.mHelperReferences.o().iterator();
        while (it2.hasNext()) {
        ...
        Iterator<Object> it4 = this.mReferences.o().iterator();
        while (it4.hasNext()) {
        ...
        for (Object obj3 : this.mReferences.o()) {
    ...
    public void directMapping() {
        for (Object obj : this.mReferences.o()) {
            ConstraintReference constraints = constraints(obj);
            if (constraints != null) {
