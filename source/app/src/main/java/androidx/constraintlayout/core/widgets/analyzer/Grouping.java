...
public class Grouping {
    ...
    public static WidgetGroup findDependents(ConstraintWidget constraintWidget, int i10, ArrayList<WidgetGroup> arrayList, WidgetGroup widgetGroup) {
        ...
        if (i11 != -1 && (widgetGroup == null || i11 != widgetGroup.f32555id)) {
            int i12 = 0;
            while (true) {
    ...
    public static boolean simpleSolvingPass(ConstraintWidgetContainer constraintWidgetContainer, BasicMeasure.Measurer measurer) {
        ...
        if (arrayList2 != null) {
            ...
            while (it2.hasNext()) {
                ...
                WidgetGroup findDependents = findDependents(helperWidget2, i13, arrayList7, widgetGroup3);
                helperWidget2.addDependents(arrayList7, i13, findDependents);
        ...
        if (arrayList4 != null) {
            ...
            while (it8.hasNext()) {
                ...
                WidgetGroup findDependents2 = findDependents(helperWidget3, i14, arrayList7, widgetGroup4);
                helperWidget3.addDependents(arrayList7, i14, findDependents2);
