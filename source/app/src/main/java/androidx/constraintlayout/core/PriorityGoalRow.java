...
public class PriorityGoalRow extends ArrayRow {
    ...
    private final void addToGoal(SolverVariable solverVariable) {
        ...
        int i13 = i12 + 1;
        this.numGoals = i13;
        if (i13 > 1 && solverVariableArr3[i12].f32541id > solverVariable.f32541id) {
            int i14 = 0;
            while (true) {
                i10 = this.numGoals;
                if (i14 >= i10) {
            ...
            Arrays.sort(this.sortArray, 0, i10, new Comparator<SolverVariable>() {
                @Override
                public int compare(SolverVariable solverVariable2, SolverVariable solverVariable3) {
                    return solverVariable2.f32541id - solverVariable3.f32541id;
                }
            });
    ...
    public SolverVariable getPivotCandidate(LinearSystem linearSystem, boolean[] zArr) {
        ...
        for (int i11 = 0; i11 < this.numGoals; i11++) {
            ...
            if (!zArr[solverVariable.f32541id]) {
                this.accessor.init(solverVariable);
                if (i10 == -1) {
