...
public class LinearSystem {
    ...
    private SolverVariable createVariable(String str, SolverVariable.Type type) {
        ...
        this.mNumColumns++;
        acquireSolverVariable.f32541id = i10;
    ...
    private String getDisplayStrength(int i10) {
        return i10 == 1 ? JavaCore.COMPILER_TASK_PRIORITY_LOW : i10 == 2 ? "MEDIUM" : i10 == 3 ? JavaCore.COMPILER_TASK_PRIORITY_HIGH : i10 == 4 ? "HIGHEST" : i10 == 5 ? "EQUALITY" : i10 == 8 ? "FIXED" : i10 == 6 ? "BARRIER" : KeyProperties.DIGEST_NONE;
    }
    ...
    private final int optimize(Row row, boolean z10) {
        ...
        while (!z11) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f32541id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                boolean[] zArr = this.mAlreadyTestedCandidates;
                int i12 = pivotCandidate.f32541id;
                if (zArr[i12]) {
                    return i11;
                }
                zArr[i12] = true;
    ...
    */
    ...
    public SolverVariable createErrorVariable(int i10, String str) {
        ...
        this.mNumColumns++;
        acquireSolverVariable.f32541id = i11;
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            int i10 = solverVariable.f32541id;
    ...
    public void addEquality(SolverVariable solverVariable, int i10) {
        if (USE_BASIC_SYNONYMS && solverVariable.definitionId == -1) {
            ...
            for (int i11 = 0; i11 < this.mVariablesID + 1; i11++) {
                ...
                if (solverVariable2 != null && solverVariable2.isSynonym && solverVariable2.synonym == solverVariable.f32541id) {
