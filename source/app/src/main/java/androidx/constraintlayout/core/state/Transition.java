...
public class Transition implements TypedValues {
            ...
            case -1:
                return new Interpolator() {
                    ...
                    public final float getInterpolation(float f10) {
                        ...
                        lambda$getInterpolator$0 = Transition.lambda$getInterpolator$0(String.this, f10);
    ...
    public static float lambda$getInterpolator$0(String str, float f10) {
        return (float) Easing.getInterpolator(str).get(f10);
    }

    public static float lambda$getInterpolator$1(float f10) {
        return (float) Easing.getInterpolator("standard").get(f10);
    }

    public static float lambda$getInterpolator$2(float f10) {
        return (float) Easing.getInterpolator("accelerate").get(f10);
    }

    public static float lambda$getInterpolator$3(float f10) {
        return (float) Easing.getInterpolator("decelerate").get(f10);
    }

    public static float lambda$getInterpolator$4(float f10) {
        return (float) Easing.getInterpolator("linear").get(f10);
    }

    public static float lambda$getInterpolator$5(float f10) {
        return (float) Easing.getInterpolator("anticipate").get(f10);
    }

    public static float lambda$getInterpolator$6(float f10) {
        return (float) Easing.getInterpolator("overshoot").get(f10);
    }

    public static float lambda$getInterpolator$7(float f10) {
    ...
    public void fillKeyPositions(WidgetFrame widgetFrame, float[] fArr, float[] fArr2, float[] fArr3) {
        ...
        for (int i11 = 0; i11 <= 100; i11++) {
            ...
            if (hashMap != null && (keyPosition = hashMap.get(widgetFrame.widget.stringId)) != null) {
                fArr[i10] = keyPosition.f32550x;
                fArr2[i10] = keyPosition.f32551y;
    ...
    public void interpolate(int i10, int i11, float f10) {
        ...
        Iterator<String> it = this.state.o().iterator();
        while (it.hasNext()) {
