...
public class Utils {
    ...
    public static void logStack(String str, int i10) {
        ...
        for (int i11 = 1; i11 <= min; i11++) {
            ...
            String str3 = ".(" + stackTrace[i11].getFileName() + s.f32937c + stackTrace[i11].getLineNumber() + ") " + stackTrace[i11].getMethodName();
            str2 = str2 + " ";
    ...
    public static void log(String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + s.f32937c + stackTraceElement.getLineNumber() + ")" + C13155a.f85806a.substring(Integer.toString(stackTraceElement.getLineNumber()).length()) + substring;
