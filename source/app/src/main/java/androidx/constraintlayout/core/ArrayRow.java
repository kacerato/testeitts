...
public class ArrayRow implements LinearSystem.Row {
    ...
    private SolverVariable pickPivotInVariables(boolean[] zArr, SolverVariable solverVariable) {
        ...
        for (int i10 = 0; i10 < currentSize; i10++) {
            ...
            if (variableValue < 0.0f) {
                ...
                if ((zArr == null || !zArr[variable.f32541id]) && variable != solverVariable && (((type = variable.mType) == SolverVariable.Type.SLACK || type == SolverVariable.Type.ERROR) && variableValue < f10)) {
                    f10 = variableValue;
    ...
    public ArrayRow addError(LinearSystem linearSystem, int i10) {
        ...
        this.variables.put(linearSystem.createErrorVariable(i10, j.f121590b), -1.0f);
        return this;
    }
    ...
    */
    public String toReadableString() {
        boolean z10;
        String str = (this.variable == null ? "0" : "" + ((Object) this.variable)) + " = ";
