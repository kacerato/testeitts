        ...
        if (i19 != -1) {
            ...
            if (i13 != -1) {
                ...
                if (constraintWidget6 != null) {
                    ...
                    widget.immediateConnect(type, constraintWidget6, type, layoutParams.leftMargin, i17);
                }
            } else if (i14 != -1 && (constraintWidget = idToWidget.get(i14)) != null) {
                widget.immediateConnect(ConstraintAnchor.Type.LEFT, constraintWidget, ConstraintAnchor.Type.RIGHT, layoutParams.leftMargin, i17);
            }
            if (i15 != -1) {
                ConstraintWidget constraintWidget7 = idToWidget.get(i15);
                if (constraintWidget7 != null) {
                    widget.immediateConnect(ConstraintAnchor.Type.RIGHT, constraintWidget7, ConstraintAnchor.Type.LEFT, layoutParams.rightMargin, i18);
                }
            } else if (i16 != -1 && (constraintWidget2 = idToWidget.get(i16)) != null) {
                ConstraintAnchor.Type type2 = ConstraintAnchor.Type.RIGHT;
                widget.immediateConnect(type2, constraintWidget2, type2, layoutParams.rightMargin, i18);
            }
            ...
            if (i20 != -1) {
                ...
                if (constraintWidget8 != null) {
                    ...
                    widget.immediateConnect(type3, constraintWidget8, type3, layoutParams.topMargin, layoutParams.goneTopMargin);
                }
            } else {
            ...
            if (i22 != -1) {
                ...
                if (i23 != -1 && (constraintWidget4 = idToWidget.get(i23)) != null) {
                    ...
                    widget.immediateConnect(type4, constraintWidget4, type4, layoutParams.bottomMargin, layoutParams.goneBottomMargin);
                }
            }
        ...
        if (isInEditMode()) {
            ...
            for (int i11 = 0; i11 < childCount; i11++) {
                ...
                if (childAt.getVisibility() != 8 && (tag = childAt.getTag()) != null && (tag instanceof String)) {
                    String[] split = ((String) tag).split(DocLint.SEPARATOR);
                    if (split.length == 4) {
    ...
    public String getSceneString() {
        ...
        if (this.mLayoutWidget.stringId == null) {
            ...
            if (id3 != -1) {
                ...
                this.mLayoutWidget.stringId = MediaStore.Files.FileColumns.PARENT;
            }
        }
