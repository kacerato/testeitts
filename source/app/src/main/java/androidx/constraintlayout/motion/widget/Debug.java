...
public class Debug {
    public static void dumpLayoutParams(ViewGroup layout, String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + s.f32937c + stackTraceElement.getLineNumber() + ") " + str + GlideException.a.f59088e;
    ...
    public static void dumpPoc(Object obj) {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str = ".(" + stackTraceElement.getFileName() + s.f32937c + stackTraceElement.getLineNumber() + ")";
        Class<?> cls = obj.getClass();
        System.out.println(str + "------------- " + cls.getName() + " --------------------");
        for (Field field : cls.getFields()) {
            try {
                Object obj2 = field.get(obj);
                if (field.getName().startsWith("layout_constraint") && ((!(obj2 instanceof Integer) || !obj2.toString().equals("-1")) && ((!(obj2 instanceof Integer) || !obj2.toString().equals("0")) && ((!(obj2 instanceof Float) || !obj2.toString().equals("1.0")) && (!(obj2 instanceof Float) || !obj2.toString().equals(c.f5125q)))))) {
                    System.out.println(str + C13155a.f85806a + field.getName() + " " + obj2);
                }
            } catch (IllegalAccessException unused) {
            }
        }
    ...
    public static String getCallFrom(int n10) {
        ...
        return ".(" + stackTraceElement.getFileName() + s.f32937c + stackTraceElement.getLineNumber() + ")";
    }

    public static String getLoc() {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        return ".(" + stackTraceElement.getFileName() + s.f32937c + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName() + "()";
    }
    ...
    public static void logStack(String tag, String msg, int n10) {
        ...
        for (int i10 = 1; i10 <= min; i10++) {
            ...
            str = str + " ";
            Log.v(tag, msg + str + (".(" + stackTrace[i10].getFileName() + s.f32937c + stackTrace[i10].getLineNumber() + ") " + stackTrace[i10].getMethodName()) + str);
        }
    }
    ...
    public static void printStack(String msg, int n10) {
        ...
        for (int i10 = 1; i10 <= min; i10++) {
            StackTraceElement stackTraceElement = stackTrace[i10];
            String str2 = ".(" + stackTrace[i10].getFileName() + s.f32937c + stackTrace[i10].getLineNumber() + ") ";
            str = str + " ";
    ...
    public static String getState(MotionLayout layout, int stateId, int len) {
        ...
        return resourceEntryName.replaceAll(CharBuffer.allocate((resourceEntryName.length() - len) / length).toString().replace((char) 0, '.') + ConstantDescs.DEFAULT_NAME, ConstantDescs.DEFAULT_NAME);
    }
    ...
    public static void dumpLayoutParams(ViewGroup.LayoutParams param, String str) {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str2 = ".(" + stackTraceElement.getFileName() + s.f32937c + stackTraceElement.getLineNumber() + ") " + str + GlideException.a.f59088e;
        System.out.println(" >>>>>>>>>>>>>>>>>>. dump " + str2 + GlideException.a.f59088e + param.getClass().getName());
