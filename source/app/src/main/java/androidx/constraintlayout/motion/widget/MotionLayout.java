...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public class DevModeDraw {
        ...
        private void drawRectangle(Canvas canvas, MotionController motionController) {
            ...
            this.mPaint.setColor(CompilerOptions.PreviewFeatureUsed);
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> frameArrayList, int duration, int debugPath) {
            ...
            if (!MotionLayout.this.isInEditMode() && (debugPath & 1) == 2) {
                String str = MotionLayout.this.getContext().getResources().getResourceName(MotionLayout.this.mEndState) + s.f32937c + MotionLayout.this.getProgress();
    ...
    public class Model {
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c10) {
            ...
            Log.v(MotionLayout.TAG, str + "  ========= " + ((Object) c10));
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                String str3 = ConstantDescs.DEFAULT_NAME;
                sb2.append(constraintAnchor != null ? ExifInterface.GPS_DIRECTION_TRUE : ConstantDescs.DEFAULT_NAME);
                String sb3 = sb2.toString();
                StringBuilder sb4 = new StringBuilder();
                sb4.append(sb3);
                sb4.append(constraintWidget.mBottom.mTarget != null ? Signature.SIG_BYTE : ConstantDescs.DEFAULT_NAME);
                String sb5 = sb4.toString();
                StringBuilder sb6 = new StringBuilder();
                sb6.append(sb5);
                sb6.append(constraintWidget.mLeft.mTarget != null ? "L" : ConstantDescs.DEFAULT_NAME);
                ...
                Log.v(MotionLayout.TAG, str2 + GlideException.a.f59088e + name + " " + ((Object) constraintWidget) + " " + sb9);
            }
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            String str5 = Signature.SIG_BYTE;
            String str6 = "__";
            if (constraintAnchor != null) {
                StringBuilder sb3 = new StringBuilder();
                sb3.append(ExifInterface.GPS_DIRECTION_TRUE);
                sb3.append(child.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? ExifInterface.GPS_DIRECTION_TRUE : Signature.SIG_BYTE);
                str2 = sb3.toString();
            } else {
                str2 = "__";
            }
            ...
            sb11.append(str6);
            Log.v(MotionLayout.TAG, str + sb11.toString() + " ---  " + ((Object) child));
        }
            ...
            while (i11 < childCount) {
                ...
                if (motionController2 == null) {
                    ...
                    if (this.mStart != null) {
                        ...
                        int i13 = motionLayout.mPreRotateWidth;
                        int i14 = MotionLayout.this.mPreRotateHeight;
                        str = MotionLayout.TAG;
                        sparseArray = sparseArray2;
                        str2 = "no widget for  ";
                        motionController2.setStartState(viewState, childAt2, i12, i13, i14);
                        if (this.mEnd != null) {
    ...
    */
    public void evaluate(boolean force) {
        ...
        if (this.mKeepAnimating || (this.mInTransition && (force || this.mTransitionGoalPosition != f10))) {
            ...
            float f11 = !(interpolator2 instanceof MotionInterpolator) ? ((((float) (nanoTime - this.mTransitionLastTime)) * signum) * 1.0E-9f) / this.mTransitionDuration : 0.0f;
            ...
            if (interpolator2 == null || z10) {
                ...
                c10 = interpolator3 == stopLogic ? stopLogic.isStopped() ? (char) 2 : (char) 1 : (char) 0;
                ...
                if (interpolator4 instanceof MotionInterpolator) {
                    ...
                    if (Math.abs(velocity) * this.mTransitionDuration <= 1.0E-5f && c10 == 2) {
                        this.mInTransition = false;
                    }
                    ...
                    if (velocity < 0.0f && interpolation <= 0.0f) {
                        ...
                        float interpolation2 = interpolator5 == null ? f12 : interpolator5.getInterpolation(f12);
                        interpolator = this.mProgressInterpolator;
                        if (interpolator != null) {
                            float interpolation3 = interpolator.getInterpolation((signum / this.mTransitionDuration) + f12);
                            this.mLastVelocity = interpolation3;
                            this.mLastVelocity = interpolation3 - this.mProgressInterpolator.getInterpolation(f12);
                        }
                        ...
                        boolean z13 = (signum <= 0.0f && f12 >= this.mTransitionGoalPosition) || (signum <= 0.0f && f12 <= this.mTransitionGoalPosition);
                        ...
                        if (f12 <= 0.0f && (i11 = this.mBeginState) != -1 && this.mCurrentState != i11) {
                ...
                float interpolation4 = interpolator2.getInterpolation(f12);
                ...
                if (interpolator6 instanceof MotionInterpolator) {
                    ...
                    this.mLastVelocity = ((interpolator6.getInterpolation(f12 + f11) - interpolation4) * signum) / f11;
                }
                f12 = interpolation4;
            }
            c10 = 0;
    ...
    public void getViewVelocity(View view, float posOnViewX, float posOnViewY, float[] returnVelocity, int type) {
        ...
        if (this.mInterpolator != null) {
            ...
            f11 = (signum * ((interpolation - f10) / 1.0E-5f)) / this.mTransitionDuration;
        } else {
            f10 = f12;
        }
        Interpolator interpolator = this.mInterpolator;
    ...
    */
    ...
    public void updateStateAnimate(int stateId, ConstraintSet set, int duration) {
        if (this.mScene != null && this.mCurrentState == stateId) {
            ...
            updateState(i10, getConstraintSet(stateId));
            setState(i10, -1, -1);
            updateState(stateId, set);
            MotionScene.Transition transition = new MotionScene.Transition(-1, this.mScene, i10, stateId);
    ...
    public static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f32559me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f32559me.tracker = VelocityTracker.obtain();
            return f32559me;
        }
