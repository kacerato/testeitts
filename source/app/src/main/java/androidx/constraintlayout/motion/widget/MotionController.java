...
public class MotionController {
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        if (curveFitArr == null) {
            ...
            float f10 = motionPaths.f32560x;
            MotionPaths motionPaths2 = this.mStartMotionPath;
            float f11 = f10 - motionPaths2.f32560x;
            float f12 = motionPaths.f32561y - motionPaths2.f32561y;
    ...
    public float getFinalX() {
        return this.mEndMotionPath.f32560x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f32561y;
    }
    ...
    public float getKeyFrameParameter(int type, float x10, float y10) {
        ...
        float f10 = motionPaths.f32560x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f11 = motionPaths2.f32560x;
        float f12 = f10 - f11;
        float f13 = motionPaths.f32561y;
        float f14 = motionPaths2.f32561y;
        float f15 = f13 - f14;
    ...
    public KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x10, float y10) {
        ...
        float f10 = motionPaths.f32560x;
        rectF.left = f10;
        float f11 = motionPaths.f32561y;
        rectF.top = f11;
        rectF.right = f10 + motionPaths.width;
        rectF.bottom = f11 + motionPaths.height;
        RectF rectF2 = new RectF();
        MotionPaths motionPaths2 = this.mEndMotionPath;
        float f12 = motionPaths2.f32560x;
        rectF2.left = f12;
        float f13 = motionPaths2.f32561y;
        rectF2.top = f13;
    ...
    public float getStartX() {
        return this.mStartMotionPath.f32560x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f32561y;
    }
    ...
    public boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            i10 = 1;
            MotionPaths motionPaths = this.mStartMotionPath;
            float f13 = motionPaths.f32560x;
            MotionPaths motionPaths2 = this.mEndMotionPath;
            float f14 = f13 + ((motionPaths2.f32560x - f13) * f12);
            float f15 = motionPaths.f32561y;
            float f16 = f15 + ((motionPaths2.f32561y - f15) * f12);
            ...
            float f22 = f16 + 0.5f;
            int i15 = (int) f22;
            int i16 = (int) (f21 + ((f18 - f17) * f12) + f17);
            int i17 = (int) (f22 + ((f20 - f19) * f12) + f19);
            int i18 = i16 - i14;
            int i19 = i17 - i15;
        ...
        if (hashMap4 != null) {
            for (ViewOscillator viewOscillator : hashMap4.values()) {
                if (viewOscillator instanceof ViewOscillator.PathRotateSet) {
                    ...
                    ((ViewOscillator.PathRotateSet) viewOscillator).setPathRotate(child, f12, dArr4[0], dArr4[i10]);
                } else {
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (!hashSet2.isEmpty()) {
            ...
            while (it2.hasNext()) {
                ...
                if (next2.startsWith("CUSTOM,")) {
                    ...
                    String str = next2.split(DocLint.SEPARATOR)[1];
            ...
            for (String str2 : this.mAttributesMap.o()) {
        ...
        if (!hashSet.isEmpty()) {
            ...
            while (it5.hasNext()) {
                ...
                if (!this.mTimeCycleAttributesMap.containsKey(next5)) {
                    if (next5.startsWith("CUSTOM,")) {
                        ...
                        String str3 = next5.split(DocLint.SEPARATOR)[1];
            ...
            for (String str4 : this.mTimeCycleAttributesMap.o()) {
        ...
        for (String str5 : this.mEndMotionPath.attributes.o()) {
        ...
        double[][] dArr2 = (double[][]) Array.newInstance(Double.TYPE, i12, this.mInterpolateVariables.length);
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            double[][] dArr7 = (double[][]) Array.newInstance(Double.TYPE, i12, 2);
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f32560x + " y: " + this.mStartMotionPath.f32561y + " end: x: " + this.mEndMotionPath.f32560x + " y: " + this.mEndMotionPath.f32561y;
    }
