...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void applyParameters(ConstraintSet.Constraint c10) {
        ...
        for (String str : c10.mCustomConstraints.o()) {
    ...
    public void different(MotionPaths points, boolean[] mask, String[] custom, boolean arcMode) {
        boolean diff = diff(this.f32560x, points.f32560x);
        boolean diff2 = diff(this.f32561y, points.f32561y);
    ...
    public void fillStandard(double[] data, int[] toUse) {
        float[] fArr = {this.position, this.f32560x, this.f32561y, this.width, this.height, this.mPathRotate};
        int i10 = 0;
        for (int i11 : toUse) {
            if (i11 < 6) {
                data[i10] = fArr[r2];
    ...
    public void initCartesian(KeyPosition c10, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f17 = startTimePoint.f32560x;
        float f18 = startTimePoint.f32561y;
        float f19 = (endTimePoint.f32560x + (f13 / 2.0f)) - ((f14 / 2.0f) + f17);
        float f20 = (endTimePoint.f32561y + (f15 / 2.0f)) - (f18 + (f16 / 2.0f));
        float f21 = ((f13 - f14) * f11) / 2.0f;
        this.f32560x = (int) ((f17 + (f19 * f10)) - f21);
        float f22 = ((f15 - f16) * f12) / 2.0f;
        this.f32561y = (int) ((f18 + (f20 * f10)) - f22);
        ...
        this.mMode = 0;
        this.f32560x = (int) (((startTimePoint.f32560x + (f23 * f19)) + (f25 * f20)) - f21);
        this.f32561y = (int) (((startTimePoint.f32561y + (f19 * f24)) + (f20 * f10)) - f22);
    ...
    public void initPath(KeyPosition c10, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f15 = startTimePoint.f32560x;
        float f16 = startTimePoint.width;
        float f17 = startTimePoint.f32561y;
        float f18 = startTimePoint.height;
        float f19 = (endTimePoint.f32560x + (endTimePoint.width / 2.0f)) - ((f16 / 2.0f) + f15);
        float f20 = (endTimePoint.f32561y + (endTimePoint.height / 2.0f)) - ((f18 / 2.0f) + f17);
        float f21 = f19 * f10;
        float f22 = (f13 * f11) / 2.0f;
        this.f32560x = (int) ((f15 + f21) - f22);
        float f23 = f10 * f20;
        float f24 = (f14 * f12) / 2.0f;
        this.f32561y = (int) ((f17 + f23) - f24);
        this.width = (int) (f16 + r7);
        this.height = (int) (f18 + r8);
        float f25 = Float.isNaN(c10.mPercentY) ? 0.0f : c10.mPercentY;
        this.mMode = 1;
        float f26 = (int) ((startTimePoint.f32560x + f21) - f22);
        float f27 = (int) ((startTimePoint.f32561y + f23) - f24);
        this.f32560x = f26 + ((-f20) * f25);
        this.f32561y = f27 + (f19 * f25);
    ...
    public void initPolar(int parentWidth, int parentHeight, KeyPosition c10, MotionPaths s10, MotionPaths e10) {
        ...
        if (i10 == 1) {
            ...
            float f19 = e10.f32560x;
            float f20 = s10.f32560x;
            this.f32560x = (f18 * (f19 - f20)) + f20;
            if (!Float.isNaN(c10.mPercentY)) {
                f11 = c10.mPercentY;
            }
            float f21 = e10.f32561y;
            float f22 = s10.f32561y;
            this.f32561y = (f11 * (f21 - f22)) + f22;
        } else if (i10 != 2) {
            float f23 = Float.isNaN(c10.mPercentX) ? f11 : c10.mPercentX;
            float f24 = e10.f32560x;
            float f25 = s10.f32560x;
            this.f32560x = (f23 * (f24 - f25)) + f25;
            if (!Float.isNaN(c10.mPercentY)) {
                f11 = c10.mPercentY;
            }
            float f26 = e10.f32561y;
            float f27 = s10.f32561y;
            this.f32561y = (f11 * (f26 - f27)) + f27;
        } else {
            if (Float.isNaN(c10.mPercentX)) {
                float f28 = e10.f32560x;
                float f29 = s10.f32560x;
                min = ((f28 - f29) * f11) + f29;
            } else {
            ...
            this.f32560x = min;
            if (Float.isNaN(c10.mPercentY)) {
                float f30 = e10.f32561y;
                float f31 = s10.f32561y;
                f10 = (f11 * (f30 - f31)) + f31;
            } else {
                f10 = c10.mPercentY;
            }
    ...
    public void initScreen(int parentWidth, int parentHeight, KeyPosition c10, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f17 = startTimePoint.f32560x;
        float f18 = startTimePoint.f32561y;
        float f19 = endTimePoint.f32560x + (f13 / 2.0f);
        float f20 = endTimePoint.f32561y + (f15 / 2.0f);
        float f21 = (f13 - f14) * f11;
        this.f32560x = (int) ((f17 + ((f19 - ((f14 / 2.0f) + f17)) * f10)) - (f21 / 2.0f));
        float f22 = (f15 - f16) * f12;
        this.f32561y = (int) ((f18 + ((f20 - (f18 + (f16 / 2.0f))) * f10)) - (f22 / 2.0f));
        this.width = (int) (f14 + f21);
        this.height = (int) (f16 + f22);
        this.mMode = 2;
        if (!Float.isNaN(c10.mPercentX)) {
            this.f32560x = (int) (c10.mPercentX * ((int) (parentWidth - this.width)));
        }
        if (!Float.isNaN(c10.mPercentY)) {
            this.f32561y = (int) (c10.mPercentY * ((int) (parentHeight - this.height)));
        }
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(c10.mTransitionEasing);
        this.mPathMotionArc = c10.mPathMotionArc;
    ...
    public void setView(float position, View view, int[] toUse, double[] data, double[] slope, double[] cycle, boolean mForceMeasure) {
        float f10;
        float f11;
        float f12 = this.f32560x;
        float f13 = this.f32561y;
    ...
    public void setupRelative(MotionController mc2, MotionPaths relative) {
        double d10 = ((this.f32560x + (this.width / 2.0f)) - relative.f32560x) - (relative.width / 2.0f);
        double d11 = ((this.f32561y + (this.height / 2.0f)) - relative.f32561y) - (relative.height / 2.0f);
        this.mRelativeToController = mc2;
        this.f32560x = (float) Math.hypot(d11, d10);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f32561y = (float) (Math.atan2(d11, d10) + 1.5707963267948966d);
        } else {
            this.f32561y = (float) Math.toRadians(this.mRelativeAngle);
        }
    }

    @Override
    public int compareTo(MotionPaths o10) {
    ...
    public void getCenter(double p10, int[] toUse, double[] data, float[] point, double[] vdata, float[] velocity) {
        float f10;
        float f11 = this.f32560x;
        float f12 = this.f32561y;
