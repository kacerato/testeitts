...
public abstract class LimitOffsetDataSource<T> extends PositionalDataSource<T> {
    ...
    public LimitOffsetDataSource(RoomDatabase db2, SupportSQLiteQuery query, boolean inTransaction, String... tables) {
        this(db2, RoomSQLiteQuery.copyFrom(query), inTransaction, tables);
    }
    ...
    public void loadInitial(PositionalDataSource.LoadInitialParams params, PositionalDataSource.LoadInitialCallback<T> callback) {
        ...
        try {
            ...
            callback.onResult(emptyList, i10, countItems);
        } catch (Throwable th3) {
            th = th3;
    ...
    public LimitOffsetDataSource(RoomDatabase db2, SupportSQLiteQuery query, boolean inTransaction, boolean registerObserverImmediately, String... tables) {
        this(db2, RoomSQLiteQuery.copyFrom(query), inTransaction, registerObserverImmediately, tables);
    }
    ...
    public LimitOffsetDataSource(RoomDatabase db2, RoomSQLiteQuery query, boolean inTransaction, String... tables) {
        this(db2, query, inTransaction, true, tables);
    }

    public LimitOffsetDataSource(RoomDatabase db2, RoomSQLiteQuery query, boolean inTransaction, boolean registerObserverImmediately, String... tables) {
