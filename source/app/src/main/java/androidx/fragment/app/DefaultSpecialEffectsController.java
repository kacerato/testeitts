...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    private void startAnimations(List<AnimationInfo> list, List<SpecialEffectsController.Operation> list2, boolean z10, Map<SpecialEffectsController.Operation, Boolean> map) {
        int i10;
        boolean z11;
        Context context;
        View view;
                    ...
                    if (animator == null) {
                        ...
                        if (Boolean.TRUE.equals(map.get(operation2))) {
                            if (FragmentManager.isLoggingEnabled(2)) {
                                Log.v(FragmentManager.TAG, "Ignoring Animator set on " + ((Object) fragment) + " as this Fragment was involved in a Transition.");
                            }
                            next.completeSpecialEffect();
                        } else {
                            ...
                            animator.addListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animator2) {
                                    ...
                                    next.completeSpecialEffect();
                                    if (FragmentManager.isLoggingEnabled(2)) {
                                        Log.v(FragmentManager.TAG, "Animator from operation " + ((Object) operation2) + " has ended.");
                                    }
                                }
                            });
                            ...
                            next.getSignal().setOnCancelListener(new CancellationSignal.OnCancelListener() {
                                ...
                                public void onCancel() {
                                    animator.end();
                                    if (FragmentManager.isLoggingEnabled(2)) {
                                        Log.v(FragmentManager.TAG, "Animator from operation " + ((Object) operation) + " has been canceled.");
                                    }
                                }
                            });
                            z12 = true;
        ...
        while (it2.hasNext()) {
            ...
            if (z10) {
                if (FragmentManager.isLoggingEnabled(i10)) {
                    Log.v(FragmentManager.TAG, "Ignoring Animation set on " + ((Object) fragment2) + " as Animations cannot run alongside Transitions.");
                }
                animationInfo.completeSpecialEffect();
            } else if (z12) {
                if (FragmentManager.isLoggingEnabled(i10)) {
                    Log.v(FragmentManager.TAG, "Ignoring Animation set on " + ((Object) fragment2) + " as Animations cannot run alongside Animators.");
                }
                animationInfo.completeSpecialEffect();
            } else {
                ...
                if (operation3.getFinalState() != SpecialEffectsController.Operation.State.REMOVED) {
                    ...
                    endViewTransitionAnimation.setAnimationListener(new Animation.AnimationListener() {
                        ...
                        public void onAnimationEnd(Animation animation3) {
                            ...
                            if (FragmentManager.isLoggingEnabled(2)) {
                                Log.v(FragmentManager.TAG, "Animation from operation " + ((Object) operation3) + " has ended.");
                            }
                        }
                        ...
                        public void onAnimationStart(Animation animation3) {
                            if (FragmentManager.isLoggingEnabled(2)) {
                                Log.v(FragmentManager.TAG, "Animation from operation " + ((Object) operation3) + " has reached onAnimationStart.");
                            }
                        }
                    });
                    ...
                    i11 = 2;
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v(FragmentManager.TAG, "Animation from operation " + ((Object) operation3) + " has started.");
                    }
                }
                ...
                animationInfo.getSignal().setOnCancelListener(new CancellationSignal.OnCancelListener() {
                    ...
                    public void onCancel() {
                        ...
                        animationInfo.completeSpecialEffect();
                        if (FragmentManager.isLoggingEnabled(2)) {
                            Log.v(FragmentManager.TAG, "Animation from operation " + ((Object) operation3) + " has been cancelled.");
                        }
                    }
                });
                i10 = i11;
    ...
    private Map<SpecialEffectsController.Operation, Boolean> startTransitions(List<TransitionInfo> list, List<SpecialEffectsController.Operation> list2, final boolean z10, final SpecialEffectsController.Operation operation, final SpecialEffectsController.Operation operation2) {
        String str;
        String str2;
        String str3;
        View view;
        ...
        while (true) {
            ...
            if (!next.hasSharedElementTransition() || operation7 == null || operation8 == null) {
                ...
                if (enterTransitionCallback != null) {
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v(FragmentManager.TAG, "Executing exit callback for operation " + ((Object) operation7));
                    }
                    ...
                    arrayList5 = sharedElementSourceNames;
                    arrayMap2.retainAll(arrayMap3.o());
                }
                ...
                if (exitTransitionCallback != null) {
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v(FragmentManager.TAG, "Executing enter callback for operation " + ((Object) operation8));
                    }
                ...
                retainMatchingViews(arrayMap3, arrayMap2.o());
        ...
        for (final TransitionInfo transitionInfo3 : list) {
            if (!transitionInfo3.isVisibilityUnchanged()) {
                ...
                if (transition == null && !z14) {
                    ...
                    str2 = str6;
                    fragmentTransitionImpl3.setListenerForTransitionEnd(transitionInfo3.getOperation().getFragment(), mergeTransitionsInSequence, transitionInfo3.getSignal(), new Runnable() {
                        @Override
                        public void run() {
                            transitionInfo3.completeSpecialEffect();
                            if (FragmentManager.isLoggingEnabled(2)) {
                                Log.v(FragmentManager.TAG, "Transition for operation " + ((Object) operation13) + "has completed");
                            }
                        }
                    });
                } else {
                    if (FragmentManager.isLoggingEnabled(2)) {
                        str2 = str6;
                        Log.v(str2, "SpecialEffectsController: Container " + ((Object) getContainer()) + " has not been laid out. Completing operation " + ((Object) operation13));
                    } else {
                        str2 = str6;
                    }
                    transitionInfo3.completeSpecialEffect();
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            ...
            while (it6.hasNext()) {
                View next3 = it6.next();
                Log.v(str7, "View: " + ((Object) next3) + " Name: " + ViewCompat.getTransitionName(next3));
            }
            Log.v(str7, ">>>>> SharedElementLastInViews <<<<<");
            Iterator<View> it7 = arrayList17.iterator();
            while (it7.hasNext()) {
                View next4 = it7.next();
                Log.v(str7, "View: " + ((Object) next4) + " Name: " + ViewCompat.getTransitionName(next4));
            }
        }
    ...
    @Override
    public void executeOperations(List<SpecialEffectsController.Operation> list, boolean z10) {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Executing operations from " + ((Object) operation) + " to " + ((Object) operation2));
        }
        ArrayList arrayList = new ArrayList();
        ...
        arrayList3.clear();
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Completed executing operations from " + ((Object) operation) + " to " + ((Object) operation2));
        }
    }
