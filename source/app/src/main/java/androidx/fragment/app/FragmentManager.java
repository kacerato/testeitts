...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    private final Consumer<Configuration> mOnConfigurationChangedListener = new Consumer() {
        @Override
        public final void accept(Object obj) {
            FragmentManager.this.lambda$new$0((Configuration) obj);
        }
    };
    private final Consumer<Integer> mOnTrimMemoryListener = new Consumer() {
        @Override
        public final void accept(Object obj) {
            FragmentManager.this.lambda$new$1((Integer) obj);
        }
    };
    private final Consumer<MultiWindowModeChangedInfo> mOnMultiWindowModeChangedListener = new Consumer() {
        @Override
        public final void accept(Object obj) {
            FragmentManager.this.lambda$new$2((MultiWindowModeChangedInfo) obj);
        }
    };
    private final Consumer<PictureInPictureModeChangedInfo> mOnPictureInPictureModeChangedListener = new Consumer() {
        @Override
        public final void accept(Object obj) {
    ...
    public static class FragmentIntentSenderContract extends ActivityResultContract<IntentSenderRequest, ActivityResult> {
        ...
        public Intent createIntent(Context context, IntentSenderRequest intentSenderRequest) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v(FragmentManager.TAG, "CreateIntent created the following intent: " + ((Object) intent));
            }
            return intent;
        }
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> arrayList, int i10, int i11) {
        ViewGroup viewGroup;
        HashSet hashSet = new HashSet();
        while (i10 < i11) {
    ...
    public void lambda$new$2(MultiWindowModeChangedInfo multiWindowModeChangedInfo) {
        if (isParentAdded()) {
            dispatchMultiWindowModeChanged(multiWindowModeChangedInfo.isInMultiWindowMode(), false);
        }
    }

    public void lambda$new$3(PictureInPictureModeChangedInfo pictureInPictureModeChangedInfo) {
        if (isParentAdded()) {
    ...
    private void throwException(RuntimeException runtimeException) {
        ...
        if (fragmentHostCallback != null) {
            try {
                fragmentHostCallback.onDump(GlideException.a.f59088e, null, printWriter, new String[0]);
        ...
        try {
            dump(GlideException.a.f59088e, null, printWriter, new String[0]);
            throw runtimeException;
        } catch (Exception e11) {
    ...
    public void attachController(FragmentHostCallback<?> fragmentHostCallback, FragmentContainer fragmentContainer, final Fragment fragment) {
        ...
        if ((obj instanceof SavedStateRegistryOwner) && fragment == null) {
            ...
            savedStateRegistry.registerSavedStateProvider(SAVED_STATE_TAG, new SavedStateRegistry.SavedStateProvider() {
                @Override
        ...
        if (obj2 instanceof ActivityResultRegistryOwner) {
            ...
            this.mStartActivityForResult = activityResultRegistry.register(str2 + "StartActivityForResult", new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult activityResult) {
                    ...
                    if (pollFirst == null) {
                        Log.w(FragmentManager.TAG, "No Activities were started for result for " + ((Object) this));
                        return;
                    }
            ...
            this.mStartIntentSenderForResult = activityResultRegistry.register(str2 + "StartIntentSenderForResult", new FragmentIntentSenderContract(), new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult activityResult) {
                    LaunchedFragmentInfo pollFirst = FragmentManager.this.mLaunchedFragments.pollFirst();
                    if (pollFirst == null) {
                        Log.w(FragmentManager.TAG, "No IntentSenders were started for " + ((Object) this));
                        return;
                    }
                    String str3 = pollFirst.mWho;
                    int i10 = pollFirst.mRequestCode;
            ...
            this.mRequestPermissions = activityResultRegistry.register(str2 + "RequestPermissions", new ActivityResultContracts.RequestMultiplePermissions(), new ActivityResultCallback<Map<String, Boolean>>() {
                ...
                public void onActivityResult(Map<String, Boolean> map) {
                    ...
                    LaunchedFragmentInfo pollFirst = FragmentManager.this.mLaunchedFragments.pollFirst();
                    if (pollFirst == null) {
                        Log.w(FragmentManager.TAG, "No permissions were requested for " + ((Object) this));
                        return;
                    }
                    String str3 = pollFirst.mWho;
    ...
    public void launchStartIntentSenderForResult(Fragment fragment, IntentSender intentSender, int i10, Intent intent, int i11, int i12, int i13, Bundle bundle) throws IntentSender.SendIntentException {
        ...
        if (bundle != null) {
            ...
            if (isLoggingEnabled(2)) {
                Log.v(TAG, "ActivityOptions " + ((Object) bundle) + " were added to fillInIntent " + ((Object) intent2) + " for fragment " + ((Object) fragment));
            }
        ...
        this.mLaunchedFragments.addLast(new LaunchedFragmentInfo(fragment.mWho, i10));
        if (isLoggingEnabled(2)) {
            Log.v(TAG, "Fragment " + ((Object) fragment) + "is launching an IntentSender for result ");
        }
    ...
    public boolean popBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str, int i10, int i11) {
    ...
    public void restoreSaveStateInternal(Parcelable parcelable) {
        ...
        while (it.hasNext()) {
            ...
            if (savedState != null) {
                ...
                if (findRetainedFragmentByWho != null) {
                    if (isLoggingEnabled(2)) {
                        Log.v(TAG, "restoreSaveState: re-attaching retained " + ((Object) findRetainedFragmentByWho));
                    }
                ...
                fragment.mFragmentManager = this;
                if (isLoggingEnabled(2)) {
                    Log.v(TAG, "restoreSaveState: active (" + fragment.mWho + "): " + ((Object) fragment));
                }
        ...
        for (Fragment fragment2 : this.mNonConfig.getRetainedFragments()) {
            if (!this.mFragmentStore.containsActiveFragment(fragment2.mWho)) {
                if (isLoggingEnabled(2)) {
                    Log.v(TAG, "Discarding retained Fragment " + ((Object) fragment2) + " that was not found in the set of active Fragments " + ((Object) fragmentManagerState.mActive));
                }
        ...
        if (fragmentManagerState.mBackStack != null) {
            ...
            while (true) {
                ...
                if (isLoggingEnabled(2)) {
                    Log.v(TAG, "restoreAllState: back stack #" + i10 + " (index " + instantiate.mIndex + "): " + ((Object) instantiate));
                    PrintWriter printWriter = new PrintWriter(new LogWriter(TAG));
                    instantiate.dump(GlideException.a.f59088e, printWriter, false);
                    printWriter.close();
                }
        ...
        if (!allSavedState.isEmpty()) {
            ...
            if (arrayList == null || (size = arrayList.size()) <= 0) {
                ...
                for (int i10 = 0; i10 < size; i10++) {
                    ...
                    if (isLoggingEnabled(2)) {
                        Log.v(TAG, "saveAllState: adding back stack #" + i10 + ": " + ((Object) this.mBackStack.get(i10)));
                    }
                }
            }
            ...
            fragmentManagerState.mBackStackStateKeys.addAll(this.mBackStackStates.o());
            fragmentManagerState.mBackStackStates.addAll(this.mBackStackStates.values());
            fragmentManagerState.mLaunchedFragments = new ArrayList<>(this.mLaunchedFragments);
            bundle.putParcelable("state", fragmentManagerState);
            for (String str : this.mResults.o()) {
    ...
    public boolean saveBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str) {
        ...
        for (int i11 = findBackStackIndex; i11 < this.mBackStack.size(); i11++) {
            ...
            if (!backStackRecord.mReorderingAllowed) {
                throwException(new IllegalArgumentException("saveBackStack(\"" + str + "\") included FragmentTransactions must use setReorderingAllowed(true) to ensure that the back stack can be restored as an atomic operation. Found " + ((Object) backStackRecord) + " that did not use setReorderingAllowed(true)."));
            }
        }
        HashSet hashSet = new HashSet();
        for (int i12 = findBackStackIndex; i12 < this.mBackStack.size(); i12++) {
            ...
            if (!hashSet2.isEmpty()) {
                ...
                sb2.append(hashSet2.size() == 1 ? " " + hashSet2.iterator().next() : "s " + ((Object) hashSet2));
                sb2.append(" in ");
                sb2.append((Object) backStackRecord2);
    ...
    public final void setFragmentResult(String str, Bundle bundle) {
        ...
        if (isLoggingEnabled(2)) {
            Log.v(TAG, "Setting fragment result with key " + str + " and result " + ((Object) bundle));
        }
    }
    ...
    public final void setFragmentResultListener(final String str, LifecycleOwner lifecycleOwner, final FragmentResultListener fragmentResultListener) {
        ...
        if (isLoggingEnabled(2)) {
            Log.v(TAG, "Setting FragmentResultListener with key " + str + " lifecycleOwner " + ((Object) lifecycle) + " and listener " + ((Object) fragmentResultListener));
        }
