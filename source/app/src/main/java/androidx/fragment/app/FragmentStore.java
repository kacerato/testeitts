...
public class FragmentStore {
    ...
    public void makeActive(FragmentStateManager fragmentStateManager) {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v("FragmentManager", "Added fragment to active set " + ((Object) fragment));
        }
    }
    ...
    public void makeInactive(FragmentStateManager fragmentStateManager) {
        ...
        if (this.mActive.put(fragment.mWho, null) != null && FragmentManager.isLoggingEnabled(2)) {
            Log.v("FragmentManager", "Removed fragment from active set " + ((Object) fragment));
        }
    }
    ...
    public void restoreAddedFragments(List<String> list) {
        ...
        if (list != null) {
            for (String str : list) {
                ...
                if (FragmentManager.isLoggingEnabled(2)) {
                    Log.v("FragmentManager", "restoreSaveState: added (" + str + "): " + ((Object) findActiveFragment));
                }
    ...
    public ArrayList<String> saveActiveFragments() {
        ...
        for (FragmentStateManager fragmentStateManager : this.mActive.values()) {
            if (fragmentStateManager != null) {
                ...
                if (FragmentManager.isLoggingEnabled(2)) {
                    Log.v("FragmentManager", "Saved state of " + ((Object) fragment) + ": " + ((Object) fragment.mSavedFragmentState));
                }
            }
        }
        return arrayList;
        ...
        synchronized (this.mAdded) {
            try {
                ...
                while (it.hasNext()) {
                    ...
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v("FragmentManager", "saveAllState: adding fragment (" + next.mWho + "): " + ((Object) next));
                    }
                }
                return arrayList;
            } catch (Throwable th2) {
