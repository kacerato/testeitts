...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
                ...
                if (requireView.getParent() == null) {
                    if (DialogFragment.this.mDialog != null) {
                        if (FragmentManager.isLoggingEnabled(3)) {
                            Log.d(FragmentManager.TAG, "DialogFragment " + ((Object) this) + " setting the content view on " + ((Object) DialogFragment.this.mDialog));
                        }
    ...
    public FragmentContainer createFragmentContainer() {
        ...
        return new FragmentContainer() {
            ...
            public View onFindViewById(int i10) {
                return createFragmentContainer.onHasView() ? createFragmentContainer.onFindViewById(i10) : DialogFragment.this.onFindViewById(i10);
            }
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d(FragmentManager.TAG, "onCreateDialog called for DialogFragment " + ((Object) this));
        }
    ...
    public void onDismiss(DialogInterface dialogInterface) {
        ...
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d(FragmentManager.TAG, "onDismiss called for DialogFragment " + ((Object) this));
        }
    ...
    public LayoutInflater onGetLayoutInflater(Bundle bundle) {
        ...
        if (this.mShowsDialog && !this.mCreatingDialog) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.d(FragmentManager.TAG, "get layout inflater for DialogFragment " + ((Object) this) + " from dialog context");
            }
            Dialog dialog = this.mDialog;
    ...
    public void setStyle(int i10, int i11) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.d(FragmentManager.TAG, "Setting style and theme for DialogFragment " + ((Object) this) + " to " + i10 + ", " + i11);
        }
        this.mStyle = i10;
        if (i10 == 2 || i10 == 3) {
