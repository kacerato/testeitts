...
public class FragmentStateManager {
    ...
    public void activityCreated() {
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d("FragmentManager", "moveto ACTIVITY_CREATED: " + ((Object) this.mFragment));
        }
    ...
    public void attach() {
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d("FragmentManager", "moveto ATTACHED: " + ((Object) this.mFragment));
        }
        Fragment fragment = this.mFragment;
    ...
    public int computeExpectedState() {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v("FragmentManager", "computeExpectedState() of " + i10 + " for " + ((Object) this.mFragment));
        }
        return i10;
    }
    ...
    public void create() {
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d("FragmentManager", "moveto CREATED: " + ((Object) this.mFragment));
        }
        Fragment fragment = this.mFragment;
    ...
    public void createView() {
        ...
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d("FragmentManager", "moveto CREATE_VIEW: " + ((Object) this.mFragment));
        }
        Fragment fragment = this.mFragment;
        ...
        if (view != null) {
            ...
            if (fragment8.mContainer != null && visibility == 0) {
                ...
                if (findFocus != null) {
                    ...
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v("FragmentManager", "requestFocus: Saved focused view " + ((Object) findFocus) + " for Fragment " + ((Object) this.mFragment));
                    }
                }
    ...
    public void destroy() {
        ...
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d("FragmentManager", "movefrom CREATED: " + ((Object) this.mFragment));
        }
        Fragment fragment = this.mFragment;
        boolean z10 = true;
    ...
    public void destroyFragmentView() {
        View view;
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d("FragmentManager", "movefrom CREATE_VIEW: " + ((Object) this.mFragment));
        }
        Fragment fragment = this.mFragment;
    ...
    public void detach() {
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d("FragmentManager", "movefrom ATTACHED: " + ((Object) this.mFragment));
        }
        ...
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d("FragmentManager", "initState called for fragment: " + ((Object) this.mFragment));
        }
    ...
    public void moveToExpectedState() {
        ...
        if (this.mMovingToState) {
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v("FragmentManager", "Ignoring re-entrant call to moveToExpectedState() for " + ((Object) getFragment()));
                return;
            }
            return;
        }
            ...
            while (true) {
                ...
                if (computeExpectedState == i10) {
                    if (!z10 && i10 == -1 && fragment.mRemoving && !fragment.isInBackStack() && !this.mFragment.mBeingSaved) {
                        if (FragmentManager.isLoggingEnabled(3)) {
                            Log.d("FragmentManager", "Cleaning up state of never attached fragment: " + ((Object) this.mFragment));
                        }
                        this.mFragmentStore.getNonConfig().clearNonConfigState(this.mFragment);
                        this.mFragmentStore.makeInactive(this);
                        if (FragmentManager.isLoggingEnabled(3)) {
                ...
                if (computeExpectedState <= i10) {
                    switch (i10 - 1) {
                        ...
                        case 3:
                            if (FragmentManager.isLoggingEnabled(3)) {
                                Log.d("FragmentManager", "movefrom ACTIVITY_CREATED: " + ((Object) this.mFragment));
                            }
                            Fragment fragment5 = this.mFragment;
    ...
    public void pause() {
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d("FragmentManager", "movefrom RESUMED: " + ((Object) this.mFragment));
        }
    ...
    public void resume() {
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d("FragmentManager", "moveto RESUMED: " + ((Object) this.mFragment));
        }
        ...
        if (focusedView != null && isFragmentViewChild(focusedView)) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                ...
                sb2.append((Object) focusedView);
                sb2.append(" ");
                sb2.append(requestFocus ? "succeeded" : "failed");
                sb2.append(" on Fragment ");
                sb2.append((Object) this.mFragment);
                sb2.append(" resulting in focused view ");
                sb2.append((Object) this.mFragment.mView.findFocus());
    ...
    public void saveViewState() {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v("FragmentManager", "Saving view state for fragment " + ((Object) this.mFragment) + " with view " + ((Object) this.mFragment.mView));
        }
    ...
    public void start() {
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d("FragmentManager", "moveto STARTED: " + ((Object) this.mFragment));
        }
    ...
    public void stop() {
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d("FragmentManager", "movefrom STARTED: " + ((Object) this.mFragment));
        }
    ...
    public FragmentStateManager(FragmentLifecycleCallbacksDispatcher fragmentLifecycleCallbacksDispatcher, FragmentStore fragmentStore, ClassLoader classLoader, FragmentFactory fragmentFactory, FragmentState fragmentState) {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v("FragmentManager", "Instantiated fragment " + ((Object) instantiate));
        }
    }
