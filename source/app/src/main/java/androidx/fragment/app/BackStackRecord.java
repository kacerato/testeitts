...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    public void bumpBackStackNesting(int i10) {
        if (this.mAddToBackStack) {
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v("FragmentManager", "Bump nesting in " + ((Object) this) + " by " + i10);
            }
            ...
            for (int i11 = 0; i11 < size; i11++) {
                ...
                if (fragment != null) {
                    ...
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v("FragmentManager", "Bump nesting of " + ((Object) op.mFragment) + " to " + op.mFragment.mBackStackNesting);
                    }
                }
            }
        }
    ...
    public int commitInternal(boolean z10) {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v("FragmentManager", "Commit: " + ((Object) this));
            PrintWriter printWriter = new PrintWriter(new LogWriter("FragmentManager"));
            dump(GlideException.a.f59088e, printWriter);
            printWriter.close();
        }
    ...
    public boolean generateOps(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v("FragmentManager", "Run: " + ((Object) this));
        }
        arrayList.add(this);
