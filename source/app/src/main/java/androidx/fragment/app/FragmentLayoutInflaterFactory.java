    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (findFragmentById == null) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v("FragmentManager", "Fragment " + ((Object) findFragmentById) + " has been inflated via the <fragment> tag: id=0x" + Integer.toHexString(resourceId));
            }
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v("FragmentManager", "Retained Fragment " + ((Object) findFragmentById) + " has been re-attached via the <fragment> tag: id=0x" + Integer.toHexString(resourceId));
            }
        } else {
        ...
        findFragmentById.mView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
            @Override
