...
public class FragmentLifecycleCallbacksDispatcher {
    ...
    public static final class FragmentLifecycleCallbacksHolder {
        ...
        public FragmentLifecycleCallbacksHolder(FragmentManager.FragmentLifecycleCallbacks fragmentLifecycleCallbacks, boolean z10) {
    ...
    public void dispatchOnFragmentActivityCreated(Fragment fragment, Bundle bundle, boolean z10) {
    ...
    public void dispatchOnFragmentAttached(Fragment fragment, boolean z10) {
    ...
    public void dispatchOnFragmentCreated(Fragment fragment, Bundle bundle, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentDestroyed(Fragment fragment, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentDetached(Fragment fragment, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentPaused(Fragment fragment, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentPreAttached(Fragment fragment, boolean z10) {
        Context context = this.mFragmentManager.getHost().getContext();
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentPreCreated(Fragment fragment, Bundle bundle, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentResumed(Fragment fragment, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentSaveInstanceState(Fragment fragment, Bundle bundle, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentStarted(Fragment fragment, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentStopped(Fragment fragment, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentViewCreated(Fragment fragment, View view, Bundle bundle, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentViewDestroyed(Fragment fragment, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
