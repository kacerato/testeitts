...
public final class BackStackRecordState implements Parcelable {
    ...
    private void fillInBackStackRecord(BackStackRecord backStackRecord) {
        ...
        while (true) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v("FragmentManager", "Instantiate " + ((Object) backStackRecord) + " op #" + i11 + " base fragment #" + this.mOps[i12]);
            }
    ...
    public BackStackRecordState(Parcel parcel) {
        ...
        this.mBreadCrumbTitleText = creator.createFromParcel(parcel);
        this.mBreadCrumbShortTitleRes = parcel.readInt();
        this.mBreadCrumbShortTitleText = creator.createFromParcel(parcel);
