...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        printWriter.print(str);
        printWriter.println("Child " + ((Object) this.mChildFragmentManager) + s.f32937c);
        this.mChildFragmentManager.dump(str + GlideException.a.f59088e, fileDescriptor, printWriter, strArr);
    }
    ...
    public CreationExtras getDefaultViewModelCreationExtras() {
        ...
        if (application == null && FragmentManager.isLoggingEnabled(3)) {
            Log.d(FragmentManager.TAG, "Could not find Application instance from Context " + ((Object) requireContext().getApplicationContext()) + ", you will not be able to use AndroidViewModel with the default ViewModelProvider.Factory");
        }
    ...
    public ViewModelProvider.Factory getDefaultViewModelProviderFactory() {
        ...
        if (this.mDefaultFactory == null) {
            ...
            if (application == null && FragmentManager.isLoggingEnabled(3)) {
                Log.d(FragmentManager.TAG, "Could not find Application instance from Context " + ((Object) requireContext().getApplicationContext()) + ", you will need CreationExtras to use AndroidViewModel with the default ViewModelProvider.Factory");
            }
    ...
    public void onActivityResult(int i10, int i11, Intent intent) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Fragment " + ((Object) this) + " received the following in onActivityResult(): requestCode: " + i10 + " resultCode: " + i11 + " data: " + ((Object) intent));
        }
    }
    ...
    public void startIntentSenderForResult(IntentSender intentSender, int i10, Intent intent, int i11, int i12, int i13, Bundle bundle) throws IntentSender.SendIntentException {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Fragment " + ((Object) this) + " received the following in startIntentSenderForResult() requestCode: " + i10 + " IntentSender: " + ((Object) intentSender) + " fillInIntent: " + ((Object) intent) + " options: " + ((Object) bundle));
        }
    ...
    private void restoreViewState() {
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d(FragmentManager.TAG, "moveto RESTORE_VIEW_STATE: " + ((Object) this));
        }
        if (this.mView != null) {
