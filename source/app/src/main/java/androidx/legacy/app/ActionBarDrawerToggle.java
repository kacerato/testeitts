...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, int i10, int i11, int i12) {
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, boolean z10, int i10, int i11, int i12) {
