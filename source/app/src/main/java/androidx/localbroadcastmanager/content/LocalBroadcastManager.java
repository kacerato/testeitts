    ...
    public boolean sendBroadcast(Intent intent) {
        ...
        synchronized (this.mReceivers) {
            try {
                ...
                if (z10) {
                    Log.v(TAG, "Resolving type " + resolveTypeIfNeeded + " scheme " + scheme + " of intent " + ((Object) intent));
                }
                ArrayList<ReceiverRecord> arrayList3 = this.mActions.get(intent.getAction());
                if (arrayList3 != null) {
                    if (z10) {
                        Log.v(TAG, "Action list: " + ((Object) arrayList3));
                    }
                    ...
                    while (i11 < arrayList3.size()) {
                        ...
                        if (z10) {
                            Log.v(TAG, "Matching against filter " + ((Object) receiverRecord.filter));
                        }
