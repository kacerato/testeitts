...
public abstract class AbstractC15322h {

    public static final long f109669a = 4294967295L;
    ...
    public static int A(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i10 < 7) {
            ...
            int i11 = i10 + 1;
            long j22 = j11;
            long j23 = (j21 >>> 32) + (j19 * j11) + (iArr3[i11] & 4294967295L);
            iArr3[i11] = (int) j23;
            long j24 = (j23 >>> 32) + (j19 * j12) + (iArr3[r6] & 4294967295L);
            iArr3[i10 + 2] = (int) j24;
            long j25 = (j24 >>> 32) + (j19 * j13) + (iArr3[r6] & 4294967295L);
            iArr3[i10 + 3] = (int) j25;
            long j26 = (j25 >>> 32) + (j19 * j14) + (iArr3[r6] & 4294967295L);
            iArr3[i10 + 4] = (int) j26;
            long j27 = (j26 >>> 32) + (j19 * j20) + (iArr3[r6] & 4294967295L);
            iArr3[i10 + 5] = (int) j27;
            long j28 = (j27 >>> 32) + (j19 * j18) + (iArr3[r6] & 4294967295L);
            iArr3[i10 + 6] = (int) j28;
    ...
    public static int C(int i10, int[] iArr, int[] iArr2) {
        long j10 = i10 & 4294967295L;
    ...
    public static int D(int i10, int[] iArr, int[] iArr2, int i11) {
        long j10 = i10 & 4294967295L;
        long j11 = 0;
        int i12 = 0;
        do {
    ...
    public static int E(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        long j10 = i10 & 4294967295L;
    ...
    public static int F(int i10, long j10, int[] iArr, int i11) {
        ...
        return AbstractC15329o.e0(7, iArr, i11, 3);
    }
    ...
    public static void G(int[] iArr, int i10, int[] iArr2, int i11) {
        ...
        while (true) {
            ...
            if (i15 <= 0) {
                ...
                long j57 = (j47 & 4294967295L) + (j56 >>> 32) + (j15 * j52);
                long j58 = (j48 & 4294967295L) + (j57 >>> 32) + (j52 * j18);
                long j59 = j51 + (j58 >>> 32) + (j52 * j23);
                long j60 = j54 + (j59 >>> 32) + (j52 * j32);
                long j61 = (j53 & 4294967295L) + (j60 >>> 32) + (j52 * j41);
                long j62 = j55 + (j61 >>> 32);
                int i26 = (int) j57;
                iArr2[i11 + 7] = (i25 >>> 31) | (i26 << 1);
                int i27 = (int) j58;
    ...
    public static void H(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i13 <= 0) {
                ...
                long j55 = 4294967295L & j52;
                long j56 = (j45 & 4294967295L) + (j10 * j51);
                int i21 = (int) j56;
                iArr2[6] = (i20 >>> 31) | (i21 << 1);
                int i22 = i21 >>> 31;
                long j57 = (j46 & 4294967295L) + (j56 >>> 32) + (j51 * j15);
                long j58 = (j47 & 4294967295L) + (j57 >>> 32) + (j51 * j18);
                long j59 = j50 + (j58 >>> 32) + (j51 * j22);
                long j60 = j53 + (j59 >>> 32) + (j51 * j30);
                long j61 = j55 + (j60 >>> 32) + (j51 * j40);
                long j62 = j54 + (j61 >>> 32);
                int i23 = (int) j57;
                iArr2[7] = i22 | (i23 << 1);
                int i24 = (int) j58;
                ...
                int i32 = (int) j62;
                iArr2[12] = i31 | (i32 << 1);
                iArr2[13] = (i32 >>> 31) | ((iArr2[13] + ((int) (j62 >>> 32))) << 1);
                return;
            }
            i12 = i13;
        }
    ...
    public static int L(int[] iArr, int i10, int[] iArr2, int i11) {
    ...
    public static BigInteger N(int[] iArr) {
        byte[] bArr = new byte[28];
        for (int i10 = 0; i10 < 7; i10++) {
            int i11 = iArr[i10];
            if (i11 != 0) {
                p.h(i11, bArr, (6 - i10) << 2);
            }
        }
    ...
    public static boolean m(int[] iArr, int i10, int[] iArr2, int i11, int[] iArr3, int i12) {
        ...
        if (q10) {
            I(iArr, i10, iArr2, i11, iArr3, i12);
        } else {
            I(iArr2, i11, iArr, i10, iArr3, i12);
        }
        return q10;
    }
    ...
    public static void u(int[] iArr, int i10, int[] iArr2, int i11, int[] iArr3, int i12) {
        ...
        iArr3[i12 + 5] = (int) j22;
        long j23 = iArr2[i11 + 6] & 4294967295L;
        ...
        while (i13 < 7) {
            ...
            long j26 = j23;
            int i16 = i13;
            long j27 = (j25 * j10) + (iArr3[i15] & 4294967295L);
            iArr3[i15] = (int) j27;
            long j28 = (j27 >>> 32) + (j25 * j11) + (iArr3[r26] & 4294967295L);
            iArr3[i14 + 2] = (int) j28;
            long j29 = j12;
            long j30 = (j28 >>> 32) + (j25 * j12) + (iArr3[r22] & 4294967295L);
            iArr3[i14 + 3] = (int) j30;
            int i17 = i14;
            long j31 = (j30 >>> 32) + (j25 * j13) + (iArr3[r6] & 4294967295L);
            iArr3[i14 + 4] = (int) j31;
            long j32 = (j31 >>> 32) + (j25 * j14) + (iArr3[r5] & 4294967295L);
            iArr3[i17 + 5] = (int) j32;
            long j33 = (j32 >>> 32) + (j25 * j15) + (iArr3[r5] & 4294967295L);
            iArr3[i17 + 6] = (int) j33;
            long j34 = (j33 >>> 32) + (j25 * j26) + (iArr3[r3] & 4294967295L);
            iArr3[i17 + 7] = (int) j34;
    ...
    public static void v(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i11 = 7; i10 < i11; i11 = 7) {
            ...
            iArr3[i10] = (int) j26;
            int i12 = i10 + 1;
            long j27 = (j26 >>> 32) + (j25 * j11) + (iArr3[i12] & 4294967295L);
            iArr3[i12] = (int) j27;
            long j28 = j11;
            long j29 = (j27 >>> 32) + (j25 * j12) + (iArr3[r18] & 4294967295L);
            iArr3[i10 + 2] = (int) j29;
            long j30 = (j29 >>> 32) + (j25 * j13) + (iArr3[r6] & 4294967295L);
            iArr3[i10 + 3] = (int) j30;
            long j31 = (j30 >>> 32) + (j25 * j14) + (iArr3[r6] & 4294967295L);
            iArr3[i10 + 4] = (int) j31;
            long j32 = (j31 >>> 32) + (j25 * j15) + (iArr3[r6] & 4294967295L);
            iArr3[i10 + 5] = (int) j32;
            long j33 = (j32 >>> 32) + (j25 * j16) + (iArr3[r3] & 4294967295L);
            iArr3[i10 + 6] = (int) j33;
    ...
    public static int x(int i10, long j10, int[] iArr, int i11) {
        ...
        return AbstractC15329o.e0(7, iArr, i11, 4);
    }
    ...
    public static int y(int i10, int i11, int[] iArr, int i12) {
        ...
        return AbstractC15329o.e0(7, iArr, i12, 3);
    }

    public static int z(int[] iArr, int i10, int[] iArr2, int i11, int[] iArr3, int i12) {
        long j10 = iArr2[i11] & 4294967295L;
        long j11 = iArr2[i11 + 1] & 4294967295L;
        long j12 = iArr2[i11 + 2] & 4294967295L;
        long j13 = iArr2[i11 + 3] & 4294967295L;
        ...
        while (i13 < 7) {
            ...
            iArr3[i14] = (int) j20;
            int i16 = i14 + 1;
            long j22 = (j20 >>> 32) + (j18 * j11) + (iArr3[i16] & 4294967295L);
            iArr3[i16] = (int) j22;
            long j23 = (j22 >>> 32) + (j18 * j12) + (iArr3[r5] & 4294967295L);
            iArr3[i14 + 2] = (int) j23;
            long j24 = (j23 >>> 32) + (j18 * j13) + (iArr3[r5] & 4294967295L);
            iArr3[i14 + 3] = (int) j24;
            long j25 = (j24 >>> 32) + (j18 * j14) + (iArr3[r5] & 4294967295L);
            iArr3[i14 + 4] = (int) j25;
            long j26 = (j25 >>> 32) + (j18 * j15) + (iArr3[r5] & 4294967295L);
            iArr3[i14 + 5] = (int) j26;
            long j27 = (j26 >>> 32) + (j18 * j21) + (iArr3[r5] & 4294967295L);
            iArr3[i14 + 6] = (int) j27;
