...
public class Q0 extends ShaderGraphNode implements com.itsmagic.engine.Engines.Graphics.ShaderGraph.B {

    public static final String f91807e = "Pincushion Distortion";

    public final ShaderGraphSlot[] f91808c;

    public final ShaderGraphSlot[] f91809d;
    ...
    public class a implements com.itsmagic.engine.Engines.Graphics.ShaderGraph.q {
        ...
        public ShaderGraphNode d(JsonObject json) {
            return (ShaderGraphNode) X7.a.m().fromJson((JsonElement) json, Q0.class);
        }
        ...
        @Override
        public String f() {
            return "Lens Distortion (Pincushion)";
        }
    ...
    public Q0() {
        ...
        this.f91808c = new ShaderGraphSlot[]{shaderGraphSlot, shaderGraphSlot2, new ShaderGraphSlot("Strength", c11), new ShaderGraphSlot("Aspect", c11), new ShaderGraphSlot("K Values", c10)};
        this.f91809d = new ShaderGraphSlot[]{new ShaderGraphSlot("UV", c10)};
        this.serializedNodeType = f91807e;
    }
