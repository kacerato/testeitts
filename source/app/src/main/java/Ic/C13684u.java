...
public class C13684u extends ShaderGraphNode implements com.itsmagic.engine.Engines.Graphics.ShaderGraph.B {

    public static final String f92009e = "DecalPixelSample";

    public final ShaderGraphSlot[] f92010c;

    public final ShaderGraphSlot[] f92011d;
    ...
    public class a implements com.itsmagic.engine.Engines.Graphics.ShaderGraph.q {
        ...
        public Class<? extends ShaderGraphNode> b() {
            return C13684u.class;
        }

        @Override
        public String c() {
            return C13684u.f92009e;
        }

        @Override
        public ShaderGraphNode d(JsonObject json) {
            return (ShaderGraphNode) X7.a.m().fromJson((JsonElement) json, C13684u.class);
        }
    ...
    public C13684u() {
        ...
        this.f92010c = new ShaderGraphSlot[]{new ShaderGraphSlot("Layer", c10, wVar), new ShaderGraphSlot("UV", com.itsmagic.engine.Engines.Graphics.ShaderGraph.C.FLOAT2, wVar)};
        this.f92011d = new ShaderGraphSlot[]{new ShaderGraphSlot(SerializableShaderEntry.f81153g, com.itsmagic.engine.Engines.Graphics.ShaderGraph.C.FLOAT4), new ShaderGraphSlot("R", c10), new ShaderGraphSlot("G", c10), new ShaderGraphSlot(Signature.SIG_BYTE, c10), new ShaderGraphSlot(ExifInterface.GPS_MEASUREMENT_IN_PROGRESS, c10)};
        this.serializedNodeType = f92009e;
    }
    ...
    public void h(com.itsmagic.engine.Engines.Graphics.ShaderGraph.g context, com.itsmagic.engine.Engines.Graphics.ShaderGraph.w stage) {
        ...
        context.h(stage, c11 + " = decalPixel(int(" + g10 + "), " + g11 + ");");
