...
public class C13649h0 extends ShaderGraphNode implements com.itsmagic.engine.Engines.Graphics.ShaderGraph.B {

    public static final String f91913e = "Lens Distortion";

    public final ShaderGraphSlot[] f91914c;

    public final ShaderGraphSlot[] f91915d;
    ...
    public class a implements com.itsmagic.engine.Engines.Graphics.ShaderGraph.q {
        ...
        public ShaderGraphNode d(JsonObject json) {
            return (ShaderGraphNode) X7.a.m().fromJson((JsonElement) json, C13649h0.class);
        }
    ...
    public C13649h0() {
        ...
        this.f91914c = new ShaderGraphSlot[]{shaderGraphSlot, shaderGraphSlot2, new ShaderGraphSlot("Strength", c11), new ShaderGraphSlot("Aspect", c11), new ShaderGraphSlot("K Values", c10)};
        this.f91915d = new ShaderGraphSlot[]{new ShaderGraphSlot("UV", c10)};
        this.serializedNodeType = f91913e;
    }
    ...
    public void h(com.itsmagic.engine.Engines.Graphics.ShaderGraph.g context, com.itsmagic.engine.Engines.Graphics.ShaderGraph.w stage) {
        ...
        context.h(stage, context.c(this, 0, stage, c10) + " = sg_lens_distortion_uv(" + g10 + ", " + g11 + ", " + g12 + ", " + g13 + ", " + g14 + ");");
    }
