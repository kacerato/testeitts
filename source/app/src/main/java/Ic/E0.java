...
public class E0 extends ShaderGraphNode implements com.itsmagic.engine.Engines.Graphics.ShaderGraph.B {

    public static final String f91707e = "NormalMapGenerator";

    public final ShaderGraphSlot[] f91708c = {new ShaderGraphSlot(SerializableShaderEntry.f81152f, com.itsmagic.engine.Engines.Graphics.ShaderGraph.C.TEXTURE), new ShaderGraphSlot("UV", com.itsmagic.engine.Engines.Graphics.ShaderGraph.C.FLOAT2), new ShaderGraphSlot("Bias", com.itsmagic.engine.Engines.Graphics.ShaderGraph.C.NUMBER)};

    public final ShaderGraphSlot[] f91709d = {new ShaderGraphSlot("Normal", com.itsmagic.engine.Engines.Graphics.ShaderGraph.C.FLOAT3)};
    ...
    public E0() {
        this.serializedNodeType = f91707e;
    }
