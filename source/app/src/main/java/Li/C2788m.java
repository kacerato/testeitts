...
public class C2788m implements InterfaceC2374f {
    ...
    public int[] f14006d = new int[96];

    public int[] f14007e = new int[8];

    public int[] f14008f = new int[12];
    ...
    private int f() {
        return this.f14004b * 8;
    }

    public static void l(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        int i13 = i12 + 2;
        int i14 = i11 + 1;
        int i15 = 32 - i10;
    ...
    public static void m(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        int i13 = i12 + 2;
        int i14 = i11 + 1;
        int i15 = i10 - 32;
        int i16 = i11 + 2;
    ...
    public static void s(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        int i13 = i11 + 1;
        int i14 = 32 - i10;
    ...
    public static void t(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        int i13 = i11 + 1;
        int i14 = i10 - 32;
        int i15 = i11 + 2;
        int i16 = 64 - i10;
    ...
    public void a(boolean z10, InterfaceC2379k interfaceC2379k) throws IllegalArgumentException {
        ...
        u(z10, ((C3360o0) interfaceC2379k).b());
        this.f14003a = true;
        this.f14005c = z10;
        Bi.r.a(new Hi.c(b(), f(), interfaceC2379k, x0.a(z10)));
    }
    ...
    public int g(byte[] bArr, int i10, byte[] bArr2, int i11) throws DataLengthException, IllegalStateException {
        ...
        if (i11 + 16 <= bArr2.length) {
            return this.f14004b == 16 ? p(bArr, i10, bArr2, i11) : q(bArr, i10, bArr2, i11);
        }
    ...
    public final void j(int[] iArr, int[] iArr2, int i10) {
        ...
        iArr[2] = iArr[2] ^ i17;
        int r10 = (r(i15, 8) ^ i17) ^ iArr[3];
        iArr[3] = r10;
        int i18 = iArr[2] ^ iArr2[i10 + 2];
        int i19 = iArr6[(i18 >>> 24) & 255] ^ ((iArr3[i18 & 255] ^ iArr4[(i18 >>> 8) & 255]) ^ iArr5[(i18 >>> 16) & 255]);
        int i20 = iArr2[i10 + 3] ^ r10;
        int i21 = (iArr5[(i20 >>> 24) & 255] ^ ((iArr6[i20 & 255] ^ iArr3[(i20 >>> 8) & 255]) ^ iArr4[(i20 >>> 16) & 255])) ^ i19;
        iArr[0] = iArr[0] ^ i21;
        iArr[1] = (i21 ^ r(i19, 8)) ^ iArr[1];
    }

    public final void k(int[] iArr, int[] iArr2, int i10) {
        int o10 = iArr[1] ^ o(iArr[0] & iArr2[i10], 1);
        iArr[1] = o10;
        iArr[0] = (o10 | iArr2[i10 + 1]) ^ iArr[0];
        int i11 = iArr[2];
        int i12 = iArr2[i10 + 3];
        int i13 = iArr[3];
        int i14 = i11 ^ (i12 | i13);
        iArr[2] = i14;
        iArr[3] = o(iArr2[i10 + 2] & i14, 1) ^ i13;
    }
    ...
    public final int p(byte[] bArr, int i10, byte[] bArr2, int i11) {
        int[] iArr = new int[4];
        for (int i12 = 0; i12 < 4; i12++) {
            iArr[i12] = i(bArr, (i12 * 4) + i10) ^ this.f14007e[i12];
        }
        j(iArr, this.f14006d, 0);
        j(iArr, this.f14006d, 4);
        j(iArr, this.f14006d, 8);
        k(iArr, this.f14008f, 0);
        j(iArr, this.f14006d, 12);
        j(iArr, this.f14006d, 16);
        j(iArr, this.f14006d, 20);
        k(iArr, this.f14008f, 4);
        j(iArr, this.f14006d, 24);
        j(iArr, this.f14006d, 28);
        j(iArr, this.f14006d, 32);
        int i13 = iArr[2];
        int[] iArr2 = this.f14007e;
        int i14 = iArr2[4] ^ i13;
        iArr[2] = i14;
        ...
        n(i14, bArr2, i11);
        n(iArr[3], bArr2, i11 + 4);
        n(iArr[0], bArr2, i11 + 8);
        n(iArr[1], bArr2, i11 + 12);
        return 16;
    }

    public final int q(byte[] bArr, int i10, byte[] bArr2, int i11) {
        int[] iArr = new int[4];
        for (int i12 = 0; i12 < 4; i12++) {
            iArr[i12] = i(bArr, (i12 * 4) + i10) ^ this.f14007e[i12];
        }
        ...
        j(iArr, this.f14006d, 28);
        j(iArr, this.f14006d, 32);
        k(iArr, this.f14008f, 8);
        j(iArr, this.f14006d, 36);
        j(iArr, this.f14006d, 40);
        j(iArr, this.f14006d, 44);
        int i13 = iArr[2];
        int[] iArr2 = this.f14007e;
        int i14 = i13 ^ iArr2[4];
        iArr[2] = i14;
    ...
    public final void u(boolean z10, byte[] bArr) {
        ...
        j(iArr2, f13998i, 4);
        if (this.f14004b == 16) {
            int[] iArr5 = this.f14007e;
            if (z10) {
                iArr5[0] = iArr[0];
                iArr5[1] = iArr[1];
                iArr5[2] = iArr[2];
                iArr5[3] = iArr[3];
                s(15, iArr, 0, this.f14006d, 4);
                s(30, iArr, 0, this.f14006d, 12);
                s(15, iArr, 0, iArr4, 0);
                int[] iArr6 = this.f14006d;
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                s(17, iArr, 0, this.f14008f, 4);
                s(17, iArr, 0, this.f14006d, 24);
                s(17, iArr, 0, this.f14006d, 32);
                int[] iArr7 = this.f14006d;
                iArr7[0] = iArr2[0];
                iArr7[1] = iArr2[1];
                iArr7[2] = iArr2[2];
                iArr7[3] = iArr2[3];
                s(15, iArr2, 0, iArr7, 8);
                s(15, iArr2, 0, this.f14008f, 0);
                s(15, iArr2, 0, iArr4, 0);
                int[] iArr8 = this.f14006d;
                iArr8[16] = iArr4[0];
                iArr8[17] = iArr4[1];
                s(15, iArr2, 0, iArr8, 20);
                t(34, iArr2, 0, this.f14006d, 28);
                s(17, iArr2, 0, this.f14007e, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            iArr5[6] = iArr[2];
            iArr5[7] = iArr[3];
            l(15, iArr, 0, this.f14006d, 28);
            l(30, iArr, 0, this.f14006d, 20);
            l(15, iArr, 0, iArr4, 0);
            int[] iArr9 = this.f14006d;
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            l(17, iArr, 0, this.f14008f, 0);
            l(17, iArr, 0, this.f14006d, 8);
            l(17, iArr, 0, this.f14006d, 0);
            int[] iArr10 = this.f14006d;
            iArr10[34] = iArr2[0];
            iArr10[35] = iArr2[1];
            iArr10[32] = iArr2[2];
            iArr10[33] = iArr2[3];
            l(15, iArr2, 0, iArr10, 24);
            l(15, iArr2, 0, this.f14008f, 4);
            l(15, iArr2, 0, iArr4, 0);
            int[] iArr11 = this.f14006d;
            iArr11[18] = iArr4[2];
            iArr11[19] = iArr4[3];
            l(15, iArr2, 0, iArr11, 12);
            m(34, iArr2, 0, this.f14006d, 4);
            s(17, iArr2, 0, this.f14007e, 0);
            return;
        }
        ...
        j(iArr3, f13998i, 8);
        int[] iArr12 = this.f14007e;
        if (z10) {
            iArr12[0] = iArr[0];
            iArr12[1] = iArr[1];
            iArr12[2] = iArr[2];
            iArr12[3] = iArr[3];
            t(45, iArr, 0, this.f14006d, 16);
            s(15, iArr, 0, this.f14008f, 4);
            s(17, iArr, 0, this.f14006d, 32);
            t(34, iArr, 0, this.f14006d, 44);
            s(15, iArr, 4, this.f14006d, 4);
            s(15, iArr, 4, this.f14008f, 0);
            s(30, iArr, 4, this.f14006d, 24);
            t(34, iArr, 4, this.f14006d, 36);
            s(15, iArr2, 0, this.f14006d, 8);
            s(30, iArr2, 0, this.f14006d, 20);
            int[] iArr13 = this.f14008f;
            iArr13[8] = iArr2[1];
            iArr13[9] = iArr2[2];
            iArr13[10] = iArr2[3];
            iArr13[11] = iArr2[0];
            t(49, iArr2, 0, this.f14006d, 40);
            int[] iArr14 = this.f14006d;
            iArr14[0] = iArr3[0];
            iArr14[1] = iArr3[1];
            iArr14[2] = iArr3[2];
            iArr14[3] = iArr3[3];
            s(30, iArr3, 0, iArr14, 12);
            s(30, iArr3, 0, this.f14006d, 28);
            t(51, iArr3, 0, this.f14007e, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        iArr12[6] = iArr[2];
        iArr12[7] = iArr[3];
        m(45, iArr, 0, this.f14006d, 28);
        l(15, iArr, 0, this.f14008f, 4);
        l(17, iArr, 0, this.f14006d, 12);
        m(34, iArr, 0, this.f14006d, 0);
        l(15, iArr, 4, this.f14006d, 40);
        l(15, iArr, 4, this.f14008f, 8);
        l(30, iArr, 4, this.f14006d, 20);
        m(34, iArr, 4, this.f14006d, 8);
        l(15, iArr2, 0, this.f14006d, 36);
        l(30, iArr2, 0, this.f14006d, 24);
        int[] iArr15 = this.f14008f;
        iArr15[2] = iArr2[1];
        iArr15[3] = iArr2[2];
        iArr15[0] = iArr2[3];
        iArr15[1] = iArr2[0];
        m(49, iArr2, 0, this.f14006d, 4);
        int[] iArr16 = this.f14006d;
        iArr16[46] = iArr3[0];
        iArr16[47] = iArr3[1];
        iArr16[44] = iArr3[2];
        iArr16[45] = iArr3[3];
        l(30, iArr3, 0, iArr16, 32);
        l(30, iArr3, 0, this.f14006d, 16);
        t(51, iArr3, 0, this.f14007e, 0);
    }
}
