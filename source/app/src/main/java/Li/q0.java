...
public class q0 implements InterfaceC2374f {

    public static final int[] f14045c = {1116352408, 1899447441, -1245643825, -373957723, 961987163, 1508970993, -1841331548, -1424204075, -670586216, 310598401, 607225278, 1426881987, 1925078388, -2132889090, -1680079193, -1046744716, -459576895, -272742522, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, -1740746414, -1473132947, -1341970488, -1084653625, -958395405, -710438585, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, -2117940946, -1838011259, -1564481375, -1474664885, -1035236496, -949202525, -778901479, -694614492, -200395387, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, -2067236844, -1933114872, -1866530822, -1538233109, -1090935817, -965641998};

    public static final int f14046d = 32;

    public static final int f14047e = 64;

    public boolean f14048a = false;

    public int[] f14049b = null;

    private void j(byte[] bArr, int i10, byte[] bArr2, int i11) {
        int[] iArr = new int[8];
        f(bArr, iArr, i10, 0);
        for (int i12 = 63; i12 > -1; i12--) {
            ...
            int i20 = iArr[7];
            iArr[6] = i20;
            iArr[7] = (((i17 - f14045c[i12]) - this.f14049b[i12]) - ((((i18 >>> 6) | (i18 << (-6))) ^ ((i18 >>> 11) | (i18 << (-11)))) ^ ((i18 >>> 25) | (i18 << (-25))))) - ((i18 & i19) ^ ((~i18) & i20));
        }
        l(iArr, bArr2, i11);
    }
    ...
    private void k(byte[] bArr, int i10, byte[] bArr2, int i11) {
        ...
        for (int i12 = 0; i12 < 64; i12++) {
            ...
            int i15 = ~i13;
            int i16 = iArr[6];
            int i17 = ((((i13 >>> 6) | (i13 << (-6))) ^ ((i13 >>> 11) | (i13 << (-11)))) ^ ((i13 >>> 25) | (i13 << (-25)))) + ((i13 & i14) ^ (i15 & i16)) + iArr[7] + f14045c[i12] + this.f14049b[i12];
            iArr[7] = i16;
            iArr[6] = i14;
            iArr[5] = i13;
            iArr[4] = iArr[3] + i17;
    ...
    public void a(boolean z10, InterfaceC2379k interfaceC2379k) throws IllegalArgumentException {
        ...
        Bi.r.a(new Hi.c(b11, length, interfaceC2379k, x0.a(this.f14048a)));
    }
    ...
    public final void l(int[] iArr, byte[] bArr, int i10) {
        for (int i11 : iArr) {
    ...
    public void m(byte[] bArr) {
        if (bArr.length != 0 && bArr.length <= 64) {
            if (bArr.length >= 16 && bArr.length % 8 == 0) {
                i(bArr, this.f14049b, 0, 0);
                for (int i10 = 16; i10 < 64; i10++) {
                    int[] iArr = this.f14049b;
                    int i11 = iArr[i10 - 2];
