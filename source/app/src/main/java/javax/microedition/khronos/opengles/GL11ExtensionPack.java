...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/d8lib/android.jar:javax/microedition/khronos/opengles/GL11ExtensionPack.class
 */
public interface GL11ExtensionPack extends GL {
    ...
    void glBindFramebufferOES(int i10, int i11);

    void glBindRenderbufferOES(int i10, int i11);

    void glBindTexture(int i10, int i11);

    void glBlendEquation(int i10);

    void glBlendEquationSeparate(int i10, int i11);

    void glBlendFuncSeparate(int i10, int i11, int i12, int i13);

    int glCheckFramebufferStatusOES(int i10);
    ...
    void glDeleteFramebuffersOES(int i10, int[] iArr, int i11);

    void glDeleteFramebuffersOES(int i10, IntBuffer intBuffer);

    void glDeleteRenderbuffersOES(int i10, int[] iArr, int i11);

    void glDeleteRenderbuffersOES(int i10, IntBuffer intBuffer);

    void glEnable(int i10);

    void glFramebufferRenderbufferOES(int i10, int i11, int i12, int i13);

    void glFramebufferTexture2DOES(int i10, int i11, int i12, int i13, int i14);

    void glGenerateMipmapOES(int i10);

    void glGenFramebuffersOES(int i10, int[] iArr, int i11);

    void glGenFramebuffersOES(int i10, IntBuffer intBuffer);

    void glGenRenderbuffersOES(int i10, int[] iArr, int i11);

    void glGenRenderbuffersOES(int i10, IntBuffer intBuffer);

    void glGetFramebufferAttachmentParameterivOES(int i10, int i11, int i12, int[] iArr, int i13);

    void glGetFramebufferAttachmentParameterivOES(int i10, int i11, int i12, IntBuffer intBuffer);

    void glGetIntegerv(int i10, int[] iArr, int i11);

    void glGetIntegerv(int i10, IntBuffer intBuffer);

    void glGetRenderbufferParameterivOES(int i10, int i11, int[] iArr, int i12);

    void glGetRenderbufferParameterivOES(int i10, int i11, IntBuffer intBuffer);

    void glGetTexGenfv(int i10, int i11, float[] fArr, int i12);

    void glGetTexGenfv(int i10, int i11, FloatBuffer floatBuffer);

    void glGetTexGeniv(int i10, int i11, int[] iArr, int i12);

    void glGetTexGeniv(int i10, int i11, IntBuffer intBuffer);

    void glGetTexGenxv(int i10, int i11, int[] iArr, int i12);

    void glGetTexGenxv(int i10, int i11, IntBuffer intBuffer);

    boolean glIsFramebufferOES(int i10);

    boolean glIsRenderbufferOES(int i10);

    void glRenderbufferStorageOES(int i10, int i11, int i12, int i13);
    ...
    void glTexGenf(int i10, int i11, float f10);

    void glTexGenfv(int i10, int i11, float[] fArr, int i12);

    void glTexGenfv(int i10, int i11, FloatBuffer floatBuffer);

    void glTexGeni(int i10, int i11, int i12);

    void glTexGeniv(int i10, int i11, int[] iArr, int i12);

    void glTexGeniv(int i10, int i11, IntBuffer intBuffer);

    void glTexGenx(int i10, int i11, int i12);

    void glTexGenxv(int i10, int i11, int[] iArr, int i12);

    void glTexGenxv(int i10, int i11, IntBuffer intBuffer);
