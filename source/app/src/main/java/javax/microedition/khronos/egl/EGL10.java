...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/d8lib/android.jar:javax/microedition/khronos/egl/EGL10.class
 */
public interface EGL10 extends EGL {
    ...
    boolean eglChooseConfig(EGLDisplay eGLDisplay, int[] iArr, EGLConfig[] eGLConfigArr, int i10, int[] iArr2);
    ...
    boolean eglGetConfigAttrib(EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i10, int[] iArr);

    boolean eglGetConfigs(EGLDisplay eGLDisplay, EGLConfig[] eGLConfigArr, int i10, int[] iArr);

    EGLContext eglGetCurrentContext();

    EGLDisplay eglGetCurrentDisplay();

    EGLSurface eglGetCurrentSurface(int i10);
    ...
    boolean eglQueryContext(EGLDisplay eGLDisplay, EGLContext eGLContext, int i10, int[] iArr);

    String eglQueryString(EGLDisplay eGLDisplay, int i10);

    boolean eglQuerySurface(EGLDisplay eGLDisplay, EGLSurface eGLSurface, int i10, int[] iArr);
    ...
    boolean eglWaitNative(int i10, Object obj);
}
