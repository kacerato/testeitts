...
public class h {
    ...
    public static final ThreadLocal<Rect> f117034a = new a();

    public static final ThreadLocal<Rect> f117035b = new b();
    ...
    public class c implements D5.h {
        ...
        public final g f117036a;

        public c(final g val$listener) {
            this.f117036a = val$listener;
        }

        @Override
        public Variable get() {
            return new Variable("", this.f117036a.get());
        }

        @Override
        public void set(Variable variable) {
            if (variable != null) {
                this.f117036a.a(variable.float_value);
            }
        }
    }
    ...
    public static class e {
        ...
        public static final int[] f117037a;
        ...
        static {
            ...
            try {
                f117037a[C15147a.e.Above.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f117037a[C15147a.e.Below.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f117037a[C15147a.e.Right.ordinal()] = 4;
