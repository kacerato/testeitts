...
public class C3353l extends C3351k {

    public static final int f29374f = 24;

    public C3353l(byte[] bArr) {
        super(bArr);
    ...
    public static boolean i(byte[] bArr, int i10) {
        return bArr.length == 16 ? g(bArr, i10) : h(bArr, i10);
    }

    public static boolean j(byte[] bArr, int i10, int i11) {
        while (i10 < i11) {
            if (C3351k.e(bArr, i10)) {
                return true;
            }
            i10 += 8;
        }
