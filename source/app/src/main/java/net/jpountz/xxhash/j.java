...
public final class j extends b {
    ...
    public static class a implements g.b {
        ...
        public static final g.b f98139a = new a();
    ...
    public long d() {
        ...
        while (true) {
            ...
            j14 = (Long.rotateLeft(j14 ^ (Long.rotateLeft(net.jpountz.util.d.j(this.f98127i, i11) * (-4417276706812531889L), 31) * (-7046029288634856825L)), 27) * (-7046029288634856825L)) - 8796714831421723037L;
            i11 += 8;
        }
        if (i11 <= i10 - 4) {
            j14 = (Long.rotateLeft(j14 ^ ((net.jpountz.util.d.h(this.f98127i, i11) & 4294967295L) * (-7046029288634856825L)), 23) * (-4417276706812531889L)) + 1609587929392839161L;
            i11 += 4;
        }
    ...
    public void f(byte[] bArr, int i10, int i11) {
        ...
        if (i13 > 0) {
            ...
            long j10 = this.f98122d + (net.jpountz.util.d.j(this.f98127i, 0) * (-4417276706812531889L));
            this.f98122d = j10;
            this.f98122d = Long.rotateLeft(j10, 31) * (-7046029288634856825L);
            long j11 = this.f98123e + (net.jpountz.util.d.j(this.f98127i, 8) * (-4417276706812531889L));
            this.f98123e = j11;
            this.f98123e = Long.rotateLeft(j11, 31) * (-7046029288634856825L);
            long j12 = this.f98124f + (net.jpountz.util.d.j(this.f98127i, 16) * (-4417276706812531889L));
            this.f98124f = j12;
            this.f98124f = Long.rotateLeft(j12, 31) * (-7046029288634856825L);
            long j13 = this.f98125g + (net.jpountz.util.d.j(this.f98127i, 24) * (-4417276706812531889L));
            this.f98125g = j13;
        ...
        while (i12 <= i16) {
            j14 = Long.rotateLeft(j14 + (net.jpountz.util.d.j(bArr, i12) * (-4417276706812531889L)), i15) * (-7046029288634856825L);
            j15 = Long.rotateLeft(j15 + (net.jpountz.util.d.j(bArr, i12 + 8) * (-4417276706812531889L)), 31) * (-7046029288634856825L);
            j16 = Long.rotateLeft(j16 + (net.jpountz.util.d.j(bArr, i12 + 16) * (-4417276706812531889L)), 31) * (-7046029288634856825L);
            i15 = 31;
            j17 = Long.rotateLeft(j17 + (net.jpountz.util.d.j(bArr, i12 + 24) * (-4417276706812531889L)), 31) * (-7046029288634856825L);
            i12 += 32;
        }
        this.f98122d = j14;
        this.f98123e = j15;
