...
public final class r extends o {
    ...
    public static final o f98147a = new r();
    ...
    public long c(byte[] bArr, int i10, int i11, long j10) {
        ...
        if (i11 >= 32) {
            ...
            long j18 = j10;
            while (true) {
                rotateLeft = Long.rotateLeft(j17 + (net.jpountz.util.d.j(bArr, i13) * j13), 31) * j14;
                i12 = i14;
                rotateLeft2 = Long.rotateLeft(j16 + (net.jpountz.util.d.j(bArr, i13 + 8) * j13), 31) * j14;
                rotateLeft3 = Long.rotateLeft((net.jpountz.util.d.j(bArr, i13 + 16) * (-4417276706812531889L)) + j18, 31) * (-7046029288634856825L);
                rotateLeft4 = Long.rotateLeft(j15 + (net.jpountz.util.d.j(bArr, i13 + 24) * (-4417276706812531889L)), 31);
        ...
        long j19 = j11 + i11;
        while (i13 <= i12 - 8) {
            j19 = (Long.rotateLeft(j19 ^ (Long.rotateLeft(net.jpountz.util.d.j(bArr, i13) * (-4417276706812531889L), 31) * (-7046029288634856825L)), 27) * (-7046029288634856825L)) - 8796714831421723037L;
            i13 += 8;
        }
        if (i13 <= i12 - 4) {
            j19 = (Long.rotateLeft(j19 ^ ((net.jpountz.util.d.h(bArr, i13) & 4294967295L) * (-7046029288634856825L)), 23) * (-4417276706812531889L)) + 1609587929392839161L;
            i13 += 4;
        }
        int i16 = i12;
        while (i13 < i16) {
            j19 = Long.rotateLeft(j19 ^ ((net.jpountz.util.d.d(bArr, i13) & 255) * 2870177450012600261L), 11) * (-7046029288634856825L);
            i13++;
        }
