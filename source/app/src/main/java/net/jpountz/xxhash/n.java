...
public final class n extends k {
    ...
    public static final k f98143a = new n();
    ...
    public int c(byte[] bArr, int i10, int i11, int i12) {
        ...
        if (i11 >= 16) {
            ...
            int i18 = i12 - (-1640531535);
            do {
                i16 = Integer.rotateLeft(i16 + (net.jpountz.util.d.h(bArr, i10) * (-2048144777)), 13) * (-1640531535);
                i17 = Integer.rotateLeft(i17 + (net.jpountz.util.d.h(bArr, i10 + 4) * (-2048144777)), 13) * (-1640531535);
                i12 = Integer.rotateLeft(i12 + (net.jpountz.util.d.h(bArr, i10 + 8) * (-2048144777)), 13) * (-1640531535);
        ...
        int i19 = i13 + i11;
        while (i10 <= i14 - 4) {
            i19 = Integer.rotateLeft(i19 + (net.jpountz.util.d.h(bArr, i10) * (-1028477379)), 17) * 668265263;
            i10 += 4;
        }
        while (i10 < i14) {
            i19 = Integer.rotateLeft(i19 + ((net.jpountz.util.d.d(bArr, i10) & 255) * 374761393), 11) * (-1640531535);
            i10++;
        }
        int i20 = ((i19 >>> 15) ^ i19) * (-2048144777);
        int i21 = (i20 ^ (i20 >>> 13)) * (-1028477379);
