...
public final class o extends d {
    ...
    public static final d f98084c = new o();

    public static final boolean f98085d = false;

    public final int f98086a;

    public final int f98087b;

    public class a {

        public static final int f98088f = 65535;

        public static final boolean f98089g = false;

        public int f98090a;

        public final int f98091b;

        public final int[] f98092c;

        public final short[] f98093d;
        ...
        public a(int i10) {
            ...
            this.f98092c = iArr;
            Arrays.fill(iArr, -1);
            this.f98093d = new short[65536];
        }

        public final void a(int i10, int i11) {
            int g10 = C.g(i10);
            int[] iArr = this.f98092c;
            int i12 = i11 - iArr[g10];
            if (i12 >= 65536) {
                i12 = 65535;
            }
            this.f98093d[65535 & i11] = (short) i12;
            iArr[g10] = i11;
        }
        ...
        public final void c(byte[] bArr, int i10) {
            a(net.jpountz.util.d.e(bArr, i10), i10);
        }

        public final int d(int i10) {
            return this.f98092c[C.g(i10)];
        }
        ...
        public final int f(byte[] bArr, int i10) {
            return d(net.jpountz.util.d.e(bArr, i10));
        }
        ...
        public boolean i(ByteBuffer byteBuffer, int i10, int i11, C.a aVar) {
            ...
            if (e10 < i10 - 4 || e10 > i10 || e10 < this.f98091b) {
                i12 = 0;
                i13 = 0;
            } else {
            ...
            for (int i14 = 0; i14 < o.this.f98086a && e10 >= Math.max(this.f98091b, i10 - 65535) && e10 <= i10; i14++) {
            ...
            if (i13 != 0) {
                int i15 = (i13 + i10) - 3;
                while (i10 < i15 - i12) {
                    this.f98093d[i10 & 65535] = (short) i12;
                    i10++;
                }
                do {
                    this.f98093d[i10 & 65535] = (short) i12;
                    this.f98092c[C.g(net.jpountz.util.a.h(byteBuffer, i10))] = i10;
                    i10++;
                } while (i10 < i15);
                this.f98090a = i15;
            }
        ...
        public boolean j(byte[] bArr, int i10, int i11, C.a aVar) {
            ...
            h(i10, bArr);
            int f10 = f(bArr, i10);
            if (f10 < i10 - 4 || f10 > i10 || f10 < this.f98091b) {
                i12 = 0;
                i13 = 0;
            } else {
                if (B.e(bArr, f10, i10)) {
                    i12 = i10 - f10;
                    i13 = B.a(bArr, f10 + 4, i10 + 4, i11) + 4;
                    aVar.f97982c = i13;
                    aVar.f97981b = f10;
                } else {
                    i12 = 0;
            ...
            for (int i14 = 0; i14 < o.this.f98086a && f10 >= Math.max(this.f98091b, i10 - 65535) && f10 <= i10; i14++) {
                if (B.e(bArr, f10, i10) && (a10 = B.a(bArr, f10 + 4, i10 + 4, i11) + 4) > aVar.f97982c) {
                    aVar.f97981b = f10;
                    aVar.f97982c = a10;
                }
                f10 = m(f10);
            ...
            if (i13 != 0) {
                ...
                do {
                    this.f98093d[i10 & 65535] = (short) i12;
                    this.f98092c[C.g(net.jpountz.util.d.e(bArr, i10))] = i10;
                    i10++;
                } while (i10 < i15);
                this.f98090a = i15;
            }
        ...
        public boolean k(ByteBuffer byteBuffer, int i10, int i11, int i12, int i13, C.a aVar) {
            ...
            for (int i14 = 0; i14 < o.this.f98086a && e10 >= Math.max(this.f98091b, i10 - 65535) && e10 <= i10; i14++) {
                if (EnumC14390c.i(byteBuffer, e10, i10)) {
                    ...
                    int b10 = EnumC14390c.b(byteBuffer, e10, i10, this.f98091b, i11);
                    int i15 = a10 + b10;
                    if (i15 > aVar.f97982c) {
                        aVar.f97982c = i15;
        ...
        public boolean l(byte[] bArr, int i10, int i11, int i12, int i13, C.a aVar) {
            ...
            for (int i14 = 0; i14 < o.this.f98086a && f10 >= Math.max(this.f98091b, i10 - 65535) && f10 <= i10; i14++) {
                if (B.e(bArr, f10, i10)) {
                    int a10 = B.a(bArr, f10 + 4, i10 + 4, i12) + 4;
                    int b10 = B.b(bArr, f10, i10, this.f98091b, i11);
                    int i15 = a10 + b10;
                    if (i15 > aVar.f97982c) {
                        aVar.f97982c = i15;
        ...
        public final int m(int i10) {
            return i10 - (this.f98093d[i10 & 65535] & 65535);
        }
    }
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:69:0x01cb, code lost:
        ...
        r23 = r9;
        r6 = net.jpountz.lz4.B.c(r22, r23.a(), r0.f97980a, r0.f97981b, r0.f97982c, r25, net.jpountz.lz4.B.c(r22, r16, r9.f97980a, r9.f97981b, r9.f97982c, r25, r17, r10), r10);
        r3 = r0.a();
        r9 = r23;
        r8 = r0;
        r2 = r3;
    ...
    public int c(byte[] bArr, int i10, int i11, byte[] bArr2, int i12, int i13) {
        ...
        while (i20 < i18) {
            if (aVar5.j(bArr, i20, i19, aVar7)) {
                    ...
                    if (aVar8.f97980a - aVar7.f97980a >= 3) {
                        while (true) {
                            ...
                            if (aVar12.f97980a >= aVar7.a() + 3) {
                                ...
                                C.a aVar13 = aVar7;
                                i24 = B.c(bArr, i23, aVar7.f97980a, aVar7.f97981b, aVar7.f97982c, bArr2, i24, i17);
                                i23 = aVar13.a();
                                aVar7 = aVar13;
                                C.a(aVar3, aVar7);
                                C.a(aVar4, aVar3);
                ...
                int i33 = i23;
                C.a aVar15 = aVar7;
                i21 = B.c(bArr, i33, aVar7.f97980a, aVar7.f97981b, aVar7.f97982c, bArr2, i24, i17);
                i22 = aVar15.a();
                aVar8 = aVar;
                i20 = i22;
                aVar9 = aVar2;
        ...
        return B.d(bArr, i22, i16 - i22, bArr2, i21, i17) - i12;
    }

    public o(int i10) {
        this.f98086a = 1 << (i10 - 1);
        this.f98087b = i10;
    }
}
