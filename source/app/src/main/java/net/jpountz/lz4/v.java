...
public final class v extends d {
    ...
    public static final d f98107a = new v();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x00ae, code lost:
        ...
        r9 = r8 - 2;
        net.jpountz.util.d.x(r2, net.jpountz.lz4.C.e(net.jpountz.util.a.h(r17, r9)), r9 - r1);
        r9 = net.jpountz.lz4.C.e(net.jpountz.util.a.h(r17, r8));
        r15 = r1 + net.jpountz.util.d.k(r2, r9);
        net.jpountz.util.d.x(r2, r9, r8 - r1);
     */
    ...
    */
        ...
        if (i11 >= 13) {
            ...
            loop0: while (true) {
                ...
                while (true) {
                    ...
                    int k10 = net.jpountz.util.d.k(sArr, e10) + i16;
                    net.jpountz.util.d.x(sArr, e10, i20 - i16);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:11:0x0047, code lost:
        ...
        r11 = net.jpountz.lz4.B.b(r17, r15, r8, r1, r9);
        r8 = r8 - r11;
        r15 = r15 - r11;
        r11 = r8 - r9;
        r12 = r10 + 1;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x0060, code lost:
        ...
        net.jpountz.util.d.r(r20, r10, 240);
        r12 = net.jpountz.lz4.B.m(r11 - 15, r20, r12);
     */
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0071, code lost:
    
        net.jpountz.lz4.B.j(r17, r9, r20, r12, r11);
        r12 = r12 + r11;
     */
    /* JADX WARN: Code restructure failed: missing block: B:17:0x0075, code lost:
    
        net.jpountz.util.d.y(r20, r12, (short) (r8 - r15));
        r9 = r12 + 2;
        r8 = r8 + 4;
        r11 = net.jpountz.lz4.B.a(r17, r15 + 4, r8, r6);
     */
    /* JADX WARN: Code restructure failed: missing block: B:18:0x008a, code lost:
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0091, code lost:
        ...
        net.jpountz.util.d.r(r20, r10, net.jpountz.util.d.d(r20, r10) | 15);
        r9 = net.jpountz.lz4.B.m(r11 - 15, r20, r9);
     */
    /* JADX WARN: Code restructure failed: missing block: B:22:0x009f, code lost:
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x00ae, code lost:
        ...
        r9 = r8 - 2;
        net.jpountz.util.d.x(r2, net.jpountz.lz4.C.e(net.jpountz.util.d.e(r17, r9)), r9 - r1);
        r9 = net.jpountz.lz4.C.e(net.jpountz.util.d.e(r17, r8));
        r15 = r1 + net.jpountz.util.d.k(r2, r9);
        net.jpountz.util.d.x(r2, r9, r8 - r1);
     */
    /* JADX WARN: Code restructure failed: missing block: B:25:0x00d3, code lost:
    
        if (net.jpountz.lz4.B.e(r17, r8, r15) != false) goto L30;
     */
    /* JADX WARN: Code restructure failed: missing block: B:26:0x00de, code lost:
    
        net.jpountz.util.d.r(r20, r10, 0);
        r12 = r10 + 1;
     */
    /* JADX WARN: Code restructure failed: missing block: B:30:0x00ac, code lost:
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x00a1, code lost:
        ...
        net.jpountz.util.d.r(r20, r10, r11 | net.jpountz.util.d.d(r20, r10));
     */
    /* JADX WARN: Code restructure failed: missing block: B:37:0x00eb, code lost:
    ...
    /* JADX WARN: Code restructure failed: missing block: B:38:0x006c, code lost:
        ...
        net.jpountz.util.d.r(r20, r10, r11 << 4);
     */
    /* JADX WARN: Code restructure failed: missing block: B:41:0x00f1, code lost:
    ...
    */
    public static int j(byte[] bArr, int i10, int i11, byte[] bArr2, int i12, int i13) {
        ...
        if (i11 >= 13) {
            ...
            loop0: while (true) {
                ...
                while (true) {
                    ...
                    int e10 = C.e(net.jpountz.util.d.e(bArr, i20));
                    int k10 = net.jpountz.util.d.k(sArr, e10) + i16;
                    net.jpountz.util.d.x(sArr, e10, i20 - i16);
                    if (B.e(bArr, k10, i20)) {
                        break;
        ...
        return B.d(bArr, i16, i17 - i16, bArr2, i14, i13) - i12;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x010d, code lost:
        ...
        r9 = r1 - 2;
        net.jpountz.util.d.u(r7, net.jpountz.lz4.C.b(net.jpountz.util.a.h(r5, r9)), r9);
        r9 = net.jpountz.lz4.C.b(net.jpountz.util.a.h(r5, r1));
        r12 = net.jpountz.util.d.g(r7, r9);
        net.jpountz.util.d.u(r7, r9, r1);
        r9 = r1 - r12;
     */
    ...
    */
        ...
        loop0: while (true) {
            ...
            while (true) {
                ...
                if (i26 <= i20) {
                    ...
                    int g10 = net.jpountz.util.d.g(iArr, b10);
                    int i29 = i21 - g10;
                    net.jpountz.util.d.u(iArr, b10, i21);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x0063, code lost:
        ...
        r12 = net.jpountz.lz4.B.b(r19, r15, r7, r1, r9);
        r7 = r7 - r12;
        r15 = r15 - r12;
        r12 = r7 - r9;
        r13 = r10 + 1;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x007d, code lost:
        ...
        net.jpountz.util.d.r(r22, r10, 240);
        r13 = net.jpountz.lz4.B.m(r12 - 15, r22, r13);
     */
    /* JADX WARN: Code restructure failed: missing block: B:20:0x008e, code lost:
    
        net.jpountz.lz4.B.j(r19, r9, r22, r13, r12);
        r13 = r13 + r12;
     */
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0092, code lost:
    
        net.jpountz.util.d.y(r22, r13, r11);
        r9 = r13 + 2;
        r7 = r7 + 4;
        r11 = net.jpountz.lz4.B.a(r19, r15 + 4, r7, r4);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x00ab, code lost:
        ...
        net.jpountz.util.d.r(r22, r10, net.jpountz.util.d.d(r22, r10) | 15);
        r9 = net.jpountz.lz4.B.m(r11 - 15, r22, r9);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:28:0x00d5, code lost:
        ...
        r9 = r7 - 2;
        net.jpountz.util.d.u(r8, net.jpountz.lz4.C.b(net.jpountz.util.d.e(r19, r9)), r9);
        r9 = net.jpountz.lz4.C.b(net.jpountz.util.d.e(r19, r7));
        r15 = net.jpountz.util.d.g(r8, r9);
        net.jpountz.util.d.u(r8, r9, r7);
        r11 = r7 - r15;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:31:0x00fb, code lost:
        ...
        if (net.jpountz.lz4.B.e(r19, r15, r7) != false) goto L39;
     */
    /* JADX WARN: Code restructure failed: missing block: B:32:0x00fe, code lost:
    
        r13 = r10 + 1;
        net.jpountz.util.d.r(r22, r10, 0);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:40:0x00d4, code lost:
        ...
        return net.jpountz.lz4.B.d(r19, r1, r2 - r1, r22, r10, r5) - r23;
     */
    /* JADX WARN: Code restructure failed: missing block: B:41:0x00bb, code lost:
    
        net.jpountz.util.d.r(r22, r10, r11 | net.jpountz.util.d.d(r22, r10));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:45:0x0089, code lost:
        ...
        net.jpountz.util.d.r(r22, r10, r12 << 4);
     */
    ...
    */
    public int c(byte[] bArr, int i10, int i11, byte[] bArr2, int i12, int i13) {
        int i14;
        int i15 = i10;
        net.jpountz.util.d.c(bArr, i10, i11);
        net.jpountz.util.d.c(bArr2, i12, i13);
        int i16 = i12 + i13;
        if (i11 < 65547) {
        ...
        loop0: while (true) {
            ...
            while (true) {
                ...
                if (i25 <= i19) {
                    int b10 = C.b(net.jpountz.util.d.e(bArr, i20));
                    int g10 = net.jpountz.util.d.g(iArr, b10);
                    int i28 = i20 - g10;
                    net.jpountz.util.d.u(iArr, b10, i20);
                    if (i28 < 65536 && B.e(bArr, g10, i20)) {
                        break;
                    }
                    i15 = i10;
                    i20 = i25;
