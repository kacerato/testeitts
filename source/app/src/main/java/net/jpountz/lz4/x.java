...
public final class x extends y {
    ...
    public static final y f98109a = new x();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:57:0x00cb, code lost:
        ...
        net.jpountz.lz4.B.h(r18, r6, r21, r7, r9);
     */
    ...
    */
    public int a(byte[] bArr, int i10, int i11, byte[] bArr2, int i12, int i13) {
        ...
        int i15 = 1;
        if (i13 == 0) {
            if (i11 == 1 && net.jpountz.util.d.d(bArr, i10) == 0) {
                return 0;
            }
        ...
        int i19 = i12;
        while (true) {
            byte d10 = net.jpountz.util.d.d(bArr, i18);
            int i20 = i18 + i15;
            int i21 = (d10 & 255) >>> 4;
            if (i21 == 15) {
                byte b10 = -1;
                while (true) {
                    ...
                    int i22 = i20 + 1;
                    byte d11 = net.jpountz.util.d.d(bArr, i20);
                    if (d11 != -1) {
                        b10 = d11;
                        i20 = i22;
                        break;
            ...
            B.j(bArr, i20, bArr2, i19, i21);
            int o10 = net.jpountz.util.d.o(bArr, i14);
            int i25 = i14 + 2;
            int i26 = i23 - o10;
            if (i26 < i12) {
            ...
            if (i27 == 15) {
                ...
                while (true) {
                    ...
                    int i28 = i25 + 1;
                    byte d12 = net.jpountz.util.d.d(bArr, i25);
                    if (d12 != -1) {
                        i25 = i28;
                        b11 = d12;
                        break;
            ...
            i19 = i23 + i29;
            if (i19 <= i24) {
                B.k(bArr2, i26, i23, i19);
            } else {
                if (i19 > i17) {
                    throw new LZ4Exception("Malformed input at " + i25);
                }
                B.i(bArr2, i26, i23, i29);
            }
            i18 = i25;
            i15 = 1;
        }
