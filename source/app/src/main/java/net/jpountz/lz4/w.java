...
public final class w extends j {
    ...
    public static final j f98108a = new w();
    ...
    public int a(byte[] bArr, int i10, byte[] bArr2, int i11, int i12) {
        ...
        int i14;
        byte d11;
        net.jpountz.util.d.b(bArr, i10);
        net.jpountz.util.d.c(bArr2, i11, i12);
        if (i12 == 0) {
            if (net.jpountz.util.d.d(bArr, i10) == 0) {
                return 1;
            }
        ...
        int i17 = i11;
        while (true) {
            byte d12 = net.jpountz.util.d.d(bArr, i16);
            int i18 = i16 + 1;
            int i19 = (d12 & 255) >>> 4;
            if (i19 == 15) {
                while (true) {
                    i14 = i18 + 1;
                    d11 = net.jpountz.util.d.d(bArr, i18);
                    if (d11 != -1) {
                        break;
                    }
                    i19 += 255;
            ...
            if (i20 > i21) {
                if (i20 == i15) {
                    B.h(bArr, i18, bArr2, i17, i19);
                    return (i18 + i19) - i10;
                }
                throw new LZ4Exception("Malformed input at " + i18);
            }
            B.j(bArr, i18, bArr2, i17, i19);
            int i22 = i18 + i19;
            int o10 = net.jpountz.util.d.o(bArr, i22);
            i16 = i22 + 2;
            int i23 = i20 - o10;
            if (i23 < i11) {
            ...
            if (i24 == 15) {
                while (true) {
                    i13 = i16 + 1;
                    d10 = net.jpountz.util.d.d(bArr, i16);
                    if (d10 != -1) {
                        break;
                    }
                    i24 += 255;
            ...
            int i26 = i20 + i25;
            if (i26 <= i21) {
                B.k(bArr2, i23, i20, i26);
            } else {
                if (i26 > i15) {
                    throw new LZ4Exception("Malformed input at " + i16);
                }
                B.i(bArr2, i23, i20, i25);
            }
            i17 = i26;
        }
    }
