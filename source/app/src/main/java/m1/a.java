...
public final class a {
    @NonNull
    public static AttributeSet a(@NonNull Context context, @XmlRes int i10, @NonNull CharSequence charSequence) {
        int next;
        try {
    ...
    @TargetApi(21)
    public static void b(@Nullable RippleDrawable rippleDrawable, int i10) {
