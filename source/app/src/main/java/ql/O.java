...
public class O {
    ...
    public static class a extends ObjectInputStream {
        ...
        public static final Set f108310d;

        public final Class f108311b;
        ...
        public Class<?> resolveClass(ObjectStreamClass objectStreamClass) throws IOException, ClassNotFoundException {
            if (this.f108312c) {
                if (!f108310d.contains(objectStreamClass.getName())) {
                    throw new InvalidClassException("unexpected class: ", objectStreamClass.getName());
                }
            } else {
                if (!objectStreamClass.getName().equals(this.f108311b.getName())) {
                    throw new InvalidClassException("unexpected class: ", objectStreamClass.getName());
                }
                this.f108312c = true;
            }
    ...
    public static Object g(byte[] bArr, Class cls) throws IOException, ClassNotFoundException {
    ...
    public static void h(byte[][] bArr) {
        ...
        for (byte[] bArr2 : bArr) {
            System.out.println(em.h.j(bArr2));
        }
    }
    ...
    public static int j(InterfaceC2392y interfaceC2392y) {
