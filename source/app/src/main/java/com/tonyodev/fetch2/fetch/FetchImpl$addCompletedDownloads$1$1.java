...
public final class FetchImpl$addCompletedDownloads$1$1 extends kotlin.jvm.internal.O implements Mf.a<nf.P0> {
    final boolean $alertListeners;
    ...
    public FetchImpl$addCompletedDownloads$1$1(FetchImpl fetchImpl, List<? extends CompletedDownload> list, boolean z10, Func<Error> func, Func<List<Download>> func2) {
        super(0);
        this.this$0 = fetchImpl;
        this.$completedDownloads = list;
        this.$alertListeners = z10;
        this.$func2 = func;
        this.$func = func2;
    }
    ...
    public final void invoke2() {
        ...
        Logger logger2;
        try {
            final List<Download> enqueueCompletedDownloads = this.this$0.fetchHandler.enqueueCompletedDownloads(this.$completedDownloads);
            if (this.$alertListeners) {
                ...
                for (Download download : enqueueCompletedDownloads) {
                    ...
                    logger2.d("Added CompletedDownload " + ((Object) download));
                }
            }
            ...
            handler2.post(new Runnable() {
                ...
                public final void run() {
                    FetchImpl$addCompletedDownloads$1$1.invoke$lambda$1(Func.this, enqueueCompletedDownloads);
                }
            });
        } catch (Exception e10) {
            logger = this.this$0.logger;
            logger.e("Failed to add CompletedDownload list " + ((Object) this.$completedDownloads));
            ...
            if (this.$func2 != null) {
                ...
                handler.post(new Runnable() {
                    @Override
                    public final void run() {
                        FetchImpl$addCompletedDownloads$1$1.invoke$lambda$2(Func.this, errorFromMessage);
                    }
                });
            }
        }
