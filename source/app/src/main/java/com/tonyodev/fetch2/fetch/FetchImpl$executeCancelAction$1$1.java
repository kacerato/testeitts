...
public final class FetchImpl$executeCancelAction$1$1 extends kotlin.jvm.internal.O implements Mf.a<nf.P0> {
    ...
    public FetchImpl$executeCancelAction$1$1(Mf.a<? extends List<? extends Download>> aVar, FetchImpl fetchImpl, Func<Error> func, Func<List<Download>> func2) {
        super(0);
    ...
    public final void invoke2() {
        ...
        try {
            ...
            for (Download download : invoke) {
                ...
                logger2.d("Cancelled download " + ((Object) download));
            ...
            handler2.post(new Runnable() {
                ...
                public final void run() {
                    FetchImpl$executeCancelAction$1$1.invoke$lambda$1(Func.this, invoke);
                }
            });
        } catch (Exception e10) {
            ...
            if (this.$func2 != null) {
                ...
                handler.post(new Runnable() {
                    @Override
                    public final void run() {
                        FetchImpl$executeCancelAction$1$1.invoke$lambda$2(Func.this, errorFromMessage);
                    }
                });
            }
        }
