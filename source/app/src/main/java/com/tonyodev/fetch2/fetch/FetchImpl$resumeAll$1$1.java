...
public final class FetchImpl$resumeAll$1$1 extends kotlin.jvm.internal.O implements Mf.a<nf.P0> {
    ...
    public final void invoke2() {
        ...
        try {
            List<Download> resumeAll = this.this$0.fetchHandler.resumeAll();
