...
class AngularVelocityDebugControl extends AbstractPhysicsDebugControl {
    ...
    public AngularVelocityDebugControl(BulletDebugAppState bulletDebugAppState, PhysicsCollisionObject physicsCollisionObject) {
        ...
        physicsRigidBody.getAngularVelocity(vector3f2);
        Geometry geometry = new Geometry("angular velocity of " + ((Object) physicsRigidBody), new Arrow(vector3f2));
        this.geom = geometry;
        physicsRigidBody.getPhysicsLocation(vector3f);
        geometry.setLocalTranslation(vector3f);
        geometry.setMaterial(bulletDebugAppState.getAngularVelocityMaterial());
