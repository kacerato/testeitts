...
public final class C12392s2 extends AbstractC12305h2 {

    public static final String[] f63571e = {"app_version", "ALTER TABLE messages ADD COLUMN app_version TEXT;", "app_version_int", "ALTER TABLE messages ADD COLUMN app_version_int INTEGER;"};

    public final C12377q2 f63572c;

    public boolean f63573d;

    public C12392s2(C12370p3 c12370p3) {
        super(c12370p3);
        Context d10 = this.f62917a.d();
        this.f62917a.w();
        this.f63572c = new C12377q2(this, d10, "google_app_measurement_local.db");
    }
    ...
    public final void o() {
        ...
        try {
            ...
            this.f62917a.a().w().b("Reset local analytics data. records", Integer.valueOf(delete));
        } catch (SQLiteException e10) {
            this.f62917a.a().o().b("Error resetting local analytics data. error", e10);
        }
    }
    ...
    public final boolean p(I i10) {
        ...
        this.f62917a.a().p().a("Event is too long for local database. Sending event directly to service");
        return false;
    }
    ...
    public final boolean q(i7 i7Var) {
        ...
        this.f62917a.a().p().a("User property too long for local database. Sending directly to service");
        return false;
    }

    public final boolean r(C12310i c12310i) {
        C12370p3 c12370p3 = this.f62917a;
        byte[] T10 = c12370p3.C().T(c12310i);
        if (T10.length <= 131072) {
            return z(2, T10);
        }
        c12370p3.a().p().a("Conditional user property too long for local database. Sending directly to service");
        return false;
    }

    public final boolean s(G g10) {
        C12370p3 c12370p3 = this.f62917a;
        byte[] T10 = c12370p3.C().T(g10);
        if (T10 == null) {
            c12370p3.a().p().a("Null default event parameters; not writing to database");
            return false;
        }
        if (T10.length <= 131072) {
            return z(4, T10);
        }
        c12370p3.a().p().a("Default event parameters too long for local database. Sending directly to service");
        return false;
    }
    ...
    */
    public final List t(int i10) {
                            ...
                            try {
                                ...
                                if (cursor5.moveToFirst()) {
                                    ...
                                    try {
                                        ...
                                        cursor4 = null;
                                        try {
                                            this.f62917a.a().o().b("Error reading entries from local database", e);
                                            this.f63573d = true;
                                            if (cursor4 != null) {
                                            }
                                ...
                                C12370p3 c12370p3 = this.f62917a;
                                C12342m w11 = c12370p3.w();
                                C12273d2 c12273d2 = C12281e2.f63199d1;
                                boolean H10 = w11.H(r62, c12273d2);
                                int i17 = 2;
                                if (H10) {
                                            ...
                                            if (i18 == 0) {
                                                    ...
                                                    try {
                                                        try {
                                                            ...
                                                            if (createFromParcel != null) {
                                                                arrayList.add(new C12384r2(createFromParcel, str2, j13));
                                                            }
                                                        } finally {
                                                        }
                                                    } catch (SafeParcelReader.ParseException unused2) {
                                                        this.f62917a.a().o().a("Failed to load event from local database");
                                                        obtain.recycle();
                                                    }
                                                ...
                                                try {
                                                    try {
                                                        obtain.unmarshall(blob, i13, blob.length);
                                                        obtain.setDataPosition(i13);
                                                        i7Var = i7.CREATOR.createFromParcel(obtain);
                                                    } finally {
                                                    }
                                                } catch (SafeParcelReader.ParseException unused4) {
                                                    this.f62917a.a().o().a("Failed to load user property from local database");
                                                    obtain.recycle();
                                                    i7Var = null;
                                                }
                                                if (i7Var != null) {
                                                    arrayList.add(new C12384r2(i7Var, str2, j13));
                                                }
                                            } else if (i18 == 2) {
                                                obtain = Parcel.obtain();
                                                try {
                                                    try {
                                                        obtain.unmarshall(blob, i13, blob.length);
                                                        obtain.setDataPosition(i13);
                                                        c12310i = C12310i.CREATOR.createFromParcel(obtain);
                                                    } finally {
                                                    }
                                                } catch (SafeParcelReader.ParseException unused5) {
                                                    this.f62917a.a().o().a("Failed to load conditional user property from local database");
                                                    obtain.recycle();
                                                    c12310i = null;
                                                }
                                                if (c12310i != null) {
                                                    arrayList.add(new C12384r2(c12310i, str2, j13));
                                                }
                                            } else if (i18 == 4) {
                                                obtain = Parcel.obtain();
                                                try {
                                                    ...
                                                    this.f62917a.a().o().a("Failed to load default event parameters from local database");
                                                    obtain.recycle();
                                                    g10 = null;
                                                }
                                                if (g10 != null) {
                                                    arrayList.add(new C12384r2(g10, str2, j13));
                                                }
                                            } else {
                                                if (i18 == 3) {
                                                    this.f62917a.a().w().a("Skipping app launch break");
                                                } else {
                                                    this.f62917a.a().o().a("Unknown record type in local database");
                                                }
                                                query = cursor6;
                                                i17 = 2;
                                                i16 = 1;
                                ...
                                try {
                                    if (sQLiteDatabase.delete("messages", "rowid <= ?", new String[]{Long.toString(j12)}) < arrayList.size()) {
                                        this.f62917a.a().o().a("Fewer entries removed from local database than expected");
                                    }
        ...
        this.f62917a.a().r().a("Failed to read events from database in reasonable time");
        return null;
    }
    ...
    public final boolean v() {
        ...
        if (!this.f63573d && x()) {
            ...
            while (true) {
                if (i11 >= 5) {
                    this.f62917a.a().r().a("Error deleting app launch break from local database in reasonable time");
                    break;
                }
                ...
                try {
                    try {
                        try {
                            ...
                            this.f62917a.a().o().b("Error deleting app launch break from local database", e10);
                            this.f63573d = true;
                            if (0 != 0) {
                                sQLiteDatabase.close();
                            }
                    ...
                    this.f62917a.a().o().b("Error deleting app launch break from local database", e11);
                    this.f63573d = true;
                    if (0 == 0) {
                    }
                    sQLiteDatabase.close();
    ...
    @VisibleForTesting
    @WorkerThread
    public final SQLiteDatabase w() throws SQLiteException {
        if (this.f63573d) {
            return null;
        }
        SQLiteDatabase writableDatabase = this.f63572c.getWritableDatabase();
    ...
    */
    public final boolean z(int i10, byte[] bArr) {
        ...
        if (!this.f63573d) {
            ...
            o7 o10 = w10.H(null, c12273d2) ? this.f62917a.L().o(null) : null;
            ContentValues contentValues = new ContentValues();
            contentValues.put("type", Integer.valueOf(i10));
            contentValues.put("entry", bArr);
            if (c12370p3.w().H(null, c12273d2) && o10 != null) {
                contentValues.put("app_version", o10.f63446d);
                contentValues.put("app_version_int", Long.valueOf(o10.f63453k));
            }
            c12370p3.w();
            int i11 = 0;
            int i12 = 5;
                        ...
                        try {
                            ...
                            if (cursor != null) {
                                try {
                                    ...
                                    e = e10;
                                    this.f62917a.a().o().b("Error writing entry; local database full", e);
                                    this.f63573d = true;
                                    if (cursor != null) {
                                        cursor.close();
                                    }
                                    ...
                                    this.f62917a.a().o().b("Error writing entry to local database", e);
                                    this.f63573d = true;
                                    if (cursor != null) {
                                        cursor.close();
                                    }
                            ...
                            if (j10 >= 100000) {
                                c12370p3.a().o().a("Data loss, local db full");
                                long j11 = 100001 - j10;
                                ...
                                if (delete != j11) {
                                    c12370p3.a().o().d("Different delete count than expected in local db. expected, received, difference", Long.valueOf(j11), Long.valueOf(delete), Long.valueOf(j11 - delete));
                                }
                            }
            ...
            this.f62917a.a().w().a("Failed to write entry to local database");
            return false;
        }
        return z10;
    }
