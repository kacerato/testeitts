...
public enum EnumC11915b0 {
    ...
    EnumC11915b0(String str) {
        this.zzak = str;
    }

    public static final EnumC11915b0 a(@Nullable String str) {
        for (EnumC11915b0 enumC11915b0 : values()) {
            if (enumC11915b0.zzak.equals(str)) {
                return enumC11915b0;
            }
        }
        return UNKNOWN;
