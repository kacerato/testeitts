...
public class C12455c {

    public static final ThreadLocal<Matrix> f64690a = new ThreadLocal<>();

    public static final ThreadLocal<RectF> f64691b = new ThreadLocal<>();
    ...
    public static void c(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull Rect rect) {
        ThreadLocal<Matrix> threadLocal = f64690a;
        ...
        ThreadLocal<RectF> threadLocal2 = f64691b;
