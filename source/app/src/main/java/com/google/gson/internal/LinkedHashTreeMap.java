...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    Node<K, V> find(K k10, boolean z10) {
        ...
        if (node2 == null) {
            ...
            node = new Node<>(node2, k10, secondaryHash, node4, node4.prev);
            nodeArr[length] = node;
        } else {
            node = new Node<>(node2, k10, secondaryHash, node4, node4.prev);
            if (i10 < 0) {
    ...
    private static int secondaryHash(int h10) {
        int h11 = h10 ^ ((h10 >>> 20) ^ (h10 >>> 12));
        return (h11 ^ (h11 >>> 7)) ^ (h11 >>> 4);
    }
 ...
 */
    ...
    static <K, V> Node<K, V>[] doubleCapacity(Node<K, V>[] oldTable) {
        ...
        for (int i10 = 0; i10 < oldCapacity; i10++) {
            Node<K, V> root = oldTable[i10];
            if (root != null) {
                iterator.reset(root);
                int leftSize = 0;
                int rightSize = 0;
                ...
                newTable[i10] = leftSize > 0 ? leftBuilder.root() : null;
                newTable[i10 + oldCapacity] = rightSize > 0 ? rightBuilder.root() : null;
            }
        }
        return newTable;
    }
 ...
 */
    public abstract class LinkedTreeMapIterator<T> implements Iterator<T> {
        ...
        final Node<K, V> nextNode() {
            ...
            if (e10 == LinkedHashTreeMap.this.header) {
 ...
 */
    final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object o10) {
            return (o10 instanceof Map.Entry) && LinkedHashTreeMap.this.findByEntry((Map.Entry) o10) != null;
        }

        @Override
        public boolean remove(Object o10) {
            Node<K, V> node;
            if (!(o10 instanceof Map.Entry) || (node = LinkedHashTreeMap.this.findByEntry((Map.Entry) o10)) == null) {
                return false;
            }
 ...
 */
    final class KeySet extends AbstractSet<K> {
        ...
        @Override
        public boolean contains(Object o10) {
            return LinkedHashTreeMap.this.containsKey(o10);
        }
