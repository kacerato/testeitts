...
public class TypeToken<T> {
    ...
    private static boolean isAssignableFrom(Type from, GenericArrayType to) {
        ...
        if (toGenericComponentType instanceof ParameterizedType) {
            ...
            if (from instanceof GenericArrayType) {
                t10 = ((GenericArrayType) from).getGenericComponentType();
            ...
            return isAssignableFrom(t10, (ParameterizedType) toGenericComponentType, new HashMap());
        }
        return true;
    }
    ...
    private static boolean isAssignableFrom(Type from, ParameterizedType to, Map<String, Type> typeVarMap) {
        ...
        if (ptype != null) {
            ...
            for (int i10 = 0; i10 < tArgs.length; i10++) {
                Type arg = tArgs[i10];
                TypeVariable<?> var = tParams[i10];
                while (arg instanceof TypeVariable) {
                    TypeVariable<?> v10 = (TypeVariable) arg;
                    arg = typeVarMap.get(v10.getName());
                }
    ...
    private static boolean typeEquals(ParameterizedType from, ParameterizedType to, Map<String, Type> typeVarMap) {
        if (from.getRawType().equals(to.getRawType())) {
            ...
            for (int i10 = 0; i10 < fromArgs.length; i10++) {
                if (!matches(fromArgs[i10], toArgs[i10], typeVarMap)) {
                    return false;
                }
            }
            return true;
    ...
    public final boolean equals(Object o10) {
        return (o10 instanceof TypeToken) && C$Gson$Types.equals(this.type, ((TypeToken) o10).type);
    }
