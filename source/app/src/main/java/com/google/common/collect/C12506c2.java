...
public final class C12506c2 {
    ...
    public static <T> T[] d(@InterfaceC12518f2 T t10, T[] tArr) {
    ...
    public static <T> T[] e(T[] tArr, @InterfaceC12518f2 T t10) {
    ...
    public static Object[] g(Object[] objArr, int i10, int i11) {
        w2.H.f0(i10, i10 + i11, objArr.length);
        if (i11 == 0) {
            return new Object[0];
        }
