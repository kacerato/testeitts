...
public final class z {
    ...
    public static final long f67097a = -1;
    ...
    public static final class b {
        ...
        public static final long[] f67098a = new long[37];

        public static final int[] f67099b = new int[37];

        public static final int[] f67100c = new int[37];

        static {
            BigInteger bigInteger = new BigInteger("10000000000000000", 16);
            for (int i10 = 2; i10 <= 36; i10++) {
                long j10 = i10;
                f67098a[i10] = z.c(-1L, j10);
                f67099b[i10] = (int) z.k(-1L, j10);
                f67100c[i10] = bigInteger.toString(i10).length() - 1;
            }
        }
        ...
        public static boolean a(long j10, int i10, int i11) {
            ...
            long j11 = f67098a[i11];
            if (j10 < j11) {
                return false;
            }
            return j10 > j11 || i10 > f67099b[i11];
        }
    }

    public static int a(long j10, long j11) {
        return n.d(d(j10), d(j11));
    }
    ...
    public static long b(String str) {
        p a10 = p.a(str);
        try {
            return j(a10.f67069a, a10.f67070b);
