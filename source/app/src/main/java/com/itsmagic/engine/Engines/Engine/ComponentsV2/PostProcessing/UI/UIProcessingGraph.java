...
public class UIProcessingGraph extends UICustomPostProcessing implements Serializable {

    public static final Class f76103F1 = UIProcessingGraph.class;

    public static final String f76104y1 = "UIProcessingGraph";

    public transient ShaderGraphData f76105q1;

    public transient long f76106v1;

    public static class a {

        public static final int[] f76107a;

        public static final int[] f76108b;
        ...
        static {
            ...
            try {
                f76108b[MaterialBuilder.r.FLOAT3.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f76108b[MaterialBuilder.r.FLOAT4.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f76108b[MaterialBuilder.r.FLOAT.ordinal()] = 4;
            ...
            try {
                f76107a[C.FLOAT3.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f76107a[C.FLOAT4.ordinal()] = 3;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f76107a[C.TEXTURE.ordinal()] = 4;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f76107a[C.CUBEMAP.ordinal()] = 5;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f76107a[C.NUMBER01.ordinal()] = 6;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f76107a[C.NUMBER.ordinal()] = 7;
    ...
    public class b extends AbstractC13203c {
        @Override
        public Class b() {
            return UIProcessingGraph.f76103F1;
        }

        @Override
        public String c() {
            return UIProcessingGraph.f76104y1;
        }

        @Override
        public String e() {
            return Lang.l(Lang.T.UI_POST_PROCESSING) + "/Graph";
        }
    }

    public class c implements a.b {

        public boolean f76109a = false;

        public boolean f76110b = false;
        ...
        public void a(String line) {
            if (line.contains("BEGIN-" + UIProcessingGraph.this.f76006Y)) {
                this.f76109a = true;
            }
            if (this.f76109a && !line.contains("compilation terminated") && line.contains("Filament: ERROR:")) {
                ...
                UIProcessingGraph uIProcessingGraph = UIProcessingGraph.this;
                sb2.append(uIProcessingGraph.f76004W);
                sb2.append(replace);
                sb2.append("\n");
                uIProcessingGraph.f76004W = sb2.toString();
                if (line.contains(".  No code generated.")) {
                    UIProcessingGraph.this.f76003V.h();
                    b();
                }
            }
        }
        ...
        public void b() {
            ...
            this.f76110b = true;
            UIProcessingGraph.this.reloadInspector();
            UIProcessingGraph.this.f76003V = null;
            J4.d.E1();
            J4.d.M1(J4.d.q2(Tc.b.v(UIProcessingGraph.this.shaderFile) + " failed to build!"));
            for (String str : UIProcessingGraph.this.f76004W.split("\n")) {
                J4.d.M1(J4.d.q2(str));
            }
        }
    }
    ...
    public class d implements D5.h {
        ...
        @Override
        public Variable get() {
            return new Variable("temp", UIProcessingGraph.this.shaderFile + "");
        }

        @Override
        public void set(Variable variable) {
            if (variable != null) {
                UIProcessingGraph.this.shaderFile = variable.str_value;
            }
        }
    }
    ...
    public class e implements D5.h {
        ...
        @Override
        public void set(Variable variable) {
            String str = UIProcessingGraph.this.shaderFile;
            if (str == null || str.isEmpty()) {
                return;
            }
            N7.c.D().B0(new n4.e(UIProcessingGraph.this.shaderFile));
        }
    }

    public class f implements D5.h {

        public final Vb.b f76114a;

        public f(final Vb.b val$param) {
            this.f76114a = val$param;
        }

        public static void b(Variable variable, Vb.b bVar) {
            t6.e S12 = t6.j.J1() ? t6.j.S1("UIProcessingGraph - set texture") : null;
            try {
    ...
    public class g implements D5.h {
        ...
        public final Vb.b f76116a;

        public g(final Vb.b val$param) {
            this.f76116a = val$param;
        }

        @Override
        public Variable get() {
            Vb.b bVar = this.f76116a;
    ...
    public class h implements D5.h {
        ...
        public final Vb.b f76118a;

        public h(final Vb.b val$param) {
            this.f76118a = val$param;
        }

        @Override
        public Variable get() {
            Vb.b bVar = this.f76118a;
            if (bVar.f26804f == null) {
    ...
    public class i implements D5.h {
        ...
        public final Vb.b f76120a;

        public i(final Vb.b val$param) {
            this.f76120a = val$param;
        }

        @Override
        public Variable get() {
            Vb.b bVar = this.f76120a;
            if (bVar.f26804f == null) {
                bVar.f26804f = 0;
            }
            return new Variable("", this.f76120a.f26804f + "");
        }

        @Override
        public void set(Variable v10) {
            this.f76120a.f26804f = Float.valueOf(v10.float_value);
        }
    }

    public class j implements D5.h {

        public final Vb.b f76122a;

        public j(final Vb.b val$param) {
            this.f76122a = val$param;
        }

        @Override
        public Variable get() {
            Vb.b bVar = this.f76122a;
            if (bVar.f26804f == null) {
                bVar.f26804f = 0;
            }
            return new Variable("", this.f76122a.f26804f + "");
        }

        @Override
        public void set(Variable v10) {
            this.f76122a.f26804f = Float.valueOf(v10.float_value);
        }
    }
    ...
    private void applyDefaultsFromGraph(Map<String, Vb.b> paramMap, ShaderGraphData data) {
        ...
        while (it2.hasNext()) {
            ...
            if (next != null && !"cameraImage".equals(next.name)) {
                String a10 = next.a();
                switch (a.f76107a[next.type.ordinal()]) {
                    case 1:
                        it = it2;
                        i10 = i11;
    ...
    private boolean ensureCameraImageAttribute(ShaderGraphData data) {
        ...
        this.f76004W = "Missing required attribute 'cameraImage' (Texture).";
        reloadInspector();
        J4.d.E1();
        J4.d.b2(this.f76004W);
        return false;
    }
    ...
    private String mapUniformType(MaterialBuilder.r type) {
        ...
        int i10 = a.f76108b[type.ordinal()];
    ...
    private void rebuildFromGraph(ShaderGraphData data) {
        ...
        if (ensureCameraImageAttribute(data)) {
            ...
            if (h10 == null || h10.a()) {
                this.f76004W = h10 != null ? joinErrors(h10.f81319e) : "Graph compilation failed";
                reloadInspector();
                return;
            }
    ...
    private void rebuildParamsFromGraph(com.itsmagic.engine.Engines.Graphics.ShaderGraph.f compilation, ShaderGraphData data) {
        ...
        this.f76001T.addAll(linkedHashMap.values());
    }
        ...
        for (int i10 = 0; i10 < this.f76001T.size(); i10++) {
            ...
            if (bVar.f26803e && !"cameraImage".equals(bVar.f26799a) && !MediaStore.Video.VideoColumns.RESOLUTION.equals(bVar.f26799a)) {
                if (x.f81392a.equals(bVar.f26799a)) {
                    outParams.put(bVar.f26799a, Float.valueOf(this.f76007Z));
    ...
    public List<C5.b> getInspectorEntries(Context context) {
        ...
        linkedList.add(new C5.b(new d(), "Graph file", b.a.InputFile, ".vgs"));
        linkedList.add(new C5.b(new e(), "Open graph editor", b.a.Button));
        if (isFailed()) {
                    ...
                    switch (c10) {
                        case 0:
                            ...
                            linkedList.add(F5.c.C(bVar.f26799a, (float[]) bVar.f26804f, null, new c.u0() {
                                @Override
                                public final void a() {
                                    UIProcessingGraph.this.lambda$getInspectorEntries$2(bVar);
                                }
                        ...
                        case 1:
                            ...
                            linkedList.add(F5.c.P(bVar.f26799a, (float[]) bVar.f26804f, null, new c.u0() {
                                @Override
                                public final void a() {
                                    UIProcessingGraph.this.lambda$getInspectorEntries$1(bVar);
                                }
                        ...
                        case 2:
                            ...
                            linkedList.add(F5.c.V(bVar.f26799a, (float[]) bVar.f26804f, null, new c.u0() {
                                @Override
                                public final void a() {
                                    UIProcessingGraph.this.lambda$getInspectorEntries$0(bVar);
                                }
                            }));
                            break;
                        case 3:
                            linkedList.add(new C5.b(new j(bVar), bVar.f26799a, b.a.SLFloat01).d(gameObject, this, bVar.f26799a, com.itsmagic.engine.Engines.Engine.Animation.c.FLOAT));
                            break;
                        case 4:
                            linkedList.add(new C5.b(new h(bVar), bVar.f26799a, b.a.Color).d(gameObject, this, bVar.f26799a, com.itsmagic.engine.Engines.Engine.Animation.c.COLOR));
                            break;
                        case 5:
                            linkedList.add(new C5.b(new g(bVar), bVar.f26799a, b.a.Color).d(gameObject, this, bVar.f26799a, com.itsmagic.engine.Engines.Engine.Animation.c.COLOR));
                            break;
                        case 6:
                            linkedList.add(new C5.b(new i(bVar), bVar.f26799a, b.a.SLFloat).d(gameObject, this, bVar.f26799a, com.itsmagic.engine.Engines.Engine.Animation.c.FLOAT));
                            break;
                        case 7:
    ...
    public String getTitle() {
        ...
        return str != null ? Tc.b.v(str) : f76104y1;
    }
    ...
    public void updateShaderPipeline(GameObject gameObject, boolean isEditor) {
        ...
        if (str == null) {
            clearGraphState();
        } else if (this.f76105q1 == null || !str.equals(this.f76000S) || this.f76106v1 != getGraphFileStamp()) {
            this.f76000S = this.shaderFile;
            this.f76106v1 = getGraphFileStamp();
            try {
                ShaderGraphData loadGraphData = loadGraphData(this.shaderFile);
                this.f76105q1 = loadGraphData;
    ...
    public void uploadDirtyParametersDirect(DoublePassUIPostProcessPass.b writer, UIController uIController, Tb.a frameBuffer, Tb.a cacheBuffer, long dirtyMask) {
        ...
        for (int i10 = 0; i10 < this.f76001T.size(); i10++) {
            ...
            if (bVar != null && bVar.f26803e && (str = bVar.f26799a) != null && !"cameraImage".equals(str) && !MediaStore.Video.VideoColumns.RESOLUTION.equals(bVar.f26799a)) {
                if (x.f81392a.equals(bVar.f26799a)) {
                    writer.d(bVar.f26799a, this.f76007Z);
                } else if (x.f81393b.equals(bVar.f26799a)) {
    ...
    public UIProcessingGraph(String shaderFile) {
        super(f76104y1, true);
        this.shaderFile = shaderFile;
    }
    ...
    public Component mo1248clone() {
        UIProcessingGraph uIProcessingGraph = new UIProcessingGraph();
        uIProcessingGraph.shaderFile = this.shaderFile;
        return uIProcessingGraph;
    }
}
