...
public class UIRadioButton extends ImGuiRenderableComponent {

    public static final String f78671S = "UIRadioButton";

    public static final Class f78672T = UIRadioButton.class;

    public p f78673P;

    public boolean f78674Q;

    public Component f78675R;
    ...
    public class a extends AbstractC13203c {
        @Override
        public Class b() {
            return UIRadioButton.f78672T;
        }

        @Override
        public String c() {
            return UIRadioButton.f78671S;
        }
    ...
    public class b implements h {
        ...
        @Override
        public Variable get() {
            return new Variable("", UIRadioButton.this.checked + "");
        }

        @Override
        public void set(Variable variable) {
            if (variable != null) {
                UIRadioButton.this.checked = variable.booolean_value.booleanValue();
            }
        }
    }
    ...
    public class c implements h {
        ...
        public class a implements Runnable {
            ...
            public final Variable f78678b;

            public a(final Variable val$variable) {
                this.f78678b = val$variable;
            }

            @Override
            public void run() {
                UIRadioButton.this.setColor(this.f78678b.color_value.clone());
            }
        }
        ...
        @Override
        public Variable get() {
            return UIRadioButton.this.color != null ? new Variable("temp", UIRadioButton.this.color) : new Variable("", "");
        }
    ...
    public class d implements h {
        ...
        @Override
        public Variable get() {
            return new Variable("", UIRadioButton.this.border + "");
        }

        @Override
        public void set(Variable variable) {
            if (variable != null) {
                UIRadioButton.this.setBorder(variable.float_value);
            }
        }
    }
    ...
    private void deselectOthersInGroup() {
        UIRadioGroup findGroup;
        GameObject gameObject;
        UIRadioButton uIRadioButton;
        if (this.f79250n == null || (findGroup = findGroup()) == null || (gameObject = findGroup.f79250n) == null || gameObject == null) {
            return;
        }
        Component.e eVar = Component.e.UIRadioButton;
        List<com.itsmagic.engine.Engines.Engine.ObjectOriented.Components.Component> s02 = gameObject.s0(eVar);
        com.itsmagic.engine.Engines.Engine.ObjectOriented.Components.Component c02 = gameObject.c0(eVar);
        if (c02 != null) {
            s02.add(c02);
        }
        for (int i10 = 0; i10 < s02.size(); i10++) {
            com.itsmagic.engine.Engines.Engine.ObjectOriented.Components.Component component = s02.get(i10);
            if ((component instanceof UIRadioButton) && (uIRadioButton = (UIRadioButton) component) != this) {
                uIRadioButton.setCheckedInternal(false, false);
            }
        }
    }

    private UIRadioGroup findGroup() {
        GameObject gameObject = this.f79250n;
        if (gameObject == null) {
            return null;
        }
        return (UIRadioGroup) gameObject.h0(Component.e.UIRadioGroup);
    }

    private void setCheckedInternal(boolean checked, boolean updateGroup) {
        if (this.checked == checked) {
            return;
        }
        this.checked = checked;
        if (checked && updateGroup) {
    ...
    private void updateTextures() {
        p or = this.checked ? or(this.onImgH.n(), P9.a.j().m()) : or(this.offImgH.n(), P9.a.j().l());
        boolean or9p = this.checked ? or9p(this.onImgH, P9.a.j().m()) : or9p(this.offImgH, P9.a.j().l());
        if (this.f78673P != or) {
            this.f78673P = or;
            requestUIDirty();
        }
        if (this.f78674Q != or9p) {
            this.f78674Q = or9p;
            requestUIDirty();
        }
    }
    ...
    public Component.e getType() {
        return Component.e.UIRadioButton;
    }
    ...
    public void loadAsync(Lb.a listener) {
        listener.b("(" + this.f79250n.getName() + "),(RadioButton),(Loading),(checked)");
        this.onImgH.q();
        listener.e();
        listener.b("(" + this.f79250n.getName() + "),(RadioButton),(Loading),(unchecked)");
        this.offImgH.q();
        listener.e();
    }
    ...
    public void onSelectedTouchChanged(tc.h touch) {
        UITouchTrigger touchTrigger;
        super.onSelectedTouchChanged(touch);
        if (this.f79250n == null || (touchTrigger = getTouchTrigger()) == null || !touchTrigger.isDown() || this.checked) {
            return;
        }
    ...
    public JAVARuntime.Component toJAVARuntime() {
        JAVARuntime.Component component = this.f78675R;
        if (component != null) {
            return component;
        }
        JAVARuntime.UIRadioButton uIRadioButton = new JAVARuntime.UIRadioButton(this);
        this.f78675R = uIRadioButton;
        return uIRadioButton;
    }

    @Override
    public com.itsmagic.engine.Engines.Engine.ObjectOriented.Components.Component mo1248clone() {
        UIRadioButton uIRadioButton = new UIRadioButton();
        uIRadioButton.color = ColorINT.k(this.color);
        uIRadioButton.onImgH = this.onImgH.clone();
        uIRadioButton.offImgH = this.offImgH.clone();
        uIRadioButton.border = this.border;
        uIRadioButton.checked = this.checked;
        return uIRadioButton;
    }
}
