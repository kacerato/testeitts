...
public final class ExtendedInteractionActionNodes {
    ...
    public static class SetStateNode extends SimpleAction {
        ...
        public void m0(){GameObject go=Aa.b.b(this,this.f79021a,inputs[0]);if(!C13317e.J(go)&&this.f79021a!=null)go=this.f79021a.h0();InteractionState s=InteractionState.fromString(m.i0(Q(inputs[1])));if(s!=null){InteractionRegistry.setState(go,s);InteractionDispatcher.dispatchCustomEvent("interaction_state_changed",go,s.name());}done();}
    ...
    public static class SetTagNode extends SimpleAction {
        ...
        public void m0(){GameObject go=Aa.b.b(this,this.f79021a,inputs[0]);if(!C13317e.J(go)&&this.f79021a!=null)go=this.f79021a.h0();String tag=m.i0(Q(inputs[1]));if(m.O(Q(inputs[2])))InteractionRegistry.addTag(go,tag);else InteractionRegistry.removeTag(go,tag);done();}
    ...
    public static class SetCapabilityNode extends SimpleAction {
        ...
        public void m0(){GameObject go=Aa.b.b(this,this.f79021a,inputs[0]);if(!C13317e.J(go)&&this.f79021a!=null)go=this.f79021a.h0();InteractionCapability cap=InteractionCapability.fromString(m.i0(Q(inputs[1])));if(cap!=null){if(m.O(Q(inputs[2])))InteractionRegistry.addCapability(go,cap);else InteractionRegistry.removeCapability(go,cap);}done();}
    ...
    public static class SetBusyNode extends SimpleAction {
        ...
        public void m0(){GameObject go=Aa.b.b(this,this.f79021a,inputs[0]);if(!C13317e.J(go)&&this.f79021a!=null)go=this.f79021a.h0();InteractionRegistry.setBusy(go,m.O(Q(inputs[1])));done();}
    ...
    public static class SetPoweredNode extends SimpleAction {
        ...
        public void m0(){GameObject go=Aa.b.b(this,this.f79021a,inputs[0]);if(!C13317e.J(go)&&this.f79021a!=null)go=this.f79021a.h0();boolean value=m.O(Q(inputs[1]));InteractionRegistry.setPowered(go,value);InteractionDispatcher.dispatchCustomEvent(value?"power_on":"power_off",go,null);done();}
    ...
    public static class SetLockedNode extends SimpleAction {
        ...
        public void m0(){GameObject go=Aa.b.b(this,this.f79021a,inputs[0]);if(!C13317e.J(go)&&this.f79021a!=null)go=this.f79021a.h0();boolean value=m.O(Q(inputs[1]));InteractionRegistry.setLocked(go,value);InteractionDispatcher.dispatchCustomEvent(value?"locked":"unlocked",go,null);done();}
    ...
    public static class SetCooldownNode extends SimpleAction {
        ...
        public void m0(){GameObject go=Aa.b.b(this,this.f79021a,inputs[0]);if(!C13317e.J(go)&&this.f79021a!=null)go=this.f79021a.h0();String action=m.i0(Q(inputs[1]));if(m.O(Q(inputs[3])))InteractionCooldownManager.resetCooldown(go,action);else InteractionCooldownManager.setCooldown(go,action,m.V(Q(inputs[2])));done();}
    ...
    public static class SetAnalogValueNode extends SimpleAction {
        ...
        public void m0(){GameObject go=Aa.b.b(this,this.f79021a,inputs[0]);if(!C13317e.J(go)&&this.f79021a!=null)go=this.f79021a.h0();float v=m.V(Q(inputs[1]));String mode=m.i0(Q(inputs[2]));if("Add".equalsIgnoreCase(mode))v=InteractionRegistry.getAnalogValue(go)+v;InteractionRegistry.setAnalogValue(go,v);InteractionRegistry.setAttribute(go,"analog_value",Float.valueOf(InteractionRegistry.getAnalogValue(go)));InteractionDispatcher.dispatchCustomEvent("interaction_value_changed",go,Float.valueOf(InteractionRegistry.getAnalogValue(go)));done();}
    ...
    public static class ConfigurePromptNode extends SimpleAction {
        ...
        public void m0(){GameObject go=Aa.b.b(this,this.f79021a,inputs[0]);if(!C13317e.J(go)&&this.f79021a!=null)go=this.f79021a.h0();InteractionRegistry.InteractableData data=InteractionRegistry.getOrCreate(go);if(data!=null){data.promptText=m.i0(Q(inputs[1]));data.promptIcon=m.i0(Q(inputs[2]));}done();}
    ...
    public static class SendInputActionNode extends SimpleAction {
        ...
        public void m0(){GameObject actor=Aa.b.b(this,this.f79021a,inputs[0]);InteractionRuntime rt=InteractionRuntime.getInstance();if(!C13317e.J(actor))actor=rt.getInteractor();String action=m.i0(Q(inputs[1]));if(m.O(Q(inputs[2])))InteractionInputBridge.onActionPressed(action,actor,rt.getCameraTransform());else InteractionInputBridge.onActionReleased(action,actor);done();}
    ...
    public static class ReadableNode extends SimpleAction {
        ...
        public void m0(){GameObject go=Aa.b.b(this,this.f79021a,inputs[0]);if(!C13317e.J(go)&&this.f79021a!=null)go=this.f79021a.h0();boolean open=m.O(Q(inputs[1]));InteractionRegistry.setAttribute(go,"readable_title",m.i0(Q(inputs[2])));InteractionRegistry.setAttribute(go,"readable_text",m.i0(Q(inputs[3])));InteractionRegistry.setAttribute(go,"readable_open",Boolean.valueOf(open));InteractionDispatcher.dispatchCustomEvent(open?"readable_opened":"readable_closed",go,open?InteractionRegistry.getAttribute(go,"readable_text"):null);done();}
