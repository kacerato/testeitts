...
public final class ExtendedGameplayNodes {
    ...
    public static class TeleportObjectNode extends NoCodeNode implements F {
        ...
        public void m0(){GameObject obj=Aa.b.b(this,this.f79021a,inputs[0]);GameObject dest=Aa.b.b(this,this.f79021a,inputs[1]);if(!C13317e.J(obj)||!C13317e.J(dest)||obj.J0()==null||dest.J0()==null||dest.J0().J0()==null){u(outputs[1]);return;}Vector3 p=dest.J0().J0();obj.J0().f79337l.f(new Vector3(p.getX(),p.getY()+m.V(Q(inputs[2])),p.getZ()));InteractionDispatcher.dispatchCustomEvent("teleported",obj,dest);u(outputs[0]);}
    ...
    public static class SequenceNode extends NoCodeNode implements F {
        ...
        public void m0(){GameObject owner=Aa.b.b(this,this.f79021a,inputs[0]);if(!C13317e.J(owner)&&this.f79021a!=null)owner=this.f79021a.h0();if(m.S(Q(inputs[4]))){InteractionSequenceService.reset(owner);y0(outputs[3],Float.valueOf(0));u(outputs[0]);return;}InteractionSequenceService.StepResult r=InteractionSequenceService.submit(owner,m.Y(Q(inputs[1])),m.Y(Q(inputs[2])),m.S(Q(inputs[3])));y0(outputs[3],Float.valueOf(r.nextIndex));if(r.completed)u(outputs[2]);else u(r.correct?outputs[0]:outputs[1]);}
    ...
    public static class InteractionGateNode extends NoCodeNode implements F {
        ...
        public void m0(){boolean a=m.S(Q(inputs[0])),b=m.S(Q(inputs[1])),c=m.S(Q(inputs[2])),d=m.S(Q(inputs[3]));String mode=m.Y(Q(inputs[4]));boolean result="Any".equalsIgnoreCase(mode)?a||b||c||d:a&&b&&c&&d;y0(outputs[2],Boolean.valueOf(result));u(result?outputs[0]:outputs[1]);}
    ...
    public static class ReversibleInteractionNode extends SimpleAction {
        ...
        public void m0(){GameObject go=Aa.b.b(this,this.f79021a,inputs[0]);if(!C13317e.J(go)&&this.f79021a!=null)go=this.f79021a.h0();boolean reverse=m.S(Q(inputs[1]));InteractionRegistry.setAttribute(go,"interaction_reversed",Boolean.valueOf(reverse));InteractionDispatcher.dispatchCustomEvent("interaction_reversed",go,Boolean.valueOf(reverse));done();}
    ...
    public static class FeedbackNode extends SimpleAction {
        ...
        public void m0(){GameObject target=Aa.b.b(this,this.f79021a,inputs[0]);String type=m.Y(Q(inputs[1]));String text=m.Y(Q(inputs[2]));float value=m.V(Q(inputs[3]));if("Crosshair".equalsIgnoreCase(type))InteractionPromptController.setCrosshair(text);else if("Progress".equalsIgnoreCase(type))InteractionPromptController.setProgress(value);else InteractionDispatcher.dispatchCustomEvent("feedback_"+(type==null?"generic":type.trim().toLowerCase()),target,text!=null?text:Float.valueOf(value));done();}
