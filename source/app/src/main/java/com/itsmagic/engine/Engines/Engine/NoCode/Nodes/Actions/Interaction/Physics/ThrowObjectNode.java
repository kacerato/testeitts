...
/**
 * Arremessa o objeto atualmente segurado aplicando forca direcional real via GrabService.
 */
public class ThrowObjectNode extends NoCodeNode implements F {
    ...
    public void m0() {
        ...
        Vector3 customDir = (dirObj instanceof Vector3) ? (Vector3) dirObj : null;

        GrabService.throwObject(interactor, customDir, force > 0f ? force : 10.0f);
        u(this.outputs[0]);
    }
