...
public final class AdvancedWorldInteractionNodes {
    ...
    public static class ConfigureLockNode extends NoCodeNode implements F {
        ...
        public void m0(){GameObject target=target();LockService.configureKey(target,m.Y(Q(inputs[1])));LockService.configureCode(target,m.Y(Q(inputs[2])));u(outputs[0]);}
    ...
    public static class TryUnlockNode extends NoCodeNode implements F {
        ...
        public void m0(){
            ...
            InteractionResult r=LockService.tryUnlock(target,actor,m.Y(Q(inputs[2])),m.Y(Q(inputs[3])),m.S(Q(inputs[4])));
    ...
    public static class LadderInteractionNode extends NoCodeNode implements F {
        ...
        public void m0(){GameObject actor=Aa.b.b(this,f79021a,inputs[0]);if(!C13317e.J(actor))actor=InteractionRuntime.getInstance().getInteractor();String action=m.Y(Q(inputs[3]));InteractionResult r;if("Exit".equalsIgnoreCase(action))r=LadderService.exit(actor,Aa.b.b(this,f79021a,inputs[2]));else if("Climb".equalsIgnoreCase(action)||"Move".equalsIgnoreCase(action))r=LadderService.climb(actor,m.V(Q(inputs[4])));else r=LadderService.enter(actor,Aa.b.b(this,f79021a,inputs[1]));y0(outputs[3],r.failureReason.name());if(r.success)u(outputs[0]);else if(r.failureReason==InteractionResult.FailureReason.Occupied)u(outputs[1]);else u(outputs[2]);}
    ...
    public static class VehicleInteractionNode extends NoCodeNode implements F {
        ...
        public void m0(){
            ...
            GameObject vehicle=Aa.b.b(this,f79021a,inputs[1]);GameObject seat=Aa.b.b(this,f79021a,inputs[2]);String action=m.Y(Q(inputs[4]));InteractionResult r;
    ...
    public static class PowerNetworkNode extends NoCodeNode implements F {
        ...
        public void m0(){GameObject source=Aa.b.b(this,f79021a,inputs[0]);GameObject target=Aa.b.b(this,f79021a,inputs[1]);if(m.S(Q(inputs[2])))PowerService.connect(source,target);else PowerService.disconnect(target);y0(outputs[1],Boolean.valueOf(InteractionRegistry.isPowered(target)));u(outputs[0]);}
