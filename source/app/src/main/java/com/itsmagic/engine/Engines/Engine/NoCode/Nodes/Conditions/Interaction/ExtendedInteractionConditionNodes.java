...
public final class ExtendedInteractionConditionNodes {
    ...
    public static class IsEnabledNode extends BaseCondition {
        ...
        public IsEnabledNode() { this.serializedNodeType = SERIALIZED_NAME; }
        public NoCodeSlot[] F() { return inputs; }
        public void m0() { emit(InteractionRegistry.isEnabled(target())); }
        private GameObject target() { GameObject go = Aa.b.b(this, this.f79021a, inputs[0]); if (!C13317e.J(go) && this.f79021a != null) go = this.f79021a.h0(); return go; }
        public String N(NoCodeData d) { return "Interaction Enabled?"; } public String x(NoCodeData d) { return N(d); } public String a(int i, H t) { return i == 0 ? "owner" : ""; }
    }
    ...
    public static class HasTagNode extends BaseCondition {
        ...
        static { o.a(new Factory()); }
        public HasTagNode() { this.serializedNodeType = SERIALIZED_NAME; }
        public NoCodeSlot[] F() { return inputs; }
        public void m0() { GameObject go = Aa.b.b(this, this.f79021a, inputs[0]); if (!C13317e.J(go) && this.f79021a != null) go = this.f79021a.h0(); emit(InteractionRegistry.hasTag(go, m.Y(Q(inputs[1])))); }
        public String N(NoCodeData d) { return "Target Has Interaction Tag"; } public String x(NoCodeData d) { return N(d); } public String a(int i, H t) { if (i == 0) return "owner"; if (i == 1) return "tag"; return ""; }
    }
    ...
    public static class IsBusyNode extends BaseCondition {
        ...
        static { o.a(new Factory()); }
        public IsBusyNode() { this.serializedNodeType = SERIALIZED_NAME; }
        public NoCodeSlot[] F() { return inputs; }
        public void m0() { GameObject go = Aa.b.b(this, this.f79021a, inputs[0]); if (!C13317e.J(go) && this.f79021a != null) go = this.f79021a.h0(); emit(InteractionRegistry.isBusy(go)); }
        public String N(NoCodeData d) { return "Is Interaction Busy"; } public String x(NoCodeData d) { return N(d); } public String a(int i, H t) { return i == 0 ? "owner" : ""; }
    }
    ...
    public static class IsHeldNode extends BaseCondition {
        ...
        static { o.a(new Factory()); }
        public IsHeldNode() { this.serializedNodeType = SERIALIZED_NAME; }
        public NoCodeSlot[] F() { return inputs; }
        public void m0() { GameObject go = Aa.b.b(this, this.f79021a, inputs[0]); if (!C13317e.J(go) && this.f79021a != null) go = this.f79021a.h0(); emit(InteractionRegistry.isHeld(go)); }
        public String N(NoCodeData d) { return "Is Held"; } public String x(NoCodeData d) { return N(d); } public String a(int i, H t) { return i == 0 ? "owner" : ""; }
    }
    ...
    public static class IsPoweredNode extends BaseCondition {
        ...
        static { o.a(new Factory()); }
        public IsPoweredNode() { this.serializedNodeType = SERIALIZED_NAME; }
        public NoCodeSlot[] F() { return inputs; }
        public void m0() { GameObject go = Aa.b.b(this, this.f79021a, inputs[0]); if (!C13317e.J(go) && this.f79021a != null) go = this.f79021a.h0(); emit(InteractionRegistry.isPowered(go)); }
        public String N(NoCodeData d) { return "Is Powered"; } public String x(NoCodeData d) { return N(d); } public String a(int i, H t) { return i == 0 ? "owner" : ""; }
    }
    ...
    public static class CompareStateNode extends BaseCondition {
        ...
        static { o.a(new Factory()); }
        public CompareStateNode() { this.serializedNodeType = SERIALIZED_NAME; }
        public NoCodeSlot[] F() { return inputs; }
        public void m0() { GameObject go = Aa.b.b(this, this.f79021a, inputs[0]); if (!C13317e.J(go) && this.f79021a != null) go = this.f79021a.h0(); InteractionState desired = InteractionState.fromString(m.Y(Q(inputs[1]))); emit(desired != null && InteractionRegistry.getState(go) == desired); }
    ...
    public static class CooldownReadyNode extends BaseCondition {
        ...
        static { o.a(new Factory()); }
        public CooldownReadyNode() { this.serializedNodeType = SERIALIZED_NAME; }
        public NoCodeSlot[] F() { return inputs; }
        public void m0() { GameObject go = Aa.b.b(this, this.f79021a, inputs[0]); if (!C13317e.J(go) && this.f79021a != null) go = this.f79021a.h0(); emit(InteractionCooldownManager.isReady(go, m.Y(Q(inputs[1])))); }
        public String N(NoCodeData d) { return "Interaction Cooldown Ready"; } public String x(NoCodeData d) { return N(d); } public String a(int i, H t) { if (i == 0) return "owner"; if (i == 1) return "interact"; return ""; }
    }
    ...
    public static class IsTargetInRangeNode extends BaseCondition {
        ...
        static { o.a(new Factory()); }
        public IsTargetInRangeNode() { this.serializedNodeType = SERIALIZED_NAME; }
        public NoCodeSlot[] F() { return inputs; }
        public void m0() {
            ...
            float max = m.V(Q(inputs[2]));
            boolean value = false;
            if (C13317e.J(actor) && C13317e.J(target) && actor.J0() != null && target.J0() != null) {
                Vector3 a = actor.J0().J0(); Vector3 b = target.J0().J0();
    ...
    public static class HasRequiredItemNode extends BaseCondition {
        ...
        static { o.a(new Factory()); }
        public HasRequiredItemNode() { this.serializedNodeType = SERIALIZED_NAME; }
        public NoCodeSlot[] F() { return inputs; }
        public void m0() { GameObject actor = Aa.b.b(this, this.f79021a, inputs[0]); if (!C13317e.J(actor)) actor = InteractionRuntime.getInstance().getInteractor(); String tag = m.Y(Q(inputs[1])); boolean has = C13317e.J(actor) && tag != null && (InteractionRegistry.hasTag(actor, tag) || InteractionRegistry.getAttribute(actor, "has_item_" + tag.trim().toLowerCase()) != null); emit(has); }
