...
public class ExpansionsViewGroupRelativeLayout extends LinearLayout {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        if (attributeSet == null || (obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ExpansionsViewGroupRelativeLayout)) == null) {
            return;
        }
        this.expansionViewGroupManager.setOpenOnlyOne(obtainStyledAttributes.getBoolean(R.styleable.ExpansionsViewGroupRelativeLayout_expansion_openOnlyOne, false));
