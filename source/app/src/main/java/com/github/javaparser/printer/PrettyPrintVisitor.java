...
public class PrettyPrintVisitor implements VoidVisitor<Void> {
    ...
    public PrettyPrintVisitor(PrettyPrinterConfiguration prettyPrinterConfiguration) {
        ...
        this.printer = new SourcePrinter(prettyPrinterConfiguration);
    }
    ...
    public void lambda$printComment$0(final Void arg, Comment c10) {
        c10.accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    }

    public void lambda$visit$1(final Void arg, ModuleDeclaration m10) {
        m10.accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    }

    public void lambda$visit$10(final Void arg, Type t10) {
        t10.accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    }

    public void lambda$visit$11(SimpleName l10) {
        this.printer.print(" ").print(l10.getIdentifier());
    }

    public static boolean lambda$visit$12(EnumConstantDeclaration e10) {
    ...
    public static int lambda$visit$14(ImportDeclaration importDeclaration) {
    ...
    public void lambda$visit$5(final VariableDeclarator n10, final Void arg, NodeWithVariables ancestor) {
        ancestor.getMaximumCommonType().ifPresent(new Consumer() {
            ...
            public final void accept(Object obj) {
                PrettyPrintVisitor.this.lambda$null$4(n10, arg, (Type) obj);
            }
        });
    }

    public void lambda$visit$6(String line) {
        this.printer.println();
        this.printer.print(line);
    }

    public static Boolean lambda$visit$7(Statement p10) {
        return Boolean.valueOf(p10.isReturnStmt() || p10.isThrowStmt() || p10.isAssertStmt() || p10.isExpressionStmt());
    }

    public void lambda$visit$8(final Void arg, final AtomicBoolean columnAlignFirstMethodChain, final AtomicBoolean methodCallWithScopeInScope, final AtomicBoolean lastMethodInCallChain, Expression scope) {
        scope.accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    ...
    public void lambda$visit$9(final Void arg, final MethodDeclaration n10, ReceiverParameter rp) {
        rp.accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    ...
    private void printOrphanCommentsEnding(final Node node) {
        ...
        List list = (List) node.getChildNodes().stream().filter(new Predicate() {
            @Override
        ...
        while (z10 && i10 < list.size()) {
            z10 = ((Node) list.get((list.size() - 1) - i10)) instanceof Comment;
            if (z10) {
                i10++;
            }
        }
        for (int i11 = 0; i11 < i10; i11++) {
            ((Node) list.get((list.size() - i10) + i11)).accept(this, (PrettyPrintVisitor) null);
        }
    }
    ...
    private void printSwitchNode(SwitchNode n10, Void arg) {
        ...
        n10.getSelector().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.println(") {");
        if (n10.getEntries() != null) {
            indentIf(this.configuration.isIndentCaseInSwitch());
            Iterator<SwitchEntry> it = n10.getEntries().iterator();
            while (it.hasNext()) {
                it.next().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
            }
            unindentIf(this.configuration.isIndentCaseInSwitch());
        }
    ...
    public <T extends Expression> void printArguments(final NodeList<T> args, final Void arg) {
        ...
        if (!Utils.isNullOrEmpty(args)) {
            boolean z10 = args.size() > 1 && this.configuration.isColumnAlignParameters();
            if (z10) {
    ...
    public void printComment(final Optional<Comment> comment, final Void arg) {
        comment.ifPresent(new Consumer() {
            @Override
            public final void accept(Object obj) {
                PrettyPrintVisitor.this.lambda$printComment$0(arg, (Comment) obj);
            }
        });
    }
    ...
    public void printMembers(final NodeList<BodyDeclaration<?>> members, final Void arg) {
        ...
        while (it.hasNext()) {
            ...
            this.printer.println();
            next.accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
            this.printer.println();
        }
    }
    ...
    public void visit(final CompilationUnit n10, final Void arg) {
        ...
        if (n10.getPackageDeclaration().isPresent()) {
            n10.getPackageDeclaration().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        }
        n10.getImports().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        if (!n10.getImports().isEmpty()) {
            this.printer.println();
        }
        ...
        n10.getModule().ifPresent(new Consumer() {
            @Override
            public final void accept(Object obj) {
                PrettyPrintVisitor.this.lambda$visit$1(arg, (ModuleDeclaration) obj);
            }
        });
    ...
    public void visit(final PackageDeclaration n10, final Void arg) {
        ...
        n10.getName().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.println(";");
        this.printer.println();
        printOrphanCommentsEnding(n10);
    }
    ...
    public void visit(final Name n10, final Void arg) {
        ...
        if (n10.getQualifier().isPresent()) {
            n10.getQualifier().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
            this.printer.print(".");
        }
    ...
    public void visit(final ClassOrInterfaceDeclaration n10, final Void arg) {
        ...
        if (!n10.getImplementedTypes().isEmpty()) {
            ...
            while (it2.hasNext()) {
                it2.next().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
                if (it2.hasNext()) {
                    this.printer.print(", ");
                }
            }
        ...
        if (!n10.getPermittedTypes().isEmpty()) {
            ...
            while (it3.hasNext()) {
                it3.next().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
                if (it3.hasNext()) {
                    this.printer.print(", ");
                }
            }
    ...
    public void visit(final JavadocComment n10, final Void arg) {
        ...
        if (this.configuration.isPrintComments() && this.configuration.isPrintJavadoc()) {
            ...
            String[] split = Utils.normalizeEolInTextBlock(n10.getContent(), this.configuration.getEndOfLineCharacter()).split("\\R");
            ...
            boolean anyMatch = arrayList.stream().anyMatch(new Predicate() {
                ...
                public final boolean test(Object obj) {
                    ...
                    lambda$visit$2 = PrettyPrintVisitor.lambda$visit$2((String) obj);
    ...
    public void visit(final ClassOrInterfaceType n10, final Void arg) {
        ...
        if (n10.getScope().isPresent()) {
            n10.getScope().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
            this.printer.print(".");
        }
    ...
    public void visit(ArrayType arrayType, Void r42) {
        ...
        visitable.accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) r42);
    ...
    public void visit(final ArrayCreationLevel n10, final Void arg) {
        ...
        if (n10.getDimension().isPresent()) {
            n10.getDimension().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        }
        this.printer.print("]");
    }
    ...
    public void visit(final WildcardType n10, final Void arg) {
        ...
        if (n10.getExtendedType().isPresent()) {
            this.printer.print(" extends ");
            n10.getExtendedType().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        }
        if (n10.getSuperType().isPresent()) {
            this.printer.print(" super ");
            n10.getSuperType().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        }
    }
    ...
    public void visit(final FieldDeclaration n10, final Void arg) {
        ...
        if (!n10.getVariables().isEmpty()) {
            ...
            maximumCommonType.ifPresent(new Consumer() {
                @Override
                public final void accept(Object obj) {
                    PrettyPrintVisitor.this.lambda$visit$3(arg, (Type) obj);
                }
            });
    ...
    public void visit(final VariableDeclarator n10, final Void arg) {
        ...
        n10.findAncestor(NodeWithVariables.class).ifPresent(new Consumer() {
            @Override
            public final void accept(Object obj) {
                PrettyPrintVisitor.this.lambda$visit$5(n10, arg, (NodeWithVariables) obj);
            }
        });
        if (n10.getInitializer().isPresent()) {
            this.printer.print(" = ");
            n10.getInitializer().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        }
    }
    ...
    public void visit(final ArrayAccessExpr n10, final Void arg) {
        ...
        n10.getName().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.print("[");
        n10.getIndex().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.print("]");
    }
    ...
    public void visit(final ArrayCreationExpr n10, final Void arg) {
        ...
        n10.getElementType().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    ...
    public void visit(final AssignExpr n10, final Void arg) {
        printOrphanCommentsBeforeThisChildNode(n10);
        printComment(n10.getComment(), arg);
        n10.getTarget().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        ...
        n10.getValue().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    }
    ...
    public void visit(final BinaryExpr n10, final Void arg) {
        printOrphanCommentsBeforeThisChildNode(n10);
        printComment(n10.getComment(), arg);
        n10.getLeft().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        if (this.configuration.isSpaceAroundOperators()) {
            this.printer.print(" ");
        }
        this.printer.print(n10.getOperator().asString());
        ...
        n10.getRight().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    }
    ...
    public void visit(final CastExpr n10, final Void arg) {
        ...
        printComment(n10.getComment(), arg);
        this.printer.print("(");
        n10.getType2().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.print(") ");
        n10.getExpression().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    }
    ...
    public void visit(final ConditionalExpr n10, final Void arg) {
        printOrphanCommentsBeforeThisChildNode(n10);
        printComment(n10.getComment(), arg);
        n10.getCondition().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.print(" ? ");
        n10.getThenExpr().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.print(" : ");
        n10.getElseExpr().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    }
    ...
    public void visit(final EnclosedExpr n10, final Void arg) {
        ...
        printComment(n10.getComment(), arg);
        this.printer.print("(");
        n10.getInner().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.print(")");
    }
    ...
    public void visit(final FieldAccessExpr n10, final Void arg) {
        printOrphanCommentsBeforeThisChildNode(n10);
        printComment(n10.getComment(), arg);
        n10.getScope().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.print(".");
        n10.getName().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    }
    ...
    public void visit(final InstanceOfExpr n10, final Void arg) {
        ...
        if (n10.getPattern().isPresent()) {
            n10.getPattern().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        } else {
            n10.getType2().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        }
    }
    ...
    public void visit(final TextBlockLiteralExpr n10, final Void arg) {
        ...
        n10.stripIndentOfLines().forEach(new Consumer() {
            @Override
            public final void accept(Object obj) {
                PrettyPrintVisitor.this.lambda$visit$6((String) obj);
            }
        });
        this.printer.print("\"\"\"");
        this.printer.unindent();
    ...
    public void visit(final ThisExpr n10, final Void arg) {
        ...
        if (n10.getTypeName().isPresent()) {
            n10.getTypeName().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
            this.printer.print(".");
        }
    ...
    public void visit(final MethodCallExpr n10, final Void arg) {
        ...
        if (this.configuration.isColumnAlignFirstMethodChain() && ((Boolean) n10.findAncestor(Statement.class).map(new Function() {
            @Override
            public final Object apply(Object obj) {
                Boolean lambda$visit$7;
                lambda$visit$7 = PrettyPrintVisitor.lambda$visit$7((Statement) obj);
        ...
        n10.getScope().ifPresent(new Consumer() {
            @Override
            public final void accept(Object obj) {
                PrettyPrintVisitor.this.lambda$visit$8(arg, atomicBoolean, atomicBoolean3, atomicBoolean2, (Expression) obj);
            }
        });
        printTypeArgs(n10, arg);
        n10.getName().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    ...
    public void visit(final ConstructorDeclaration n10, final Void arg) {
        ...
        this.printer.print(" ");
        n10.getBody().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    }
    ...
    public void visit(final MethodDeclaration n10, final Void arg) {
        ...
        n10.getReceiverParameter().ifPresent(new Consumer() {
            @Override
            public final void accept(Object obj) {
                PrettyPrintVisitor.this.lambda$visit$9(arg, n10, (ReceiverParameter) obj);
            }
        });
        if (!Utils.isNullOrEmpty(n10.getParameters())) {
            Iterator<Parameter> it = n10.getParameters().iterator();
        ...
        if (!n10.getBody().isPresent()) {
            ...
            this.printer.print(" ");
            n10.getBody().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        }
    }
    ...
    public void visit(final ExplicitConstructorInvocationStmt n10, final Void arg) {
        ...
        if (n10.isThis()) {
            ...
            if (n10.getExpression().isPresent()) {
                n10.getExpression().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
                this.printer.print(".");
            }
            printTypeArgs(n10, arg);
            this.printer.print("super");
    ...
    public void visit(final VariableDeclarationExpr n10, final Void arg) {
        ...
        if (!n10.getVariables().isEmpty()) {
            n10.getMaximumCommonType().ifPresent(new Consumer() {
                @Override
                public final void accept(Object obj) {
                    PrettyPrintVisitor.this.lambda$visit$10(arg, (Type) obj);
                }
            });
        }
        this.printer.print(" ");
    ...
    public void visit(final LocalClassDeclarationStmt n10, final Void arg) {
        printOrphanCommentsBeforeThisChildNode(n10);
        printComment(n10.getComment(), arg);
        n10.getClassDeclaration().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    }
    ...
    public void visit(final LocalRecordDeclarationStmt n10, final Void arg) {
        printOrphanCommentsBeforeThisChildNode(n10);
        printComment(n10.getComment(), arg);
        n10.getRecordDeclaration().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    }
    ...
    public void visit(final AssertStmt n10, final Void arg) {
        ...
        n10.getCheck().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        if (n10.getMessage().isPresent()) {
            this.printer.print(" : ");
            n10.getMessage().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        }
        this.printer.print(";");
    }
    ...
    public void visit(final LabeledStmt n10, final Void arg) {
        printOrphanCommentsBeforeThisChildNode(n10);
        printComment(n10.getComment(), arg);
        n10.getLabel().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.print(": ");
        n10.getStatement().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    }
    ...
    public void visit(final SwitchEntry n10, final Void arg) {
        ...
        if (Utils.isNullOrEmpty(n10.getLabels())) {
            ...
            if (n10.getGuard().isPresent()) {
                ...
                n10.getGuard().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
            }
    ...
    public void visit(final BreakStmt n10, final Void arg) {
        ...
        n10.getLabel().ifPresent(new Consumer() {
            @Override
            public final void accept(Object obj) {
                PrettyPrintVisitor.this.lambda$visit$11((SimpleName) obj);
            }
        });
        this.printer.print(";");
    }
    ...
    public void visit(final EnumDeclaration n10, final Void arg) {
        ...
        if (n10.getEntries().isNonEmpty()) {
            boolean z10 = n10.getEntries().size() > this.configuration.getMaxEnumConstantsToAlignHorizontally() || n10.getEntries().stream().anyMatch(new Predicate() {
                @Override
                public final boolean test(Object obj) {
                    boolean lambda$visit$12;
                    lambda$visit$12 = PrettyPrintVisitor.lambda$visit$12((EnumConstantDeclaration) obj);
    ...
    public void visit(final IfStmt n10, final Void arg) {
        ...
        n10.getThenStmt().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        if (!z10) {
            this.printer.unindent();
        }
        if (n10.getElseStmt().isPresent()) {
            ...
            if (n10.getElseStmt().isPresent()) {
                n10.getElseStmt().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
            }
            if (z11 || z12) {
                return;
            }
    ...
    public void visit(final ContinueStmt n10, final Void arg) {
        ...
        n10.getLabel().ifPresent(new Consumer() {
            @Override
            public final void accept(Object obj) {
                PrettyPrintVisitor.this.lambda$visit$13((SimpleName) obj);
            }
        });
        this.printer.print(";");
    }
    ...
    public void visit(final ForEachStmt n10, final Void arg) {
        ...
        n10.getVariable().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.print(" : ");
        n10.getIterable().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.print(") ");
        n10.getBody().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    }
    ...
    public void visit(final ForStmt n10, final Void arg) {
        ...
        if (n10.getCompare().isPresent()) {
            n10.getCompare().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        }
        this.printer.print(VectorFormat.DEFAULT_SEPARATOR);
    ...
    public void visit(final TryStmt n10, final Void arg) {
        ...
        n10.getTryBlock().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        ...
        if (n10.getFinallyBlock().isPresent()) {
            ...
            n10.getFinallyBlock().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        }
    }
    ...
    public void visit(final CatchClause n10, final Void arg) {
        ...
        n10.getParameter().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.print(") ");
        n10.getBody().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
    }
    ...
    public void visit(final AnnotationMemberDeclaration n10, final Void arg) {
        ...
        if (n10.getDefaultValue().isPresent()) {
            this.printer.print(" default ");
            n10.getDefaultValue().get().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        }
        this.printer.print(";");
    }
    ...
    public void visit(final SingleMemberAnnotationExpr n10, final Void arg) {
        ...
        n10.getName().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.print("(");
        n10.getMemberValue().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        this.printer.print(")");
    }
    ...
    public void visit(final BlockComment n10, final Void arg) {
        ...
        String[] split = Utils.normalizeEolInTextBlock(n10.getContent(), this.configuration.getEndOfLineCharacter()).split("\\R", -1);
    ...
    public void visit(LambdaExpr n10, Void arg) {
        ...
        if (body instanceof ExpressionStmt) {
            ((ExpressionStmt) body).getExpression().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        } else {
            body.accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        }
    }
    ...
    public void visit(NodeList n10, Void arg) {
        if (this.configuration.isOrderImports() && n10.size() > 0 && (n10.get(0) instanceof ImportDeclaration)) {
            NodeList nodeList = new NodeList(n10);
            nodeList.sort(Comparator.comparingInt(new ToIntFunction() {
                @Override
                public final int applyAsInt(Object obj) {
                    int lambda$visit$14;
                    lambda$visit$14 = PrettyPrintVisitor.lambda$visit$14((ImportDeclaration) obj);
                    return lambda$visit$14;
                }
            }).thenComparing(new P()));
            Iterator it = nodeList.iterator();
            while (it.hasNext()) {
                ((Node) it.next()).accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
            }
            return;
        }
        Iterator it2 = n10.iterator();
        while (it2.hasNext()) {
            ((Node) it2.next()).accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
        }
    }
    ...
    public void visit(ModuleDeclaration n10, Void arg) {
        ...
        n10.getDirectives().accept((VoidVisitor<PrettyPrintVisitor>) this, (PrettyPrintVisitor) arg);
