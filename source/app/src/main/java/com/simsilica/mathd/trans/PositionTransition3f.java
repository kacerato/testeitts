...
public class PositionTransition3f implements Transition<PositionTransition3f> {
    ...
    public PositionTransition3f(long j10, Vector3f vector3f, Quaternion quaternion, boolean z10) {
        this.endTime = j10;
    ...
    public static TransitionBuffer<PositionTransition3f> createBuffer(int i10) {
    ...
    public String toString() {
        return "PositionTransition3f[ t:" + this.startTime + ", pos:" + ((Object) this.startPos) + ", rot:" + ((Object) this.startRot) + ", vis:" + this.startVisible + " -> t:" + this.endTime + ", pos:" + ((Object) this.endPos) + ", rot:" + ((Object) this.endRot) + ", vis:" + this.endVisible + " ]";
    }
    ...
    @Override
    public void setPreviousTransition(PositionTransition3f positionTransition3f) {
        long j10 = positionTransition3f.endTime;
        this.startTime = j10;
        this.startPos = positionTransition3f.endPos;
        this.startRot = positionTransition3f.endRot;
        this.startVisible = positionTransition3f.endVisible;
        if (j10 > this.endTime) {
            throw new IllegalArgumentException("Frame transitions cannot go backwards.");
        }
    }

    public PositionTransition3f(long j10, Vec3d vec3d, Quatd quatd, boolean z10) {
        this.endTime = j10;
