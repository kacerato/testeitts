...
public class C6330Zr extends AbstractC6216Xr implements InterfaceC5484La {
    public C6330Zr(int i10, C5693Op c5693Op, C4785x5 c4785x5) {
    ...
    public C6330Zr(int i10, C4554l1 c4554l1) {
        super(i10, c4554l1);
    }
    ...
    public final InterfaceC5404Jp a(C4554l1 c4554l1) {
        C6330Zr c6330Zr = new C6330Zr(this.f45540f, c4554l1);
        c6330Zr.e(u());
        return c6330Zr;
    }
}
