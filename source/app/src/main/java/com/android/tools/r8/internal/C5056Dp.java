...
public class C5056Dp extends AbstractC5346Ip implements InterfaceC5368Ja {
    public C5056Dp(int i10, C5693Op c5693Op, C4785x5 c4785x5) {
    ...
    public C5056Dp(int i10, int i11, C4554l1 c4554l1) {
    ...
    public final InterfaceC5404Jp a(C4554l1 c4554l1) {
        C5056Dp c5056Dp = new C5056Dp(this.f46869f, this.f46870g, c4554l1);
        c5056Dp.e(u());
        return c5056Dp;
    }
}
