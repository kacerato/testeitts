...
public class C5062Ds extends AbstractC5981To {
    public C5062Ds(int i10, C5693Op c5693Op) {
        super(i10, c5693Op);
    }
    ...
    public C5062Ds(int i10) {
        super(i10);
    }

    @Override
    public final void a(C6382aB c6382aB) {
        c6382aB.a(c6382aB.f46462u.g(), new C5698Or0(c6382aB.b(this.f44594f, EnumC5592Mw0.f42461b)));
        c6382aB.b();
    }
    ...
    public final void a(C4766w5 c4766w5, com.android.tools.r8.graph.H5 h52, AbstractC5308Hz abstractC5308Hz, AbstractC5308Hz abstractC5308Hz2, RR rr, ShortBuffer shortBuffer) {
        AbstractC5635Np.a(this.f44594f, 39, shortBuffer);
    }
}
