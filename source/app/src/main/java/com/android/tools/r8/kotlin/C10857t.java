...
public final class C10857t extends AbstractC10877x {

    public final String f55466a;

    public C10857t(String str) {
        this.f55466a = str;
    }
    ...
    @Override
    public final boolean a(C10420yQ c10420yQ, C4798y c4798y) {
        c10420yQ.f54009b = new AbstractC6750cQ.b(this.f55466a);
        return false;
    }
}
