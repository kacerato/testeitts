...
public class C8992ps extends AbstractC6216Xr {
    public C8992ps(int i10, C5693Op c5693Op, C4785x5 c4785x5) {
    ...
    public C8992ps(int i10, C4554l1 c4554l1) {
        super(i10, c4554l1);
    }
    ...
    public final InterfaceC5404Jp a(C4554l1 c4554l1) {
        C8992ps c8992ps = new C8992ps(this.f45540f, c4554l1);
        c8992ps.e(u());
        return c8992ps;
    }
}
