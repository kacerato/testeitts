...
public class C5633No extends AbstractC6039Uo {
    public C5633No(int i10, C5693Op c5693Op) {
        super(i10, c5693Op);
    }
    ...
    public C5633No(int i10, int i11) {
        super(i10, i11);
    }

    @Override
    public final void a(C6382aB c6382aB) {
        c6382aB.a(T10.f44372h, T10.f44371g, this.f44876f, this.f44877g);
    }
}
