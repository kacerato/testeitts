...
public class C5172Fp extends AbstractC5346Ip implements InterfaceC5368Ja {
    public C5172Fp(int i10, C5693Op c5693Op, C4785x5 c4785x5) {
    ...
    public C5172Fp(int i10, int i11, C4554l1 c4554l1) {
    ...
    public final InterfaceC5404Jp a(C4554l1 c4554l1) {
        C5172Fp c5172Fp = new C5172Fp(this.f46869f, this.f46870g, c4554l1);
        c5172Fp.e(u());
        return c5172Fp;
    }
}
