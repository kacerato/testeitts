...
public class C9486sq extends AbstractC5346Ip {
    public C9486sq(int i10, C5693Op c5693Op, C4785x5 c4785x5) {
    ...
    public C9486sq(int i10, int i11, C4554l1 c4554l1) {
    ...
    public final InterfaceC5404Jp a(C4554l1 c4554l1) {
        C9486sq c9486sq = new C9486sq(this.f46869f, this.f46870g, c4554l1);
        c9486sq.e(u());
        return c9486sq;
    }
}
