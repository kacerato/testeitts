...
public class C5114Ep extends AbstractC5346Ip implements InterfaceC5368Ja {
    public C5114Ep(int i10, C5693Op c5693Op, C4785x5 c4785x5) {
    ...
    public C5114Ep(int i10, int i11, C4554l1 c4554l1) {
    ...
    public final InterfaceC5404Jp a(C4554l1 c4554l1) {
        C5114Ep c5114Ep = new C5114Ep(this.f46869f, this.f46870g, c4554l1);
        c5114Ep.e(u());
        return c5114Ep;
    }
}
