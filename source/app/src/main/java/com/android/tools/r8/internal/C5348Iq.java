...
public class C5348Iq extends AbstractC5981To {
    public C5348Iq(int i10, C5693Op c5693Op) {
        super(i10, c5693Op);
    }
    ...
    public C5348Iq(int i10) {
        super(i10);
    }

    @Override
    public final void a(C6382aB c6382aB) {
        c6382aB.b(this.f44594f);
    }
    ...
    public final void a(C4766w5 c4766w5, com.android.tools.r8.graph.H5 h52, AbstractC5308Hz abstractC5308Hz, AbstractC5308Hz abstractC5308Hz2, RR rr, ShortBuffer shortBuffer) {
        AbstractC5635Np.a(this.f44594f, 13, shortBuffer);
    }
}
