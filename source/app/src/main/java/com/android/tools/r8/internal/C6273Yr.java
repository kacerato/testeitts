...
public class C6273Yr extends AbstractC6216Xr implements InterfaceC5484La {
    public C6273Yr(int i10, C5693Op c5693Op, C4785x5 c4785x5) {
    ...
    public C6273Yr(int i10, C4554l1 c4554l1) {
        super(i10, c4554l1);
    }
    ...
    public final InterfaceC5404Jp a(C4554l1 c4554l1) {
        C6273Yr c6273Yr = new C6273Yr(this.f45540f, c4554l1);
        c6273Yr.e(u());
        return c6273Yr;
    }
}
