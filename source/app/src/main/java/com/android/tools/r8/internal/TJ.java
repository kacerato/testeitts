...
public final class TJ extends WJ {
    ...
    public static final boolean f44432o = true;

    public TJ(com.android.tools.r8.graph.A2 a22, C10340xw0 c10340xw0, List list) {
    ...
    public final void a(C5458Kn c5458Kn) {
        ...
        if (b(c5458Kn)) {
            ...
            if (!d(c5458Kn) && !e(c5458Kn)) {
                abstractC5635Np = new C6652bq(a10, y22, B2());
            } else {
            ...
            if (!d(c5458Kn) && !e(c5458Kn)) {
                c6269Yp = new C6485aq(a11, B2(), iArr[0], iArr[1], iArr[2], iArr[3], iArr[4]);
            } else {
    ...
    public final boolean b(AbstractC10561zE abstractC10561zE) {
        ...
        return (abstractC10561zE instanceof TJ) && super.b(abstractC10561zE);
    }
    ...
    public final com.android.tools.r8.ir.optimize.O a(com.android.tools.r8.ir.optimize.X x10, com.android.tools.r8.graph.H5 h52) {
        ...
        Z4.c<?> o10 = ((C11245i) x10.f54825a.f()).b(B22, true).o();
    ...
    public final void a(C7543h9 c7543h9) {
        c7543h9.a(new C7437ga(185, B2(), true), this);
    }
    ...
    public final void a(PS ps) {
        ...
        ps.getClass();
        ps.a(185, Collections.singletonList(B22), arrayList);
    }
    ...
    public final boolean a(com.android.tools.r8.graph.M2 m22, com.android.tools.r8.graph.H5 h52, C4798y c4798y, int i10, int i11) {
        ...
        com.android.tools.r8.graph.A2 B22 = B2();
        com.android.tools.r8.graph.Z4 c10 = ((C11245i) c4798y.f()).c(B22.f38297f, B22);
        if (c10.w()) {
            return c4798y.a(c10.s().B0(), m22).d();
        }
        return false;
    }
}
