...
public final class Q0 extends O0 {
    ...
    public final int b(O0 o02, AbstractC8953pf abstractC8953pf) {
        return abstractC8953pf.a(this.f36717d, ((Q0) o02).f36717d);
    }

    @Override
    public final void c(AbstractC9213rA abstractC9213rA) {
        ((C9547tA) abstractC9213rA).f52553a.a(this.f36717d);
    }

    public final int hashCode() {
        return (this.f36717d * 7) + 6;
    }
