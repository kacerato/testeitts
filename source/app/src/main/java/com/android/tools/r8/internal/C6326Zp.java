...
public class C6326Zp extends AbstractC7151eq {
    public C6326Zp(int i10, C5693Op c5693Op, C4785x5 c4785x5) {
    ...
    public C6326Zp(int i10, int i11, com.android.tools.r8.graph.A2 a22) {
        super(i10, i11, a22);
    }

    @Override
    public final void a(C6382aB c6382aB) {
        c6382aB.a(EnumC8071kK.f49580d, b(), (com.android.tools.r8.graph.I2) null, this.f50427f, this.f50428g);
    }

    @Override
    public final InterfaceC6984dq a(com.android.tools.r8.graph.A2 a22) {
        C6326Zp c6326Zp = new C6326Zp(this.f50428g, this.f50427f, a22);
        c6326Zp.e(u());
        return c6326Zp;
    }
}
