...
public class C6045Ur extends AbstractC6216Xr implements InterfaceC5484La {
    public C6045Ur(int i10, C5693Op c5693Op, C4785x5 c4785x5) {
    ...
    public C6045Ur(int i10, C4554l1 c4554l1) {
        super(i10, c4554l1);
    }
    ...
    public final InterfaceC5404Jp a(C4554l1 c4554l1) {
        C6045Ur c6045Ur = new C6045Ur(this.f45540f, c4554l1);
        c6045Ur.e(u());
        return c6045Ur;
    }
}
