...
public final class OpcodeInfo {
    ...
    public static class Info {
        ...
        public Info(int i10, String str, InstructionCodec instructionCodec, IndexType indexType) {
            this.opcode = i10;
            this.name = str;
    ...
    public static Info get(int i10) {
        try {
            Info info = INFO[i10 + 1];
            if (info != null) {
                return info;
            }
        } catch (ArrayIndexOutOfBoundsException unused) {
        }
        throw new IllegalArgumentException("bogus opcode: " + Hex.u2or4(i10));
    }

    public static InstructionCodec getFormat(int i10) {
        return get(i10).getFormat();
    }

    public static IndexType getIndexType(int i10) {
        return get(i10).getIndexType();
    }

    public static String getName(int i10) {
        return get(i10).getName();
    }
