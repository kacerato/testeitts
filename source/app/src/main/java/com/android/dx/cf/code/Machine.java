...
public interface Machine {
    ...
    void auxIntArg(int i10);

    void auxSwitchArg(SwitchList switchList);

    void auxTargetArg(int i10);
    ...
    void localArg(Frame frame, int i10);

    void localInfo(boolean z10);

    void localTarget(int i10, Type type, LocalItem localItem);

    void popArgs(Frame frame, int i10);
    ...
    void run(Frame frame, int i10, int i11);
}
