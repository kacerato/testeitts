...
public class LiteralOpUpgrader {
    ...
    public void replacePlainInsn(NormalSsaInsn normalSsaInsn, RegisterSpecList registerSpecList, int i10, Constant constant) {
        ...
        NormalSsaInsn normalSsaInsn2 = new NormalSsaInsn(constant == null ? new PlainInsn(ropFor, originalRopInsn.getPosition(), normalSsaInsn.getResult(), registerSpecList) : new PlainCstInsn(ropFor, originalRopInsn.getPosition(), normalSsaInsn.getResult(), registerSpecList, constant), normalSsaInsn.getBlock());
