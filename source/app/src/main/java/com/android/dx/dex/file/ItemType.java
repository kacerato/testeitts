...
public enum ItemType implements ToHuman {
    ...
    TYPE_CODE_ITEM(AL.AL_FREQUENCY, "code_item"),
    TYPE_STRING_DATA_ITEM(8194, "string_data_item"),
    TYPE_DEBUG_INFO_ITEM(AL.AL_CHANNELS, "debug_info_item"),
    ...
    ItemType(int i10, String str) {
        this.mapValue = i10;
        this.typeName = str;
        this.humanName = (str.endsWith("_item") ? str.substring(0, str.length() - 5) : str).replace('_', C15883c.f126249O);
    }
