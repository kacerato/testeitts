...
public class ByteOps {
    ...
    static {
        ...
        while (i11 < 2498) {
            int i12 = 16;
            int digit = (Character.digit(OPCODE_DETAILS.charAt(i11), 16) << 4) | Character.digit(OPCODE_DETAILS.charAt(i11 + 1), 16);
            char charAt = OPCODE_DETAILS.charAt(i11 + 3);
            if (charAt == '-') {
                i12 = 1;
            } else if (charAt == 'I') {
                i12 = 13;
            ...
            int i13 = i11 + 5;
            if (OPCODE_DETAILS.charAt(i11 + 4) == ':') {
                while (true) {
                    char charAt2 = OPCODE_DETAILS.charAt(i13);
                    if (charAt2 == 'D') {
                        i10 = i12 | 256;
                    } else if (charAt2 == 'F') {
                        i10 = i12 | 64;
            ...
            int indexOf = OPCODE_DETAILS.indexOf(59, i13);
            OPCODE_INFO[digit] = i12;
            OPCODE_NAMES[digit] = OPCODE_DETAILS.substring(i13, indexOf);
            i11 = indexOf + 1;
        }
    }
    ...
    public static int opInfo(int i10) {
        return OPCODE_INFO[i10];
    }

    public static String opName(int i10) {
        String[] strArr = OPCODE_NAMES;
        String str = strArr[i10];
        if (str != null) {
            return str;
        }
        String str2 = "unused_" + Hex.u1(i10);
        strArr[i10] = str2;
        return str2;
    }
}
