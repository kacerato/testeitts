...
public final class IndexMap {
    ...
    public final class EncodedValueTransformer {
        ...
        private void writeTypeAndArg(int i10, int i11) {
            this.out.writeByte(i10 | (i11 << 5));
        }
    ...
    public int adjustAnnotation(int i10) {
        return this.annotationOffsets.get(Integer.valueOf(i10)).intValue();
    }

    public int adjustAnnotationDirectory(int i10) {
        return this.annotationDirectoryOffsets.get(Integer.valueOf(i10)).intValue();
    }

    public int adjustAnnotationSet(int i10) {
        return this.annotationSetOffsets.get(Integer.valueOf(i10)).intValue();
    }

    public int adjustAnnotationSetRefList(int i10) {
        return this.annotationSetRefListOffsets.get(Integer.valueOf(i10)).intValue();
    }
    ...
    public int adjustField(int i10) {
        return this.fieldIds[i10] & 65535;
    }

    public int adjustMethod(int i10) {
        return this.methodIds[i10] & 65535;
    }

    public int adjustProto(int i10) {
        return this.protoIds[i10] & 65535;
    }

    public int adjustStaticValues(int i10) {
        return this.staticValuesOffsets.get(Integer.valueOf(i10)).intValue();
    }
    ...
    public int adjustTypeListOffset(int i10) {
        return this.typeListOffsets.get(Integer.valueOf(i10)).intValue();
    }
    ...
    public void putAnnotationDirectoryOffset(int i10, int i11) {
        ...
        this.annotationDirectoryOffsets.put(Integer.valueOf(i10), Integer.valueOf(i11));
    }
    ...
    public void putAnnotationOffset(int i10, int i11) {
        ...
        this.annotationOffsets.put(Integer.valueOf(i10), Integer.valueOf(i11));
    }
    ...
    public void putAnnotationSetOffset(int i10, int i11) {
        ...
        this.annotationSetOffsets.put(Integer.valueOf(i10), Integer.valueOf(i11));
    }
    ...
    public void putAnnotationSetRefListOffset(int i10, int i11) {
        ...
        this.annotationSetRefListOffsets.put(Integer.valueOf(i10), Integer.valueOf(i11));
    }

    public void putStaticValuesOffset(int i10, int i11) {
        if (i10 <= 0 || i11 <= 0) {
            throw new IllegalArgumentException();
        }
        this.staticValuesOffsets.put(Integer.valueOf(i10), Integer.valueOf(i11));
    }
    ...
    public void putTypeListOffset(int i10, int i11) {
        ...
        this.typeListOffsets.put(Integer.valueOf(i10), Integer.valueOf(i11));
    }
