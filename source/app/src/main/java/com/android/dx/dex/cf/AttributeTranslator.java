...
public class AttributeTranslator {
    ...
    public static Annotations getClassAnnotations(DirectClassFile directClassFile, CfOptions cfOptions) {
        ...
        try {
            ...
            cfOptions.warn.println("warning: " + e10.getMessage());
        }
    ...
    private static Annotations translateInnerClasses(CstType cstType, AttributeList attributeList, boolean z10) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            InnerClassList.Item item2 = innerClasses.get(i10);
        ...
        if (size2 != 0) {
            ...
            for (int i11 = 0; i11 < size2; i11++) {
                stdTypeList.set(i11, (Type) arrayList.get(i11));
            }
