...
public final class CstType extends TypedConstant {
    ...
    private static final ConcurrentMap<Type, CstType> interns = new ConcurrentHashMap(1000, 0.75f, 4);
    ...
    public static CstType forBoxedPrimitiveType(Type type) {
        switch (type.getBasicType()) {
            ...
            case 8:
                return SHORT;
            default:
                throw new IllegalArgumentException("not primitive: " + ((Object) type));
        }
    }
    ...
    private static void internInitial(CstType cstType) {
        ...
        throw new IllegalStateException("Attempted re-init of " + ((Object) cstType));
    }
    ...
    public String toString() {
        return "type{" + toHuman() + JavaElement.JEM_ANNOTATION;
    }
