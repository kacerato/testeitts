...
public final class Rops {
    ...
    */
    ...
    public static Rop opFilledNewArray(TypeBearer typeBearer, int i10) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            stdTypeList.set(i11, componentType);
        }
    ...
    public static Rop ropFor(int i10, TypeBearer typeBearer, TypeList typeList, Constant constant) {
        switch (i10) {
            case 1:
                return NOP;
            case 2:
            ...
            case 57:
            default:
                throw new RuntimeException("unknown opcode " + RegOps.opName(i10));
            case 43:
                return CHECK_CAST;
            case 44:
                return INSTANCE_OF;
    ...
    private static Rop throwBadType(TypeBearer typeBearer) {
        throw new IllegalArgumentException("bad type: " + ((Object) typeBearer));
    }

    private static Rop throwBadTypes(TypeList typeList) {
        throw new IllegalArgumentException("bad types: " + ((Object) typeList));
    }
}
