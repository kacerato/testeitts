...
public final class AnnotationsDirectoryItem extends OffsettedItem {
    ...
    public void debugPrint(PrintWriter printWriter) {
        if (this.classAnnotations != null) {
            printWriter.println("  class annotations: " + ((Object) this.classAnnotations));
        }
        if (this.fieldAnnotations != null) {
            printWriter.println("  field annotations:");
            Iterator<FieldAnnotationStruct> it = this.fieldAnnotations.iterator();
            while (it.hasNext()) {
                printWriter.println(C13155a.f85806a + it.next().toHuman());
            }
        }
        if (this.methodAnnotations != null) {
            ...
            while (it2.hasNext()) {
                printWriter.println(C13155a.f85806a + it2.next().toHuman());
            }
        }
        if (this.parameterAnnotations != null) {
            ...
            while (it3.hasNext()) {
                printWriter.println(C13155a.f85806a + it3.next().toHuman());
            }
        }
    }
