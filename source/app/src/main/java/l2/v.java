...
public class v {
    ...
    public static final int f96103a = -1;

    @AttrRes
    public static final int f96104b = 0;

    public static final int f96105c = 0;

    public static final int f96106d = 1;

    public static final RectF f96107e = new RectF();

    public static class a implements C3572o.c {

        public final RectF f96108a;
        ...
        public InterfaceC3561d a(@NonNull InterfaceC3561d interfaceC3561d) {
            return interfaceC3561d instanceof C3570m ? interfaceC3561d : new C3570m(interfaceC3561d.a(this.f96108a) / this.f96108a.height());
        }
    }

    public static class b implements d {

        public final RectF f96109a;

        public final RectF f96110b;

        public final float f96111c;

        public final float f96112d;

        public final float f96113e;
        ...
        public InterfaceC3561d a(@NonNull InterfaceC3561d interfaceC3561d, @NonNull InterfaceC3561d interfaceC3561d2) {
            return new C3558a(v.l(interfaceC3561d.a(this.f96109a), interfaceC3561d2.a(this.f96110b), this.f96111c, this.f96112d, this.f96113e));
        }
    }
