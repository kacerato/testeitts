...
public class d extends KeyFactorySpi implements InterfaceC3897c {
    @Override
    public PublicKey a(h0 h0Var) throws IOException {
        return new C15861b(h0Var);
    }

    @Override
    public PrivateKey b(v vVar) throws IOException {
        return new C15860a(vVar);
    }
    ...
    public final Key engineTranslateKey(Key key) throws InvalidKeyException {
        if ((key instanceof C15860a) || (key instanceof C15861b)) {
            return key;
        }
