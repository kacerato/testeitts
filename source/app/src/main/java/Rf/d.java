...
public class d extends c {
    ...
    @f
    @InterfaceC14422l0(version = "1.2")
    public static void c0(double d10) {
    }
    ...
    public static final double o(double d10) {
        double d11 = a.f22778e;
        if (d10 < d11) {
            return d10 <= (-d11) ? -o(-d10) : Math.abs(d10) >= a.f22777d ? d10 - (((d10 * d10) * d10) / 6) : d10;
        }
        if (d10 <= a.f22780g) {
    ...
    @InterfaceC14422l0(version = "1.2")
    public static final float p0(float f10) {
        return (float) (Math.log(f10) / a.f22775b);
    }
    ...
    public static final double u(double d10) {
        if (Math.abs(d10) < a.f22778e) {
            return Math.abs(d10) > a.f22777d ? d10 + (((d10 * d10) * d10) / 3) : d10;
        }
        double d11 = 1;
