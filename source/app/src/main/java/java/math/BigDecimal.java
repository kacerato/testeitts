...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/d8lib/android.jar:java/math/BigDecimal.class
 */
public class BigDecimal extends Number implements Comparable<BigDecimal>, Serializable {
    ...
    public BigDecimal(char[] in2, int offset, int len) {
        throw new RuntimeException("Stub!");
    }

    public BigDecimal(char[] in2, int offset, int len, MathContext mc2) {
        throw new RuntimeException("Stub!");
    }

    public BigDecimal(char[] in2) {
        throw new RuntimeException("Stub!");
    }

    public BigDecimal(char[] in2, MathContext mc2) {
        throw new RuntimeException("Stub!");
    }
