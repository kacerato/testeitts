...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/d8lib/android.jar:java/util/zip/ZipOutputStream.class
 */
public class ZipOutputStream extends DeflaterOutputStream {
    ...
    public void putNextEntry(ZipEntry e10) throws IOException {
        throw new RuntimeException("Stub!");
    }
