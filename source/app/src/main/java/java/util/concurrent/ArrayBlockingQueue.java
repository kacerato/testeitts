...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/d8lib/android.jar:java/util/concurrent/ArrayBlockingQueue.class
 */
public class ArrayBlockingQueue<E> extends AbstractQueue<E> implements BlockingQueue<E>, Serializable {
    ...
    public ArrayBlockingQueue(int capacity, boolean fair, Collection<? extends E> c10) {
        throw new RuntimeException("Stub!");
    }
