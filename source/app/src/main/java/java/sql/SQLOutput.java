...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/d8lib/android.jar:java/sql/SQLOutput.class
 */
public interface SQLOutput {
    ...
    void writeByte(byte b10) throws SQLException;

    void writeShort(short s10) throws SQLException;
