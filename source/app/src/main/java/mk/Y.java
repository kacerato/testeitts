...
public class Y extends i.b {
    public Y(AbstractC13875e abstractC13875e, jk.f fVar, jk.f fVar2) {
    ...
    public jk.i A() {
        ...
        return new Y(this.f93912a, fVar, fVar2.a(fVar3), new jk.f[]{fVar3});
    }
    ...
    public jk.i M() {
        ...
        return new Y(i10, p12, fVar.r(a10, k10).a(p12).a(k11), new jk.f[]{k11});
    }
    ...
    public jk.i N(jk.i iVar) {
        ...
        if (m10.j()) {
            return new Y(i10, m10, i10.r().o());
        }
        jk.f k11 = m10.p().k(k10);
        jk.f k12 = m10.k(p13).k(p12);
        return new Y(i10, k11, m10.a(p13).p().m(a10, b10, k12), new jk.f[]{k12});
    }
    ...
    public jk.i a(jk.i iVar) {
        ...
        if (n10.j()) {
            ...
            if (fVar4.j()) {
                return new Y(i10, fVar4, i10.r().o());
            }
        ...
        return new Y(i10, fVar4, fVar6, new jk.f[]{fVar5});
    }

    @Override
    public jk.i d() {
        return new Y(null, f(), g());
    }
    ...
    public Y(AbstractC13875e abstractC13875e, jk.f fVar, jk.f fVar2, jk.f[] fVarArr) {
