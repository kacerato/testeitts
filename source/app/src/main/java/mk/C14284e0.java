...
public class C14284e0 extends i.b {
    public C14284e0(AbstractC13875e abstractC13875e, jk.f fVar, jk.f fVar2) {
    ...
    public jk.i A() {
        ...
        return new C14284e0(this.f93912a, fVar, fVar2.a(fVar3), new jk.f[]{fVar3});
    }
    ...
    public jk.i M() {
        ...
        if (a10.j()) {
            return new C14284e0(i10, a10, i10.r().o());
        }
        jk.f p12 = a10.p();
        ...
        return new C14284e0(i10, p12, fVar.r(a10, k10).a(p12).a(k11), new jk.f[]{k11});
    }
    ...
    public jk.i N(jk.i iVar) {
        ...
        if (m10.j()) {
            return new C14284e0(i10, m10, i10.r().o());
        }
        jk.f k11 = m10.p().k(k10);
        jk.f k12 = m10.k(p13).k(p12);
        return new C14284e0(i10, k11, m10.a(p13).p().m(a10, b10, k12), new jk.f[]{k12});
    }
    ...
    public jk.i a(jk.i iVar) {
        ...
        if (n10.j()) {
            ...
            if (fVar4.j()) {
                return new C14284e0(i10, fVar4, i10.r().o());
            }
            ...
            jk.f k12 = k10.k(k11);
            if (k12.j()) {
                return new C14284e0(i10, k12, i10.r().o());
            }
            jk.f k13 = a10.k(p10);
        ...
        return new C14284e0(i10, fVar4, fVar6, new jk.f[]{fVar5});
    }

    @Override
    public jk.i d() {
        return new C14284e0(null, f(), g());
    }
    ...
    public C14284e0(AbstractC13875e abstractC13875e, jk.f fVar, jk.f fVar2, jk.f[] fVarArr) {
