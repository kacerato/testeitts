...
public class J0 extends AbstractC13875e.b {

    public static final int f97211s = 6;

    public static final jk.f[] f97212t = {new G0(InterfaceC13874d.f93854b)};
    ...
    public class a extends AbstractC13871a {
        ...
        private jk.i c(long[] jArr, long[] jArr2) {
            return J0.this.k(new G0(jArr), new G0(jArr2), J0.f97212t);
        }
        ...
        public jk.i a(int i10) {
            ...
            int i11 = 0;
            for (int i12 = 0; i12 < this.f97214a; i12++) {
                long j10 = ((i12 ^ i10) - 1) >> 31;
                for (int i13 = 0; i13 < 5; i13++) {
                    long j11 = c10[i13];
                    long[] jArr = this.f97215b;
    ...
    public J0() {
        ...
        this.f97213r = new K0(this, null, null);
        this.f93868b = o(BigInteger.valueOf(1L));
        this.f93869c = o(new BigInteger(1, em.h.d("027B680AC8B8596DA5A4AF8A19A0303FCA97FD7645309FA2A581485AF6263E313B79A2F5")));
        this.f93870d = new BigInteger(1, em.h.d("03FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEF90399660FC938A90165B042A7CEFADB307"));
    ...
    public jk.i j(jk.f fVar, jk.f fVar2) {
        return new K0(this, fVar, fVar2);
    }

    @Override
    public jk.i k(jk.f fVar, jk.f fVar2, jk.f[] fVarArr) {
        return new K0(this, fVar, fVar2, fVarArr);
    }
