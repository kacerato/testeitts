...
public class C14301n extends i.c {
    public C14301n(AbstractC13875e abstractC13875e, jk.f fVar, jk.f fVar2) {
        super(abstractC13875e, fVar, fVar2);
    }

    @Override
    public jk.i A() {
        return v() ? this : new C14301n(this.f93912a, this.f93913b, this.f93914c.n(), this.f93915d);
    }
    ...
    public jk.i M() {
        ...
        C14297l.o(c14299m.f97376g, h12);
        int[] h13 = AbstractC15320f.h();
        C14297l.o(h12, h13);
        boolean i11 = c14299m3.i();
        int[] iArr = c14299m3.f97376g;
        if (!i11) {
            C14297l.o(iArr, h11);
            iArr = h11;
        }
        C14297l.q(c14299m2.f97376g, iArr, h10);
        C14297l.a(c14299m2.f97376g, iArr, h11);
        C14297l.h(h11, h10, h11);
        C14297l.n(AbstractC15320f.b(h11, h11, h11), h11);
        C14297l.h(h12, c14299m2.f97376g, h12);
        C14297l.n(AbstractC15329o.H0(5, h12, 2, 0), h12);
        C14297l.n(AbstractC15329o.K0(5, h13, 3, 0, h10), h10);
        C14299m c14299m4 = new C14299m(h13);
        C14297l.o(h11, c14299m4.f97376g);
        int[] iArr2 = c14299m4.f97376g;
        C14297l.q(iArr2, h12, iArr2);
        int[] iArr3 = c14299m4.f97376g;
        C14297l.q(iArr3, h12, iArr3);
        C14299m c14299m5 = new C14299m(h12);
        C14297l.q(h12, c14299m4.f97376g, c14299m5.f97376g);
        int[] iArr4 = c14299m5.f97376g;
        C14297l.h(iArr4, h11, iArr4);
        int[] iArr5 = c14299m5.f97376g;
        C14297l.q(iArr5, h10, iArr5);
        C14299m c14299m6 = new C14299m(h11);
        C14297l.s(c14299m.f97376g, c14299m6.f97376g);
        if (!i11) {
            int[] iArr6 = c14299m6.f97376g;
            C14297l.h(iArr6, c14299m3.f97376g, iArr6);
        }
        return new C14301n(i10, c14299m4, c14299m5, new jk.f[]{c14299m6});
    }
    ...
    public jk.i a(jk.i iVar) {
        ...
        return new C14301n(i10, c14299m7, c14299m8, new jk.f[]{c14299m9});
    }

    @Override
    public jk.i d() {
        return new C14301n(null, f(), g());
    }

    public C14301n(AbstractC13875e abstractC13875e, jk.f fVar, jk.f fVar2, jk.f[] fVarArr) {
