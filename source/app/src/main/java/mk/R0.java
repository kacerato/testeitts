...
public class R0 {
    ...
    public static final long f97256a = 576460752303423487L;

    public static final long[] f97257b = {3161836309350906777L, -7642453882179322845L, -3821226941089661423L, 7312758566309945096L, -556661012383879292L, 8945041530681231562L, -4750851271514160027L, 6847946401097695794L, 541669439031730457L};
    ...
    public static long[] h(BigInteger bigInteger) {
        return AbstractC15329o.V(571, bigInteger);
    }

    public static void i(long[] jArr, long[] jArr2) {
        long[] d10 = AbstractC15328n.d();
        AbstractC15328n.b(jArr, jArr2);
    ...
    public static void k(long[] jArr, long[] jArr2, long[] jArr3) {
        for (int i10 = 56; i10 >= 0; i10 -= 8) {
            ...
            AbstractC15329o.L0(16, jArr3, 0, 8, 0L);
        }
        for (int i13 = 56; i13 >= 0; i13 -= 8) {
            ...
            if (i13 > 0) {
                AbstractC15329o.L0(18, jArr3, 0, 8, 0L);
            }
        }
    }
    ...
    public static void m(long[] jArr, long[] jArr2) {
        C15316b.d(jArr, 0, 9, jArr2, 0);
    }

    public static void n(long[] jArr, long[] jArr2) {
        if (AbstractC15328n.h(jArr)) {
    ...
    public static long[] s(long[] jArr) {
        ...
        while (i10 > 0) {
            int i12 = i11 + 18;
            AbstractC15329o.G0(9, jArr2, i12 >>> 1, 0L, jArr2, i12);
            u(jArr2, i12);
            a(jArr2, 9, jArr2, i12, jArr2, i11 + 27);
            i10--;
            i11 = i12;
        }
        AbstractC15329o.M0(144, jArr2, 0, 4, 0L, jArr2, 144);
        return jArr2;
    }
    ...
    public static void v(long[] jArr, long[] jArr2) {
        ...
        for (int i11 = 0; i11 < 4; i11++) {
            int i12 = i10 + 1;
            long m10 = C15316b.m(jArr[i10]);
            i10 += 2;
            long m11 = C15316b.m(jArr[i12]);
            c10[i11] = (4294967295L & m10) | (m11 << 32);
            c11[i11] = (m10 >>> 32) | (C12510d2.f66536l & m11);
        }
        long m12 = C15316b.m(jArr[i10]);
        c10[4] = 4294967295L & m12;
        c11[4] = m12 >>> 32;
        o(c11, f97257b, jArr2);
        b(jArr2, c10, jArr2);
    }
