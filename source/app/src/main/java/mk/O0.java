...
public class O0 extends i.b {
    public O0(AbstractC13875e abstractC13875e, jk.f fVar, jk.f fVar2) {
    ...
    public jk.i A() {
        ...
        return new O0(this.f93912a, fVar, fVar2.a(fVar3), new jk.f[]{fVar3});
    }
    ...
    public jk.i M() {
        ...
        return new O0(i10, p11, p12.a(a10).a(p10).k(p12).a(fVar3).a(p11).a(k10), new jk.f[]{k10});
    }
    ...
    public jk.i N(jk.i iVar) {
        ...
        if (m10.j()) {
            return new O0(i10, m10, i10.r());
        }
        jk.f k11 = m10.p().k(k10);
        jk.f k12 = m10.k(p13).k(p12);
        return new O0(i10, k11, m10.a(p13).p().m(a10, b10, k12), new jk.f[]{k12});
    }
    ...
    public jk.i a(jk.i iVar) {
        ...
        return new O0(i10, fVar4, fVar6, new jk.f[]{fVar5});
    }

    @Override
    public jk.i d() {
        return new O0(null, f(), g());
    }
    ...
    public O0(AbstractC13875e abstractC13875e, jk.f fVar, jk.f fVar2, jk.f[] fVarArr) {
