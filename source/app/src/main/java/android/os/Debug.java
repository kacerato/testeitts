...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/os/Debug.class
 */
public final class Debug {
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/os/Debug$MemoryInfo.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/os/Debug$InstructionCount.class
 */
    @Deprecated
    ...
    public static boolean dumpService(String name, FileDescriptor fd2, String[] args) {
        throw new RuntimeException("Stub!");
    }
}
