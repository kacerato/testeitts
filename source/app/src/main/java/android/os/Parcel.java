...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/os/Parcel.class
 */
public final class Parcel {
    ...
    public final void writeByteArray(byte[] b10) {
        throw new RuntimeException("Stub!");
    }

    public final void writeByteArray(byte[] b10, int offset, int len) {
        throw new RuntimeException("Stub!");
    }
    ...
    public final void writeValue(Object v10) {
        throw new RuntimeException("Stub!");
    }

    public final void writeParcelable(Parcelable p10, int parcelableFlags) {
        throw new RuntimeException("Stub!");
    }

    public final void writeSerializable(Serializable s10) {
        throw new RuntimeException("Stub!");
    }

    public final void writeException(Exception e10) {
        throw new RuntimeException("Stub!");
    }
    ...
    public final <T> ArrayList<T> createTypedArrayList(Parcelable.Creator<T> c10) {
        throw new RuntimeException("Stub!");
    }

    public final <T> void readTypedList(List<T> list, Parcelable.Creator<T> c10) {
        throw new RuntimeException("Stub!");
    }
    ...
    public final <T> T[] createTypedArray(Parcelable.Creator<T> c10) {
        throw new RuntimeException("Stub!");
    }

    public final <T> void readTypedArray(T[] val, Parcelable.Creator<T> c10) {
        throw new RuntimeException("Stub!");
    }

    public final <T> T readTypedObject(Parcelable.Creator<T> c10) {
        throw new RuntimeException("Stub!");
    }
