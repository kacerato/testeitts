...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/opengl/GLES31Ext.class
 */
public class GLES31Ext {
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/opengl/GLES31Ext$DebugProcKHR.class
 */
    ...
    public static native void glDebugMessageControlKHR(int i10, int i11, int i12, int i13, int[] iArr, int i14, boolean z10);

    public static native void glDebugMessageControlKHR(int i10, int i11, int i12, int i13, IntBuffer intBuffer, boolean z10);

    public static native void glDebugMessageInsertKHR(int i10, int i11, int i12, int i13, String str);

    public static native void glDebugMessageCallbackKHR(DebugProcKHR debugProcKHR);

    public static native int glGetDebugMessageLogKHR(int i10, int i11, int[] iArr, int i12, int[] iArr2, int i13, int[] iArr3, int i14, int[] iArr4, int i15, int[] iArr5, int i16, byte[] bArr, int i17);

    public static native int glGetDebugMessageLogKHR(int i10, IntBuffer intBuffer, IntBuffer intBuffer2, IntBuffer intBuffer3, IntBuffer intBuffer4, IntBuffer intBuffer5, ByteBuffer byteBuffer);

    public static native String[] glGetDebugMessageLogKHR(int i10, int[] iArr, int i11, int[] iArr2, int i12, int[] iArr3, int i13, int[] iArr4, int i14);

    public static native String[] glGetDebugMessageLogKHR(int i10, IntBuffer intBuffer, IntBuffer intBuffer2, IntBuffer intBuffer3, IntBuffer intBuffer4);

    public static native void glPushDebugGroupKHR(int i10, int i11, int i12, String str);

    public static native void glPopDebugGroupKHR();

    public static native void glObjectLabelKHR(int i10, int i11, int i12, String str);

    public static native String glGetObjectLabelKHR(int i10, int i11);

    public static native void glObjectPtrLabelKHR(long j10, String str);

    public static native String glGetObjectPtrLabelKHR(long j10);

    public static native DebugProcKHR glGetDebugMessageCallbackKHR();

    public static native void glMinSampleShadingOES(float f10);

    public static native void glTexStorage3DMultisampleOES(int i10, int i11, int i12, int i13, int i14, int i15, boolean z10);

    public static native void glCopyImageSubDataEXT(int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, int i19, int i20, int i21, int i22, int i23, int i24);

    public static native void glEnableiEXT(int i10, int i11);

    public static native void glDisableiEXT(int i10, int i11);

    public static native void glBlendEquationiEXT(int i10, int i11);

    public static native void glBlendEquationSeparateiEXT(int i10, int i11, int i12);

    public static native void glBlendFunciEXT(int i10, int i11, int i12);

    public static native void glBlendFuncSeparateiEXT(int i10, int i11, int i12, int i13, int i14);

    public static native void glColorMaskiEXT(int i10, boolean z10, boolean z11, boolean z12, boolean z13);

    public static native boolean glIsEnablediEXT(int i10, int i11);

    public static native void glFramebufferTextureEXT(int i10, int i11, int i12, int i13);

    public static native void glPrimitiveBoundingBoxEXT(float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17);

    public static native void glPatchParameteriEXT(int i10, int i11);

    public static native void glTexParameterIivEXT(int i10, int i11, int[] iArr, int i12);

    public static native void glTexParameterIivEXT(int i10, int i11, IntBuffer intBuffer);

    public static native void glTexParameterIuivEXT(int i10, int i11, int[] iArr, int i12);

    public static native void glTexParameterIuivEXT(int i10, int i11, IntBuffer intBuffer);

    public static native void glGetTexParameterIivEXT(int i10, int i11, int[] iArr, int i12);

    public static native void glGetTexParameterIivEXT(int i10, int i11, IntBuffer intBuffer);

    public static native void glGetTexParameterIuivEXT(int i10, int i11, int[] iArr, int i12);

    public static native void glGetTexParameterIuivEXT(int i10, int i11, IntBuffer intBuffer);

    public static native void glSamplerParameterIivEXT(int i10, int i11, int[] iArr, int i12);

    public static native void glSamplerParameterIivEXT(int i10, int i11, IntBuffer intBuffer);

    public static native void glSamplerParameterIuivEXT(int i10, int i11, int[] iArr, int i12);

    public static native void glSamplerParameterIuivEXT(int i10, int i11, IntBuffer intBuffer);

    public static native void glGetSamplerParameterIivEXT(int i10, int i11, int[] iArr, int i12);

    public static native void glGetSamplerParameterIivEXT(int i10, int i11, IntBuffer intBuffer);

    public static native void glGetSamplerParameterIuivEXT(int i10, int i11, int[] iArr, int i12);

    public static native void glGetSamplerParameterIuivEXT(int i10, int i11, IntBuffer intBuffer);

    public static native void glTexBufferEXT(int i10, int i11, int i12);

    public static native void glTexBufferRangeEXT(int i10, int i11, int i12, int i13, int i14);
