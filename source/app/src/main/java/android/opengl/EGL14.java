...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/opengl/EGL14.class
 */
public class EGL14 {
    ...
    public static native EGLDisplay eglGetDisplay(int i10);

    public static native boolean eglInitialize(EGLDisplay eGLDisplay, int[] iArr, int i10, int[] iArr2, int i11);

    public static native boolean eglTerminate(EGLDisplay eGLDisplay);

    public static native String eglQueryString(EGLDisplay eGLDisplay, int i10);

    public static native boolean eglGetConfigs(EGLDisplay eGLDisplay, EGLConfig[] eGLConfigArr, int i10, int i11, int[] iArr, int i12);

    public static native boolean eglChooseConfig(EGLDisplay eGLDisplay, int[] iArr, int i10, EGLConfig[] eGLConfigArr, int i11, int i12, int[] iArr2, int i13);

    public static native boolean eglGetConfigAttrib(EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i10, int[] iArr, int i11);

    public static native EGLSurface eglCreatePbufferSurface(EGLDisplay eGLDisplay, EGLConfig eGLConfig, int[] iArr, int i10);

    @Deprecated
    public static native EGLSurface eglCreatePixmapSurface(EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i10, int[] iArr, int i11);

    public static native boolean eglDestroySurface(EGLDisplay eGLDisplay, EGLSurface eGLSurface);

    public static native boolean eglQuerySurface(EGLDisplay eGLDisplay, EGLSurface eGLSurface, int i10, int[] iArr, int i11);

    public static native boolean eglBindAPI(int i10);
    ...
    public static native EGLSurface eglCreatePbufferFromClientBuffer(EGLDisplay eGLDisplay, int i10, int i11, EGLConfig eGLConfig, int[] iArr, int i12);

    public static native boolean eglSurfaceAttrib(EGLDisplay eGLDisplay, EGLSurface eGLSurface, int i10, int i11);

    public static native boolean eglBindTexImage(EGLDisplay eGLDisplay, EGLSurface eGLSurface, int i10);

    public static native boolean eglReleaseTexImage(EGLDisplay eGLDisplay, EGLSurface eGLSurface, int i10);

    public static native boolean eglSwapInterval(EGLDisplay eGLDisplay, int i10);

    public static native EGLContext eglCreateContext(EGLDisplay eGLDisplay, EGLConfig eGLConfig, EGLContext eGLContext, int[] iArr, int i10);
    ...
    public static native EGLSurface eglGetCurrentSurface(int i10);

    public static native EGLDisplay eglGetCurrentDisplay();

    public static native boolean eglQueryContext(EGLDisplay eGLDisplay, EGLContext eGLContext, int i10, int[] iArr, int i11);

    public static native boolean eglWaitGL();

    public static native boolean eglWaitNative(int i10);

    public static native boolean eglSwapBuffers(EGLDisplay eGLDisplay, EGLSurface eGLSurface);

    public static native boolean eglCopyBuffers(EGLDisplay eGLDisplay, EGLSurface eGLSurface, int i10);
