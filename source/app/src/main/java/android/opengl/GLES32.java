...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/opengl/GLES32.class
 */
public class GLES32 extends GLES31 {
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/opengl/GLES32$DebugProc.class
 */
    public interface DebugProc {
        void onMessage(int i10, int i11, int i12, int i13, String str);
    }

    public static native void glBlendBarrier();

    public static native void glCopyImageSubData(int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, int i19, int i20, int i21, int i22, int i23, int i24);

    public static native void glDebugMessageControl(int i10, int i11, int i12, int i13, int[] iArr, int i14, boolean z10);

    public static native void glDebugMessageControl(int i10, int i11, int i12, int i13, IntBuffer intBuffer, boolean z10);

    public static native void glDebugMessageInsert(int i10, int i11, int i12, int i13, int i14, String str);

    public static native void glDebugMessageCallback(DebugProc debugProc);

    public static native int glGetDebugMessageLog(int i10, int i11, int[] iArr, int i12, int[] iArr2, int i13, int[] iArr3, int i14, int[] iArr4, int i15, int[] iArr5, int i16, byte[] bArr, int i17);

    public static native int glGetDebugMessageLog(int i10, IntBuffer intBuffer, IntBuffer intBuffer2, IntBuffer intBuffer3, IntBuffer intBuffer4, IntBuffer intBuffer5, ByteBuffer byteBuffer);

    public static native String[] glGetDebugMessageLog(int i10, int[] iArr, int i11, int[] iArr2, int i12, int[] iArr3, int i13, int[] iArr4, int i14);

    public static native String[] glGetDebugMessageLog(int i10, IntBuffer intBuffer, IntBuffer intBuffer2, IntBuffer intBuffer3, IntBuffer intBuffer4);

    public static native void glPushDebugGroup(int i10, int i11, int i12, String str);

    public static native void glPopDebugGroup();

    public static native void glObjectLabel(int i10, int i11, int i12, String str);

    public static native String glGetObjectLabel(int i10, int i11);

    public static native void glObjectPtrLabel(long j10, String str);

    public static native String glGetObjectPtrLabel(long j10);

    public static native long glGetPointerv(int i10);

    public static native void glEnablei(int i10, int i11);

    public static native void glDisablei(int i10, int i11);

    public static native void glBlendEquationi(int i10, int i11);

    public static native void glBlendEquationSeparatei(int i10, int i11, int i12);

    public static native void glBlendFunci(int i10, int i11, int i12);

    public static native void glBlendFuncSeparatei(int i10, int i11, int i12, int i13, int i14);

    public static native void glColorMaski(int i10, boolean z10, boolean z11, boolean z12, boolean z13);

    public static native boolean glIsEnabledi(int i10, int i11);

    public static native void glDrawElementsBaseVertex(int i10, int i11, int i12, Buffer buffer, int i13);

    public static native void glDrawRangeElementsBaseVertex(int i10, int i11, int i12, int i13, int i14, Buffer buffer, int i15);

    public static native void glDrawElementsInstancedBaseVertex(int i10, int i11, int i12, Buffer buffer, int i13, int i14);

    public static native void glDrawElementsInstancedBaseVertex(int i10, int i11, int i12, int i13, int i14, int i15);

    public static native void glFramebufferTexture(int i10, int i11, int i12, int i13);

    public static native void glPrimitiveBoundingBox(float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17);

    public static native int glGetGraphicsResetStatus();

    public static native void glReadnPixels(int i10, int i11, int i12, int i13, int i14, int i15, int i16, Buffer buffer);

    public static native void glGetnUniformfv(int i10, int i11, int i12, float[] fArr, int i13);

    public static native void glGetnUniformfv(int i10, int i11, int i12, FloatBuffer floatBuffer);

    public static native void glGetnUniformiv(int i10, int i11, int i12, int[] iArr, int i13);

    public static native void glGetnUniformiv(int i10, int i11, int i12, IntBuffer intBuffer);

    public static native void glGetnUniformuiv(int i10, int i11, int i12, int[] iArr, int i13);

    public static native void glGetnUniformuiv(int i10, int i11, int i12, IntBuffer intBuffer);

    public static native void glMinSampleShading(float f10);

    public static native void glPatchParameteri(int i10, int i11);

    public static native void glTexParameterIiv(int i10, int i11, int[] iArr, int i12);

    public static native void glTexParameterIiv(int i10, int i11, IntBuffer intBuffer);

    public static native void glTexParameterIuiv(int i10, int i11, int[] iArr, int i12);

    public static native void glTexParameterIuiv(int i10, int i11, IntBuffer intBuffer);

    public static native void glGetTexParameterIiv(int i10, int i11, int[] iArr, int i12);

    public static native void glGetTexParameterIiv(int i10, int i11, IntBuffer intBuffer);

    public static native void glGetTexParameterIuiv(int i10, int i11, int[] iArr, int i12);

    public static native void glGetTexParameterIuiv(int i10, int i11, IntBuffer intBuffer);

    public static native void glSamplerParameterIiv(int i10, int i11, int[] iArr, int i12);

    public static native void glSamplerParameterIiv(int i10, int i11, IntBuffer intBuffer);

    public static native void glSamplerParameterIuiv(int i10, int i11, int[] iArr, int i12);

    public static native void glSamplerParameterIuiv(int i10, int i11, IntBuffer intBuffer);

    public static native void glGetSamplerParameterIiv(int i10, int i11, int[] iArr, int i12);

    public static native void glGetSamplerParameterIiv(int i10, int i11, IntBuffer intBuffer);

    public static native void glGetSamplerParameterIuiv(int i10, int i11, int[] iArr, int i12);

    public static native void glGetSamplerParameterIuiv(int i10, int i11, IntBuffer intBuffer);

    public static native void glTexBuffer(int i10, int i11, int i12);

    public static native void glTexBufferRange(int i10, int i11, int i12, int i13, int i14);

    public static native void glTexStorage3DMultisample(int i10, int i11, int i12, int i13, int i14, int i15, boolean z10);
