...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/net/Uri.class
 */
public abstract class Uri implements Parcelable, Comparable<Uri> {
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/net/Uri$Builder.class
 */
    ...
    public static String encode(String s10, String allow) {
        throw new RuntimeException("Stub!");
    }
