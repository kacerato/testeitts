...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/net/UrlQuerySanitizer.class
 */
public class UrlQuerySanitizer {

    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/net/UrlQuerySanitizer$ValueSanitizer.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/net/UrlQuerySanitizer$ParameterValuePair.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/net/UrlQuerySanitizer$IllegalCharacterValueSanitizer.class
 */
    ...
    protected int decodeHexDigit(char c10) {
        throw new RuntimeException("Stub!");
    }
