...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/graphics/Color.class
 */
public class Color {
    ...
    public static Color valueOf(float r10, float g10, float b10) {
        throw new RuntimeException("Stub!");
    }

    public static Color valueOf(float r10, float g10, float b10, float a10) {
        throw new RuntimeException("Stub!");
    }

    public static Color valueOf(float r10, float g10, float b10, float a10, ColorSpace colorSpace) {
        throw new RuntimeException("Stub!");
    }
    ...
    public static long convert(float r10, float g10, float b10, float a10, ColorSpace source, ColorSpace destination) {
        throw new RuntimeException("Stub!");
    }
    ...
    public static long convert(float r10, float g10, float b10, float a10, ColorSpace.Connector connector) {
        throw new RuntimeException("Stub!");
    }
