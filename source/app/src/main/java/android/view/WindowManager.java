...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/view/WindowManager.class
 */
public interface WindowManager extends ViewManager {
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/view/WindowManager$BadTokenException.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/view/WindowManager$InvalidDisplayException.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/view/WindowManager$LayoutParams.class
 */
    public static class LayoutParams extends ViewGroup.LayoutParams implements Parcelable {
        ...
        public LayoutParams(int w10, int h10, int _type, int _flags, int _format) {
            super((ViewGroup.LayoutParams) null);
            throw new RuntimeException("Stub!");
        }

        public LayoutParams(int w10, int h10, int xpos, int ypos, int _type, int _flags, int _format) {
            super((ViewGroup.LayoutParams) null);
            throw new RuntimeException("Stub!");
        }
