...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/content/Intent.class
 */
public class Intent implements Parcelable, Cloneable {
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/content/Intent$ShortcutIconResource.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/content/Intent$FilterComparison.class
 */
    ...
    public ComponentName resolveActivity(PackageManager pm2) {
        throw new RuntimeException("Stub!");
    }

    public ActivityInfo resolveActivityInfo(PackageManager pm2, int flags) {
        throw new RuntimeException("Stub!");
    }
    ...
    public void setSourceBounds(Rect r10) {
        throw new RuntimeException("Stub!");
    }
