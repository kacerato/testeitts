...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/content/res/Configuration.class
 */
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    public Configuration(Configuration o10) {
        throw new RuntimeException("Stub!");
    }
    ...
    public void setTo(Configuration o10) {
        throw new RuntimeException("Stub!");
    }
