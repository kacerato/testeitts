...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/content/IntentFilter.class
 */
public class IntentFilter implements Parcelable {
    public static final Parcelable.Creator<IntentFilter> CREATOR = null;
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/content/IntentFilter$MalformedMimeTypeException.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/content/IntentFilter$AuthorityEntry.class
 */
    ...
    public IntentFilter(IntentFilter o10) {
        throw new RuntimeException("Stub!");
    }
