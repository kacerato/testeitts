...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacter.class
 */
public final class UCharacter implements UCharacterEnums.ECharacterCategory, UCharacterEnums.ECharacterDirection {
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacter$BidiPairedBracketType.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacter$DecompositionType.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacter$EastAsianWidth.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacter$GraphemeClusterBreak.class
 */
    public interface GraphemeClusterBreak {
        ...
        public static final int f32428L = 4;
        ...
        public static final int f32429T = 8;

        public static final int f32430V = 9;
        public static final int ZWJ = 17;
    }

    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacter$HangulSyllableType.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacter$JoiningGroup.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacter$JoiningType.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacter$LineBreak.class
 */
    public interface LineBreak {
        ...
        public static final int f32432H2 = 31;

        public static final int f32433H3 = 32;
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacter$NumericType.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacter$SentenceBreak.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacter$WordBreak.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacter$UnicodeBlock.class
 */
    ...
    public static int getBidiPairedBracket(int c10) {
        throw new RuntimeException("Stub!");
    }
    ...
    public static String getName(String s10, String separator) {
        throw new RuntimeException("Stub!");
    }
