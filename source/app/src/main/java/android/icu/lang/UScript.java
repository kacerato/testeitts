...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UScript.class
 */
public final class UScript {
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UScript$ScriptUsage.class
 */
    ...
    public static final boolean hasScript(int c10, int sc2) {
        throw new RuntimeException("Stub!");
    }

    public static final int getScriptExtensions(int c10, BitSet set) {
        throw new RuntimeException("Stub!");
    }
