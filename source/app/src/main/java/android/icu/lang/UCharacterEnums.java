...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacterEnums.class
 */
public class UCharacterEnums {

    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacterEnums$ECharacterCategory.class
 */
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/lang/UCharacterEnums$ECharacterDirection.class
 */
