...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/util/Calendar.class
 */
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/icu/util/Calendar$WeekData.class
 */
    ...
    protected static final int gregorianMonthLength(int y10, int m10) {
        throw new RuntimeException("Stub!");
    }

    protected static final int gregorianPreviousMonthLength(int y10, int m10) {
        throw new RuntimeException("Stub!");
    }
