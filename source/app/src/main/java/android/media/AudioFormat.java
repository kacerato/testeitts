...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/media/AudioFormat.class
 */
public final class AudioFormat implements Parcelable {
    ...
    public static final Parcelable.Creator<AudioFormat> CREATOR = null;
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/media/AudioFormat$Builder.class
 */
    public static class Builder {
        ...
        public Builder(AudioFormat af2) {
            throw new RuntimeException("Stub!");
        }
