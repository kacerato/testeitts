...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/telephony/TelephonyManager.class
 */
public class TelephonyManager {
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/telephony/TelephonyManager$UssdResponseCallback.class
 */
    ...
    public IccOpenLogicalChannelResponse iccOpenLogicalChannel(String AID, int p22) {
        throw new RuntimeException("Stub!");
    }
    ...
    public String iccTransmitApduLogicalChannel(int channel, int cla, int instruction, int p12, int p22, int p32, String data) {
        throw new RuntimeException("Stub!");
    }

    public String iccTransmitApduBasicChannel(int cla, int instruction, int p12, int p22, int p32, String data) {
        throw new RuntimeException("Stub!");
    }

    public byte[] iccExchangeSimIO(int fileID, int command, int p12, int p22, int p32, String filePath) {
        throw new RuntimeException("Stub!");
    }
