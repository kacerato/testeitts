...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/database/DatabaseUtils.class
 */
public class DatabaseUtils {
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/database/DatabaseUtils$InsertHelper.class
 */
    @Deprecated
    public static class InsertHelper {
        public InsertHelper(SQLiteDatabase db2, String tableName) {
    ...
    public static final void writeExceptionToParcel(Parcel reply, Exception e10) {
        throw new RuntimeException("Stub!");
    }
    ...
    public static void appendEscapedSQLString(StringBuilder sb2, String sqlString) {
        throw new RuntimeException("Stub!");
    }
    ...
    public static String concatenateWhere(String a10, String b10) {
        throw new RuntimeException("Stub!");
    }
    ...
    public static long queryNumEntries(SQLiteDatabase db2, String table) {
        throw new RuntimeException("Stub!");
    }

    public static long queryNumEntries(SQLiteDatabase db2, String table, String selection) {
        throw new RuntimeException("Stub!");
    }

    public static long queryNumEntries(SQLiteDatabase db2, String table, String selection, String[] selectionArgs) {
        throw new RuntimeException("Stub!");
    }

    public static long longForQuery(SQLiteDatabase db2, String query, String[] selectionArgs) {
        throw new RuntimeException("Stub!");
    }
    ...
    public static String stringForQuery(SQLiteDatabase db2, String query, String[] selectionArgs) {
        throw new RuntimeException("Stub!");
    }
    ...
    public static ParcelFileDescriptor blobFileDescriptorForQuery(SQLiteDatabase db2, String query, String[] selectionArgs) {
        throw new RuntimeException("Stub!");
    }
