...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/renderscript/ScriptIntrinsicBlend.class
 */
public class ScriptIntrinsicBlend extends ScriptIntrinsic {
    ...
    public static ScriptIntrinsicBlend create(RenderScript rs, Element e10) {
        throw new RuntimeException("Stub!");
    }
