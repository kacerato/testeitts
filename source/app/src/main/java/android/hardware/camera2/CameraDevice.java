...
/* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/hardware/camera2/CameraDevice.class
 */
public abstract class CameraDevice implements AutoCloseable {
    ...
    public abstract CaptureRequest.Builder createCaptureRequest(int i10) throws CameraAccessException;
    ...
    /* JADX WARN: Classes with same name are omitted:
  base.apk:assets/Editor/javaLibs.zip:JAVARuntime/android/hardware/camera2/CameraDevice$StateCallback.class
 */
    public static abstract class StateCallback {
        ...
        public abstract void onError(CameraDevice cameraDevice, int i10);
