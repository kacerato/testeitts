...
public abstract class p<X extends Number & Comparable<X>> {
    ...
    public static class a {
        ...
        public static final int[] f5436a;
        ...
        static {
            ...
            try {
                f5436a[RoundingMode.HALF_EVEN.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f5436a[RoundingMode.HALF_DOWN.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f5436a[RoundingMode.HALF_UP.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f5436a[RoundingMode.FLOOR.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f5436a[RoundingMode.CEILING.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f5436a[RoundingMode.UP.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f5436a[RoundingMode.UNNECESSARY.ordinal()] = 8;
    ...
    public final double b(X x10, RoundingMode roundingMode) {
        ...
        double d10;
        H.F(x10, "x");
        H.F(roundingMode, "mode");
        double c10 = c(x10);
        if (Double.isInfinite(c10)) {
            switch (a.f5436a[roundingMode.ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
