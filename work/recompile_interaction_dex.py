...
work_dir = r"C:\Users\donod\Downloads\itsmaagic\work\build_interaction"
...
public class Vector3 implements Serializable {
    ...
    public void set(Vector3 other) { if (other != null) set(other.x, other.y, other.z); }
    public void setX(float x) { this.x = x; }
    public void setY(float y) { this.y = y; }
    public void setZ(float z) { this.z = z; }
    public void d(Vector3 v) {}
