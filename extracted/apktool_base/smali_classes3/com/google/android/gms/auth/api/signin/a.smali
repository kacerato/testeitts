...
.method public static a(Landroid/content/Context;Ly0/c;)Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
    .locals 1
    ...
    invoke-static {}, Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;->n()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;->D0([Lcom/google/android/gms/common/api/Scope;)Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
...
.method public static varargs b(Landroid/content/Context;Lcom/google/android/gms/common/api/Scope;[Lcom/google/android/gms/common/api/Scope;)Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
    ...
    invoke-virtual {p0, p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;->D0([Lcom/google/android/gms/common/api/Scope;)Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;

    return-object p0
.end method

.method public static c(Landroid/app/Activity;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Ly0/b;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Ly0/b;-><init>(Landroid/app/Activity;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)V

    return-object v0
.end method

.method public static d(Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Ly0/b;
    .locals 1
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v0, p0, p1}, Ly0/b;-><init>(Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)V
...
.method public static e(Landroid/content/Context;)Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
    ...
    invoke-virtual {p0}, Lz0/r;->d()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
...
.method public static f(Landroid/content/Intent;)Lv1/k;
    .locals 2
    ...
    invoke-static {p0}, Lz0/q;->g(Landroid/content/Intent;)Ly0/d;

    move-result-object p0

    invoke-virtual {p0}, Ly0/d;->a()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;

    move-result-object v0

    invoke-virtual {p0}, Ly0/d;->getStatus()Lcom/google/android/gms/common/api/Status;
    ...
    invoke-static {p0}, Lv1/n;->f(Ljava/lang/Exception;)Lv1/k;
...
.method public static g(Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Ly0/c;)Z
    .locals 1
...
.method public static i(Landroid/app/Activity;ILcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Ly0/c;)V
    .locals 1
    .param p0    # Landroid/app/Activity;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-interface {p3}, Ly0/c;->b()Ljava/util/List;
...
.method public static k(Landroidx/fragment/app/Fragment;ILcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Ly0/c;)V
    .locals 1
...
.method public static varargs m(Landroid/app/Activity;Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;[Lcom/google/android/gms/common/api/Scope;)Landroid/content/Intent;
    ...
    invoke-direct {p1, p0, p2}, Ly0/b;-><init>(Landroid/app/Activity;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)V
