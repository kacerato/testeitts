.class public interface abstract Lcom/github/javaparser/ast/nodeTypes/NodeWithOptionalScope;
...
.method public abstract removeScope()Lcom/github/javaparser/ast/Node;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TN;"
        }
...
.method public traverseScope()Ljava/util/Optional;
    ...
    invoke-interface {p0}, Lcom/github/javaparser/ast/nodeTypes/NodeWithOptionalScope;->getScope()Ljava/util/Optional;
