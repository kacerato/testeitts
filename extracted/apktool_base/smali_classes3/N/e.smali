...
.method public bridge synthetic a(Ljava/lang/Object;IILC/h;)Lcom/bumptech/glide/load/engine/t;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, LN/e;->c(Landroid/net/Uri;IILC/h;)Lcom/bumptech/glide/load/engine/t;
...
.method public bridge synthetic b(Ljava/lang/Object;LC/h;)Z
    ...
    invoke-virtual {p0, p1, p2}, LN/e;->h(Landroid/net/Uri;LC/h;)Z
...
.method public c(Landroid/net/Uri;IILC/h;)Lcom/bumptech/glide/load/engine/t;
    ...
    invoke-virtual {p0, p1, p2}, LN/e;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    invoke-virtual {p0, p2, p1}, LN/e;->g(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    iget-object p3, p0, LN/e;->a:Landroid/content/Context;

    invoke-static {p3, p2, p1}, LN/a;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    iget-object v0, p0, LN/e;->a:Landroid/content/Context;
    ...
    iget-object v1, p0, LN/e;->a:Landroid/content/Context;
...
.method public final g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-virtual {p0, p1, p2}, LN/e;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-virtual {p0, p2}, LN/e;->e(Landroid/net/Uri;)I
...
.method public h(Landroid/net/Uri;LC/h;)Z
    .locals 0
    .param p1    # Landroid/net/Uri;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
