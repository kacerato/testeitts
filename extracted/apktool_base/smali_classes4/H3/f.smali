...
.method public constructor <init>(LH3/e;)V
    ...
    iput-object v0, p0, LH3/f;->X:Ljava/util/List;

    filled-new-array {v1}, [Landroid/widget/ImageView;

    move-result-object v0

    iput-object v0, p0, LH3/f;->c0:[Landroid/widget/ImageView;

    const/4 v0, 0x2

    iput v0, p0, LH3/f;->e0:I

    const/4 v0, 0x0

    invoke-super {p0, v0}, Lcom/itsmagic/engine/Activities/Editor/Interface/Objects/EditorPanel;->e1(Z)V

    iput-object p1, p0, LH3/f;->Y:LH3/e;

    return-void
.end method

.method private A1(Landroid/widget/LinearLayout;)LM7/k;
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-virtual {p0, v0, p1, v1}, LH3/f;->z1(Landroid/content/Context;Landroid/widget/LinearLayout;Landroid/view/LayoutInflater;)LM7/k;
...
.method private B1(Landroid/widget/LinearLayout;LM7/g;)V
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-direct {p0, p1}, LH3/f;->A1(Landroid/widget/LinearLayout;)LM7/k;
...
.method private C1(II)V
    ...
    iget-object p1, p0, LH3/f;->Y:LH3/e;

    invoke-interface {p1}, LH3/e;->getSelected()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, LH3/f;->d0:Ljava/lang/String;
    ...
    :cond_0
    iget-object p1, p0, LH3/f;->Z:Le7/a;

    invoke-virtual {p1}, Le7/a;->j()V

    iget-object p1, p0, LH3/f;->Z:Le7/a;

    iget-object p2, p0, LH3/f;->X:Ljava/util/List;
...
.method public static E1(Ljava/lang/String;)LJAVARuntime/Texture;
    .locals 5
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-static {p0}, LH3/f;->x1(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v1}, LH3/f;->G1(Ljava/io/File;)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-static {v0, v1}, LH3/f;->t1(Ljava/io/File;Ljava/io/File;)Z
...
.method public static G1(Ljava/io/File;)Z
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public static H1(Landroid/view/View;Lr4/a$e;LH3/e;)V
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-direct {v0, p2}, LH3/f;-><init>(LH3/e;)V
    ...
    new-instance v2, LH3/f$a;

    invoke-direct {v2, v0, p2, p0, p1}, LH3/f$a;-><init>(LH3/f;Lq7/a;Landroid/view/View;Lr4/a$e;)V
...
.method public static synthetic p1(LH3/f;)[Landroid/widget/ImageView;
    .locals 0

    iget-object p0, p0, LH3/f;->c0:[Landroid/widget/ImageView;

    return-object p0
.end method

.method public static synthetic q1(LH3/f;)LH3/e;
    .locals 0

    iget-object p0, p0, LH3/f;->Y:LH3/e;

    return-object p0
.end method

.method public static synthetic r1(LH3/f;)Ljava/lang/String;
    .locals 0

    iget-object p0, p0, LH3/f;->d0:Ljava/lang/String;

    return-object p0
.end method

.method public static synthetic s1(LH3/f;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method public static t1(Ljava/io/File;Ljava/io/File;)Z
    .locals 5
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {v0, v2}, Lcom/itsmagic/engine/Engines/Engine/Texture/Utils/TextureConfig;->m0(Lcom/itsmagic/engine/Engines/Engine/Texture/Utils/TextureConfig$d;)Lcom/itsmagic/engine/Engines/Engine/Texture/Utils/TextureConfig;

    const/16 v2, 0x10

    iput v2, v0, Lcom/itsmagic/engine/Engines/Engine/Texture/Utils/TextureConfig;->maxResolutionID:I

    iput-boolean v3, v0, Lcom/itsmagic/engine/Engines/Engine/Texture/Utils/TextureConfig;->gammaCorrection:Z

    const/16 v2, 0x64

    invoke-virtual {v0, v2}, Lcom/itsmagic/engine/Engines/Engine/Texture/Utils/TextureConfig;->B0(I)V
...
.method public static y1(Ljava/lang/String;)Ljava/io/File;
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public C0()Landroid/view/View;
    ...
    invoke-direct {v1, p0}, LH3/f$b;-><init>(LH3/f;)V
    ...
    iput-object v1, p0, LH3/f;->a0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    new-instance v4, LH3/f$c;

    invoke-direct {v4, p0}, LH3/f$c;-><init>(LH3/f;)V

    invoke-direct {v1, v3, v4}, Le7/a;-><init>(Landroid/content/Context;Le7/a$a;)V

    iput-object v1, p0, LH3/f;->Z:Le7/a;

    iget-object v3, p0, LH3/f;->a0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v1, p0, LH3/f;->a0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v4, p0, LH3/f;->Z:Le7/a;
    ...
    iput-object v1, p0, LH3/f;->b0:Lo7/a;
    ...
    invoke-direct {p0, v2, v1}, LH3/f;->C1(II)V
...
.method public D1()V
    ...
    iget-object v0, p0, LH3/f;->X:Ljava/util/List;
    ...
    :cond_0
    iget-object v4, p0, LH3/f;->X:Ljava/util/List;
...
.method public z1(Landroid/content/Context;Landroid/widget/LinearLayout;Landroid/view/LayoutInflater;)LM7/k;
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
