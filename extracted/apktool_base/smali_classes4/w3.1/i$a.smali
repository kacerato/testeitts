...
.method public constructor <init>(IILjava/util/List;)V
    ...
    iput p1, p0, Lw3/i$a;->a:I

    iput p2, p0, Lw3/i$a;->b:I

    iput-object p3, p0, Lw3/i$a;->c:Ljava/util/List;

    return-void
.end method

.method public static synthetic a(Lw3/i$a;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lw3/i$a;->c:Ljava/util/List;

    return-object p0
.end method

.method public static synthetic b(Lw3/i$a;)I
    .locals 0

    iget p0, p0, Lw3/i$a;->b:I
...
.method public static c([BI)[I
    ...
    invoke-static {p0, p1}, Lw3/i;->a([BI)I
...
.method public static e(Ljava/lang/String;)[B
    ...
    invoke-static {p0}, Lw3/i$a;->f(I)[B
...
.method public static g(Ljava/lang/String;)[B
    ...
    invoke-static {p0}, Lw3/i$a;->h(I)[B

    move-result-object p0

    array-length v1, v0

    invoke-static {v1}, Lw3/i$a;->h(I)[B
...
.method public static k([BI)Lw3/i$a;
    .locals 8
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-static {p0, v0}, Lw3/i;->a([BI)I

    move-result v0

    add-int/lit8 v1, p1, 0x4

    invoke-static {p0, v1}, Lw3/i;->b([BI)I

    move-result v1

    add-int/lit8 v2, p1, 0x8

    invoke-static {p0, v2}, Lw3/i;->b([BI)I

    move-result v2

    add-int/lit8 v3, p1, 0xc

    invoke-static {p0, v3}, Lw3/i;->b([BI)I

    move-result v3

    add-int/lit8 v4, p1, 0x10

    invoke-static {p0, v4}, Lw3/i;->b([BI)I

    move-result v4

    add-int/lit8 v5, p1, 0x14

    invoke-static {p0, v5}, Lw3/i;->b([BI)I
    ...
    invoke-static {p0, v7}, Lw3/i;->b([BI)I

    move-result v7

    add-int/2addr v7, p1

    invoke-static {p0, v7, v3}, Lw3/i$a;->l([BIZ)Ljava/lang/String;
    ...
    :cond_1
    new-instance p0, Lw3/i$a;

    invoke-direct {p0, v4, v1, v5}, Lw3/i$a;-><init>(IILjava/util/List;)V
...
.method public static l([BIZ)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lw3/i$a;->d([BI)[I
    ...
    invoke-static {p0, v2}, Lw3/i$a;->d([BI)[I
    ...
    :cond_0
    invoke-static {p0, p1}, Lw3/i$a;->c([BI)[I
...
.method public i(I)Ljava/lang/String;
    ...
    iget-object v0, p0, Lw3/i$a;->c:Ljava/util/List;
...
.method public j(Ljava/lang/String;)I
    ...
    :goto_0
    iget-object v1, p0, Lw3/i$a;->c:Ljava/util/List;
...
.method public m(Ljava/lang/String;)[B
    ...
    invoke-static {v6}, Lw3/i$a;->g(Ljava/lang/String;)[B
    ...
    :cond_1
    invoke-static {v6}, Lw3/i$a;->e(Ljava/lang/String;)[B
    ...
    invoke-static {p1, v2, v1}, Lw3/i;->c([BII)V

    const/4 v1, 0x2

    invoke-static {p1, v1, v7}, Lw3/i;->c([BII)V

    invoke-static {p1, v4, v5}, Lw3/i;->d([BII)V
    ...
    invoke-static {p1, v1, v0}, Lw3/i;->d([BII)V

    const/16 v0, 0xc

    invoke-static {p1, v0, v2}, Lw3/i;->d([BII)V

    const/16 v0, 0x10

    iget v1, p0, Lw3/i$a;->a:I

    invoke-static {p1, v0, v1}, Lw3/i;->d([BII)V

    const/16 v0, 0x14

    invoke-static {p1, v0, v6}, Lw3/i;->d([BII)V
    ...
    invoke-static {p1, v5, v1}, Lw3/i;->d([BII)V
