...
.field public static final b:LA2/d0;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, LD2/s$b;

    invoke-direct {v0}, LD2/s$b;-><init>()V

    sput-object v0, LD2/s;->b:LA2/d0;
...
.method public static A(Ljava/io/File;Ljava/nio/charset/Charset;LD2/w;)Ljava/lang/Object;
    .locals 0
    ...
    invoke-static {p0, p1}, LD2/s;->e(Ljava/io/File;Ljava/nio/charset/Charset;)LD2/j;
...
.method public static B(Ljava/io/File;Ljava/nio/charset/Charset;)Ljava/util/List;
    ...
    new-instance p1, LD2/s$a;

    invoke-direct {p1}, LD2/s$a;-><init>()V

    invoke-virtual {p0, p1}, LD2/j;->q(LD2/w;)Ljava/lang/Object;
...
.method public static C(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lw2/M;->h(C)Lw2/M;

    move-result-object v3

    invoke-virtual {v3}, Lw2/M;->g()Lw2/M;

    move-result-object v3

    invoke-virtual {v3, p0}, Lw2/M;->n(Ljava/lang/CharSequence;)Ljava/lang/Iterable;
    ...
    invoke-virtual {v0, v4}, Lw2/y;->k(Ljava/lang/Iterable;)Ljava/lang/String;
...
.method public static D(Ljava/io/File;)[B
    ...
    invoke-static {p0}, LD2/s;->c(Ljava/io/File;)LD2/f;
...
.method public static G(Ljava/lang/CharSequence;Ljava/io/File;Ljava/nio/charset/Charset;)V
    ...
    new-array v0, v0, [LD2/r;

    invoke-static {p1, p2, v0}, LD2/s;->d(Ljava/io/File;Ljava/nio/charset/Charset;[LD2/r;)LD2/i;

    move-result-object p1

    invoke-virtual {p1, p0}, LD2/i;->c(Ljava/lang/CharSequence;)V
...
.method public static H([BLjava/io/File;)V
    ...
    invoke-static {p1, v0}, LD2/s;->b(Ljava/io/File;[LD2/r;)LD2/e;

    move-result-object p1

    invoke-virtual {p1, p0}, LD2/e;->d([B)V
...
.method public static varargs b(Ljava/io/File;[LD2/r;)LD2/e;
    .locals 2

    new-instance v0, LD2/s$c;

    const/4 v1, 0x0

    invoke-direct {v0, p0, p1, v1}, LD2/s$c;-><init>(Ljava/io/File;[LD2/r;LD2/s$a;)V

    return-object v0
.end method

.method public static c(Ljava/io/File;)LD2/f;
    .locals 2

    new-instance v0, LD2/s$d;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, LD2/s$d;-><init>(Ljava/io/File;LD2/s$a;)V

    return-object v0
.end method

.method public static varargs d(Ljava/io/File;Ljava/nio/charset/Charset;[LD2/r;)LD2/i;
    .locals 0

    invoke-static {p0, p2}, LD2/s;->b(Ljava/io/File;[LD2/r;)LD2/e;

    move-result-object p0

    invoke-virtual {p0, p1}, LD2/e;->a(Ljava/nio/charset/Charset;)LD2/i;
...
.method public static e(Ljava/io/File;Ljava/nio/charset/Charset;)LD2/j;
    .locals 0
...
.method public static f(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-static {v0, v1, p0, p1}, Lw2/H;->y(ZLjava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, LD2/f;->f(LD2/e;)J
...
.method public static h(Ljava/io/File;Ljava/nio/charset/Charset;Ljava/lang/Appendable;)V
    ...
    invoke-virtual {p0, p2}, LD2/j;->f(Ljava/lang/Appendable;)J
...
.method public static k(Ljava/io/File;Ljava/io/File;)Z
    ...
    invoke-static {p1}, LD2/s;->c(Ljava/io/File;)LD2/f;

    move-result-object p1

    invoke-virtual {p0, p1}, LD2/f;->e(LD2/f;)Z
...
.method public static l()LA2/e0;
    ...
    sget-object v0, LD2/s;->b:LA2/d0;

    invoke-static {v0}, LA2/e0;->h(LA2/d0;)LA2/e0;
...
.method public static o(Ljava/io/File;LB2/q;)LB2/p;
    .locals 0
    .annotation build LI2/l;
        imports = {
            "com.google.common.io.Files"
    ...
    invoke-virtual {p0, p1}, LD2/f;->j(LB2/q;)LB2/p;
...
.method public static q()Lw2/I;
    ...
    sget-object v0, LD2/s$e;->IS_FILE:LD2/s$e;
...
.method public static r(Ljava/io/File;)Ljava/nio/MappedByteBuffer;
    ...
    invoke-static {p0, v0}, LD2/s;->s(Ljava/io/File;Ljava/nio/channels/FileChannel$MapMode;)Ljava/nio/MappedByteBuffer;
...
.method public static s(Ljava/io/File;Ljava/nio/channels/FileChannel$MapMode;)Ljava/nio/MappedByteBuffer;
    ...
    invoke-static {p0, p1, v0, v1}, LD2/s;->u(Ljava/io/File;Ljava/nio/channels/FileChannel$MapMode;J)Ljava/nio/MappedByteBuffer;
...
.method public static t(Ljava/io/File;Ljava/nio/channels/FileChannel$MapMode;J)Ljava/nio/MappedByteBuffer;
    ...
    invoke-static {p0, p1, p2, p3}, LD2/s;->u(Ljava/io/File;Ljava/nio/channels/FileChannel$MapMode;J)Ljava/nio/MappedByteBuffer;
...
.method public static u(Ljava/io/File;Ljava/nio/channels/FileChannel$MapMode;J)Ljava/nio/MappedByteBuffer;
    ...
    invoke-virtual {v0, p0}, LD2/m;->d(Ljava/io/Closeable;)Ljava/io/Closeable;
    ...
    :goto_1
    :try_start_1
    invoke-virtual {v0, p0}, LD2/m;->e(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
...
.method public static v(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-static {p0, p1}, LD2/s;->f(Ljava/io/File;Ljava/io/File;)V
...
.method public static y(Ljava/io/File;LD2/d;)Ljava/lang/Object;
    .locals 0
    .annotation runtime LD2/C;
    .end annotation
    ...
    invoke-virtual {p0, p1}, LD2/f;->n(LD2/d;)Ljava/lang/Object;
...
.method public static z(Ljava/io/File;Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, LD2/j;->o()Ljava/lang/String;
