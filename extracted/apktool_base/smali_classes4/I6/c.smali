...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LI6/c;->d:Landroid/text/TextWatcher;

    return-void
.end method

.method public static synthetic o(LI6/c;)Ljava/lang/String;
    .locals 0
...
.method private r()V
    ...
    new-instance v2, LI6/c$a;

    invoke-direct {v2, p0}, LI6/c$a;-><init>(LI6/c;)V

    invoke-direct {v1, v2}, LI6/a;-><init>(LF6/b;)V
...
.method public onClose(Landroid/content/Context;)V
    ...
    invoke-virtual {p0}, LI6/c;->hasScript()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, LI6/c;->saveScript(Landroid/content/Context;)Z

    :cond_0
    invoke-virtual {p0}, LI6/c;->unload()V
...
.method public openScript(Ljd/b;Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, LI6/c;->q(Ljava/lang/String;)V
...
.method public q(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, LI6/c;->init()V
    ...
    iput-object v0, p0, LI6/c;->c:Ljava/lang/String;
    ...
    iput-object v0, p0, LI6/c;->a:Ljava/lang/String;

    iput-object p1, p0, LI6/c;->b:Ljava/lang/String;

    if-eqz v0, :cond_0

    invoke-direct {p0, v0}, LI6/c;->p(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    iget-object p1, p0, LI6/c;->d:Landroid/text/TextWatcher;

    if-nez p1, :cond_1

    new-instance p1, LI6/c$c;

    invoke-direct {p1, p0}, LI6/c$c;-><init>(LI6/c;)V

    iput-object p1, p0, LI6/c;->d:Landroid/text/TextWatcher;
...
.method public replaceScript(Ljd/b;Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p2}, LI6/c;->saveScript(Landroid/content/Context;)Z
...
.method public saveScript(Landroid/content/Context;)Z
    ...
    iput-object v1, p0, LI6/c;->a:Ljava/lang/String;
...
.method public unload()V
    ...
    iput-object v0, p0, LI6/c;->b:Ljava/lang/String;
