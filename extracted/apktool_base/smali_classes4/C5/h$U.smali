...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = LC5/h;->H(LC5/b;Landroid/content/Context;Landroid/widget/ImageView;)V
.end annotation
...
.method public constructor <init>(LC5/b;Landroid/content/Context;Landroid/widget/ImageView;)V
    ...
    iput-object p1, p0, LC5/h$U;->a:LC5/b;

    iput-object p2, p0, LC5/h$U;->b:Landroid/content/Context;

    iput-object p3, p0, LC5/h$U;->c:Landroid/widget/ImageView;
...
.method public b(Ljd/b;)V
    ...
    iget-object v1, p0, LC5/h$U;->a:LC5/b;

    if-eqz v1, :cond_3

    iget-object v1, p0, LC5/h$U;->b:Landroid/content/Context;

    if-eqz v1, :cond_3

    :try_start_0
    iget-object v1, p0, LC5/h$U;->c:Landroid/widget/ImageView;
    ...
    iget-object v4, p0, LC5/h$U;->b:Landroid/content/Context;
    ...
    iget-object v2, p0, LC5/h$U;->c:Landroid/widget/ImageView;
    ...
    invoke-static {v2, v0, v1, v4, v3}, LVc/e;->Q(Landroid/widget/ImageView;Ljava/lang/String;Landroid/content/Context;ILcom/bumptech/glide/load/engine/i;)V
    ...
    iget-object v2, p0, LC5/h$U;->b:Landroid/content/Context;
    ...
    invoke-static {v1, v0, v2, v3}, LIc/l;->j(Landroid/widget/ImageView;Ljava/lang/String;Landroid/content/Context;Z)V

    goto :goto_1

    :cond_1
    iget-object v0, p0, LC5/h$U;->c:Landroid/widget/ImageView;
    ...
    :cond_2
    iget-object p1, p0, LC5/h$U;->a:LC5/b;
