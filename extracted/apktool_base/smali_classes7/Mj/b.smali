...
.method public b(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    :cond_1
    :goto_0
    iget-object p1, p0, LMj/b;->a:Ljavax/crypto/spec/DHParameterSpec;
...
.method public engineGetEncoded()[B
    ...
    iget-object v1, p0, LMj/b;->a:Ljavax/crypto/spec/DHParameterSpec;

    invoke-virtual {v1}, Ljavax/crypto/spec/DHParameterSpec;->getP()Ljava/math/BigInteger;

    move-result-object v1

    iget-object v2, p0, LMj/b;->a:Ljavax/crypto/spec/DHParameterSpec;

    invoke-virtual {v2}, Ljavax/crypto/spec/DHParameterSpec;->getG()Ljava/math/BigInteger;

    move-result-object v2

    iget-object v3, p0, LMj/b;->a:Ljavax/crypto/spec/DHParameterSpec;

    invoke-virtual {v3}, Ljavax/crypto/spec/DHParameterSpec;->getL()I

    move-result v3

    invoke-direct {v0, v1, v2, v3}, LXh/h;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;I)V
...
.method public engineGetEncoded(Ljava/lang/String;)[B
    ...
    .line 2
    invoke-virtual {p0, p1}, LMj/b;->a(Ljava/lang/String;)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-virtual {p0}, LMj/b;->engineGetEncoded()[B
...
.method public engineGetParameterSpec(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    invoke-virtual {p0, p1}, LMj/b;->b(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
...
.method public engineInit(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object p1, p0, LMj/b;->a:Ljavax/crypto/spec/DHParameterSpec;
...
.method public engineInit([B)V
    ...
    :try_start_0
    invoke-static {p1}, LXh/h;->v(Ljava/lang/Object;)LXh/h;
    ...
    :goto_0
    iput-object v1, p0, LMj/b;->a:Ljavax/crypto/spec/DHParameterSpec;
...
.method public engineInit([BLjava/lang/String;)V
    ...
    .line 3
    invoke-virtual {p0, p2}, LMj/b;->a(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, LMj/b;->engineInit([B)V
