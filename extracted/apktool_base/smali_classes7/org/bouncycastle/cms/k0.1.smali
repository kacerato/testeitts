...
# direct methods
.method public constructor <init>(Luh/C;Lhi/b;Lorg/bouncycastle/cms/K;)V
    .locals 1
    ...
    iput-object p1, p0, Lorg/bouncycastle/cms/k0;->g:Luh/C;

    invoke-virtual {p1}, Luh/C;->A()Luh/P;
...
.method public j(Lorg/bouncycastle/cms/E0;)Lorg/bouncycastle/cms/J0;
    ...
    check-cast p1, Lorg/bouncycastle/cms/i0;
    ...
    iget-object v2, p0, Lorg/bouncycastle/cms/k0;->g:Luh/C;
    ...
    invoke-virtual {v2}, Luh/C;->u()Loh/y;
    ...
    invoke-interface {p1, v0, v1, v2}, Lorg/bouncycastle/cms/i0;->a(Lhi/b;Lhi/b;[B)Lorg/bouncycastle/cms/J0;
