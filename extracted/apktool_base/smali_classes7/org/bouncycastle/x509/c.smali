...
.method public static b(Lorg/bouncycastle/x509/k;Ljava/util/List;)Ljava/util/Collection;
    ...
    :try_start_0
    invoke-virtual {v1, p0}, Lorg/bouncycastle/x509/r;->a(Lorg/bouncycastle/util/r;)Ljava/util/Collection;
...
.method public static d(Ljava/security/PublicKey;)Lhi/b;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-virtual {p0}, Lhi/h0;->v()Lhi/b;
...
.method public static e(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/x509/d;)V
    ...
    :try_start_1
    sget-object p1, Lhi/y0;->k:Loh/x;

    invoke-virtual {p1}, Loh/x;->J()Ljava/lang/String;

    move-result-object p1

    invoke-static {v0, p1}, Lorg/bouncycastle/x509/c;->g(Ljava/security/cert/X509Extension;Ljava/lang/String;)Loh/B;
...
.method public static g(Ljava/security/cert/X509Extension;Ljava/lang/String;)Loh/B;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    :cond_0
    invoke-static {p1, p0}, Lorg/bouncycastle/x509/c;->j(Ljava/lang/String;[B)Loh/B;
...
.method public static j(Ljava/lang/String;[B)Loh/B;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
...
.method public static final k(Loh/E;)Ljava/util/Set;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method public static r(I[Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/security/cert/X509Certificate;)V
    ...
    invoke-virtual {v3, v0}, Lorg/bouncycastle/jce/provider/I;->f(Ljava/util/Set;)V
    ...
    invoke-static {p4, v2}, Lorg/bouncycastle/x509/c;->g(Ljava/security/cert/X509Extension;Ljava/lang/String;)Loh/B;
...
.method public static s(I[Ljava/util/List;Ljava/lang/String;Lorg/bouncycastle/jce/provider/I;)Lorg/bouncycastle/jce/provider/I;
    .locals 6
    ...
    invoke-static {p3, p1, v4}, Lorg/bouncycastle/x509/c;->v(Lorg/bouncycastle/jce/provider/I;[Ljava/util/List;Lorg/bouncycastle/jce/provider/I;)Lorg/bouncycastle/jce/provider/I;
...
.method public static v(Lorg/bouncycastle/jce/provider/I;[Ljava/util/List;Lorg/bouncycastle/jce/provider/I;)Lorg/bouncycastle/jce/provider/I;
    .locals 2
    ...
    invoke-static {p1, p2}, Lorg/bouncycastle/x509/c;->w([Ljava/util/List;Lorg/bouncycastle/jce/provider/I;)V

    return-object p0
.end method

.method public static w([Ljava/util/List;Lorg/bouncycastle/jce/provider/I;)V
    .locals 1
    ...
    invoke-static {p0, v0}, Lorg/bouncycastle/x509/c;->w([Ljava/util/List;Lorg/bouncycastle/jce/provider/I;)V
