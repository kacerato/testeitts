...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jce/provider/E;-><init>(Z)V
...
.method public constructor <init>(Z)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/E;->a:Ldk/f;

    iput-boolean p1, p0, Lorg/bouncycastle/jce/provider/E;->b:Z
...
# virtual methods
.method public a(Ljava/security/cert/X509Certificate;LHj/u;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    .locals 5
    ...
    :cond_0
    invoke-virtual {p2}, LHj/u;->b()Ljava/util/Set;
    ...
    new-instance v2, Lorg/bouncycastle/jce/provider/G;

    iget-boolean v3, p0, Lorg/bouncycastle/jce/provider/E;->b:Z

    invoke-direct {v2, v3}, Lorg/bouncycastle/jce/provider/G;-><init>(Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_5

    :try_start_1
    invoke-virtual {p2}, LHj/u;->a()LHj/v;
    ...
    invoke-virtual {v4}, LHj/v;->t()Ljava/lang/String;

    move-result-object v4

    invoke-static {p1, v3, v4}, Lorg/bouncycastle/jce/provider/f;->w(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Z
    ...
    :try_start_3
    invoke-virtual {v2, v0, p2}, Lorg/bouncycastle/jce/provider/G;->engineValidate(Ljava/security/cert/CertPath;Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathValidatorResult;
    ...
    invoke-virtual {v2}, LHj/v;->n()Ljava/util/List;
    ...
    invoke-static {v2, v3}, Lorg/bouncycastle/jce/provider/f;->g([BLjava/util/Map;)Ljava/util/List;
    ...
    invoke-static {p1, v3, v0}, Lorg/bouncycastle/jce/provider/f;->c(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, v2, p2, p3}, Lorg/bouncycastle/jce/provider/E;->a(Ljava/security/cert/X509Certificate;LHj/u;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    ...
    :goto_1
    iput-object p2, p0, Lorg/bouncycastle/jce/provider/E;->c:Ljava/lang/Exception;
...
.method public b()Ljava/security/cert/PKIXCertPathChecker;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/E;->a:Ldk/f;
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-direct {v0, v1}, LHj/v$b;-><init>(Ljava/security/cert/PKIXParameters;)V

    instance-of v2, p1, Lorg/bouncycastle/x509/f;

    if-eqz v2, :cond_1

    check-cast p1, Lorg/bouncycastle/x509/e;

    invoke-virtual {p1}, Lorg/bouncycastle/x509/f;->d()Ljava/util/List;
    ...
    invoke-virtual {v0, v2}, LHj/v$b;->n(LHj/s;)LHj/v$b;

    goto :goto_0

    :cond_0
    new-instance v1, LHj/u$b;

    invoke-virtual {v0}, LHj/v$b;->q()LHj/v;

    move-result-object v0

    invoke-direct {v1, v0}, LHj/u$b;-><init>(LHj/v;)V

    invoke-virtual {p1}, Lorg/bouncycastle/x509/e;->y()Ljava/util/Set;

    move-result-object v0

    invoke-virtual {v1, v0}, LHj/u$b;->d(Ljava/util/Set;)LHj/u$b;

    invoke-virtual {p1}, Lorg/bouncycastle/x509/e;->z()I

    move-result p1

    invoke-virtual {v1, p1}, LHj/u$b;->f(I)LHj/u$b;

    goto :goto_1

    :cond_1
    new-instance p1, LHj/u$b;

    invoke-direct {p1, v1}, LHj/u$b;-><init>(Ljava/security/cert/PKIXBuilderParameters;)V

    move-object v1, p1

    :goto_1
    invoke-virtual {v1}, LHj/u$b;->e()LHj/u;
    ...
    invoke-static {p1}, Lorg/bouncycastle/jce/provider/f;->d(LHj/u;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, v2, p1, v0}, Lorg/bouncycastle/jce/provider/E;->a(Ljava/security/cert/X509Certificate;LHj/u;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    ...
    iget-object p1, p0, Lorg/bouncycastle/jce/provider/E;->c:Ljava/lang/Exception;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/E;->c:Ljava/lang/Exception;

    invoke-virtual {v0}, Ljava/lang/Throwable;->getMessage()Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lorg/bouncycastle/jce/provider/E;->c:Ljava/lang/Exception;
...
.method public bridge synthetic engineGetRevocationChecker()Ljava/security/cert/CertPathChecker;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/E;->b()Ljava/security/cert/PKIXCertPathChecker;
