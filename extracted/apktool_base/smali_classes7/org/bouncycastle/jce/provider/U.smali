...
.method public constructor <init>(Lhi/r;)V
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/jce/provider/U;->f:Z

    iput-object p1, p0, Lorg/bouncycastle/jce/provider/U;->b:Lhi/r;

    :try_start_0
    invoke-virtual {p1}, Lhi/r;->C()Lhi/b;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/U;->c:Ljava/lang/String;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/provider/U;->d:[B
    ...
    :goto_0
    invoke-static {p0}, Lorg/bouncycastle/jce/provider/U;->d(Ljava/security/cert/X509CRL;)Z

    move-result p1

    iput-boolean p1, p0, Lorg/bouncycastle/jce/provider/U;->e:Z
    :try_end_0
...
.method public static d(Ljava/security/cert/X509CRL;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
...
.method public final a(Ljava/security/PublicKey;Ljava/security/Signature;)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/U;->b:Lhi/r;

    invoke-virtual {v0}, Lhi/r;->C()Lhi/b;

    move-result-object v0

    iget-object v1, p0, Lorg/bouncycastle/jce/provider/U;->b:Lhi/r;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/U;->getTBSCertList()[B

    move-result-object p1

    invoke-virtual {p2, p1}, Ljava/security/Signature;->update([B)V

    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/U;->getSignature()[B
...
.method public final c(Z)Ljava/util/Set;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/U;->getVersion()I
...
.method public final e()Ljava/util/Set;
    ...
    new-instance v4, Lorg/bouncycastle/jce/provider/T;

    iget-boolean v5, p0, Lorg/bouncycastle/jce/provider/U;->e:Z

    invoke-direct {v4, v3, v5, v2}, Lorg/bouncycastle/jce/provider/T;-><init>(Lhi/i0$b;ZLfi/d;)V

    invoke-interface {v0, v4}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    iget-boolean v4, p0, Lorg/bouncycastle/jce/provider/U;->e:Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_1
    instance-of v0, p1, Lorg/bouncycastle/jce/provider/U;

    if-eqz v0, :cond_3

    check-cast p1, Lorg/bouncycastle/jce/provider/U;

    iget-boolean v0, p0, Lorg/bouncycastle/jce/provider/U;->f:Z

    if-eqz v0, :cond_2

    iget-boolean v0, p1, Lorg/bouncycastle/jce/provider/U;->f:Z

    if-eqz v0, :cond_2

    iget v0, p1, Lorg/bouncycastle/jce/provider/U;->g:I

    iget v2, p0, Lorg/bouncycastle/jce/provider/U;->g:I
    ...
    iget-object p1, p1, Lorg/bouncycastle/jce/provider/U;->b:Lhi/r;
...
.method public getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    invoke-virtual {p0, v0}, Lorg/bouncycastle/jce/provider/U;->c(Z)Ljava/util/Set;
...
.method public getRevokedCertificate(Ljava/math/BigInteger;)Ljava/security/cert/X509CRLEntry;
    ...
    new-instance p1, Lorg/bouncycastle/jce/provider/T;

    iget-boolean v0, p0, Lorg/bouncycastle/jce/provider/U;->e:Z

    invoke-direct {p1, v3, v0, v2}, Lorg/bouncycastle/jce/provider/T;-><init>(Lhi/i0$b;ZLfi/d;)V
...
.method public getRevokedCertificates()Ljava/util/Set;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/U;->e()Ljava/util/Set;
...
.method public getSigAlgName()Ljava/lang/String;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/U;->c:Ljava/lang/String;
...
.method public getSigAlgParams()[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/U;->d:[B
...
.method public hasUnsupportedCriticalExtension()Z
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/U;->getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    :cond_0
    sget-object v1, Lorg/bouncycastle/jce/provider/N;->e:Ljava/lang/String;

    invoke-interface {v0, v1}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v1, Lorg/bouncycastle/jce/provider/N;->g:Ljava/lang/String;
...
.method public hashCode()I
    ...
    iput v0, p0, Lorg/bouncycastle/jce/provider/U;->g:I

    :cond_0
    iget v0, p0, Lorg/bouncycastle/jce/provider/U;->g:I
...
.method public isRevoked(Ljava/security/cert/Certificate;)Z
    ...
    iget-boolean v6, p0, Lorg/bouncycastle/jce/provider/U;->e:Z
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/U;->getIssuerDN()Ljava/security/Principal;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/U;->getThisUpdate()Ljava/util/Date;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/U;->getNextUpdate()Ljava/util/Date;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/U;->getSigAlgName()Ljava/lang/String;
    ...
    :cond_1
    iget-object v3, p0, Lorg/bouncycastle/jce/provider/U;->b:Lhi/r;
    ...
    :cond_9
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/U;->getRevokedCertificates()Ljava/util/Set;
...
.method public verify(Ljava/security/PublicKey;)V
    ...
    :goto_0
    invoke-virtual {p0, p1, v0}, Lorg/bouncycastle/jce/provider/U;->a(Ljava/security/PublicKey;Ljava/security/Signature;)V
...
.method public verify(Ljava/security/PublicKey;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-virtual {p0, p1, p2}, Lorg/bouncycastle/jce/provider/U;->a(Ljava/security/PublicKey;Ljava/security/Signature;)V
