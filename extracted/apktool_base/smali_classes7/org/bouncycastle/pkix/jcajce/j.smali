.class public Lorg/bouncycastle/pkix/jcajce/j;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/pkix/jcajce/j;->a:Ljava/lang/String;
...
.method public static a(Ljava/util/Set;Ljava/lang/Object;)V
    ...
    invoke-static {p1}, Lorg/bouncycastle/pkix/jcajce/j;->j(Ljava/security/cert/X509Certificate;)Lfi/d;
    ...
    sget-object v1, Lgi/e;->V:Lfi/f;

    invoke-interface {v1, p0}, Lfi/f;->g(Lfi/d;)Ljava/lang/String;
...
.method public static b(Ljava/util/LinkedHashSet;LHj/t;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public static c(Lhi/m;Ljava/util/Map;)Ljava/util/List;
    .locals 6
...
.method public static d(Lhi/y;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/pkix/jcajce/AnnotatedException;
...
.method public static e(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/pkix/jcajce/b;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/pkix/jcajce/AnnotatedException;
    ...
    :try_start_0
    invoke-static {p1}, Lorg/bouncycastle/pkix/jcajce/j;->p(Ljava/security/cert/X509CRL;)Z
    ...
    invoke-static {p2}, Lorg/bouncycastle/pkix/jcajce/j;->j(Ljava/security/cert/X509Certificate;)Lfi/d;

    move-result-object v1

    if-nez v0, :cond_0

    invoke-static {p1}, Lorg/bouncycastle/pkix/jcajce/j;->i(Ljava/security/cert/X509CRL;)Lfi/d;

    move-result-object v2

    invoke-virtual {v1, v2}, Lfi/d;->equals(Ljava/lang/Object;)Z
    ...
    :cond_2
    invoke-static {v0}, Lorg/bouncycastle/pkix/jcajce/j;->n(Ljavax/security/auth/x500/X500Principal;)Lfi/d;
    ...
    invoke-static {p2, p1}, Lorg/bouncycastle/pkix/jcajce/j;->h(Ljava/security/cert/X509Extension;Loh/x;)Loh/B;
    ...
    :cond_5
    invoke-virtual {p3, v0}, Lorg/bouncycastle/pkix/jcajce/b;->c(I)V

    invoke-virtual {p3, p1}, Lorg/bouncycastle/pkix/jcajce/b;->d(Ljava/util/Date;)V
...
.method public static f(Lhi/y;Ljava/lang/Object;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/pkix/jcajce/AnnotatedException;,
    ...
    invoke-static {v2}, Lorg/bouncycastle/pkix/jcajce/j;->j(Ljava/security/cert/X509Certificate;)Lfi/d;

    move-result-object v2

    invoke-interface {v1, v2}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    invoke-static {p0, v1, v0}, Lorg/bouncycastle/pkix/jcajce/j;->d(Lhi/y;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    :try_end_0
    ...
    :cond_0
    new-instance p0, LHj/p$b;

    invoke-direct {p0, v0}, LHj/p$b;-><init>(Ljava/security/cert/CRLSelector;)V

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, LHj/p$b;->h(Z)LHj/p$b;

    move-result-object p0

    invoke-virtual {p0}, LHj/p$b;->g()LHj/p;

    move-result-object p0

    invoke-static {p0, p2, p3, p4}, Lorg/bouncycastle/pkix/jcajce/e;->b(LHj/p;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;

    move-result-object p0

    invoke-static {p0, p1}, Lorg/bouncycastle/pkix/jcajce/j;->a(Ljava/util/Set;Ljava/lang/Object;)V
...
.method public static g(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    :goto_0
    :try_start_2
    sget-object v3, Lorg/bouncycastle/pkix/jcajce/j;->a:Ljava/lang/String;
    ...
    invoke-virtual {v2, p1}, LHj/p$b;->k(Z)V
    ...
    invoke-static {p1, p0, p2, p3}, Lorg/bouncycastle/pkix/jcajce/e;->b(LHj/p;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-static {p2}, Lorg/bouncycastle/pkix/jcajce/j;->o(Ljava/security/cert/X509CRL;)Z
...
.method public static h(Ljava/security/cert/X509Extension;Loh/x;)Loh/B;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/pkix/jcajce/AnnotatedException;
    ...
    :cond_0
    invoke-static {p1, p0}, Lorg/bouncycastle/pkix/jcajce/j;->l(Loh/x;[B)Loh/B;
...
.method public static i(Ljava/security/cert/X509CRL;)Lfi/d;
    .locals 0
    ...
    invoke-static {p0}, Lorg/bouncycastle/pkix/jcajce/j;->n(Ljavax/security/auth/x500/X500Principal;)Lfi/d;
...
.method public static j(Ljava/security/cert/X509Certificate;)Lfi/d;
    .locals 0
...
.method public static k(Ljava/util/List;ILdk/f;)Ljava/security/PublicKey;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public static l(Loh/x;[B)Loh/B;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/pkix/jcajce/AnnotatedException;
...
.method public static m(LHj/v;Ljava/util/Date;)Ljava/util/Date;
    .locals 0
...
.method public static n(Ljavax/security/auth/x500/X500Principal;)Lfi/d;
    .locals 0
...
.method public static o(Ljava/security/cert/X509CRL;)Z
    ...
    :cond_0
    sget-object v0, Lorg/bouncycastle/pkix/jcajce/h;->c:Ljava/lang/String;
