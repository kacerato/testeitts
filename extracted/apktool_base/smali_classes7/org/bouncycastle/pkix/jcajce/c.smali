.class public Lorg/bouncycastle/pkix/jcajce/c;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/bouncycastle/pkix/jcajce/c$a;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/pkix/jcajce/c;->b:Ljava/util/Map;
...
.method public static declared-synchronized a(Ljava/security/cert/CertificateFactory;Ljava/util/Date;Ljava/net/URI;)LHj/o;
    .locals 4
    ...
    const-class v0, Lorg/bouncycastle/pkix/jcajce/c;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lorg/bouncycastle/pkix/jcajce/c;->b:Ljava/util/Map;
    ...
    invoke-interface {v1, v2}, LHj/o;->a(Lorg/bouncycastle/util/r;)Ljava/util/Collection;
    ...
    invoke-static {p0, p2}, Lorg/bouncycastle/pkix/jcajce/c;->c(Ljava/security/cert/CertificateFactory;Ljava/net/URI;)Ljava/util/Collection;
    ...
    :cond_4
    invoke-static {p0, p2}, Lorg/bouncycastle/pkix/jcajce/c;->b(Ljava/security/cert/CertificateFactory;Ljava/net/URI;)Ljava/util/Collection;

    move-result-object p0

    :goto_2
    new-instance p1, Lorg/bouncycastle/pkix/jcajce/c$a;

    new-instance v1, Lorg/bouncycastle/util/e;

    invoke-direct {v1, p0}, Lorg/bouncycastle/util/e;-><init>(Ljava/util/Collection;)V

    invoke-direct {p1, v1}, Lorg/bouncycastle/pkix/jcajce/c$a;-><init>(Lorg/bouncycastle/util/t;)V

    sget-object p0, Lorg/bouncycastle/pkix/jcajce/c;->b:Ljava/util/Map;
...
.method public static c(Ljava/security/cert/CertificateFactory;Ljava/net/URI;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
