...
.field public static final h:Ljava/lang/String; = "PBEWithSHAAndTwofish-CBC"

.field public static final i:I = 0x14

.field public static final j:I = 0x400

.field public static final k:Ljava/lang/String; = "PBEWithSHAAnd3-KeyTripleDES-CBC"
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->b:Ljava/util/Hashtable;

    invoke-static {}, LBi/r;->h()Ljava/security/SecureRandom;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->c:Ljava/security/SecureRandom;

    new-instance v0, Ldk/c;

    invoke-direct {v0}, Ldk/c;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->e:Ldk/f;

    iput p1, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->d:I
...
.method public a(Ljava/security/SecureRandom;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->c:Ljava/security/SecureRandom;
...
.method public final d(Ljava/io/DataInputStream;)Ljava/security/cert/Certificate;
    ...
    :try_start_0
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->e:Ldk/f;

    invoke-interface {p1, v0}, Ldk/f;->r(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method public final e(Ljava/io/DataInputStream;)Ljava/security/Key;
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->e:Ldk/f;

    invoke-interface {v0, v2}, Ldk/f;->s(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;
    ...
    :cond_7
    invoke-static {v3}, LXh/v;->v(Ljava/lang/Object;)LXh/v;
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    new-instance v4, LSi/k;

    new-instance v5, LIi/J;

    invoke-direct {v5}, LIi/J;-><init>()V

    invoke-direct {v4, v5}, LSi/k;-><init>(LBi/y;)V
    ...
    invoke-direct {v6}, LIi/J;-><init>()V

    invoke-direct {v5, v6}, LOi/H;-><init>(LBi/y;)V

    invoke-virtual {v5, p2, v2, v3}, LBi/L;->j([B[BI)V

    if-eq p1, v1, :cond_3

    invoke-virtual {v4}, LSi/k;->d()I

    move-result p1

    :goto_1
    invoke-virtual {v5, p1}, LBi/L;->d(I)LBi/k;
    ...
    invoke-static {p2, v1}, Lorg/bouncycastle/util/a;->e0([BB)V

    invoke-virtual {v4, p1}, LSi/k;->a(LBi/k;)V

    new-instance p1, LQi/e;

    invoke-direct {p1, v0, v4}, LQi/e;-><init>(Ljava/io/InputStream;LBi/I;)V
    ...
    invoke-virtual {v4, p1, v1}, LSi/k;->c([BI)I
...
.method public engineSetKeyEntry(Ljava/lang/String;Ljava/security/Key;[C[Ljava/security/cert/Certificate;)V
    ...
    iget-object p3, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->b:Ljava/util/Hashtable;
...
.method public engineStore(Ljava/io/OutputStream;[C)V
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->c:Ljava/security/SecureRandom;
    ...
    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->c:Ljava/security/SecureRandom;

    invoke-virtual {v3, v1}, Ljava/security/SecureRandom;->nextBytes([B)V

    iget v3, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->d:I
    ...
    invoke-direct {p1, v3}, LSi/k;-><init>(LBi/y;)V

    new-instance v3, LQi/f;

    invoke-direct {v3, p1}, LQi/f;-><init>(LBi/I;)V
    ...
    invoke-direct {v4, v5}, LOi/H;-><init>(LBi/y;)V

    invoke-static {p2}, LBi/L;->a([C)[B

    move-result-object p2

    invoke-virtual {v4, p2, v1, v2}, LBi/L;->j([B[BI)V
    ...
    :goto_0
    invoke-virtual {v4, v1}, LBi/L;->d(I)LBi/k;

    move-result-object v1

    invoke-virtual {p1, v1}, LSi/k;->a(LBi/k;)V
    ...
    :cond_1
    new-instance p2, Lfm/f;

    invoke-direct {p2, v0, v3}, Lfm/f;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V
...
.method public h(Ljava/io/InputStream;)V
    ...
    iget-object v8, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->b:Ljava/util/Hashtable;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->b:Ljava/util/Hashtable;
...
.method public i(Ljava/lang/String;I[C[BI)Ljavax/crypto/Cipher;
    ...
    iget-object p3, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->e:Ldk/f;

    invoke-interface {p3, p1}, Ldk/f;->s(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;
    ...
    iget-object p4, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->e:Ldk/f;

    invoke-interface {p4, p1}, Ldk/f;->e(Ljava/lang/String;)Ljavax/crypto/Cipher;
