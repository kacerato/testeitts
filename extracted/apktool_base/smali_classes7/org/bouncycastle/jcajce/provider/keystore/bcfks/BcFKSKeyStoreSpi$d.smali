.class public Lorg/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$d;
.super Lorg/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$f;
.source "SourceFile"
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$f;-><init>(Ldk/f;)V
...
.method public bridge synthetic engineDeleteEntry(Ljava/lang/String;)V
    ...
    invoke-super {p0, p1}, Lorg/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$f;->engineDeleteEntry(Ljava/lang/String;)V
...
.method public bridge synthetic engineGetKey(Ljava/lang/String;[C)Ljava/security/Key;
    ...
    invoke-super {p0, p1, p2}, Lorg/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$f;->engineGetKey(Ljava/lang/String;[C)Ljava/security/Key;
...
.method public bridge synthetic engineSetCertificateEntry(Ljava/lang/String;Ljava/security/cert/Certificate;)V
    ...
    invoke-super {p0, p1, p2}, Lorg/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$f;->engineSetCertificateEntry(Ljava/lang/String;Ljava/security/cert/Certificate;)V
...
.method public bridge synthetic engineSetKeyEntry(Ljava/lang/String;Ljava/security/Key;[C[Ljava/security/cert/Certificate;)V
    ...
    .line 1
    invoke-super {p0, p1, p2, p3, p4}, Lorg/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$f;->engineSetKeyEntry(Ljava/lang/String;Ljava/security/Key;[C[Ljava/security/cert/Certificate;)V
...
.method public bridge synthetic engineSetKeyEntry(Ljava/lang/String;[B[Ljava/security/cert/Certificate;)V
    ...
    .line 2
    invoke-super {p0, p1, p2, p3}, Lorg/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$f;->engineSetKeyEntry(Ljava/lang/String;[B[Ljava/security/cert/Certificate;)V
