...
.field public transient f:Loh/g;
...
.method public constructor <init>(Lhi/h0;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->b:Ljava/lang/String;

    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->g(Lhi/h0;)V
...
.method public constructor <init>(Lhk/g;LTj/c;)V
    ...
    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->d:LXi/M;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->e:Ljava/security/spec/ECParameterSpec;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->e:Ljava/security/spec/ECParameterSpec;
...
.method public constructor <init>(Ljava/lang/String;LXi/M;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->b:Ljava/lang/String;

    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->d:LXi/M;
...
.method public constructor <init>(Ljava/lang/String;LXi/M;Lhk/e;)V
    ...
    invoke-direct {p0, p1, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->a(Ljava/security/spec/EllipticCurve;LXi/G;)Ljava/security/spec/ECParameterSpec;
...
.method public constructor <init>(Ljava/lang/String;LXi/M;Ljava/security/spec/ECParameterSpec;)V
    ...
    new-instance v2, Lyh/g;

    invoke-virtual {v1}, LXi/H;->m()Loh/x;

    move-result-object v3

    invoke-virtual {v1}, LXi/H;->k()Loh/x;

    move-result-object v4

    invoke-virtual {v1}, LXi/H;->l()Loh/x;

    move-result-object v1

    invoke-direct {v2, v3, v4, v1}, Lyh/g;-><init>(Loh/x;Loh/x;Loh/x;)V

    iput-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->f:Loh/g;
    ...
    :cond_1
    iput-object p3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->e:Ljava/security/spec/ECParameterSpec;
...
.method public constructor <init>(Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;)V
    ...
    iget-object v0, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->d:LXi/M;

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->d:LXi/M;

    iget-object v0, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->e:Ljava/security/spec/ECParameterSpec;

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->e:Ljava/security/spec/ECParameterSpec;

    iget-boolean v0, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->c:Z

    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->c:Z

    iget-object p1, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->f:Loh/g;

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->f:Loh/g;
...
.method private g(Lhi/h0;)V
    ...
    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->b:Ljava/lang/String;
    ...
    invoke-static {v2, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/i;->f(LTj/c;Lhk/e;)LXi/G;

    move-result-object v2

    invoke-direct {v3, v1, v2}, LXi/M;-><init>(Ljk/i;LXi/G;)V

    iput-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->d:LXi/M;
    ...
    invoke-static {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/h;->d(Ljk/i;)Ljava/security/spec/ECPoint;
    ...
    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->e:Ljava/security/spec/ECParameterSpec;
...
.method public Ne()Ljk/i;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->e:Ljava/security/spec/ECParameterSpec;

    if-nez v0, :cond_0

    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->d:LXi/M;
...
.method public b(Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->c:Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->d:LXi/M;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->d()Lhk/e;

    move-result-object v0

    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->d()Lhk/e;
...
.method public f()Loh/g;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->f:Loh/g;
    ...
    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->f:Loh/g;
...
.method public getAlgorithm()Ljava/lang/String;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->b:Ljava/lang/String;
...
.method public getEncoded()[B
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->f()Loh/g;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->e:Ljava/security/spec/ECParameterSpec;
    ...
    iget-boolean v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->c:Z
    ...
    :cond_1
    :goto_1
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->d:LXi/M;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->d:LXi/M;
    ...
    invoke-direct {p0, v3, v4, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->e([BILjava/math/BigInteger;)V

    const/16 v1, 0x20

    invoke-direct {p0, v3, v1, v2}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/b;->e([BILjava/math/BigInteger;)V
