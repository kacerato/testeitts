...
.method private evaluateNewSimplex(Lorg/apache/commons/math3/analysis/MultivariateFunction;[Lorg/apache/commons/math3/optim/PointValuePair;DLjava/util/Comparator;)Lorg/apache/commons/math3/optim/PointValuePair;
    ...
    invoke-virtual {p0, v1, v3}, Lorg/apache/commons/math3/optim/nonlinear/scalar/noderiv/AbstractSimplex;->setPoint(ILorg/apache/commons/math3/optim/PointValuePair;)V

    invoke-virtual {p0}, Lorg/apache/commons/math3/optim/nonlinear/scalar/noderiv/AbstractSimplex;->getDimension()I
    ...
    :goto_0
    invoke-virtual {p0}, Lorg/apache/commons/math3/optim/nonlinear/scalar/noderiv/AbstractSimplex;->getSize()I
    ...
    invoke-virtual {p0, v4, v5}, Lorg/apache/commons/math3/optim/nonlinear/scalar/noderiv/AbstractSimplex;->setPoint(ILorg/apache/commons/math3/optim/PointValuePair;)V
    ...
    invoke-virtual {p0, p1, v5}, Lorg/apache/commons/math3/optim/nonlinear/scalar/noderiv/AbstractSimplex;->evaluate(Lorg/apache/commons/math3/analysis/MultivariateFunction;Ljava/util/Comparator;)V

    invoke-virtual {p0, v1}, Lorg/apache/commons/math3/optim/nonlinear/scalar/noderiv/AbstractSimplex;->getPoint(I)Lorg/apache/commons/math3/optim/PointValuePair;
...
.method public iterate(Lorg/apache/commons/math3/analysis/MultivariateFunction;Ljava/util/Comparator;)V
    ...
    invoke-virtual {p0}, Lorg/apache/commons/math3/optim/nonlinear/scalar/noderiv/AbstractSimplex;->getPoints()[Lorg/apache/commons/math3/optim/PointValuePair;
    ...
    invoke-virtual {p0, v7}, Lorg/apache/commons/math3/optim/nonlinear/scalar/noderiv/AbstractSimplex;->setPoints([Lorg/apache/commons/math3/optim/PointValuePair;)V
