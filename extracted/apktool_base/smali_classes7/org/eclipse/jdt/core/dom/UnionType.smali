.class public Lorg/eclipse/jdt/core/dom/UnionType;
...
.method static constructor <clinit>()V
    ...
    const-class v3, Lorg/eclipse/jdt/core/dom/UnionType;
    ...
    sput-object v0, Lorg/eclipse/jdt/core/dom/UnionType;->TYPES_PROPERTY:Lorg/eclipse/jdt/core/dom/ChildListPropertyDescriptor;
    ...
    sput-object v0, Lorg/eclipse/jdt/core/dom/UnionType;->PROPERTY_DESCRIPTORS:Ljava/util/List;
...
.method public constructor <init>(Lorg/eclipse/jdt/core/dom/AST;)V
    ...
    sget-object v0, Lorg/eclipse/jdt/core/dom/UnionType;->TYPES_PROPERTY:Lorg/eclipse/jdt/core/dom/ChildListPropertyDescriptor;
    ...
    iput-object p1, p0, Lorg/eclipse/jdt/core/dom/UnionType;->types:Lorg/eclipse/jdt/core/dom/ASTNode$NodeList;
...
.method public static propertyDescriptors(I)Ljava/util/List;
    ...
    sget-object p0, Lorg/eclipse/jdt/core/dom/UnionType;->PROPERTY_DESCRIPTORS:Ljava/util/List;
...
.method public accept0(Lorg/eclipse/jdt/core/dom/ASTVisitor;)V
    ...
    invoke-virtual {p1, p0}, Lorg/eclipse/jdt/core/dom/ASTVisitor;->visit(Lorg/eclipse/jdt/core/dom/UnionType;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lorg/eclipse/jdt/core/dom/UnionType;->types:Lorg/eclipse/jdt/core/dom/ASTNode$NodeList;
    ...
    :cond_0
    invoke-virtual {p1, p0}, Lorg/eclipse/jdt/core/dom/ASTVisitor;->endVisit(Lorg/eclipse/jdt/core/dom/UnionType;)V
...
.method public clone0(Lorg/eclipse/jdt/core/dom/AST;)Lorg/eclipse/jdt/core/dom/ASTNode;
    ...
    invoke-direct {v0, p1}, Lorg/eclipse/jdt/core/dom/UnionType;-><init>(Lorg/eclipse/jdt/core/dom/AST;)V
    ...
    invoke-virtual {v0}, Lorg/eclipse/jdt/core/dom/UnionType;->types()Ljava/util/List;

    move-result-object v1

    invoke-virtual {p0}, Lorg/eclipse/jdt/core/dom/UnionType;->types()Ljava/util/List;
...
.method public final internalStructuralPropertiesForType(I)Ljava/util/List;
    ...
    invoke-static {p1}, Lorg/eclipse/jdt/core/dom/UnionType;->propertyDescriptors(I)Ljava/util/List;
...
.method public final subtreeMatch0(Lorg/eclipse/jdt/core/dom/ASTMatcher;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p1, p0, p2}, Lorg/eclipse/jdt/core/dom/ASTMatcher;->match(Lorg/eclipse/jdt/core/dom/UnionType;Ljava/lang/Object;)Z
...
.method public treeSize()I
    ...
    invoke-virtual {p0}, Lorg/eclipse/jdt/core/dom/UnionType;->memSize()I

    move-result v0

    iget-object v1, p0, Lorg/eclipse/jdt/core/dom/UnionType;->types:Lorg/eclipse/jdt/core/dom/ASTNode$NodeList;
