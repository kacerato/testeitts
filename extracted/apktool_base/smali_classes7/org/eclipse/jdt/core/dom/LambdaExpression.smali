.class public Lorg/eclipse/jdt/core/dom/LambdaExpression;
...
.field public static final PARENTHESES_PROPERTY:Lorg/eclipse/jdt/core/dom/SimplePropertyDescriptor;

.field private static final PROPERTY_DESCRIPTORS_8_0:Ljava/util/List;


# instance fields
.field private body:Lorg/eclipse/jdt/core/dom/ASTNode;

.field private hasParentheses:Z
...
.method static constructor <clinit>()V
    ...
    const-class v2, Lorg/eclipse/jdt/core/dom/LambdaExpression;

    const-string v3, "parentheses"
    ...
    sput-object v0, Lorg/eclipse/jdt/core/dom/LambdaExpression;->PARENTHESES_PROPERTY:Lorg/eclipse/jdt/core/dom/SimplePropertyDescriptor;

    new-instance v1, Lorg/eclipse/jdt/core/dom/ChildListPropertyDescriptor;

    const-string v3, "parameters"

    const-class v5, Lorg/eclipse/jdt/core/dom/VariableDeclaration;
    ...
    sput-object v1, Lorg/eclipse/jdt/core/dom/LambdaExpression;->PARAMETERS_PROPERTY:Lorg/eclipse/jdt/core/dom/ChildListPropertyDescriptor;
    ...
    const-class v7, Lorg/eclipse/jdt/core/dom/LambdaExpression;

    const-string v8, "body"

    const-class v9, Lorg/eclipse/jdt/core/dom/ASTNode;
    ...
    sput-object v3, Lorg/eclipse/jdt/core/dom/LambdaExpression;->BODY_PROPERTY:Lorg/eclipse/jdt/core/dom/ChildPropertyDescriptor;
    ...
    sput-object v0, Lorg/eclipse/jdt/core/dom/LambdaExpression;->PROPERTY_DESCRIPTORS_8_0:Ljava/util/List;
...
.method public constructor <init>(Lorg/eclipse/jdt/core/dom/AST;)V
    ...
    iput-boolean p1, p0, Lorg/eclipse/jdt/core/dom/LambdaExpression;->hasParentheses:Z
    ...
    iput-object p1, p0, Lorg/eclipse/jdt/core/dom/LambdaExpression;->parameters:Lorg/eclipse/jdt/core/dom/ASTNode$NodeList;

    const/4 p1, 0x0

    iput-object p1, p0, Lorg/eclipse/jdt/core/dom/LambdaExpression;->body:Lorg/eclipse/jdt/core/dom/ASTNode;
...
.method public static propertyDescriptors(I)Ljava/util/List;
    ...
    sget-object p0, Lorg/eclipse/jdt/core/dom/LambdaExpression;->PROPERTY_DESCRIPTORS_8_0:Ljava/util/List;
...
.method public accept0(Lorg/eclipse/jdt/core/dom/ASTVisitor;)V
    ...
    invoke-virtual {p1, p0}, Lorg/eclipse/jdt/core/dom/ASTVisitor;->visit(Lorg/eclipse/jdt/core/dom/LambdaExpression;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lorg/eclipse/jdt/core/dom/LambdaExpression;->parameters:Lorg/eclipse/jdt/core/dom/ASTNode$NodeList;
    ...
    invoke-virtual {p0}, Lorg/eclipse/jdt/core/dom/LambdaExpression;->getBody()Lorg/eclipse/jdt/core/dom/ASTNode;
    ...
    :cond_0
    invoke-virtual {p1, p0}, Lorg/eclipse/jdt/core/dom/ASTVisitor;->endVisit(Lorg/eclipse/jdt/core/dom/LambdaExpression;)V
...
.method public clone0(Lorg/eclipse/jdt/core/dom/AST;)Lorg/eclipse/jdt/core/dom/ASTNode;
    ...
    invoke-direct {v0, p1}, Lorg/eclipse/jdt/core/dom/LambdaExpression;-><init>(Lorg/eclipse/jdt/core/dom/AST;)V
    ...
    invoke-virtual {p0}, Lorg/eclipse/jdt/core/dom/LambdaExpression;->hasParentheses()Z

    move-result v1

    invoke-virtual {v0, v1}, Lorg/eclipse/jdt/core/dom/LambdaExpression;->setParentheses(Z)V

    invoke-virtual {v0}, Lorg/eclipse/jdt/core/dom/LambdaExpression;->parameters()Ljava/util/List;

    move-result-object v1

    invoke-virtual {p0}, Lorg/eclipse/jdt/core/dom/LambdaExpression;->parameters()Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Lorg/eclipse/jdt/core/dom/LambdaExpression;->setBody(Lorg/eclipse/jdt/core/dom/ASTNode;)V

    return-object v0
.end method

.method public getBody()Lorg/eclipse/jdt/core/dom/ASTNode;
    .locals 2

    iget-object v0, p0, Lorg/eclipse/jdt/core/dom/LambdaExpression;->body:Lorg/eclipse/jdt/core/dom/ASTNode;
    ...
    iput-object v0, p0, Lorg/eclipse/jdt/core/dom/LambdaExpression;->body:Lorg/eclipse/jdt/core/dom/ASTNode;

    sget-object v1, Lorg/eclipse/jdt/core/dom/LambdaExpression;->BODY_PROPERTY:Lorg/eclipse/jdt/core/dom/ChildPropertyDescriptor;
...
.method public hasParentheses()Z
    ...
    iget-boolean v0, p0, Lorg/eclipse/jdt/core/dom/LambdaExpression;->hasParentheses:Z
...
.method public final internalGetSetBooleanProperty(Lorg/eclipse/jdt/core/dom/SimplePropertyDescriptor;ZZ)Z
    ...
    :cond_0
    invoke-virtual {p0, p3}, Lorg/eclipse/jdt/core/dom/LambdaExpression;->setParentheses(Z)V
...
.method public final internalGetSetChildProperty(Lorg/eclipse/jdt/core/dom/ChildPropertyDescriptor;ZLorg/eclipse/jdt/core/dom/ASTNode;)Lorg/eclipse/jdt/core/dom/ASTNode;
    ...
    :cond_0
    invoke-virtual {p0, p3}, Lorg/eclipse/jdt/core/dom/LambdaExpression;->setBody(Lorg/eclipse/jdt/core/dom/ASTNode;)V
...
.method public final internalStructuralPropertiesForType(I)Ljava/util/List;
    ...
    invoke-static {p1}, Lorg/eclipse/jdt/core/dom/LambdaExpression;->propertyDescriptors(I)Ljava/util/List;
...
.method public resolveMethodBinding()Lorg/eclipse/jdt/core/dom/IMethodBinding;
    ...
    invoke-virtual {v0, p0}, Lorg/eclipse/jdt/core/dom/BindingResolver;->resolveMethod(Lorg/eclipse/jdt/core/dom/LambdaExpression;)Lorg/eclipse/jdt/core/dom/IMethodBinding;
...
.method public setBody(Lorg/eclipse/jdt/core/dom/ASTNode;)V
    .locals 2

    instance-of v0, p1, Lorg/eclipse/jdt/core/dom/Expression;
...
.method public setParentheses(Z)V
    .locals 1
...
.method public final subtreeMatch0(Lorg/eclipse/jdt/core/dom/ASTMatcher;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p1, p0, p2}, Lorg/eclipse/jdt/core/dom/ASTMatcher;->match(Lorg/eclipse/jdt/core/dom/LambdaExpression;Ljava/lang/Object;)Z
...
.method public treeSize()I
    ...
    invoke-virtual {p0}, Lorg/eclipse/jdt/core/dom/LambdaExpression;->memSize()I

    move-result v0

    iget-object v1, p0, Lorg/eclipse/jdt/core/dom/LambdaExpression;->parameters:Lorg/eclipse/jdt/core/dom/ASTNode$NodeList;
    ...
    iget-object v1, p0, Lorg/eclipse/jdt/core/dom/LambdaExpression;->body:Lorg/eclipse/jdt/core/dom/ASTNode;
