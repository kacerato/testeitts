.class public Lorg/eclipse/jdt/core/dom/ProvidesDirective;
.super Lorg/eclipse/jdt/core/dom/ModuleDirective;
.source "SourceFile"


# static fields
.field public static final IMPLEMENTATIONS_PROPERTY:Lorg/eclipse/jdt/core/dom/ChildListPropertyDescriptor;
...
# instance fields
.field private implementations:Lorg/eclipse/jdt/core/dom/ASTNode$NodeList;
...
.method static constructor <clinit>()V
    ...
    const-class v1, Lorg/eclipse/jdt/core/dom/ProvidesDirective;
    ...
    sput-object v6, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->NAME_PROPERTY:Lorg/eclipse/jdt/core/dom/ChildPropertyDescriptor;
    ...
    const-class v3, Lorg/eclipse/jdt/core/dom/ProvidesDirective;

    const-string v4, "implementations"
    ...
    sput-object v0, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->IMPLEMENTATIONS_PROPERTY:Lorg/eclipse/jdt/core/dom/ChildListPropertyDescriptor;
    ...
    sput-object v0, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->PROPERTY_DESCRIPTORS_9_0:Ljava/util/List;
...
.method public constructor <init>(Lorg/eclipse/jdt/core/dom/AST;)V
    ...
    iput-object p1, p0, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->name:Lorg/eclipse/jdt/core/dom/Name;

    new-instance p1, Lorg/eclipse/jdt/core/dom/ASTNode$NodeList;

    sget-object v0, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->IMPLEMENTATIONS_PROPERTY:Lorg/eclipse/jdt/core/dom/ChildListPropertyDescriptor;
    ...
    iput-object p1, p0, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->implementations:Lorg/eclipse/jdt/core/dom/ASTNode$NodeList;
...
.method public static propertyDescriptors(I)Ljava/util/List;
    ...
    sget-object p0, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->PROPERTY_DESCRIPTORS_9_0:Ljava/util/List;
...
.method public accept0(Lorg/eclipse/jdt/core/dom/ASTVisitor;)V
    ...
    invoke-virtual {p1, p0}, Lorg/eclipse/jdt/core/dom/ASTVisitor;->visit(Lorg/eclipse/jdt/core/dom/ProvidesDirective;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->getName()Lorg/eclipse/jdt/core/dom/Name;
    ...
    iget-object v0, p0, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->implementations:Lorg/eclipse/jdt/core/dom/ASTNode$NodeList;
    ...
    :cond_0
    invoke-virtual {p1, p0}, Lorg/eclipse/jdt/core/dom/ASTVisitor;->endVisit(Lorg/eclipse/jdt/core/dom/ProvidesDirective;)V
...
.method public clone0(Lorg/eclipse/jdt/core/dom/AST;)Lorg/eclipse/jdt/core/dom/ASTNode;
    ...
    invoke-direct {v0, p1}, Lorg/eclipse/jdt/core/dom/ProvidesDirective;-><init>(Lorg/eclipse/jdt/core/dom/AST;)V
    ...
    invoke-virtual {v0, v1}, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->setName(Lorg/eclipse/jdt/core/dom/Name;)V

    invoke-virtual {v0}, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->implementations()Ljava/util/List;

    move-result-object v1

    invoke-virtual {p0}, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->implementations()Ljava/util/List;
...
.method public getName()Lorg/eclipse/jdt/core/dom/Name;
    ...
    iget-object v0, p0, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->name:Lorg/eclipse/jdt/core/dom/Name;
    ...
    iput-object v0, p0, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->name:Lorg/eclipse/jdt/core/dom/Name;

    sget-object v1, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->NAME_PROPERTY:Lorg/eclipse/jdt/core/dom/ChildPropertyDescriptor;
...
.method public implementations()Ljava/util/List;
    .locals 1
...
.method public final internalGetSetChildProperty(Lorg/eclipse/jdt/core/dom/ChildPropertyDescriptor;ZLorg/eclipse/jdt/core/dom/ASTNode;)Lorg/eclipse/jdt/core/dom/ASTNode;
    ...
    invoke-virtual {p0, p3}, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->setName(Lorg/eclipse/jdt/core/dom/Name;)V
...
.method public final internalStructuralPropertiesForType(I)Ljava/util/List;
    ...
    invoke-static {p1}, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->propertyDescriptors(I)Ljava/util/List;
...
.method public final subtreeMatch0(Lorg/eclipse/jdt/core/dom/ASTMatcher;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p1, p0, p2}, Lorg/eclipse/jdt/core/dom/ASTMatcher;->match(Lorg/eclipse/jdt/core/dom/ProvidesDirective;Ljava/lang/Object;)Z
...
.method public treeSize()I
    ...
    invoke-virtual {p0}, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->memSize()I

    move-result v0

    iget-object v1, p0, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->name:Lorg/eclipse/jdt/core/dom/Name;
    ...
    iget-object v1, p0, Lorg/eclipse/jdt/core/dom/ProvidesDirective;->implementations:Lorg/eclipse/jdt/core/dom/ASTNode$NodeList;
