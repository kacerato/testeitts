.class public Lorg/eclipse/jdt/core/dom/Dimension;
...
.method static constructor <clinit>()V
    ...
    const-class v3, Lorg/eclipse/jdt/core/dom/Dimension;
    ...
    sput-object v0, Lorg/eclipse/jdt/core/dom/Dimension;->ANNOTATIONS_PROPERTY:Lorg/eclipse/jdt/core/dom/ChildListPropertyDescriptor;
    ...
    sput-object v0, Lorg/eclipse/jdt/core/dom/Dimension;->PROPERTY_DESCRIPTORS_8_0:Ljava/util/List;
...
.method public constructor <init>(Lorg/eclipse/jdt/core/dom/AST;)V
    ...
    iput-object p1, p0, Lorg/eclipse/jdt/core/dom/Dimension;->annotations:Lorg/eclipse/jdt/core/dom/ASTNode$NodeList;
...
.method public static propertyDescriptors(I)Ljava/util/List;
    ...
    sget-object p0, Lorg/eclipse/jdt/core/dom/Dimension;->PROPERTY_DESCRIPTORS_8_0:Ljava/util/List;
...
.method public accept0(Lorg/eclipse/jdt/core/dom/ASTVisitor;)V
    ...
    invoke-virtual {p1, p0}, Lorg/eclipse/jdt/core/dom/ASTVisitor;->visit(Lorg/eclipse/jdt/core/dom/Dimension;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lorg/eclipse/jdt/core/dom/Dimension;->annotations:Lorg/eclipse/jdt/core/dom/ASTNode$NodeList;
    ...
    :cond_0
    invoke-virtual {p1, p0}, Lorg/eclipse/jdt/core/dom/ASTVisitor;->endVisit(Lorg/eclipse/jdt/core/dom/Dimension;)V
...
.method public clone0(Lorg/eclipse/jdt/core/dom/AST;)Lorg/eclipse/jdt/core/dom/ASTNode;
    ...
    invoke-direct {v0, p1}, Lorg/eclipse/jdt/core/dom/Dimension;-><init>(Lorg/eclipse/jdt/core/dom/AST;)V

    invoke-virtual {v0}, Lorg/eclipse/jdt/core/dom/Dimension;->annotations()Ljava/util/List;

    move-result-object v1

    invoke-virtual {p0}, Lorg/eclipse/jdt/core/dom/Dimension;->annotations()Ljava/util/List;
...
.method public final internalStructuralPropertiesForType(I)Ljava/util/List;
    ...
    invoke-static {p1}, Lorg/eclipse/jdt/core/dom/Dimension;->propertyDescriptors(I)Ljava/util/List;
...
.method public final subtreeMatch0(Lorg/eclipse/jdt/core/dom/ASTMatcher;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p1, p0, p2}, Lorg/eclipse/jdt/core/dom/ASTMatcher;->match(Lorg/eclipse/jdt/core/dom/Dimension;Ljava/lang/Object;)Z
...
.method public treeSize()I
    ...
    invoke-virtual {p0}, Lorg/eclipse/jdt/core/dom/Dimension;->memSize()I

    move-result v0

    iget-object v1, p0, Lorg/eclipse/jdt/core/dom/Dimension;->annotations:Lorg/eclipse/jdt/core/dom/ASTNode$NodeList;
