...
.method static constructor <clinit>()V
    ...
    sput-object v0, LOk/b;->a:Ljava/util/Map;

    new-instance v1, Ljava/util/HashSet;

    invoke-direct {v1}, Ljava/util/HashSet;-><init>()V

    sput-object v1, LOk/b;->b:Ljava/util/Set;

    new-instance v2, Ljava/util/HashSet;

    invoke-direct {v2}, Ljava/util/HashSet;-><init>()V

    sput-object v2, LOk/b;->c:Ljava/util/Set;

    sget-object v3, LXh/t;->a1:Loh/x;

    invoke-interface {v1, v3}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    sget-object v3, LXh/t;->c1:Loh/x;

    invoke-interface {v1, v3}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    sget-object v3, LXh/t;->d1:Loh/x;

    invoke-interface {v1, v3}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    sget-object v3, LXh/t;->e1:Loh/x;

    invoke-interface {v1, v3}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    sget-object v3, LXh/t;->f1:Loh/x;
    ...
    sget-object v3, LSh/d;->y:Loh/x;

    invoke-interface {v2, v3}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    sget-object v4, LSh/d;->H:Loh/x;
...
.method public static a(Z[B[CLjava/lang/String;[B)[B
    ...
    invoke-static {v2, v5, v4, v3}, LOk/b;->d([CI[BZ)LXi/o0;

    move-result-object v2

    new-instance v3, LLi/v;

    invoke-direct {v3}, LLi/v;-><init>()V
    ...
    invoke-static {v2, v13, v4}, LOk/b;->c([CI[B)LXi/o0;

    move-result-object v2

    new-instance v3, LLi/u;

    invoke-direct {v3}, LLi/u;-><init>()V
    ...
    invoke-static {v2, v3, v4}, LOk/b;->c([CI[B)LXi/o0;

    move-result-object v2

    new-instance v3, LLi/j;

    invoke-direct {v3}, LLi/j;-><init>()V
    ...
    :cond_8
    :goto_4
    new-instance v3, LXi/B0;

    div-int/lit8 v5, v11, 0x8

    invoke-static {v2, v5, v4}, LOk/b;->c([CI[B)LXi/o0;
    ...
    invoke-direct {v3, v2, v11}, LXi/B0;-><init>([BI)V
    ...
    invoke-static {v2, v11, v4}, LOk/b;->c([CI[B)LXi/o0;
    ...
    invoke-static {v3}, LTi/c;->m(LBi/f;)LTi/d;
    ...
    invoke-static {v3, v4}, LTi/g;->q(LBi/f;I)LTi/h;
    ...
    invoke-direct {v4, v3, v5}, LTi/C;-><init>(LBi/f;I)V
    ...
    :try_start_0
    new-instance v4, LBi/h;

    invoke-direct {v4, v3}, LBi/h;-><init>(LBi/f;)V
    ...
    invoke-direct {v4, v3, v8}, LWi/e;-><init>(LBi/f;LWi/a;)V
    ...
    invoke-virtual {v6, v0, v2}, LBi/h;->f(ZLBi/k;)V
    ...
    invoke-direct {v3, v2, v10}, LXi/w0;-><init>(LBi/k;[B)V

    invoke-virtual {v6, v0, v3}, LBi/h;->f(ZLBi/k;)V

    :goto_a
    array-length v0, v1

    invoke-virtual {v6, v0}, LBi/h;->c(I)I
    ...
    invoke-virtual {v6, v8, v0}, LBi/h;->a([BI)I
...
.method public static b(Ljava/lang/String;[C[BI)LXi/o0;
    .locals 2
    ...
    invoke-virtual {v0, p1, p2, p3}, LBi/L;->j([B[BI)V

    invoke-static {p0}, LOk/b;->e(Ljava/lang/String;)I
...
.method public static c([CI[B)LXi/o0;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/openssl/PEMException;
    ...
    invoke-static {p0, p1, p2, v0}, LOk/b;->d([CI[BZ)LXi/o0;
...
.method public static d([CI[BZ)LXi/o0;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/openssl/PEMException;
    ...
    invoke-virtual {v0, p0, p2, v1}, LBi/L;->j([B[BI)V

    const/16 p0, 0x8

    mul-int/2addr p1, p0

    invoke-virtual {v0, p1}, LBi/L;->e(I)LBi/k;
    ...
    new-instance p0, LXi/o0;

    invoke-direct {p0, p1}, LXi/o0;-><init>([B)V
...
.method public static e(Ljava/lang/String;)I
    ...
    sget-object v0, LOk/b;->a:Ljava/util/Map;
...
.method public static g(Loh/x;)Z
    .locals 1

    sget-object v0, LOk/b;->b:Ljava/util/Set;
...
.method public static h(Loh/x;)Z
    .locals 1

    sget-object v0, LOk/b;->c:Ljava/util/Set;
