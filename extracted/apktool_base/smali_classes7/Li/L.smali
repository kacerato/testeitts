...
.field public i:LXi/h0;

.field public j:[B

.field public k:LOi/u;

.field public l:LBi/H;
...
.method public constructor <init>(LBi/e;LBi/w;LBi/I;)V
    ...
    iput-object p1, p0, LLi/L;->a:LBi/e;

    iput-object p2, p0, LLi/L;->b:LBi/w;

    iput-object p3, p0, LLi/L;->c:LBi/I;
    ...
    iput-object p1, p0, LLi/L;->d:LBi/h;
...
.method public constructor <init>(LBi/e;LBi/w;LBi/I;LBi/h;)V
    ...
    iput-object p4, p0, LLi/L;->d:LBi/h;
...
.method public final a([BII)[B
    ...
    iget-object v0, p0, LLi/L;->j:[B

    array-length v0, v0

    iget-object v1, p0, LLi/L;->c:LBi/I;
    ...
    iget-object v0, p0, LLi/L;->d:LBi/h;
    ...
    iget-object v2, p0, LLi/L;->c:LBi/I;
    ...
    iget-object v3, p0, LLi/L;->i:LXi/h0;
    ...
    iget-object v7, p0, LLi/L;->b:LBi/w;

    invoke-interface {v7, v6, v1, v5}, LBi/w;->a([BII)I

    iget-object v5, p0, LLi/L;->j:[B
    ...
    :cond_2
    iget-object v0, p0, LLi/L;->i:LXi/h0;
    ...
    :cond_3
    iget-object v2, p0, LLi/L;->d:LBi/h;

    invoke-virtual {v2, v1, v0}, LBi/h;->f(ZLBi/k;)V

    iget-object v0, p0, LLi/L;->d:LBi/h;

    iget-object v2, p0, LLi/L;->j:[B

    array-length v2, v2

    sub-int v2, p3, v2

    iget-object v3, p0, LLi/L;->c:LBi/I;
    ...
    iget-object v5, p0, LLi/L;->d:LBi/h;
    ...
    :goto_2
    iget-object v2, p0, LLi/L;->i:LXi/h0;
    ...
    invoke-virtual {p0, v2}, LLi/L;->e([B)[B
    ...
    iget-object v7, p0, LLi/L;->c:LBi/I;
    ...
    iget-object v9, p0, LLi/L;->c:LBi/I;

    new-instance v10, LXi/o0;

    invoke-direct {v10, v4}, LXi/o0;-><init>([B)V

    invoke-interface {v9, v10}, LBi/I;->a(LBi/k;)V

    iget-object v4, p0, LLi/L;->c:LBi/I;

    iget-object v9, p0, LLi/L;->j:[B
    ...
    iget-object p1, p0, LLi/L;->c:LBi/I;
    ...
    iget-object p1, p0, LLi/L;->d:LBi/h;
...
.method public final b([BII)[B
    ...
    iget-object v6, p0, LLi/L;->b:LBi/w;

    invoke-interface {v6, v5, v1, v4}, LBi/w;->a([BII)I

    iget-object v4, p0, LLi/L;->j:[B
    ...
    iget-object p2, p0, LLi/L;->d:LBi/h;
    ...
    :cond_3
    iget-object p1, p0, LLi/L;->i:LXi/h0;

    invoke-virtual {p1}, LXi/h0;->b()[B

    move-result-object p1

    iget-object p2, p0, LLi/L;->j:[B

    array-length p2, p2

    if-eqz p2, :cond_4

    invoke-virtual {p0, p1}, LLi/L;->e([B)[B
    ...
    :goto_4
    iget-object v0, p0, LLi/L;->c:LBi/I;
    ...
    iget-object v5, p0, LLi/L;->c:LBi/I;

    new-instance v6, LXi/o0;

    invoke-direct {v6, v3}, LXi/o0;-><init>([B)V

    invoke-interface {v5, v6}, LBi/I;->a(LBi/k;)V
...
.method public final c(LBi/k;)V
    ...
    iput-object p1, p0, LLi/L;->i:LXi/h0;
...
.method public g(LXi/c;LBi/k;LBi/H;)V
    ...
    iput-boolean v0, p0, LLi/L;->f:Z

    iput-object p1, p0, LLi/L;->g:LBi/k;

    iput-object p3, p0, LLi/L;->l:LBi/H;

    invoke-virtual {p0, p2}, LLi/L;->c(LBi/k;)V
...
.method public h(LXi/c;LBi/k;LOi/u;)V
    ...
    iput-object p1, p0, LLi/L;->h:LBi/k;

    iput-object p3, p0, LLi/L;->k:LOi/u;
...
.method public i(ZLBi/k;LBi/k;LBi/k;)V
    ...
    iput-boolean p1, p0, LLi/L;->f:Z

    iput-object p2, p0, LLi/L;->g:LBi/k;

    iput-object p3, p0, LLi/L;->h:LBi/k;

    const/4 p1, 0x0

    new-array p1, p1, [B

    iput-object p1, p0, LLi/L;->j:[B

    invoke-virtual {p0, p4}, LLi/L;->c(LBi/k;)V
...
.method public j([BII)[B
    ...
    iget-boolean v1, p0, LLi/L;->f:Z

    if-eqz v1, :cond_0

    iget-object v0, p0, LLi/L;->k:LOi/u;
    ...
    iput-object v1, p0, LLi/L;->g:LBi/k;

    invoke-virtual {v0}, LBi/C;->a()[B

    move-result-object v0

    iput-object v0, p0, LLi/L;->j:[B

    goto :goto_2

    :cond_0
    iget-object v1, p0, LLi/L;->l:LBi/H;
    ...
    :try_start_0
    iget-object v2, p0, LLi/L;->l:LBi/H;

    invoke-interface {v2, v1}, LBi/H;->a(Ljava/io/InputStream;)LXi/c;

    move-result-object v2

    iput-object v2, p0, LLi/L;->h:LBi/k;
    :try_end_0
    ...
    :cond_1
    :goto_2
    iget-object v0, p0, LLi/L;->a:LBi/e;

    iget-object v1, p0, LLi/L;->g:LBi/k;

    invoke-interface {v0, v1}, LBi/e;->a(LBi/k;)V

    iget-object v0, p0, LLi/L;->a:LBi/e;

    iget-object v1, p0, LLi/L;->h:LBi/k;

    invoke-interface {v0, v1}, LBi/e;->b(LBi/k;)Ljava/math/BigInteger;

    move-result-object v0

    iget-object v1, p0, LLi/L;->a:LBi/e;
    ...
    iget-object v2, p0, LLi/L;->b:LBi/w;
    ...
    invoke-virtual {p0, p1, p2, p3}, LLi/L;->b([BII)[B
    ...
    :cond_3
    invoke-virtual {p0, p1, p2, p3}, LLi/L;->a([BII)[B
