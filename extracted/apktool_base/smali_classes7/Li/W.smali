...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LLi/W;->g:LBi/y;

    const/16 v0, 0x14

    new-array v0, v0, [B

    iput-object v0, p0, LLi/W;->h:[B
...
.method private e([B)[B
    ...
    iget-object v2, p0, LLi/W;->g:LBi/y;
    ...
    iget-object p1, p0, LLi/W;->g:LBi/y;

    iget-object v2, p0, LLi/W;->h:[B

    invoke-interface {p1, v2, v4}, LBi/y;->c([BI)I

    iget-object p1, p0, LLi/W;->h:[B
...
.method private f([B[B)Z
    ...
    invoke-direct {p0, p1}, LLi/W;->e([B)[B
...
.method public a(ZLBi/k;)V
    ...
    iput-object p1, p0, LLi/W;->f:Ljava/security/SecureRandom;
    ...
    iput-object p1, p0, LLi/W;->b:LBi/k;
    ...
    :cond_3
    iput-object p2, p0, LLi/W;->b:LBi/k;
    ...
    iget-object p2, p0, LLi/W;->f:Ljava/security/SecureRandom;

    invoke-virtual {p2, p1}, Ljava/security/SecureRandom;->nextBytes([B)V

    new-instance p1, LXi/w0;

    iget-object p2, p0, LLi/W;->b:LBi/k;
...
.method public c([BII)[B
    ...
    iget-object p3, p0, LLi/W;->f:Ljava/security/SecureRandom;
    ...
    :cond_1
    invoke-direct {p0, v2}, LLi/W;->e([B)[B
    ...
    iget-object v1, p0, LLi/W;->c:LXi/w0;

    invoke-virtual {v0, v3, v1}, LTi/c;->a(ZLBi/k;)V
    ...
    invoke-virtual {v2, p1, v1, p1, v1}, LTi/c;->g([BI[BI)I
    ...
    iget-object v0, p0, LLi/W;->b:LBi/k;

    sget-object v1, LLi/W;->i:[B

    invoke-direct {p2, v0, v1}, LXi/w0;-><init>(LBi/k;[B)V

    iget-object v0, p0, LLi/W;->a:LTi/c;

    invoke-virtual {v0, v3, p2}, LTi/c;->a(ZLBi/k;)V
    ...
    invoke-virtual {v0, p1, p2, p1, p2}, LTi/c;->g([BI[BI)I
...
.method public d([BII)[B
    ...
    iget-object v1, p0, LLi/W;->b:LBi/k;

    sget-object v2, LLi/W;->i:[B

    invoke-direct {v0, v1, v2}, LXi/w0;-><init>(LBi/k;[B)V

    iget-object v1, p0, LLi/W;->a:LTi/c;

    const/4 v2, 0x0

    invoke-virtual {v1, v2, v0}, LTi/c;->a(ZLBi/k;)V
    ...
    invoke-virtual {v1, v0, p2, v0, p2}, LTi/c;->g([BI[BI)I
    ...
    iget-object v4, p0, LLi/W;->d:[B

    invoke-direct {p1, v0, v4}, LXi/w0;-><init>(LBi/k;[B)V

    iput-object p1, p0, LLi/W;->c:LXi/w0;

    iget-object v0, p0, LLi/W;->a:LTi/c;

    invoke-virtual {v0, v2, p1}, LTi/c;->a(ZLBi/k;)V
    ...
    :goto_2
    iget-object v3, p0, LLi/W;->a:LTi/c;

    invoke-virtual {v3}, LTi/c;->c()I
    ...
    invoke-virtual {v4, p1, v3, p1, v3}, LTi/c;->g([BI[BI)I
    ...
    invoke-direct {p0, v0, v1}, LLi/W;->f([B[B)Z
