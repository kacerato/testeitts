...
.method static constructor <clinit>()V
    ...
    sput-object v0, LLi/P;->e:Ljava/math/BigInteger;
    ...
    sput-object v0, LLi/P;->f:Ljava/math/BigInteger;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LLi/P;->c:[Ljava/util/Vector;

    const/4 v0, 0x0

    iput-boolean v0, p0, LLi/P;->d:Z

    return-void
.end method

.method public static f(Ljava/util/Vector;Ljava/util/Vector;)Ljava/math/BigInteger;
    .locals 5

    sget-object v0, LLi/P;->e:Ljava/math/BigInteger;

    sget-object v1, LLi/P;->f:Ljava/math/BigInteger;
...
.method public a(ZLBi/k;)V
    ...
    check-cast v0, LXi/t0;

    iput-object v0, p0, LLi/P;->b:LXi/t0;

    iget-boolean v0, p0, LLi/P;->a:Z

    if-nez v0, :cond_4

    iget-boolean v0, p0, LLi/P;->d:Z
    ...
    :cond_1
    iget-object v0, p0, LLi/P;->b:LXi/t0;

    check-cast v0, LXi/u0;

    invoke-virtual {v0}, LXi/u0;->h()Ljava/util/Vector;
    ...
    iput-object v2, p0, LLi/P;->c:[Ljava/util/Vector;
    ...
    iget-object v5, p0, LLi/P;->c:[Ljava/util/Vector;
    ...
    sget-object v6, LLi/P;->f:Ljava/math/BigInteger;

    invoke-virtual {v5, v6}, Ljava/util/Vector;->addElement(Ljava/lang/Object;)V

    iget-boolean v5, p0, LLi/P;->d:Z
    ...
    :cond_2
    sget-object v5, LLi/P;->e:Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, LXi/u0;->g()Ljava/math/BigInteger;
    ...
    iget-object v8, p0, LLi/P;->c:[Ljava/util/Vector;

    aget-object v8, v8, v2

    invoke-virtual {v0}, LXi/t0;->d()Ljava/math/BigInteger;

    move-result-object v9

    invoke-virtual {v0}, LXi/t0;->f()Ljava/math/BigInteger;
    ...
    iget-object v1, p0, LLi/P;->b:LXi/t0;

    invoke-virtual {v1}, LXi/t0;->f()Ljava/math/BigInteger;
...
.method public b([BII)[B
    ...
    :cond_4
    iget-boolean p1, p0, LLi/P;->a:Z

    if-eqz p1, :cond_5

    invoke-virtual {p0, p2}, LLi/P;->g(Ljava/math/BigInteger;)[B
    ...
    iget-object p3, p0, LLi/P;->b:LXi/t0;

    check-cast p3, LXi/u0;

    invoke-virtual {p3}, LXi/u0;->h()Ljava/util/Vector;
    ...
    invoke-virtual {p3}, LXi/u0;->g()Ljava/math/BigInteger;
    ...
    invoke-virtual {p3}, LXi/t0;->f()Ljava/math/BigInteger;
    ...
    iget-object v4, p0, LLi/P;->c:[Ljava/util/Vector;
    ...
    iget-object p3, p0, LLi/P;->c:[Ljava/util/Vector;
    ...
    :goto_2
    iget-object p1, p0, LLi/P;->c:[Ljava/util/Vector;
    ...
    iget-object p2, p0, LLi/P;->c:[Ljava/util/Vector;
    ...
    :cond_a
    invoke-static {p1, v1}, LLi/P;->f(Ljava/util/Vector;Ljava/util/Vector;)Ljava/math/BigInteger;
...
.method public e([B[B)[B
    ...
    :cond_2
    iget-object p1, p0, LLi/P;->b:LXi/t0;

    invoke-virtual {p1}, LXi/t0;->f()Ljava/math/BigInteger;
...
.method public g(Ljava/math/BigInteger;)[B
    ...
    iget-object v2, p0, LLi/P;->b:LXi/t0;

    invoke-virtual {v2}, LXi/t0;->d()Ljava/math/BigInteger;

    move-result-object v2

    iget-object v3, p0, LLi/P;->b:LXi/t0;

    invoke-virtual {v3}, LXi/t0;->f()Ljava/math/BigInteger;
...
.method public h([B)[B
    ...
    invoke-virtual {p0, p1, v3, v0}, LLi/P;->b([BII)[B
    ...
    invoke-virtual {p0, p1, v3, v6}, LLi/P;->b([BII)[B
    ...
    invoke-virtual {p0, p1, v2, v0}, LLi/P;->b([BII)[B
