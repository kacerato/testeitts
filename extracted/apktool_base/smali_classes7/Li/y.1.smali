...
.method public constructor <init>(I)V
    ...
    invoke-direct {v0, p1}, LLi/x;-><init>(I)V

    iput-object v0, p0, LLi/y;->b:LLi/x;

    invoke-virtual {v0}, LLi/x;->c()I
    ...
    iput-object p1, p0, LLi/y;->c:[B

    iget-object p1, p0, LLi/y;->b:LLi/x;

    invoke-virtual {p1}, LLi/x;->c()I

    move-result p1

    new-array p1, p1, [B

    iput-object p1, p0, LLi/y;->e:[B
    ...
    iput-object p1, p0, LLi/y;->f:[B

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, LLi/y;->g:Ljava/util/ArrayList;

    const/4 p1, 0x4

    new-array p1, p1, [B

    iput-object p1, p0, LLi/y;->d:[B
...
.method public a(ZLBi/k;)V
    ...
    :cond_0
    iput-boolean p1, p0, LLi/y;->a:Z

    instance-of v0, p2, LXi/o0;

    if-eqz v0, :cond_1

    iget-object v0, p0, LLi/y;->b:LLi/x;

    invoke-virtual {v0, p1, p2}, LLi/x;->a(ZLBi/k;)V
...
.method public c([BII)[B
    ...
    iget-object v4, p0, LLi/y;->b:LLi/x;

    invoke-virtual {v4}, LLi/x;->c()I
    ...
    iget-object p1, p0, LLi/y;->c:[B

    iget-object p2, p0, LLi/y;->b:LLi/x;

    invoke-virtual {p2}, LLi/x;->c()I
    ...
    iget-object p1, p0, LLi/y;->g:Ljava/util/ArrayList;
    ...
    iget-object p3, p0, LLi/y;->b:LLi/x;

    invoke-virtual {p3}, LLi/x;->c()I
    ...
    iget-object p3, p0, LLi/y;->g:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, LLi/y;->g:Ljava/util/ArrayList;
    ...
    invoke-virtual {p2, v5, v6, v5, v6}, LLi/x;->g([BI[BI)I

    add-int/lit8 p1, p1, 0x1

    iget-object p2, p0, LLi/y;->d:[B

    invoke-virtual {p0, p1, p2, v6}, LLi/y;->e(I[BI)V
    ...
    iget-object v4, p0, LLi/y;->g:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, LLi/y;->b:LLi/x;

    invoke-virtual {v7}, LLi/x;->c()I
...
.method public d([BII)[B
    ...
    iget-object v1, p0, LLi/y;->b:LLi/x;

    invoke-virtual {v1}, LLi/x;->c()I
    ...
    iget-object v5, p0, LLi/y;->b:LLi/x;

    invoke-virtual {v5}, LLi/x;->c()I
    ...
    iget-object v5, p0, LLi/y;->g:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, LLi/y;->b:LLi/x;

    invoke-virtual {v6}, LLi/x;->c()I
    ...
    iget-object v8, p0, LLi/y;->b:LLi/x;

    invoke-virtual {v8}, LLi/x;->c()I
    ...
    iget-object v8, p0, LLi/y;->g:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, LLi/y;->g:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v6, v7, v4}, LLi/y;->e(I[BI)V
    ...
    invoke-virtual {v6, v3, v4, v3, v4}, LLi/x;->g([BI[BI)I
    ...
    iget-object v7, p0, LLi/y;->g:Ljava/util/ArrayList;
    ...
    iget-object v9, p0, LLi/y;->g:Ljava/util/ArrayList;

    invoke-virtual {v9, v8}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v8

    iget-object v9, p0, LLi/y;->b:LLi/x;

    invoke-virtual {v9}, LLi/x;->c()I
    ...
    iget-object v2, p0, LLi/y;->g:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, LLi/y;->b:LLi/x;

    invoke-virtual {v2}, LLi/x;->c()I
