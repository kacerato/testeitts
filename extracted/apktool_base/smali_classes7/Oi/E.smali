...
.method static constructor <clinit>()V
    ...
    sput-object v0, LOi/E;->i:Ljava/math/BigInteger;
...
.method public static d(IILjava/security/SecureRandom;)Ljava/math/BigInteger;
    .locals 2

    :goto_0
    invoke-static {p0, p1, p2}, Lorg/bouncycastle/util/b;->h(IILjava/security/SecureRandom;)Ljava/math/BigInteger;
...
.method public static e(Ljava/security/SecureRandom;I)I
    .locals 4
...
.method public static f(Ljava/util/Vector;Ljava/security/SecureRandom;)Ljava/util/Vector;
    .locals 5
    ...
    invoke-static {p1, v3}, LOi/E;->e(Ljava/security/SecureRandom;I)I
...
.method public a()LBi/c;
    ...
    iget-object v1, v0, LOi/E;->g:LXi/s0;

    invoke-virtual {v1}, LBi/G;->b()I

    move-result v1

    iget-object v2, v0, LOi/E;->g:LXi/s0;

    invoke-virtual {v2}, LBi/G;->a()Ljava/security/SecureRandom;

    move-result-object v2

    iget-object v3, v0, LOi/E;->g:LXi/s0;

    invoke-virtual {v3}, LXi/s0;->c()I

    move-result v3

    iget-object v4, v0, LOi/E;->g:LXi/s0;

    invoke-virtual {v4}, LXi/s0;->e()Z
    ...
    iget-object v7, v0, LOi/E;->g:LXi/s0;

    invoke-virtual {v7}, LXi/s0;->d()I
    ...
    :cond_0
    iget-object v5, v0, LOi/E;->g:LXi/s0;

    invoke-virtual {v5}, LXi/s0;->d()I

    move-result v5

    invoke-static {v5}, LOi/E;->c(I)Ljava/util/Vector;

    move-result-object v5

    invoke-static {v5, v2}, LOi/E;->f(Ljava/util/Vector;Ljava/security/SecureRandom;)Ljava/util/Vector;

    move-result-object v10

    sget-object v5, LOi/E;->i:Ljava/math/BigInteger;
    ...
    invoke-static {v9, v3, v2}, LOi/E;->d(IILjava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    invoke-static {v11, v3, v2}, LOi/E;->d(IILjava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    sget-object v11, LOi/E;->i:Ljava/math/BigInteger;
    ...
    invoke-static {v8, v7}, Lorg/bouncycastle/util/b;->p(Ljava/math/BigInteger;Ljava/math/BigInteger;)Z
    ...
    invoke-static {v1, v3, v2}, Lorg/bouncycastle/util/b;->h(IILjava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    sget-object v2, LOi/E;->i:Ljava/math/BigInteger;
    ...
    invoke-virtual {v12, v5}, Ljava/math/BigInteger;->equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {v1, v5, v2, v8, v4}, LXi/t0;-><init>(ZLjava/math/BigInteger;Ljava/math/BigInteger;I)V

    new-instance v4, LXi/u0;
    ...
    invoke-direct/range {v6 .. v11}, LXi/u0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;ILjava/util/Vector;Ljava/math/BigInteger;)V

    invoke-direct {v0, v1, v4}, LBi/c;-><init>(LXi/c;LXi/c;)V
...
.method public b(LBi/G;)V
    ...
    check-cast v0, LXi/s0;

    iput-object v0, p0, LOi/E;->g:LXi/s0;
