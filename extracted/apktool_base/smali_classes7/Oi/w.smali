...
.method static constructor <clinit>()V
    ...
    sput-object v0, LOi/w;->d:Ljava/math/BigInteger;
    ...
    sput-object v0, LOi/w;->e:Ljava/math/BigInteger;
...
.method public a()LXi/c0;
    ...
    iget-object v1, p0, LOi/w;->c:Ljava/security/SecureRandom;

    invoke-virtual {v1}, Ljava/util/Random;->nextInt()I

    move-result v1

    iget-object v5, p0, LOi/w;->c:Ljava/security/SecureRandom;

    invoke-virtual {v5}, Ljava/util/Random;->nextInt()I

    move-result v5

    iget v6, p0, LOi/w;->a:I

    if-eq v6, v4, :cond_1

    if-ne v6, v3, :cond_0

    invoke-virtual {p0, v1, v5, v0}, LOi/w;->e(II[Ljava/math/BigInteger;)V
    ...
    :cond_1
    invoke-virtual {p0, v1, v5, v0, v4}, LOi/w;->c(II[Ljava/math/BigInteger;I)I
    ...
    invoke-virtual {p0, v2, v0}, LOi/w;->g(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v3

    new-instance v4, LXi/c0;

    new-instance v6, LXi/f0;

    invoke-direct {v6, v1, v5}, LXi/f0;-><init>(II)V

    invoke-direct {v4, v2, v0, v3, v6}, LXi/c0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;LXi/f0;)V
    ...
    invoke-virtual/range {v1 .. v6}, LOi/w;->f(JJ[Ljava/math/BigInteger;)V
    ...
    invoke-virtual/range {v1 .. v7}, LOi/w;->d(JJ[Ljava/math/BigInteger;I)J
    ...
    invoke-virtual {p0, v1, v0}, LOi/w;->g(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v2

    new-instance v3, LXi/c0;

    new-instance v4, LXi/f0;

    invoke-direct {v4, v10, v11, v12, v13}, LXi/f0;-><init>(JJ)V

    invoke-direct {v3, v1, v0, v2, v4}, LXi/c0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;LXi/f0;)V
...
.method public b(IILjava/security/SecureRandom;)V
    ...
    iput p1, p0, LOi/w;->a:I

    iput p2, p0, LOi/w;->b:I

    iput-object p3, p0, LOi/w;->c:Ljava/security/SecureRandom;
...
.method public final c(II[Ljava/math/BigInteger;I)I
    ...
    sget-object v14, LOi/w;->e:Ljava/math/BigInteger;
    ...
    sget-object v11, LOi/w;->e:Ljava/math/BigInteger;
    ...
    sget-object v5, LOi/w;->e:Ljava/math/BigInteger;
    ...
    sget-object v5, LOi/w;->d:Ljava/math/BigInteger;
    ...
    sget-object v8, LOi/w;->d:Ljava/math/BigInteger;
    ...
    :cond_a
    :goto_9
    iget-object v4, v0, LOi/w;->c:Ljava/security/SecureRandom;
    ...
    :cond_b
    :goto_a
    iget-object v1, v0, LOi/w;->c:Ljava/security/SecureRandom;
...
.method public final d(JJ[Ljava/math/BigInteger;I)J
    ...
    sget-object v12, LOi/w;->e:Ljava/math/BigInteger;
    ...
    sget-object v10, LOi/w;->e:Ljava/math/BigInteger;
    ...
    sget-object v10, LOi/w;->d:Ljava/math/BigInteger;
    ...
    sget-object v4, LOi/w;->e:Ljava/math/BigInteger;
    ...
    :cond_a
    :goto_9
    iget-object v7, v0, LOi/w;->c:Ljava/security/SecureRandom;
...
.method public final e(II[Ljava/math/BigInteger;)V
    ...
    invoke-virtual {v0, v1, v4, v2, v3}, LOi/w;->c(II[Ljava/math/BigInteger;I)I
    ...
    sget-object v3, LOi/w;->e:Ljava/math/BigInteger;
    ...
    sget-object v2, LOi/w;->e:Ljava/math/BigInteger;
    ...
    sget-object v3, LOi/w;->d:Ljava/math/BigInteger;
    ...
    sget-object v15, LOi/w;->e:Ljava/math/BigInteger;
...
.method public final f(JJ[Ljava/math/BigInteger;)V
    ...
    invoke-virtual/range {v0 .. v6}, LOi/w;->d(JJ[Ljava/math/BigInteger;I)J
    ...
    sget-object v1, LOi/w;->e:Ljava/math/BigInteger;
    ...
    sget-object v2, LOi/w;->d:Ljava/math/BigInteger;
    ...
    sget-object v8, LOi/w;->e:Ljava/math/BigInteger;
    ...
    :cond_7
    :goto_6
    iget-object v0, v7, LOi/w;->c:Ljava/security/SecureRandom;
...
.method public final g(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    sget-object v0, LOi/w;->d:Ljava/math/BigInteger;
    ...
    :cond_0
    iget-object v2, p0, LOi/w;->c:Ljava/security/SecureRandom;
