...
.method public constructor <init>(Ljava/security/KeyPair;Ljava/security/PublicKey;)V
    ...
    invoke-direct {p0, v0, p1, p2, v1}, Lck/s;-><init>(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;[B)V
...
.method public constructor <init>(Ljava/security/KeyPair;Ljava/security/PublicKey;[B)V
    ...
    invoke-direct {p0, v0, p1, p2, p3}, Lck/s;-><init>(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;[B)V
...
.method public constructor <init>(Ljava/security/PrivateKey;Ljava/security/PublicKey;)V
    ...
    .line 3
    invoke-direct {p0, v0, p1, p2, v0}, Lck/s;-><init>(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;[B)V
...
.method public constructor <init>(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;)V
    ...
    .line 5
    invoke-direct {p0, p1, p2, p3, v0}, Lck/s;-><init>(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;[B)V
...
.method public constructor <init>(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;[B)V
    ...
    iput-object p1, p0, Lck/s;->b:Ljava/security/PublicKey;

    iput-object p2, p0, Lck/s;->c:Ljava/security/PrivateKey;

    iput-object p3, p0, Lck/s;->d:Ljava/security/PublicKey;

    invoke-static {p4}, Lorg/bouncycastle/util/a;->p([B)[B

    move-result-object p1

    iput-object p1, p0, Lck/s;->e:[B
...
.method public a()Ljava/security/PrivateKey;
    ...
    iget-object v0, p0, Lck/s;->c:Ljava/security/PrivateKey;
...
.method public b()Ljava/security/PublicKey;
    ...
    iget-object v0, p0, Lck/s;->b:Ljava/security/PublicKey;
...
.method public c()Ljava/security/PublicKey;
    ...
    iget-object v0, p0, Lck/s;->d:Ljava/security/PublicKey;
