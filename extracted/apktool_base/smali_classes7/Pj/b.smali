...
.method public b(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    iget-object v0, p0, LPj/b;->a:Lhk/j;

    invoke-virtual {v0}, Lhk/j;->b()Ljava/math/BigInteger;

    move-result-object v0

    iget-object v1, p0, LPj/b;->a:Lhk/j;

    invoke-virtual {v1}, Lhk/j;->a()Ljava/math/BigInteger;
    ...
    :cond_2
    :goto_0
    iget-object p1, p0, LPj/b;->a:Lhk/j;
...
.method public engineGetEncoded()[B
    ...
    iget-object v2, p0, LPj/b;->a:Lhk/j;

    invoke-virtual {v2}, Lhk/j;->a()Ljava/math/BigInteger;

    move-result-object v2

    invoke-direct {v0, v1, v2}, LBj/a;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public engineGetEncoded(Ljava/lang/String;)[B
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0}, LPj/b;->engineGetEncoded()[B
...
.method public engineInit(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object p1, p0, LPj/b;->a:Lhk/j;
    ...
    iput-object v0, p0, LPj/b;->a:Lhk/j;
...
.method public engineInit([B)V
    ...
    invoke-static {p1}, LBj/a;->v(Ljava/lang/Object;)LBj/a;

    move-result-object p1

    new-instance v1, Lhk/j;

    invoke-virtual {p1}, LBj/a;->x()Ljava/math/BigInteger;

    move-result-object v2

    invoke-virtual {p1}, LBj/a;->u()Ljava/math/BigInteger;

    move-result-object p1

    invoke-direct {v1, v2, p1}, Lhk/j;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    iput-object v1, p0, LPj/b;->a:Lhk/j;
    :try_end_0
...
.method public engineInit([BLjava/lang/String;)V
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p1}, LPj/b;->engineInit([B)V
