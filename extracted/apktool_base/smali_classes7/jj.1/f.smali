...
.method public static b(Ljava/util/Set;[Ljava/security/cert/CRL;)[Ljavax/net/ssl/X509TrustManager;
    ...
    invoke-direct {v2, p0, p1, v1}, Ljj/f$b;-><init>(Ljava/util/Set;[Ljava/security/cert/CRL;[Ljava/security/cert/X509Certificate;)V
...
.method public static d(Ljava/security/cert/X509Certificate;)V
    ...
    invoke-direct {v0, p0}, Lli/h;-><init>([B)V

    invoke-virtual {v0}, Lli/h;->d()Lhi/C;

    move-result-object p0

    invoke-static {p0}, Lhi/N;->u(Lhi/C;)Lhi/N;
    ...
    invoke-virtual {p0, v1}, Lhi/N;->x(I)Z
    ...
    invoke-static {p0}, Lhi/A;->u(Lhi/C;)Lhi/A;

    move-result-object p0

    if-eqz p0, :cond_4

    sget-object v0, Lhi/M;->e:Lhi/M;
