...
# static fields
.field public static final c:Ljava/lang/String; = "BC JKS store is read-only and only supports certificate entries"
...
.method public constructor <init>(Ldk/f;)V
    ...
    iput-object v0, p0, LYj/b;->a:Ljava/util/Hashtable;

    iput-object p1, p0, LYj/b;->b:Ldk/f;
...
# virtual methods
.method public final a(LBi/y;[C)V
    .locals 3
    ...
    invoke-interface {p1, v2}, LBi/y;->update(B)V
    ...
    invoke-static {p2}, Lorg/bouncycastle/util/w;->j(Ljava/lang/String;)[B
...
.method public final b(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    iget-object v0, p0, LYj/b;->b:Ldk/f;

    if-eqz v0, :cond_0

    :try_start_0
    invoke-interface {v0, p1}, Ldk/f;->r(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method public final c(Ljava/io/InputStream;[C)LYj/b$b;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, v0, p2}, LYj/b;->a(LBi/y;[C)V
    ...
    invoke-interface {v0, p1, v1, p2}, LBi/y;->update([BII)V
    ...
    invoke-interface {v0, v2, v1}, LBi/y;->c([BI)I
    ...
    invoke-direct {v0, p1, v1, v2}, LYj/b$b;-><init>([BII)V
    ...
    invoke-direct {p2, p1, v1, v2}, LYj/b$b;-><init>([BII)V
...
.method public engineAliases()Ljava/util/Enumeration;
    ...
    iget-object v0, p0, LYj/b;->a:Ljava/util/Hashtable;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, LYj/b;->a:Ljava/util/Hashtable;
...
.method public engineGetCertificate(Ljava/lang/String;)Ljava/security/cert/Certificate;
    ...
    iget-object p1, p1, LYj/b$a;->b:Ljava/security/cert/Certificate;
...
.method public engineGetCertificateAlias(Ljava/security/cert/Certificate;)Ljava/lang/String;
    ...
    check-cast v3, LYj/b$a;

    iget-object v3, v3, LYj/b$a;->b:Ljava/security/cert/Certificate;
...
.method public engineGetCreationDate(Ljava/lang/String;)Ljava/util/Date;
    ...
    iget-object p1, p1, LYj/b$a;->a:Ljava/util/Date;
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    .line 1
    :cond_0
    invoke-virtual/range {p0 .. p2}, LYj/b;->c(Ljava/io/InputStream;[C)LYj/b$b;

    move-result-object v2

    iget-object v3, v1, LYj/b;->a:Ljava/util/Hashtable;
    ...
    invoke-virtual {v1, v8}, LYj/b;->b(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    :cond_3
    invoke-virtual {v1, v4}, LYj/b;->b(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    new-instance v6, LYj/b$b;

    invoke-direct {v6, v15, v10, v14}, LYj/b$b;-><init>([BII)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_2
    invoke-virtual {v6}, LYj/b$b;->c()V

    iget-object v6, v1, LYj/b;->a:Ljava/util/Hashtable;

    new-instance v15, LYj/b$a;

    invoke-direct {v15, v13, v14}, LYj/b$a;-><init>(Ljava/util/Date;Ljava/security/cert/Certificate;)V
...
.method public engineLoad(Ljava/security/KeyStore$LoadStoreParameter;)V
    ...
    .line 2
    invoke-virtual {p0, p1, p1}, LYj/b;->engineLoad(Ljava/io/InputStream;[C)V
    ...
    invoke-virtual {p0, v0, p1}, LYj/b;->engineLoad(Ljava/io/InputStream;[C)V
