...
.method static constructor <clinit>()V
    ...
    sput-object v0, LDi/g;->a:Ljava/math/BigInteger;
    ...
    sput-object v0, LDi/g;->b:Ljava/math/BigInteger;
...
.method public static B(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;[Ljava/math/BigInteger;Ljava/lang/String;LBi/y;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/crypto/CryptoException;
    ...
    invoke-static {p2, v0, p3, p5, p6}, LDi/g;->d(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/lang/String;LBi/y;)Ljava/math/BigInteger;

    move-result-object p5

    sget-object p6, LDi/g;->a:Ljava/math/BigInteger;
    ...
    sget-object p6, LDi/g;->b:Ljava/math/BigInteger;
...
.method public static d(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/lang/String;LBi/y;)Ljava/math/BigInteger;
    .locals 0

    invoke-interface {p4}, LBi/y;->reset()V

    invoke-static {p4, p0}, LDi/g;->s(LBi/y;Ljava/math/BigInteger;)V

    invoke-static {p4, p1}, LDi/g;->s(LBi/y;Ljava/math/BigInteger;)V

    invoke-static {p4, p2}, LDi/g;->s(LBi/y;Ljava/math/BigInteger;)V

    invoke-static {p4, p3}, LDi/g;->r(LBi/y;Ljava/lang/String;)V
    ...
    invoke-interface {p4, p0, p1}, LBi/y;->c([BI)I
...
.method public static f(Ljava/math/BigInteger;LBi/y;)[B
    .locals 1

    invoke-interface {p1}, LBi/y;->reset()V

    invoke-static {p1, p0}, LDi/g;->q(LBi/y;Ljava/math/BigInteger;)V

    const-string p0, "JPAKE_KC"

    invoke-static {p1, p0}, LDi/g;->p(LBi/y;Ljava/lang/String;)V
    ...
    invoke-interface {p1, p0, v0}, LBi/y;->c([BI)I

    return-object p0
.end method

.method public static g(Ljava/lang/String;Ljava/lang/String;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;LBi/y;)Ljava/math/BigInteger;
    .locals 2

    invoke-static {p6, p7}, LDi/g;->f(Ljava/math/BigInteger;LBi/y;)[B

    move-result-object p6

    new-instance v0, LSi/k;

    invoke-direct {v0, p7}, LSi/k;-><init>(LBi/y;)V
    ...
    invoke-direct {v1, p6}, LXi/o0;-><init>([B)V

    invoke-virtual {v0, v1}, LSi/k;->a(LBi/k;)V

    const-string v1, "KC_1_U"

    invoke-static {v0, v1}, LDi/g;->t(LBi/I;Ljava/lang/String;)V

    invoke-static {v0, p0}, LDi/g;->t(LBi/I;Ljava/lang/String;)V

    invoke-static {v0, p1}, LDi/g;->t(LBi/I;Ljava/lang/String;)V

    invoke-static {v0, p2}, LDi/g;->u(LBi/I;Ljava/math/BigInteger;)V

    invoke-static {v0, p3}, LDi/g;->u(LBi/I;Ljava/math/BigInteger;)V

    invoke-static {v0, p4}, LDi/g;->u(LBi/I;Ljava/math/BigInteger;)V

    invoke-static {v0, p5}, LDi/g;->u(LBi/I;Ljava/math/BigInteger;)V

    const/4 p0, 0x0

    invoke-virtual {v0, p7, p0}, LSi/k;->c([BI)I

    invoke-static {p6, p0}, Lorg/bouncycastle/util/a;->e0([BB)V
...
.method public static h(Ljava/math/BigInteger;[B)Ljava/math/BigInteger;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/crypto/CryptoException;
...
.method public static i(Ljava/math/BigInteger;[C)Ljava/math/BigInteger;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/crypto/CryptoException;
    ...
    invoke-static {p0, p1}, LDi/g;->h(Ljava/math/BigInteger;[B)Ljava/math/BigInteger;
...
.method public static j([C)Ljava/math/BigInteger;
    .locals 2
    ...
    invoke-static {p0}, Lorg/bouncycastle/util/w;->o([C)[B
...
.method public static k(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .locals 0
...
.method public static l(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/lang/String;LBi/y;Ljava/security/SecureRandom;)[Ljava/math/BigInteger;
    .locals 2

    sget-object v0, LDi/g;->a:Ljava/math/BigInteger;

    sget-object v1, LDi/g;->b:Ljava/math/BigInteger;
    ...
    invoke-static {p2, p0, p3, p5, p6}, LDi/g;->d(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/lang/String;LBi/y;)Ljava/math/BigInteger;
...
.method public static m(Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    .locals 2
...
.method public static n(Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    .locals 1

    sget-object v0, LDi/g;->b:Ljava/math/BigInteger;
...
.method public static p(LBi/y;Ljava/lang/String;)V
    .locals 2
...
.method public static q(LBi/y;Ljava/math/BigInteger;)V
    .locals 2
...
.method public static r(LBi/y;Ljava/lang/String;)V
    .locals 3
    ...
    invoke-interface {p0, v0, v2, v1}, LBi/y;->update([BII)V

    array-length v0, p1

    invoke-interface {p0, p1, v2, v0}, LBi/y;->update([BII)V
...
.method public static s(LBi/y;Ljava/math/BigInteger;)V
    .locals 3
...
.method public static t(LBi/I;Ljava/lang/String;)V
    .locals 2
    ...
    invoke-interface {p0, p1, v1, v0}, LBi/I;->update([BII)V
...
.method public static u(LBi/I;Ljava/math/BigInteger;)V
    .locals 2
...
.method public static v(Ljava/math/BigInteger;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/crypto/CryptoException;
...
.method public static w(Ljava/math/BigInteger;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/crypto/CryptoException;
...
.method public static x(Ljava/lang/String;Ljava/lang/String;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;LBi/y;Ljava/math/BigInteger;)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/crypto/CryptoException;
    ...
    invoke-static/range {v0 .. v7}, LDi/g;->g(Ljava/lang/String;Ljava/lang/String;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;LBi/y;)Ljava/math/BigInteger;
