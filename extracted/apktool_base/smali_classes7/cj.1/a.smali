...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcj/a;->b:Ljava/math/BigInteger;
...
.method public static a(II[B[B)I
    .locals 3
...
.method public static c(Ljava/math/BigInteger;[BII)Ljava/math/BigInteger;
    .locals 0

    invoke-static {p1, p2, p3}, Lorg/bouncycastle/util/b;->j([BII)Ljava/math/BigInteger;
...
.method public static d([BIILXi/F0;ILjava/security/SecureRandom;)[B
    .locals 7
    ...
    invoke-static {p3}, Lcj/a;->e(LXi/F0;)I
    ...
    invoke-virtual {p3}, LXi/c;->c()Z

    move-result v1

    if-eqz v1, :cond_3

    invoke-virtual {p3}, LXi/F0;->f()Ljava/math/BigInteger;
    ...
    sget-object v6, LBi/o;->DECRYPTION:LBi/o;

    invoke-direct {v4, v5, v3, p3, v6}, LHi/c;-><init>(Ljava/lang/String;ILjava/lang/Object;LBi/o;)V

    invoke-static {v4}, LBi/r;->a(LBi/n;)V
    ...
    :try_start_0
    invoke-static {v1, p0, p1, p2}, Lcj/a;->c(Ljava/math/BigInteger;[BII)Ljava/math/BigInteger;

    move-result-object p0

    invoke-static {p3, p0, p5}, Lcj/a;->g(LXi/F0;Ljava/math/BigInteger;Ljava/security/SecureRandom;)[B
    ...
    invoke-static {p0, v2, v4}, Lcj/a;->b([BII)I

    move-result p2

    invoke-static {p0, p1}, Lorg/bouncycastle/util/p;->g([BI)S
    ...
    :cond_0
    invoke-static {p0, p3}, Lorg/bouncycastle/util/a;->e0([BB)V
    :try_end_0
...
.method public static e(LXi/F0;)I
    .locals 0
...
.method public static f(LXi/F0;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .locals 1
...
.method public static g(LXi/F0;Ljava/math/BigInteger;Ljava/security/SecureRandom;)[B
    .locals 5
    ...
    instance-of v2, p0, LXi/G0;

    if-eqz v2, :cond_0

    move-object v2, p0

    check-cast v2, LXi/G0;

    invoke-virtual {v2}, LXi/G0;->l()Ljava/math/BigInteger;

    move-result-object v3

    if-eqz v3, :cond_0

    sget-object p0, Lcj/a;->b:Ljava/math/BigInteger;

    invoke-virtual {v0, p0}, Ljava/math/BigInteger;->subtract(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v4

    invoke-static {p0, v4, p2}, Lorg/bouncycastle/util/b;->g(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    invoke-static {v0, p2}, Lorg/bouncycastle/util/b;->n(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-static {v2, p1}, Lcj/a;->h(LXi/G0;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-static {p1, v1}, Lcj/a;->j(Ljava/math/BigInteger;I)[B

    move-result-object p1

    invoke-static {v0, v1}, Lcj/a;->j(Ljava/math/BigInteger;I)[B

    move-result-object p2

    invoke-static {p0, v1}, Lcj/a;->j(Ljava/math/BigInteger;I)[B

    move-result-object p0

    invoke-static {v1, p1, p0}, Lcj/a;->i(I[B[B)I

    move-result p1

    invoke-static {v1, p1, p2, p0}, Lcj/a;->a(II[B[B)I

    return-object p0

    :cond_0
    invoke-static {p0, p1}, Lcj/a;->f(LXi/F0;Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method public static h(LXi/G0;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .locals 7
...
.method public static i(I[B[B)I
    .locals 3
...
.method public static j(Ljava/math/BigInteger;I)[B
    .locals 3
