...
.method static constructor <clinit>()V
    ...
    sput-object v0, LD7/b;->a:Ljava/util/List;

    new-instance v0, Lcom/itsmagic/engine/Engines/Utils/ListUtils/SteppedArrayList;

    invoke-direct {v0}, Lcom/itsmagic/engine/Engines/Utils/ListUtils/SteppedArrayList;-><init>()V

    sput-object v0, LD7/b;->b:Ljava/util/List;

    new-instance v0, LD7/b$a;

    invoke-direct {v0}, LD7/b$a;-><init>()V

    sput-object v0, LD7/b;->e:Lcom/itsmagic/engine/Engines/Engine/Modules/UpdateModule;
...
.method public static c(Ljava/io/File;Landroid/widget/ImageView;)V
    ...
    sget-object v0, LD7/b;->a:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    sget-object v1, LD7/b;->e:Lcom/itsmagic/engine/Engines/Engine/Modules/UpdateModule;
    ...
    :goto_0
    sget-object v2, LD7/b;->a:Ljava/util/List;
    ...
    check-cast v2, LD7/b$d;

    iget-object v2, v2, LD7/b$d;->a:Ljava/io/File;
    ...
    :cond_1
    new-instance v1, LD7/b$d;

    invoke-direct {v1, p0}, LD7/b$d;-><init>(Ljava/io/File;)V

    new-instance p0, Ljava/lang/ref/WeakReference;

    invoke-direct {p0, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p0, v1, LD7/b$d;->g:Ljava/lang/ref/WeakReference;
...
.method public static e()V
    ...
    sget-object v0, LD7/b;->c:LD7/b$d;
    ...
    :cond_1
    iget-object v0, v0, LD7/b$d;->b:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;
...
.method public static f(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)V
    ...
    invoke-static {v1}, LD7/b;->f(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)V
...
.method public static g()V
    ...
    invoke-static {v1, v0}, LD7/b;->d(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;F)V
    ...
    iput-boolean v1, v0, LD7/b$d;->c:Z
...
.method public static h()V
    ...
    :cond_0
    sget-object v0, LD7/b;->b:Ljava/util/List;
    ...
    sget-object v1, LD7/b;->a:Ljava/util/List;
    ...
    check-cast v0, LD7/b$d;

    sput-object v0, LD7/b;->c:LD7/b$d;
    ...
    sput-object v0, LD7/b;->d:LE7/b;

    :cond_2
    :try_start_1
    sget-object v0, LD7/b;->c:LD7/b$d;

    invoke-virtual {v0}, LD7/b$d;->c()Ljava/lang/String;
    ...
    new-instance v3, LD7/b$b;

    invoke-direct {v3}, LD7/b$b;-><init>()V

    invoke-static {v0, v1, v1, v3}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->U(Ljava/lang/String;ZZLcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject$e;)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;
    ...
    sget-object v3, LD7/b;->c:LD7/b$d;

    iput-object v0, v3, LD7/b$d;->b:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;

    sget-object v3, LD7/b;->d:LE7/b;

    iput-boolean v1, v3, LE7/b;->d:Z

    iput-boolean v1, v3, LE7/b;->e:Z
    ...
    :cond_3
    sput-object v2, LD7/b;->c:LD7/b$d;
    :try_end_1
    ...
    sget-object v0, LD7/b;->e:Lcom/itsmagic/engine/Engines/Engine/Modules/UpdateModule;
    ...
    sput-object v2, LD7/b;->d:LE7/b;

    goto :goto_3

    :cond_5
    invoke-static {}, LD7/b;->i()V
...
.method public static i()V
    ...
    sget-object v1, LD7/b;->c:LD7/b$d;

    iget-object v1, v1, LD7/b$d;->b:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;

    invoke-static {v1}, LD7/b;->j(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)V
    ...
    iget v4, v3, LD7/b$d;->d:I

    if-gtz v4, :cond_3

    if-eqz v0, :cond_4

    invoke-virtual {v3}, LD7/b$d;->b()Z
    ...
    iput v2, v0, LD7/b$d;->d:I

    invoke-virtual {v0}, LD7/b$d;->e()Ljava/io/File;

    move-result-object v0

    sget-object v2, LD7/b;->c:LD7/b$d;

    iget-object v2, v2, LD7/b$d;->g:Ljava/lang/ref/WeakReference;
    ...
    iget-object v3, v3, LE7/e;->e:LTb/a;

    sget-object v4, LD7/b;->c:LD7/b$d;

    invoke-virtual {v4}, LD7/b$d;->e()Ljava/io/File;

    move-result-object v4

    new-instance v5, LD7/b$c;

    invoke-direct {v5, v2, v0}, LD7/b$c;-><init>(Landroid/widget/ImageView;Ljava/io/File;)V

    const/16 v0, 0x50

    invoke-virtual {v3, v4, v0, v5}, LTb/a;->g(Ljava/io/File;ILjava/lang/Runnable;)V
    ...
    invoke-static {v2, v0}, LE7/f;->b(Ljava/lang/String;Lcom/itsmagic/engine/Activities/Editor/Utils/ThumbBuilder/Core/Manifest;)V
    ...
    iput v4, v3, LD7/b$d;->d:I

    if-gtz v4, :cond_4

    invoke-virtual {v3}, LD7/b$d;->a()V
