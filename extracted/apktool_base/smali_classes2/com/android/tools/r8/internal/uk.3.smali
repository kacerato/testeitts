...
.method public final parsePartialFrom(Lcom/android/tools/r8/internal/Be;Lcom/android/tools/r8/internal/zv;)Ljava/lang/Object;
    ...
    iput-object v5, v0, Lcom/android/tools/r8/internal/wk;->e:Ljava/util/List;

    move v3, v4

    :cond_2
    iget-object v5, v0, Lcom/android/tools/r8/internal/wk;->e:Ljava/util/List;
    ...
    :cond_3
    iget v5, v0, Lcom/android/tools/r8/internal/wk;->c:I

    or-int/2addr v5, v6

    iput v5, v0, Lcom/android/tools/r8/internal/wk;->c:I

    invoke-virtual {p1}, Lcom/android/tools/r8/internal/Be;->c()Z

    move-result v5

    iput-boolean v5, v0, Lcom/android/tools/r8/internal/wk;->d:Z
    :try_end_0
    ...
    iget-object p2, v0, Lcom/android/tools/r8/internal/wk;->e:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, v0, Lcom/android/tools/r8/internal/wk;->e:Ljava/util/List;
    ...
    iget-object p1, v0, Lcom/android/tools/r8/internal/wk;->e:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, v0, Lcom/android/tools/r8/internal/wk;->e:Ljava/util/List;
