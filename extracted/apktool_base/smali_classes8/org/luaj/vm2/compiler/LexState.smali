...
# instance fields
.field L:Lorg/luaj/vm2/compiler/LuaC$CompileState;
...
.method static constructor <clinit>()V
    ...
    sget-object v2, Lorg/luaj/vm2/compiler/LexState;->RESERVED:Ljava/util/Hashtable;
    ...
    invoke-direct {v1, v0, v0}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    new-instance v2, Lorg/luaj/vm2/compiler/LexState$Priority;

    invoke-direct {v2, v0, v0}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    new-instance v3, Lorg/luaj/vm2/compiler/LexState$Priority;

    const/4 v0, 0x7

    invoke-direct {v3, v0, v0}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    new-instance v4, Lorg/luaj/vm2/compiler/LexState$Priority;

    invoke-direct {v4, v0, v0}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    new-instance v5, Lorg/luaj/vm2/compiler/LexState$Priority;

    invoke-direct {v5, v0, v0}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    new-instance v6, Lorg/luaj/vm2/compiler/LexState$Priority;

    const/16 v0, 0xa

    const/16 v7, 0x9

    invoke-direct {v6, v0, v7}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    new-instance v7, Lorg/luaj/vm2/compiler/LexState$Priority;

    const/4 v0, 0x5

    const/4 v8, 0x4

    invoke-direct {v7, v0, v8}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    new-instance v8, Lorg/luaj/vm2/compiler/LexState$Priority;

    const/4 v0, 0x3

    invoke-direct {v8, v0, v0}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    new-instance v9, Lorg/luaj/vm2/compiler/LexState$Priority;

    invoke-direct {v9, v0, v0}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    new-instance v10, Lorg/luaj/vm2/compiler/LexState$Priority;

    invoke-direct {v10, v0, v0}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    new-instance v11, Lorg/luaj/vm2/compiler/LexState$Priority;

    invoke-direct {v11, v0, v0}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    new-instance v12, Lorg/luaj/vm2/compiler/LexState$Priority;

    invoke-direct {v12, v0, v0}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    new-instance v13, Lorg/luaj/vm2/compiler/LexState$Priority;

    invoke-direct {v13, v0, v0}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    new-instance v14, Lorg/luaj/vm2/compiler/LexState$Priority;

    const/4 v0, 0x2

    invoke-direct {v14, v0, v0}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    new-instance v15, Lorg/luaj/vm2/compiler/LexState$Priority;

    const/4 v0, 0x1

    invoke-direct {v15, v0, v0}, Lorg/luaj/vm2/compiler/LexState$Priority;-><init>(II)V

    filled-new-array/range {v1 .. v15}, [Lorg/luaj/vm2/compiler/LexState$Priority;
...
.method public addprototype()Lorg/luaj/vm2/Prototype;
    ...
    iget v3, v0, Lorg/luaj/vm2/compiler/FuncState;->np:I
    ...
    invoke-static {v2, v0}, Lorg/luaj/vm2/compiler/Constants;->realloc([Lorg/luaj/vm2/Prototype;I)[Lorg/luaj/vm2/Prototype;
...
.method public assignment(Lorg/luaj/vm2/compiler/LexState$LHS_assign;I)V
    ...
    iget-short p2, p2, Lorg/luaj/vm2/compiler/FuncState;->freereg:S

    sub-int/2addr p2, v3

    const/4 v1, 0x6

    invoke-virtual {v0, v1, p2}, Lorg/luaj/vm2/compiler/LexState$expdesc;->init(II)V
...
.method public check_conflict(Lorg/luaj/vm2/compiler/LexState$LHS_assign;Lorg/luaj/vm2/compiler/LexState$expdesc;)V
    ...
    iget-object v9, p2, Lorg/luaj/vm2/compiler/LexState$expdesc;->u:Lorg/luaj/vm2/compiler/LexState$expdesc$U;

    iget v9, v9, Lorg/luaj/vm2/compiler/LexState$expdesc$U;->info:I

    if-ne v7, v9, :cond_0

    iput-short v4, v6, Lorg/luaj/vm2/compiler/LexState$expdesc$U;->ind_vt:S
    ...
    iget-short v4, v6, Lorg/luaj/vm2/compiler/LexState$expdesc$U;->ind_idx:S
    ...
    iput-short v1, v6, Lorg/luaj/vm2/compiler/LexState$expdesc$U;->ind_idx:S
    ...
    invoke-virtual {v0, v5}, Lorg/luaj/vm2/compiler/FuncState;->reserveregs(I)V
...
.method public exprstat()V
    ...
    invoke-virtual {p0, v2, v3}, Lorg/luaj/vm2/compiler/LexState;->check_condition(ZLjava/lang/String;)V
    ...
    invoke-static {v0, v4}, Lorg/luaj/vm2/compiler/Constants;->SETARG_C(Lorg/luaj/vm2/compiler/InstructionPtr;I)V
    ...
    invoke-virtual {p0, v1, v4}, Lorg/luaj/vm2/compiler/LexState;->assignment(Lorg/luaj/vm2/compiler/LexState$LHS_assign;I)V
...
.method public findlabel(I)Z
    ...
    invoke-virtual {v0, v1, v5}, Lorg/luaj/vm2/compiler/FuncState;->patchclose(II)V
...
.method public funcargs(Lorg/luaj/vm2/compiler/LexState$expdesc;I)V
    ...
    invoke-virtual {v0, v4, v2, v1, v3}, Lorg/luaj/vm2/compiler/FuncState;->codeABC(IIII)I
...
.method public llex(Lorg/luaj/vm2/compiler/LexState$SemInfo;)I
    ...
    :cond_16
    invoke-virtual {p0, v1, p1}, Lorg/luaj/vm2/compiler/LexState;->read_string(ILorg/luaj/vm2/compiler/LexState$SemInfo;)V
...
.method public localfunc()V
    ...
    invoke-virtual {p0, v0, v3, v4}, Lorg/luaj/vm2/compiler/LexState;->body(Lorg/luaj/vm2/compiler/LexState$expdesc;ZI)V
...
.method public simpleexp(Lorg/luaj/vm2/compiler/LexState$expdesc;)V
    ...
    invoke-virtual {v0, v1, v3, v4, v3}, Lorg/luaj/vm2/compiler/FuncState;->codeABC(IIII)I
...
.method public strx2number(Ljava/lang/String;Lorg/luaj/vm2/compiler/LexState$SemInfo;)Lorg/luaj/vm2/LuaValue;
    ...
    invoke-direct {p0, v5}, Lorg/luaj/vm2/compiler/LexState;->isxdigit(I)Z
    ...
    invoke-direct {p0, v2}, Lorg/luaj/vm2/compiler/LexState;->isdigit(I)Z
    ...
    invoke-static {p1, p2, v0, v1}, Lorg/luaj/vm2/lib/MathLib;->dpow_d(DD)D

    move-result-wide p1

    mul-double/2addr v3, p1

    invoke-static {v3, v4}, Lorg/luaj/vm2/LuaValue;->valueOf(D)Lorg/luaj/vm2/LuaNumber;
