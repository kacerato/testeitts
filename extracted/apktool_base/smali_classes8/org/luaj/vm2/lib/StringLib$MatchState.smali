...
.method public classend(I)I
    ...
    const-string v0, "malformed pattern (ends with %)"
...
.method public match(II)I
    ...
    :cond_3
    invoke-virtual {p0, p1, v0, v2}, Lorg/luaj/vm2/lib/StringLib$MatchState;->start_capture(III)I
...
.method public matchbalance(II)I
    ...
    invoke-virtual {v5, v3}, Lorg/luaj/vm2/LuaString;->luaByte(I)I
...
.method public push_captures(ZII)Lorg/luaj/vm2/Varargs;
    ...
    invoke-direct {p0, p1, p2, p3}, Lorg/luaj/vm2/lib/StringLib$MatchState;->push_onecapture(III)Lorg/luaj/vm2/LuaValue;
