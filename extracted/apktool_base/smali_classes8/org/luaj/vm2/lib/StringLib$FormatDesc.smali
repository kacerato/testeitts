...
# static fields
.field private static final MAX_FLAGS:I = 0x5


# instance fields
.field private alternateForm:Z

.field public final conversion:I

.field private explicitPlus:Z

.field private leftAdjust:Z

.field public final length:I

.field private precision:I

.field private space:Z

.field private width:I

.field private zeroPad:Z
...
.method public constructor <init>(Lorg/luaj/vm2/Varargs;Lorg/luaj/vm2/LuaString;I)V
    ...
    iput v5, p0, Lorg/luaj/vm2/lib/StringLib$FormatDesc;->width:I
...
.method public format(Lorg/luaj/vm2/Buffer;J)V
    ...
    iget v1, p0, Lorg/luaj/vm2/lib/StringLib$FormatDesc;->precision:I
    ...
    :goto_0
    invoke-static {p2, p3, v1}, Ljava/lang/Long;->toString(JI)Ljava/lang/String;

    move-result-object p2

    iget p3, p0, Lorg/luaj/vm2/lib/StringLib$FormatDesc;->conversion:I
    ...
    :cond_4
    iget-boolean v1, p0, Lorg/luaj/vm2/lib/StringLib$FormatDesc;->explicitPlus:Z

    if-nez v1, :cond_6

    iget-boolean v1, p0, Lorg/luaj/vm2/lib/StringLib$FormatDesc;->space:Z
    ...
    iget-boolean p3, p0, Lorg/luaj/vm2/lib/StringLib$FormatDesc;->zeroPad:Z

    if-eqz p3, :cond_8

    iget p3, p0, Lorg/luaj/vm2/lib/StringLib$FormatDesc;->width:I
    ...
    :cond_9
    iget-boolean p3, p0, Lorg/luaj/vm2/lib/StringLib$FormatDesc;->leftAdjust:Z

    const/16 v1, 0x20

    if-nez p3, :cond_a

    invoke-static {p1, v1, v3}, Lorg/luaj/vm2/lib/StringLib$FormatDesc;->pad(Lorg/luaj/vm2/Buffer;CI)V
    ...
    invoke-virtual {p1, p3}, Lorg/luaj/vm2/Buffer;->append(B)Lorg/luaj/vm2/Buffer;
    ...
    :cond_b
    iget-boolean p3, p0, Lorg/luaj/vm2/lib/StringLib$FormatDesc;->explicitPlus:Z
    ...
    :cond_c
    iget-boolean p3, p0, Lorg/luaj/vm2/lib/StringLib$FormatDesc;->space:Z

    if-eqz p3, :cond_d

    invoke-virtual {p1, v1}, Lorg/luaj/vm2/Buffer;->append(B)Lorg/luaj/vm2/Buffer;
    ...
    invoke-static {p1, p3, v2}, Lorg/luaj/vm2/lib/StringLib$FormatDesc;->pad(Lorg/luaj/vm2/Buffer;CI)V
