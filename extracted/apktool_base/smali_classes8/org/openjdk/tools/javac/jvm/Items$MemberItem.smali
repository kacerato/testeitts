.class Lorg/openjdk/tools/javac/jvm/Items$MemberItem;
...
# direct methods
.method public constructor <init>(Lorg/openjdk/tools/javac/jvm/Items;Lorg/openjdk/tools/javac/code/Symbol;Z)V
    .locals 1

    iput-object p1, p0, Lorg/openjdk/tools/javac/jvm/Items$MemberItem;->this$0:Lorg/openjdk/tools/javac/jvm/Items;
    ...
    iput-object p2, p0, Lorg/openjdk/tools/javac/jvm/Items$MemberItem;->member:Lorg/openjdk/tools/javac/code/Symbol;

    iput-boolean p3, p0, Lorg/openjdk/tools/javac/jvm/Items$MemberItem;->nonvirtual:Z
...
.method public drop()V
    ...
    iget-object v0, p0, Lorg/openjdk/tools/javac/jvm/Items$MemberItem;->this$0:Lorg/openjdk/tools/javac/jvm/Items;
...
.method public invoke()Lorg/openjdk/tools/javac/jvm/Items$Item;
    ...
    iget-object v0, p0, Lorg/openjdk/tools/javac/jvm/Items$MemberItem;->member:Lorg/openjdk/tools/javac/code/Symbol;

    iget-object v1, p0, Lorg/openjdk/tools/javac/jvm/Items$MemberItem;->this$0:Lorg/openjdk/tools/javac/jvm/Items;

    iget-object v1, v1, Lorg/openjdk/tools/javac/jvm/Items;->types:Lorg/openjdk/tools/javac/code/Types;

    invoke-virtual {v0, v1}, Lorg/openjdk/tools/javac/code/Symbol;->externalType(Lorg/openjdk/tools/javac/code/Types;)Lorg/openjdk/tools/javac/code/Type;
    ...
    iget-object v2, p0, Lorg/openjdk/tools/javac/jvm/Items$MemberItem;->member:Lorg/openjdk/tools/javac/code/Symbol;
    ...
    iget-boolean v2, p0, Lorg/openjdk/tools/javac/jvm/Items$MemberItem;->nonvirtual:Z

    if-nez v2, :cond_0

    iget-object v2, p0, Lorg/openjdk/tools/javac/jvm/Items$MemberItem;->this$0:Lorg/openjdk/tools/javac/jvm/Items;
    ...
    iget-object v4, p0, Lorg/openjdk/tools/javac/jvm/Items$MemberItem;->member:Lorg/openjdk/tools/javac/code/Symbol;

    invoke-virtual {v2, v4}, Lorg/openjdk/tools/javac/jvm/Pool;->put(Ljava/lang/Object;)I

    move-result v2

    invoke-virtual {v3, v2, v0}, Lorg/openjdk/tools/javac/jvm/Code;->emitInvokeinterface(ILorg/openjdk/tools/javac/code/Type;)V
    ...
    invoke-virtual {v3, v2, v0}, Lorg/openjdk/tools/javac/jvm/Code;->emitInvokespecial(ILorg/openjdk/tools/javac/code/Type;)V
    ...
    invoke-virtual {v3, v2, v0}, Lorg/openjdk/tools/javac/jvm/Code;->emitInvokevirtual(ILorg/openjdk/tools/javac/code/Type;)V
...
.method public stash(I)V
    ...
    invoke-virtual {v0, p1}, Lorg/openjdk/tools/javac/jvm/Items$Item;->stash(I)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lorg/openjdk/tools/javac/jvm/Items$MemberItem;->member:Lorg/openjdk/tools/javac/code/Symbol;

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    iget-boolean v1, p0, Lorg/openjdk/tools/javac/jvm/Items$MemberItem;->nonvirtual:Z
