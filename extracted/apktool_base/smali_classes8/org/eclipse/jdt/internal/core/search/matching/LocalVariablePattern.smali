.class public Lorg/eclipse/jdt/internal/core/search/matching/LocalVariablePattern;
.super Lorg/eclipse/jdt/internal/core/search/matching/VariablePattern;
.source "SourceFile"


# instance fields
.field localVariable:Lorg/eclipse/jdt/internal/core/LocalVariable;


# direct methods
.method public constructor <init>(Lorg/eclipse/jdt/internal/core/LocalVariable;II)V
    .locals 2

    invoke-virtual {p1}, Lorg/eclipse/jdt/internal/core/LocalVariable;->getElementName()Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v0, p2, p3}, Lorg/eclipse/jdt/internal/core/search/matching/VariablePattern;-><init>(I[CII)V

    iput-object p1, p0, Lorg/eclipse/jdt/internal/core/search/matching/LocalVariablePattern;->localVariable:Lorg/eclipse/jdt/internal/core/LocalVariable;
...
.method public findIndexMatches(Lorg/eclipse/jdt/internal/core/index/Index;Lorg/eclipse/jdt/internal/core/search/IndexQueryRequestor;Lorg/eclipse/jdt/core/search/SearchParticipant;Lorg/eclipse/jdt/core/search/IJavaSearchScope;Lorg/eclipse/core/runtime/IProgressMonitor;)V
    ...
    iget-object p5, p0, Lorg/eclipse/jdt/internal/core/search/matching/LocalVariablePattern;->localVariable:Lorg/eclipse/jdt/internal/core/LocalVariable;

    const/4 v0, 0x3

    invoke-virtual {p5, v0}, Lorg/eclipse/jdt/internal/core/JavaElement;->getAncestor(I)Lorg/eclipse/jdt/core/IJavaElement;
    ...
    iget-object v0, p0, Lorg/eclipse/jdt/internal/core/search/matching/LocalVariablePattern;->localVariable:Lorg/eclipse/jdt/internal/core/LocalVariable;

    const/4 v1, 0x7

    invoke-virtual {v0, v1}, Lorg/eclipse/jdt/internal/core/JavaElement;->getAncestor(I)Lorg/eclipse/jdt/core/IJavaElement;
    ...
    invoke-virtual {p5}, Lorg/eclipse/jdt/internal/core/LocalVariable;->getPath()Lorg/eclipse/core/runtime/IPath;
...
.method public print(Ljava/lang/StringBuffer;)Ljava/lang/StringBuffer;
    ...
    const-string v0, "LocalVarCombinedPattern: "

    goto :goto_0

    :cond_0
    const-string v0, "LocalVarDeclarationPattern: "
    ...
    :cond_1
    const-string v0, "LocalVarReferencePattern: "
