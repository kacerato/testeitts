.class Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt;->loadModules(Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt;)V
.end annotation
...
# direct methods
.method public constructor <init>(Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt;Ljava/io/File;)V
    .locals 0

    iput-object p1, p0, Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt$2;->val$jrt:Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt;

    iput-object p2, p0, Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt$2;->val$imageFile:Ljava/io/File;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    const/4 p1, 0x0

    iput-object p1, p0, Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt$2;->packageSet:Lorg/eclipse/jdt/internal/compiler/util/SimpleSet;
...
.method public bridge synthetic visitFile(Ljava/lang/Object;Ljava/lang/Object;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt$2;->visitFile(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;
...
.method public bridge synthetic visitModule(Ljava/lang/Object;Ljava/lang/String;)Ljava/nio/file/FileVisitResult;
    ...
    invoke-virtual {p0, p1, p2}, Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt$2;->visitModule(Ljava/nio/file/Path;Ljava/lang/String;)Ljava/nio/file/FileVisitResult;
...
.method public visitModule(Ljava/nio/file/Path;Ljava/lang/String;)Ljava/nio/file/FileVisitResult;
    ...
    .line 2
    :try_start_0
    iget-object p1, p0, Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt$2;->val$jrt:Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt;

    iget-object v0, p0, Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt$2;->val$imageFile:Ljava/io/File;
    ...
    invoke-virtual {p1, p2}, Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt;->acceptModule([B)V
    :try_end_0
...
.method public bridge synthetic visitPackage(Ljava/lang/Object;Ljava/lang/Object;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt$2;->visitPackage(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;
...
.method public visitPackage(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;
    ...
    .line 2
    iget-object p2, p0, Lorg/eclipse/jdt/internal/core/builder/ClasspathJrt$2;->packageSet:Lorg/eclipse/jdt/internal/compiler/util/SimpleSet;
