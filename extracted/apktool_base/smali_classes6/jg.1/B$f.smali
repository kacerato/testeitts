...
.method public constructor <init>([Ljg/i;LMf/p;)V
    ...
    iput-object p1, p0, Ljg/B$f;->b:[Ljg/i;

    iput-object p2, p0, Ljg/B$f;->c:LMf/p;
...
.method public a(Ljg/j;Lyf/f;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Ljg/B$f;->b:[Ljg/i;

    invoke-static {}, Lkotlin/jvm/internal/M;->w()V

    new-instance v1, Ljg/B$j;

    iget-object v2, p0, Ljg/B$f;->b:[Ljg/i;

    invoke-direct {v1, v2}, Ljg/B$j;-><init>([Ljg/i;)V

    invoke-static {}, Lkotlin/jvm/internal/M;->w()V

    new-instance v2, Ljg/B$k;

    iget-object v3, p0, Ljg/B$f;->c:LMf/p;

    const/4 v4, 0x0

    invoke-direct {v2, v3, v4}, Ljg/B$k;-><init>(LMf/p;Lyf/f;)V
...
.method public d(Ljg/j;Lyf/f;)Ljava/lang/Object;
    ...
    new-instance v0, Ljg/B$f$a;

    invoke-direct {v0, p0, p2}, Ljg/B$f$a;-><init>(Ljg/B$f;Lyf/f;)V
