...
.method public constructor <init>(Ljava/util/concurrent/Callable;LFe/o;LFe/g;Z)V
    ...
    iput-object p1, p0, LMe/t0;->b:Ljava/util/concurrent/Callable;

    iput-object p2, p0, LMe/t0;->c:LFe/o;

    iput-object p3, p0, LMe/t0;->d:LFe/g;

    iput-boolean p4, p0, LMe/t0;->e:Z
...
.method public t1(LBe/v;)V
    ...
    :try_start_0
    iget-object v0, p0, LMe/t0;->b:Ljava/util/concurrent/Callable;
    ...
    :try_start_1
    iget-object v1, p0, LMe/t0;->c:LFe/o;
    ...
    new-instance v2, LMe/t0$a;

    iget-object v3, p0, LMe/t0;->d:LFe/g;

    iget-boolean v4, p0, LMe/t0;->e:Z

    invoke-direct {v2, p1, v0, v3, v4}, LMe/t0$a;-><init>(LBe/v;Ljava/lang/Object;LFe/g;Z)V

    invoke-interface {v1, v2}, LBe/y;->d(LBe/v;)V
    ...
    iget-boolean v2, p0, LMe/t0;->e:Z

    if-eqz v2, :cond_0

    :try_start_2
    iget-object v2, p0, LMe/t0;->d:LFe/g;
    ...
    invoke-static {v2, p1}, LGe/e;->g(Ljava/lang/Throwable;LBe/v;)V

    return-void

    :cond_0
    :goto_0
    invoke-static {v1, p1}, LGe/e;->g(Ljava/lang/Throwable;LBe/v;)V

    iget-boolean p1, p0, LMe/t0;->e:Z

    if-nez p1, :cond_1

    :try_start_3
    iget-object p1, p0, LMe/t0;->d:LFe/g;
