...
.method public static a([BZLjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    sget-object p2, LFg/d;->w:Ljava/nio/charset/Charset;
...
.method public static b(Ljava/lang/String;Ljava/nio/charset/Charset;)[B
    ...
    sget-object p1, LFg/d;->x:Ljava/nio/charset/Charset;
...
.method public static c(LBg/r;Ljava/lang/String;)LBg/j;
    .locals 3
    ...
    invoke-static {p0, p1}, Lyg/d;->d(LBg/r;Ljava/lang/String;)LBg/j;
...
.method public static d(LBg/r;Ljava/lang/String;)LBg/j;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lnet/lingala/zip4j/exception/ZipException;
    ...
    invoke-virtual {p0}, LBg/r;->b()LBg/d;
    ...
    invoke-virtual {p0}, LBg/d;->b()Ljava/util/List;
...
.method public static f(LBg/r;)J
    .locals 2

    invoke-virtual {p0}, LBg/r;->n()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, LBg/r;->j()LBg/o;

    move-result-object p0

    invoke-virtual {p0}, LBg/o;->f()J
...
.method public static g(Ljava/util/List;)J
    ...
    invoke-virtual {v4}, LBg/b;->q()LBg/p;
