...
# direct methods
.method public constructor <init>(LBe/I;LFe/o;LBe/G;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LOe/y1$b;->b:LBe/I;

    iput-object p2, p0, LOe/y1$b;->c:LFe/o;

    new-instance p1, LGe/h;

    invoke-direct {p1}, LGe/h;-><init>()V

    iput-object p1, p0, LOe/y1$b;->d:LGe/h;

    iput-object p3, p0, LOe/y1$b;->g:LBe/G;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicLong;-><init>()V

    iput-object p1, p0, LOe/y1$b;->e:Ljava/util/concurrent/atomic/AtomicLong;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, LOe/y1$b;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public a()V
    ...
    iget-object v0, p0, LOe/y1$b;->e:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget-object v0, p0, LOe/y1$b;->d:LGe/h;

    invoke-virtual {v0}, LGe/h;->dispose()V

    iget-object v0, p0, LOe/y1$b;->b:LBe/I;
...
.method public b(J)V
    ...
    iget-object p1, p0, LOe/y1$b;->f:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-static {p1}, LGe/d;->a(Ljava/util/concurrent/atomic/AtomicReference;)Z

    iget-object p1, p0, LOe/y1$b;->g:LBe/G;

    const/4 p2, 0x0

    iput-object p2, p0, LOe/y1$b;->g:LBe/G;
...
.method public c(JLjava/lang/Throwable;)V
    ...
    iget-object p1, p0, LOe/y1$b;->b:LBe/I;
...
.method public dispose()V
    ...
    iget-object v0, p0, LOe/y1$b;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public f(LBe/G;)V
    ...
    iget-object v1, p0, LOe/y1$b;->d:LGe/h;
...
.method public h(Ljava/lang/Object;)V
    ...
    iget-object v4, p0, LOe/y1$b;->e:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    :try_start_0
    iget-object v0, p0, LOe/y1$b;->c:LFe/o;
    ...
    invoke-direct {v0, v5, v6, p0}, LOe/y1$a;-><init>(JLOe/y1$d;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iget-object p1, p0, LOe/y1$b;->d:LGe/h;
