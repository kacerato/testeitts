...
.method public mf(S)I
    ...
    :cond_1
    invoke-virtual {p0, p1, v2, v3, v0}, LWd/h0;->nf(SIIB)I
...
.method public nf(SIIB)I
    .locals 4

    iget-object p4, p0, LWd/h0;->q:[S
...
.method public of(S)I
    ...
    invoke-virtual {p0, v2, p1}, LWd/h0;->pf(IS)V
    ...
    :cond_1
    invoke-virtual {p0, p1, v2, v0, v1}, LWd/h0;->qf(SIIB)I
...
.method public qf(SIIB)I
    ...
    invoke-virtual {p0, v3, p1}, LWd/h0;->pf(IS)V

    return v3

    :cond_3
    iput-boolean v1, p0, LWd/h0;->s:Z

    invoke-virtual {p0, v4, p1}, LWd/h0;->pf(IS)V
