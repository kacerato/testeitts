.class public Ljpct/ae/wrapper/JTexture;
...
.method public static final DEFAULT_HEIGHT()I
    .locals 1
...
.method public static final DEFAULT_WIDTH()I
    .locals 1
...
.method public Initialize(Ljava/io/InputStream;)V
    ...
    invoke-direct {v0, p1}, Lcom/threed/jpct/Texture;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {p0, v0}, Ljpct/ae/wrapper/JTexture;->setObject(Ljava/lang/Object;)V

    return-void
.end method

.method public Initialize2(Ljava/io/InputStream;Z)V
    .locals 1

    new-instance v0, Lcom/threed/jpct/Texture;

    invoke-direct {v0, p1, p2}, Lcom/threed/jpct/Texture;-><init>(Ljava/io/InputStream;Z)V
...
.method public Initialize3(Landroid/graphics/Bitmap;)V
    ...
    invoke-direct {v0, p1}, Lcom/threed/jpct/Texture;-><init>(Landroid/graphics/Bitmap;)V
...
.method public Initialize4(Landroid/graphics/Bitmap;Z)V
    .locals 1

    new-instance v0, Lcom/threed/jpct/Texture;

    invoke-direct {v0, p1, p2}, Lcom/threed/jpct/Texture;-><init>(Landroid/graphics/Bitmap;Z)V
...
.method public Initialize5(Landroid/graphics/drawable/Drawable;)V
    .locals 1

    new-instance v0, Lcom/threed/jpct/Texture;

    invoke-direct {v0, p1}, Lcom/threed/jpct/Texture;-><init>(Landroid/graphics/drawable/Drawable;)V
...
.method public Initialize6(Landroid/graphics/drawable/Drawable;Z)V
    .locals 1

    new-instance v0, Lcom/threed/jpct/Texture;

    invoke-direct {v0, p1, p2}, Lcom/threed/jpct/Texture;-><init>(Landroid/graphics/drawable/Drawable;Z)V
...
.method public Initialize7(II)V
    .locals 1

    new-instance v0, Lcom/threed/jpct/Texture;

    invoke-direct {v0, p1, p2}, Lcom/threed/jpct/Texture;-><init>(II)V
...
.method public Initialize8(III)V
    .locals 1

    new-instance v0, Lcom/threed/jpct/Texture;

    invoke-direct {v0, p1, p2, p3}, Lcom/threed/jpct/Texture;-><init>(III)V
...
.method public Initialize9(IILcom/threed/jpct/RGBColor;)V
    .locals 1

    new-instance v0, Lcom/threed/jpct/Texture;

    invoke-direct {v0, p1, p2, p3}, Lcom/threed/jpct/Texture;-><init>(IILcom/threed/jpct/RGBColor;)V
...
.method public add(Lcom/threed/jpct/Texture;F)V
    ...
    invoke-virtual {p0}, Ljpct/ae/wrapper/JTexture;->getObject()Ljava/lang/Object;
